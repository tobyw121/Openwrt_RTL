...
must(drv, '1.8.3-mw5-stablefast-v44.65.6', 'driver version')
...
must(drv, 'static bool mw5_hw_qos = true;', 'HW QoS remains default on')
...
print(f'MW5 v44.65.6 stable-fast validation OK: {len(checks)} checks')
