...
need(D,'1.8.34-mw5-oem-v212-v44.66.12','version')
...
need(D,'mw5_dsa_host_vlan version=v44.66.12 p0_mode=%s p0_router_mode=%u tx_dvid_lan=%u tx_dvid_wan=%u physical_dp=p0','runtime P0 diagnostic')
need(D,'p0-transparent','live transparent command'); need(D,'p0-router-vlan','A/B fallback command')
need(P331,'mw5_diag=v44.66.12','switch diag revision'); need(P331,'cpu_tag_policy=v44.66.12','switch policy revision')
need(P330,'MW5 CPU tag parser v44.66.12','switch parser revision'); need(P330,'RTL8365MB_MW5_VLAN_EGRESS_MODE_KEEP','user egress KEEP')
...
need(RA,'v7.9/v44.66.12','router audit revision'); need(PA,'pc_audit=v7.9-v44.66.12','PC audit revision')
...
if errs:
    print('MW5 OEM V212 v44.66.12 validation FAILED',file=sys.stderr)
    for e in errs: print(' - '+e,file=sys.stderr)
    sys.exit(1)
print('MW5 OEM V212 v44.66.12 validation OK')
