...
"""Static regression guard for MW5 OEM V212 v44.66.5."""
...
need(DRV, '#define DRV_VERSION\t\t\t"1.8.27-mw5-oem-v212-v44.66.5"', 'driver version')
...
# v44.66.5 corrected physical topology: a real RTL8367 tag stays on wire and
...
need(PATCH331, 'mw5_diag=v44.66.5', 'patch331 diagnostic revision')
need(PATCH331, 'cpu_tag_policy=v44.66.5', 'patch331 CPU-tag policy revision')
...
need(ROUTER_AUDIT, 'collector v7.2/v44.66.5', 'router audit revision')
...
need(PC_AUDIT, 'pc_audit=v7.2-v44.66.5', 'PC audit revision')
...
if errors:
    print('MW5 OEM V212 v44.66.5 validation FAILED', file=sys.stderr)
    for e in errors: print('  - ' + e, file=sys.stderr)
    sys.exit(1)
print('MW5 OEM V212 v44.66.5 validation OK')
