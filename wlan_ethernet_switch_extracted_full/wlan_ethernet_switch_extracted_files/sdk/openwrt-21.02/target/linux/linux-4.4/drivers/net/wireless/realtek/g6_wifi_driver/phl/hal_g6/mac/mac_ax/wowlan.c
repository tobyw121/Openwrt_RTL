		      ...
		      struct rtw_tcp_keepalive_parm *parm)
{
	...
	cpu_to_le32(SET_WORD((u8)parm->macid,
			     FWCMD_H2C_TCP_KEEPALIVE_MACID) |
		    SET_WORD(parm->period,
			     FWCMD_H2C_TCP_KEEPALIVE_PERIOD) |
		    SET_WORD(parm->tx_pktid,
			     FWCMD_H2C_TCP_KEEPALIVE_TX_PKTID) |
		    (parm->enable ?
		     FWCMD_H2C_TCP_KEEPALIVE_ENABLE : 0));
