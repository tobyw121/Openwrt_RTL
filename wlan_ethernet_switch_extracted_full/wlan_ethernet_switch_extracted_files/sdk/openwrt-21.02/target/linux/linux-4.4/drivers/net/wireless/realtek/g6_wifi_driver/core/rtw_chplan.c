...
static const struct ch_list_t rtw_channel_def_5g[] = {
	...
	/* RTW_CHD_5G_53 */	CH_LIST_ENT(13, 36, 40, 44, 48, 52, 56, 60, 64, 149, 153, 157, 161, 165, 0),
};
...
static const struct chplan_ent_t RTW_ChannelPlanMap[] = {
	[0x00] = CHPLAN_ENT(ETSI , 02, ETSI , 06),  /* TODO 暂时写为BR对应的信道，避免样机启动后beacon帧中支持的信道列表异常，后续适配根据国家码启动5g接口后将该改动revert */
	...
	[0x09] = CHPLAN_ENT(ETSI , 02, ETSI , 53),
	...
	[0x26] = CHPLAN_ENT(ETSI , 01, ETSI , 14),
