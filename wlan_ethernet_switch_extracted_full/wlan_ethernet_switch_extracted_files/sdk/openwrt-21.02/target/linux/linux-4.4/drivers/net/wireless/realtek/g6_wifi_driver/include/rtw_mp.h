...
#include <drv_types.h>
#include "../phl/test/mp/phl_test_mp_def.h"
...
#else
#define RTW_MAX_TEST_CMD_BUF 2048
#endif
...
extern s32 g6_mp_start_test(_adapter *padapter);
extern void g6_mp_stop_test(_adapter *padapter);
...
void	rtw_set_phl_pre_tx(_adapter *padapter);
