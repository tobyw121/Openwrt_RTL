...
#define WPA_CIPHER_SMS4 BIT(12)
#define WPA_CIPHER_GCM_SM4 BIT(13)
#define WPA_CIPHER_BIP_CMAC_SM4_128 BIT(14)
#endif
...
#define WLAN_AKM_TYPE_OWE BIT(15)
#endif /* CONFIG_HAPD_OWE */
#define WLAN_AKM_TYPE_DPP BIT(16)
#if defined(CONFIG_RTL_CFG80211_WAPI_SUPPORT)
#define WLAN_AKM_TYPE_WAPI_PSK BIT(17)
#define WLAN_AKM_TYPE_WAPI_CERT BIT(18)
#endif
...
#define WLAN_REASON_DISASSOC_DUE_BSS_TRANSITION 12	//Disassociated due to BSS Transition Management
...
#define WLAN_EID_SUPPORTED_REGULATORY_CLASSES 59
...
#define WLAN_EID_EXTENSION_MU_EDCA	38
...
enum rtw_ieee80211_category {
	...
	RTW_WLAN_CATEGORY_PROTECTED_PUBLIC = 9,
	...
	RTW_WLAN_CATEGORY_UNPROTECTED_S1G = 22,
...
/* HE features action code */
enum rtw_ieee80211_he_actioncode {
	RTW_WLAN_ACTION_HE_COMPRESSED_BEAMFORMING_CQI = 0,
	RTW_WLAN_ACTION_HE_QUIET_TIME_PERIOD = 1,
	RTW_WLAN_ACTION_HE_OPS = 2,
};
...
enum rtw_ieee80211_wnm_actioncode {
	...
	RTW_WLAN_ACTION_WNM_NOTIFICATION_REQ = 26,
};
#define _WNM_PREFERED_BSS_TRANS_LIST_INCLUDED_	19
#define MAX_LIST_LEN							2304
#endif

enum rtw_ieee80211_s1g_actiobcode {
	RTW_WLAN_ACTION_UNPROETCT_S1G_TWTSETUP = 6,
	RTW_WLAN_ACTION_UNPROETCT_S1G_TWTTEARDOWN = 7,
	RTW_WLAN_ACTION_UNPROETCT_S1G_TWTINFO = 11,
};
...
u8 *rtw_set_ie_ch_switch_wrapper(u8 *buf, u32 *buf_len, u8 new_bw, u8 new_center_ch);
#endif
...
#if defined(CONFIG_RTL_CFG80211_WAPI_SUPPORT)
int rtw_parse_wapi_ie(u8 *wapi_ie, int wapi_ie_len, int *group_cipher, int *pairwise_cipher, int *gmcs, u32 *akm, u8 *mfp_opt);
#endif
