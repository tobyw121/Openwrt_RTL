...
void reg_write8_usb_8851e(struct mac_ax_adapter *adapter, u32 addr, u8 val)
{
...
u32 read_usb3phy_para_8851e(struct mac_ax_adapter *adapter, u16 offset, u8 b_sel)
{
	u32 value32 = 0, ret;
	u16 rdata = 0;
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
...
u32 write_usb3phy_para_8851e(struct mac_ax_adapter *adapter,
...
{
	u32 dw1 = ((struct wd_body_usb_8851e *)agg->pkt)->dword1;

	((struct wd_body_usb_8851e *)agg->pkt)->dword1 =
			 ...
			 struct mac_ax_rx_agg_cfg *cfg)
{
	...
	/* size unit was 4k in 8851A|B|51B */
...
u32 usb_pwr_switch_8851e(void *vadapter, u8 pre_switch, u8 on)
{
	return MACSUCCESS;
}
