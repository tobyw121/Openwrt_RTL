...
u8 reg_read8_usb_8851b(struct mac_ax_adapter *adapter, u32 addr)
{
	u8 offset, count = 0;
	u32 val;
...
void reg_write8_usb_8851b(struct mac_ax_adapter *adapter, u32 addr, u8 val)
{
	PLTFM_REG_W8(addr, val);
}

u16 reg_read16_usb_8851b(struct mac_ax_adapter *adapter, u32 addr)
{
	u8 offset, count = 0;
	u32 val;
...
void reg_write16_usb_8851b(struct mac_ax_adapter *adapter, u32 addr, u16 val)
{
	PLTFM_REG_W16(addr, val);
}

u32 reg_read32_usb_8851b(struct mac_ax_adapter *adapter, u32 addr)
{
	u8 count = 0;
...
void reg_write32_usb_8851b(struct mac_ax_adapter *adapter, u32 addr, u32 val)
{
	PLTFM_REG_W32(addr, val);
}

u8 get_bulkout_id_8851b(struct mac_ax_adapter *adapter, u8 ch_dma, u8 mode)
{
	u8 bulkout_id = 0;
...
u32 usb_pre_init_8851b(struct mac_ax_adapter *adapter, void *param)
{
	u32 val32 = 0;
...
u32 usb_init_8851b(struct mac_ax_adapter *adapter, void *param)
{
	u32 val32;
	u8 val8;
...
u32 usb_deinit_8851b(struct mac_ax_adapter *adapter, void *param)
{
	return MACSUCCESS;
}

u32 read_usb2phy_para_8851b(struct mac_ax_adapter *adapter, u16 offset)
{
	u32 value32 = 0;
	u8 rdata = 0;
...
u32 write_usb2phy_para_8851b(struct mac_ax_adapter *adapter, u16 offset, u8 val)
{
	u32 value32 = 0;
...
u32 read_usb3phy_para_8851b(struct mac_ax_adapter *adapter, u16 offset, u8 b_sel)
{
	u32 value32 = 0, ret;
	u16 rdata = 0;
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
...
u32 write_usb3phy_para_8851b(struct mac_ax_adapter *adapter,
...
u32 u2u3_switch_8851b(struct mac_ax_adapter *adapter)
{
	u32 ret = 0;
...
u32 get_usb_support_ability_8851b(struct mac_ax_adapter *adapter)
{
	u32 u2force = 0;
	u32 u3force = 0;
...
u32 usb_tx_agg_cfg_8851b(struct mac_ax_adapter *adapter,
			 struct mac_ax_usb_tx_agg_cfg *agg)
{
	u32 dw1 = ((struct wd_body_usb_8851b *)agg->pkt)->dword1;

	((struct wd_body_usb_8851b *)agg->pkt)->dword1 =
		SET_CLR_WORD(dw1, agg->agg_num, AX_TXD_DMA_TXAGG_NUM);
	return MACSUCCESS;
}

u32 usb_rx_agg_cfg_8851b(struct mac_ax_adapter *adapter,
...
u32 usb_pwr_switch_8851b(void *vadapter, u8 pre_switch, u8 on)
{
	return MACSUCCESS;
}

u32 set_usb_wowlan_8851b(struct mac_ax_adapter *adapter,
...
u32 usb_get_txagg_num_8851b(struct mac_ax_adapter *adapter, u8 band)
{
...
u32 usb_get_rx_state_8851b(struct mac_ax_adapter *adapter, u32 *val)
{
...
u32 usb_ep_cfg_8851b(struct mac_ax_adapter *adapter, struct mac_ax_usb_ep *cfg)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
