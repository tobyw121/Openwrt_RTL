...
#include "../phy_misc.h"
#include "../h2c_agg.h"
#include "mac_priv_8852a.h"
#include "../dbcc.h"
#include "../beacon.h"
#include "coex_8852a.h"
#include "phy_rpt_8852a.h"
#include "hwamsdu_8852a.h"
#include "hdr_conv_rx_8852a.h"
#include "dle_8852a.h"
...
static struct mac_ax_intf_ops mac8852a_sdio_ops = {
	...
	sdio_pre_init_8852a, /* intf_pre_init */
	sdio_init, /* intf_init */
...
static struct mac_ax_intf_ops mac8852a_usb_ops = {
	...
	usb_get_rx_state_8852a, /*get_usb_rx_state*/
...
static struct mac_ax_intf_ops mac8852a_pcie_ops = {
	...
	ctrl_txdma_ch_pcie_8852a, /*ctrl_txdma_ch*/
	clr_idx_all_pcie, /*clr_idx_all*/
	poll_txdma_ch_idle_pcie_8852a, /*poll_txdma_ch_idle*/
	poll_rxdma_ch_idle_pcie_8852a, /*poll_rxdma_ch_idle*/
	ctrl_txhci_pcie, /*ctrl_txhci*/
	ctrl_rxhci_pcie, /*ctrl_rxhci*/
	ctrl_dma_io_pcie, /*ctrl_dma_io*/
	get_io_stat_pcie_8852a, /* get_io_stat */
	pcie_get_txagg_num, /*get_txagg_num*/
	get_avail_txbd_8852a, /*get_avail_txbd*/
	get_avail_rxbd_8852a, /*get_avail_rxbd*/
...
static struct mac_ax_ops mac8852a_ops = {
	...
	mac_get_macaddr,
	mac_build_txdesc_8852a, /* build_txdesc */
	mac_refill_txdesc_8852a, /* refill_txdesc */
	mac_parse_rxdesc_8852a, /* parse_rxdesc */
	...
	/*TRX related*/
	mac_txdesc_len_8852a, /* txdesc_len */
	...
	mac_enable_cut_hwamsdu_8852a, /* enable_cut_hwamsdu */
	mac_cut_hwamsdu_chk_mpdu_len_en_8852a, /* enable cut-amsdu chk mpdu size*/
	...
	mac_hdr_conv_rx_en_8852a, /* enable rx mac hdr conversion*/
	mac_hdr_conv_rx_en_driv_info_hdr_8852a, /*en rx hdr conv driver info*/
	...
	mac_is_txq_empty_8852a, /*is_txq_empty*/
	mac_is_rxq_empty_8852a, /*is_rxq_empty*/
	...
	mac_patch_rx_rate_8852a, /*for patch rate*/
	mac_get_wp_offset_8852a, /* wd offload for wp_offset, called while forming metadata */
	...
	mac_coex_init_8852a, /* coex_init */
	mac_read_coex_reg_8852a, /* coex_read */
	mac_write_coex_reg_8852a, /* coex_write */
					     ...
					     struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	p = get_priv(adapter);
	*p = get_mac_8852a_priv_ops(intf);

	switch (intf) {
#if MAC_AX_SDIO_SUPPORT
	case MAC_AX_INTF_SDIO:
		adapter->ops->intf_ops = &mac8852a_sdio_ops;
		pwr_info->intf_pwr_switch = sdio_pwr_switch_8852a;
		break;
#endif
#if MAC_AX_USB_SUPPORT
	case MAC_AX_INTF_USB:
...
u32 dmac_func_en_8852a(struct mac_ax_adapter *adapter)
{
...
u32 dmac_func_pre_en_8852a(struct mac_ax_adapter *adapter)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32;
