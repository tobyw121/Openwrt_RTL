...
static u32 mu_vld_chk(struct mac_ax_adapter *adapter, u8 *vld)
{
	...
	case MAC_AX_CHIP_ID_8851B:
		...
		break;
	case MAC_AX_CHIP_ID_8851E:
		mu_support = STA_SCH_MU_SUPPORT_8851E;
		break;
	case MAC_AX_CHIP_ID_8852D:
		mu_support = STA_SCH_MU_SUPPORT_8852D;
		break;
	default:
		return MACCHIPID;
	}
...
static u32 ru_vld_chk(struct mac_ax_adapter *adapter, u8 *vld)
{
	...
	case MAC_AX_CHIP_ID_8851B:
		...
		break;
	case MAC_AX_CHIP_ID_8851E:
		ru_support = STA_SCH_RU_SUPPORT_8851E;
		break;
	case MAC_AX_CHIP_ID_8852D:
		ru_support = STA_SCH_RU_SUPPORT_8852D;
		break;
	default:
		return MACCHIPID;
	}
