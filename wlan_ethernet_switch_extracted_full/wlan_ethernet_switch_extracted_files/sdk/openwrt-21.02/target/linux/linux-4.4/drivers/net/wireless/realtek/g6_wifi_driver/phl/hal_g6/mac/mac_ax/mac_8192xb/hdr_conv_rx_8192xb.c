...
u32 mac_hdr_conv_rx_en_8192xb(struct mac_ax_adapter *adapter,
...
u32 mac_hdr_conv_rx_en_driv_info_hdr_8192xb(struct mac_ax_adapter *adapter,
					    struct mac_ax_rx_driv_info_hdr_cfg *cfg)
{
	...
	enum mac_ax_drv_info_size drv_info_0;
	u32 val, ori_drv_info;
	...
	if ((u32)drv_info_0 > ori_drv_info) {
		val = MAC_REG_R32(R_AX_RCR);
