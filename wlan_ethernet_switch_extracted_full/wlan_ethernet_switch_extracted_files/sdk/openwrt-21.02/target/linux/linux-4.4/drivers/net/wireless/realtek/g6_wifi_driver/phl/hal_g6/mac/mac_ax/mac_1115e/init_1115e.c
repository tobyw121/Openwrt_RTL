...
#if MAC_AX_SDIO_SUPPORT
static struct mac_ax_intf_ops mac1115e_sdio_ops = {
	...
	sdio_pre_init_1115e, /* intf_pre_init */
	sdio_init, /* intf_init */
...
#if MAC_AX_USB_SUPPORT
static struct mac_ax_intf_ops mac1115e_usb_ops = {
	reg_read8_usb_1115e, /* reg_read8 */
	reg_write8_usb_1115e, /* reg_write8 */
	reg_read16_usb_1115e, /* reg_read16 */
	reg_write16_usb_1115e, /* reg_write16 */
	reg_read32_usb_1115e, /* reg_read32 */
	reg_write32_usb_1115e, /* reg_write32 */
	NULL, /* tx_allow_sdio */
	NULL, /* tx_cmd_addr_sdio */
	usb_pre_init_1115e, /* intf_pre_init */
	usb_init_1115e, /* intf_init */
	usb_deinit_1115e, /* intf_deinit */
	NULL, /* reg_read_n_sdio */
	get_bulkout_id_1115e, /*get_bulkout_id*/
	ltr_set_usb, /* ltr_set_pcie */
	u2u3_switch_1115e, /*u2u3_switch*/
	get_usb_mode, /*get_usb_mode*/
	get_usb_support_ability_1115e,/*get_usb_support_ability*/
	usb_tx_agg_cfg_1115e, /*usb_tx_agg_cfg*/
	usb_rx_agg_cfg_1115e, /*usb_rx_agg_cfg*/
	set_usb_wowlan_1115e, /*set_wowlan*/
	...
	usb_get_txagg_num_1115e, /*get_txagg_num*/
	...
	usb_get_rx_state_1115e, /*get_usb_rx_state*/
...
#if MAC_AX_PCIE_SUPPORT
static struct mac_ax_intf_ops mac1115e_pcie_ops = {
	...
	ctrl_txdma_ch_pcie_1115e, /*ctrl_txdma_ch*/
	clr_idx_all_pcie, /*clr_idx_all*/
	poll_txdma_ch_idle_pcie_1115e, /*poll_txdma_ch_idle*/
	poll_rxdma_ch_idle_pcie_1115e, /*poll_rxdma_ch_idle*/
	ctrl_txhci_pcie, /*ctrl_txhci*/
	ctrl_rxhci_pcie, /*ctrl_rxhci*/
	ctrl_dma_io_pcie, /*ctrl_dma_io*/
	get_io_stat_pcie_1115e, /* get_io_stat */
	pcie_get_txagg_num, /*get_txagg_num*/
	get_avail_txbd_1115e, /*get_avail_txbd*/
	get_avail_rxbd_1115e, /*get_avail_rxbd*/
...
static struct mac_ax_ops mac1115e_ops = {
	NULL, /* intf_ops */
	/*System level*/
	...
	mac_get_macaddr,
	mac_build_txdesc_1115e, /* build_txdesc */
	mac_refill_txdesc_1115e, /* refill_txdesc */
	mac_parse_rxdesc_1115e, /* parse_rxdesc */
	...
	mac_dump_efuse_ofld,
	mac_efuse_ofld_map,
	mac_upd_dctl_info_1115e, /*update dmac ctrl info*/
	mac_upd_cctl_info_1115e, /*update cmac ctrl info*/
	...
	mac_sta_add_key_1115e, /* add station key */
	mac_sta_del_key_1115e, /* del station key */
	...
	/*TRX related*/
	mac_txdesc_len_1115e, /* txdesc_len */
	...
	mac_enable_cut_hwamsdu_1115e, /* enable_cut_hwamsdu */
	mac_cut_hwamsdu_chk_mpdu_len_en_1115e, /* enable cut-amsdu chk mpdu size*/
	...
	mac_hdr_conv_rx_en_1115e, /* enable rx mac hdr conversion*/
	mac_hdr_conv_rx_en_driv_info_hdr_1115e, /*en rx hdr conv driver info*/
	...
	mac_is_txq_empty_1115e, /*is_txq_empty*/
	mac_is_rxq_empty_1115e, /*is_rxq_empty*/
	...
	mac_patch_rx_rate_1115e, /*for patch rx rate*/
	mac_get_wp_offset_1115e, /* wd offload for wp_offset, called while forming metadata */
	/*frame exchange related*/
	mac_upd_mudecision_para, /* upd_ba_infotbl */
	mac_mu_sta_upd, /* upd_mu_sta */
	mac_upd_ul_fixinfo, /* upd_ul_fixinfo */
	NULL,
	mac_f2p_test_cmd_1115e, /*f2p test cmd para*/
	...
	mac_pinmux_set_func_1115e, /* pinmux_set_func */
	mac_pinmux_free_func, /* pinmux_free_func */
	mac_sel_uart_tx_pin, /* sel_uart_tx_pin */
	mac_sel_uart_rx_pin, /* sel_uart_rx_pin */
	mac_gpio_init_1115e, /* gpio_init */
	mac_set_gpio_func_1115e, /* set_gpio_func */
	...
	mac_coex_init_1115e, /* coex_init */
	mac_read_coex_reg_1115e, /* coex_read */
	mac_write_coex_reg_1115e, /* coex_write */
	...
	mac_cfg_per_pkt_phy_rpt_1115e, /* cfg_per_pkt_phy_rpt */
#if MAC_AX_FEATURE_DBGPKG
...
static struct mac_ax_hw_info mac1115e_hw_info = {
	0, /* done */
	MAC_BE_CHIP_ID_1115E, /* chip_id */
	0xFF, /* cv */
	0, /* acv */
	0xFF, /* fv */
	...
	pwr_on_seq_1115e, /* pwr_on_seq */
	pwr_off_seq_1115e, /* pwr_off_seq */
	PWR_SEQ_VER_1115E, /* pwr_seq_ver */
	458752, /* fifo_size */
...
struct mac_ax_ft_status mac_1115e_ft_status[] = {
	{MAC_AX_FT_DUMP_EFUSE, MAC_AX_STATUS_IDLE, NULL, 0},
	{MAC_AX_FT_MAX, MAC_AX_STATUS_ERR, NULL, 0},
};

static struct mac_ax_adapter mac_1115e_adapter = {
	&mac1115e_ops, /* ops */
	NULL, /* drv_adapter */
	NULL, /* phl_adapter */
	NULL, /* pltfm_cb */
					     ...
					     struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	hal_mem_cpy(drv_adapter, adapter, &mac_1115e_adapter,
		    sizeof(struct mac_ax_adapter));
	...
	case MAC_AX_INTF_SDIO:
		adapter->ops->intf_ops = &mac1115e_sdio_ops;
		pwr_info->intf_pwr_switch = sdio_pwr_switch;
		break;
#endif
#if MAC_AX_USB_SUPPORT
	case MAC_AX_INTF_USB:
		adapter->ops->intf_ops = &mac1115e_usb_ops;
		pwr_info->intf_pwr_switch = usb_pwr_switch;
		break;
#endif
#if MAC_AX_PCIE_SUPPORT
	case MAC_AX_INTF_PCIE:
		adapter->ops->intf_ops = &mac1115e_pcie_ops;
					     ...
					     struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	pltfm_cb->rtl_memcpy(drv_adapter, adapter, &mac_1115e_adapter,
		     sizeof(struct mac_ax_adapter));
	...
	pltfm_cb->rtl_memcpy(drv_adapter, hw_info, &mac1115e_hw_info,
		sizeof(struct mac_ax_hw_info));
...
u32 dmac_func_pre_en_1115e(struct mac_ax_adapter *adapter)
{
	...
	val32 = (B_BE_MAC_EN | B_BE_DMAC_EN |
		 B_BE_DISPATCHER_EN | B_BE_PKTBUF_EN | B_BE_H_AXIDMA_EN);
		MAC_REG_W32(R_BE_DMAC_FUNC_EN, val32);

	val32 = (B_BE_DISPATCHEB_BE_CKEN);
	MAC_REG_W32(R_BE_DMAC_CLK_EN, val32);

	adapter->sm.dmac_func = MAC_AX_FUNC_ON;

	val32 = MAC_REG_R32(R_BE_HAXI_INIT_CFG1);
	...
	val32 = (val32 & ~B_BE_STOP_AXI_MST) | B_BE_TXDMA_EN |
		 B_BE_RXDMA_EN;
	MAC_REG_W32(R_BE_HAXI_INIT_CFG1, val32);

	val32 = MAC_REG_R32(R_BE_HAXI_DMA_STOP1) &
		~(B_BE_STOP_CH0 | B_BE_STOP_CH1 | B_BE_STOP_CH2 |
		  ...
		  B_BE_STOP_CH12);
	MAC_REG_W32(R_BE_HAXI_DMA_STOP1, val32);
