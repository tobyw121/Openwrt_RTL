...
extern int br_set_interface_vlan(const char *bridge, const char *dev, int vlan, int vlanpos);
extern int br_set_interface_tag(const char *bridge, const char *dev, const char *vlan);
extern int br_show_vlan(const char *bridge);
