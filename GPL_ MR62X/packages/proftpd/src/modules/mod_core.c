...
// add by zhangzhongwei, 2014.2.24
MODRET set_guestlimit(cmd_rec *cmd) {
  int bool = -1;
  config_rec *c = NULL;
...
#endif /* end of PR_USE_GUEST_LIMIT */
...
#ifdef PR_USE_GUEST_LIMIT  
  { "AllowGuestNetwork",	set_guestlimit,			NULL }, // add by zhangzhongwei, 2014.2.24
#endif 
  { NULL, NULL, NULL }
};
