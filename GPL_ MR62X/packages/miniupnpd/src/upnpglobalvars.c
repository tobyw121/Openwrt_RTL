...
char manufacturer[MANUFACTURER_MAX_LEN] = ROOTDEV_MANUFACTURER;
char manufacturerurl[MANUFACTURERURL_MAX_LEN] = ROOTDEV_MANUFACTURERURL;
char modeldescription[MODELDESCRIPTION_MAX_LEN] = ROOTDEV_MODELDESCRIPTION;
char modelname[MODELNAME_MAX_LEN] = ROOTDEV_MODELNAME;
char modelnumber[MODELNUMBER_MAX_LEN] = "1";
char modelurl[MODELURL_MAX_LEN] = ROOTDEV_MODELURL;
...
char randomprefix[RANDOM_PREFIX_LEN] = "abcde";
/*global random path.*/
char rootDescPath[RANDOM_PATH_LEN];

#ifdef HAS_DUMMY_SERVICE
char dummyPath[RANDOM_PATH_LEN];
#endif

char wancfgPath[RANDOM_PATH_LEN];
char wancfgControlURL[RANDOM_PATH_LEN];
char wancfgEventURL[RANDOM_PATH_LEN];

char wanIPCPath[RANDOM_PATH_LEN];
char wanIPCControlURL[RANDOM_PATH_LEN];
char wanIPCEventURL[RANDOM_PATH_LEN];

#ifdef ENABLE_L3F_SERVICE
char L3FPath[RANDOM_PATH_LEN];
char L3FControlURL[RANDOM_PATH_LEN];
char L3FEventURL[RANDOM_PATH_LEN];
#endif

#ifdef ENABLE_6FC_SERVICE
char wanIP6FCPath[RANDOM_PATH_LEN];
char wanIP6FCControlURL[RANDOM_PATH_LEN];
char wanIP6FCEventURL[RANDOM_PATH_LEN];
#endif

#ifdef ENABLE_DP_SERVICE
/* For DeviceProtection introduced in IGD v2 */
char DPPath[RANDOM_PATH_LEN];
char DPControlURL[RANDOM_PATH_LEN];
char DPEventURL[RANDOM_PATH_LEN];
#endif
