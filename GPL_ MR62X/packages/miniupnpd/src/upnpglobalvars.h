...
extern unsigned int max_rules;

#define RANDOM_PREFIX_LEN (6)
extern char randomprefix[];
/*global random path.*/
#define RANDOM_PATH_LEN (32)
extern char rootDescPath[];

#ifdef HAS_DUMMY_SERVICE
extern char dummyPath[];
#endif

extern char wancfgPath[];
extern char wancfgControlURL[];
extern char wancfgEventURL[];

extern char wanIPCPath[];
extern char wanIPCControlURL[];
extern char wanIPCEventURL[];

#ifdef ENABLE_L3F_SERVICE
extern char L3FPath[];
extern char L3FControlURL[];
extern char L3FEventURL[];
#endif

#ifdef ENABLE_6FC_SERVICE
extern char wanIP6FCPath[];
extern char wanIP6FCControlURL[];
extern char wanIP6FCEventURL[];
#endif

#ifdef ENABLE_DP_SERVICE
/* For DeviceProtection introduced in IGD v2 */
extern char DPPath[];
extern char DPControlURL[];
extern char DPEventURL[];
#endif
