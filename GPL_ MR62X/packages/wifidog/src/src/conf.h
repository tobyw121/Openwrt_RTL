...
#define NUM_EXT_INTERFACE_DETECT_RETRY 10
...
#else
	#define DEFAULT_CONFIGFILE SYSCONFDIR"/wifidog/wifidog.conf"
	#define DEFAULT_HTMLMSGFILE SYSCONFDIR"/wifidog/wifidog-msg.html"
#endif
#else
	#define DEFAULT_CONFIGFILE "/var/etc/wifidog.conf"
	//#define DEFAULT_HTMLMSGFILE "/etc/wifidog/wifidog-msg.html"
	#define DEFAULT_HTMLMSGFILE "/etc/wifidog/portal.html"
	#define DEFAULT_CONFIGPATH "/etc/wifidog/wifidog.conf"
#endif
#define DEFAULT_PORTALBGRJPG "/etc/wifidog/portal_back.jpg"
#define DEFAULT_PORTALLOGOJPG "/etc/wifidog/portal_logo.png"
#define DEFAULT_PORTALLANJS "/etc/wifidog/lan.js"
#define DEFAULT_PORTALJQUER "/etc/wifidog/jquery.min.js"
#define DEFAULT_PORTALCLOSEICONPNG "/etc/wifidog/Close.png"
#define DEFAULT_PORTALENABLE1ICONPNG "/etc/wifidog/Enable1.png"
#define DEFAULT_PORTALENABLE2ICONPNG "/etc/wifidog/Enable2.png"
#define DEFAULT_PORTALINVISIBLEICONPNG "/etc/wifidog/Invisible.png"
#define DEFAULT_PORTALVISIBLEICONPNG "/etc/wifidog/Visible.png"
#define DEFAULT_PORTALREDECLAMATIONICONPNG "/etc/wifidog/red-eclamation.png"



#define DEFAULT_USERPORTALBGRJPG "/www/tmp/portal_back.jpg"
#define DEFAULT_USERPORTALLOGOJPG "/www/tmp/portal_logo.png"
...
#define DEFAULT_GATEWAY "br-lan"
#define DEFAULT_GATEWAYPORT 2060
#define DEFAULT_HTTPDNAME "WiFiDog"
#define DEFAULT_CLIENTTIMEOUT 60
#define DEFAULT_CHECKINTERVAL 60

#define DEFAULT_AUTHTYPE "none"
#define DEFAULT_AUTHPASSWORD "01234567"
#define DEFAULT_REDIENABLE "on"
#define DEFAULT_REDIURL "www.baidu.com"
#define DEFAULT_AUTHTERM ""
#define DEFAULT_AUTHTITLE "welcome"
#define DEFAULT_AUTHFONTCOLOR "#FFFFFF"
#define DEFAULT_AUTHTHEMECOLOR "#4acbd6"
#define DEFAULT_AUTHFONTOPACITY "100%"
#define DEFAULT_AUTHTHEMEOPACITY "100%"
#define DEFAULT_AUTHTIMEOUT "60"
...
typedef struct {
    ...
    char *authfontcolor;
	char *auththemecolor;
    char *authfontopacity;
	char *auththemeopacity;
	char *authtimeout;
