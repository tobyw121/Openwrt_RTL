/*
 * @Author: your name
 * @Date: 2021-01-14 14:19:20
 * @LastEditTime: 2021-01-14 14:40:48
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \ax10_1\Iplatform\packages\opensource\wifidog\src\src\firewall.h
 */ 
/********************************************************************\
...
typedef enum _t_fw_marks {
    FW_MARK_PROBATION = 00000, /**< @brief The client is in probation period and must be authenticated 
			    @todo: VERIFY THAT THIS IS ACCURATE*/
    FW_MARK_KNOWN = 10000,  /**< @brief The client is known to the firewall */ 
    FW_MAKR_INTERFACE = 20000, /* the control interface mark for the firewall*/
    FW_MARK_LOCKED = 30000, /**< @brief The client has been locked out */
    FW_MARK_MASK = 30000
