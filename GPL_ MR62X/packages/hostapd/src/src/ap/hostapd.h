...
enum pin_status {
	WPS_PIN_STATUS_DISABLE,
	WPS_PIN_STATUS_ACTIVE,
	WPS_PIN_STATUS_TIMEOUT,
};
...
#ifdef CONFIG_RTL_CFG80211_WAPI_SUPPORT
struct hostapd_data * rtl_get_hostapd_data(struct hapd_interfaces *interfaces, const u8 *mac);
#endif
