...
struct wpa_driver_ap_params {
	...
	/**
	 * airtime_fairness - Whether airtime fairness is enabled
	 *
	 * If this is enabled, Transfer the service time of some slow devices to 
	 * fast devices to improve the transmission speed of the entire WLAN, 
	 * optimize the waiting time, and improve the availability, 
	 * but slow devices become slower.
	 */
	int airtime_fairness;
