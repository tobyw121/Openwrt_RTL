...
static int hostapd_cli_cmd_pin_lock_status(struct wpa_ctrl *ctrl, int argc,
					  char *argv[])
{
	return wpa_ctrl_command(ctrl, "PIN_LOCK_STATUS");
}
...
static const struct hostapd_cli_cmd hostapd_cli_commands[] = {
	...
	{ "pin_lock_status", hostapd_cli_cmd_pin_lock_status, NULL,
	  "= get pin lock status" },
