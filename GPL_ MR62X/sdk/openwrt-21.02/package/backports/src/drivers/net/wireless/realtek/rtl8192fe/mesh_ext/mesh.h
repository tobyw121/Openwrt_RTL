...
#define RTK_MESH_VERSION "Realtek Mesh v2.4"
...
#define MESH_EXPIRE_TO_STAGE2		RTL_MILISECONDS_TO_JIFFIES(3000)	// MP Prob req wai time
...
struct MESH_Neighbor_Entry {
    ...
    // UINT8	NeighborMACADDR[MACADDRLEN]; 	// in fact, this info can be obtained by this.pstate->cmn_info.mac_addr
...
extern void triband_set_mesh(void);
extern int triband_get_mesh_priv(struct rtl8192cd_priv *priv, struct rtl8192cd_priv *mesh_priv[]);
