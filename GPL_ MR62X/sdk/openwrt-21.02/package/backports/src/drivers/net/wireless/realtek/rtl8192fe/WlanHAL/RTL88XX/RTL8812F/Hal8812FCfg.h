...
#ifdef DMA_BUF_SEP
#define DESC_DMA_TXBD_PAGE_8812F	((TOTAL_NUM_TXBD_NO_BCN_8812F * sizeof(TX_BUFFER_DESCRIPTOR)))
#define DESC_DMA_TXDESC_PAGE_8812F	(TOTAL_NUM_TXBD_NO_BCN_8812F * SIZE_TXDESC_88XX_8812F)
#define DESC_DMA_BCN_PAGE_8812F		(((1+HAL_NUM_VWLAN) * TXBD_BEACON_OFFSET_MAX) + ((1+HAL_NUM_VWLAN) * SIZE_TXDESC_88XX_8812F))
#else
