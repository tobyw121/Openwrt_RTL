...
#ifdef DMA_BUF_SEP
#define DESC_DMA_RXBD_PAGE_SIZE		((TOTAL_NUM_RXBD * sizeof(RX_BUFFER_DESCRIPTOR)))
#define DESC_DMA_TXBD_PAGE_SIZE		(TOTAL_NUM_TXBD_NO_BCN * sizeof(TX_BUFFER_DESCRIPTOR))
#define DESC_DMA_TXDESC_PAGE_SIZE	(TOTAL_NUM_TXBD_NO_BCN * SIZE_TXDESC_88XX_MAX)
#define DESC_DMA_BCN_PAGE_SIZE		(((1+HAL_NUM_VWLAN) * TXBD_BEACON_OFFSET_MAX) + ((1+HAL_NUM_VWLAN) * SIZE_TXDESC_88XX_MAX))
#else
