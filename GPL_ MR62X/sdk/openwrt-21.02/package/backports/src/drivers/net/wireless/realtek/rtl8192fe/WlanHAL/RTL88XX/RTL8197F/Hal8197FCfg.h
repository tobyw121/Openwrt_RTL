...
#ifdef DMA_BUF_SEP
#define DESC_DMA_TXBD_PAGE_8197F	((TOTAL_NUM_TXBD_NO_BCN_8197F * sizeof(TX_BUFFER_DESCRIPTOR)))
#define DESC_DMA_TXDESC_PAGE_8197F	(TOTAL_NUM_TXBD_NO_BCN_8197F * SIZE_TXDESC_88XX_8197F)
#define DESC_DMA_BCN_PAGE_8197F		(((1+HAL_NUM_VWLAN) * TXBD_BEACON_OFFSET_MAX) + ((1+HAL_NUM_VWLAN) * SIZE_TXDESC_88XX_8197F))
#else
