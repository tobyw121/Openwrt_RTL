...
define KernelPackage/nf-conntrack
  ...
  DEPENDS:=+kmod-pptp +kmod-lib-crc32c
...
define KernelPackage/nf-nat
  ...
  $(if $(LINUX_VERSION_GT),,$(LINUX_DIR)/net/$(P_V4)nf_nat_ipv4.ko)
  AUTOLOAD:=$(call AutoProbe,$(notdir $(NF_NAT-m)) $(if $(LINUX_VERSION_GT),,$(LINUX_DIR)/net/$(P_V4)nf_nat_ipv4.ko))
endef
...
define KernelPackage/ipt-nat
  ...
  $(if $(LINUX_VERSION_GT),,$(LINUX_DIR)/net/$(P_XT)nf_nat_redirect.ko)
  AUTOLOAD:=$(call AutoProbe,$(notdir $(IPT_NAT-m)) $(if $(LINUX_VERSION_GT),,$(LINUX_DIR)/net/$(P_XT)nf_nat_redirect.ko))
