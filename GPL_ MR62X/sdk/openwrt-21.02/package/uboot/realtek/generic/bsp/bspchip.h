...
#define BSP_CPU0_FREQ		400000000     /* 400 MHz */
...
//#define BSP_PS_GPIO_IRQ		(BSP_IRQ_ICTL_BASE + 19)
...
#define BSP_PCIE_IRQ        (BSP_IRQ_ICTL_BASE + 21)
...
#define BSP_UART1_LCR       (BSP_UART1_BASE + 0x00C)
   ...
   #define     BSP_NO_STOP            0x00
   #define     BSP_ONE_STOP          0x04
...
#define BSP_IRR1_SETTING    IRR_IPtoCPU(2,0,2,2, 0,0,2,0)	//IP [15~8]
#define BSP_IRR2_SETTING    IRR_IPtoCPU(0,0,2,0, 0,0,0,0)	//IP [23~16]
#define BSP_IRR3_SETTING    IRR_IPtoCPU(0,0,0,0, 0,0,0,0)	//IP [31~24]
...
#define BSP_TC3DATA		(BSP_TC_BASE + 0x24)
 ...
 */
#if defined(CONFIG_SW_8367R) || defined(CONFIG_8211F_SUPPORT) || defined(CONFIG_SW_83XX) 
#define BSP_RESET_BTN_PIN				BSP_GPIO_PIN_E1
#define BSP_RESET_BTN_PIN_MUX_SEL		BSP_PIN_MUX_SEL17
#define BSP_RESET_BTN_PIN_MUX			(0x1 << 28)
#define BSP_RESET_BTN_PIN_MASK			(0xf << 28)
#define BSP_RESET_LED_PIN				BSP_GPIO_PIN_H1
#define BSP_RESET_LED_PIN_MUX_SEL		BSP_PIN_MUX_SEL13
#define BSP_RESET_LED_PIN_MUX			(0x2 << 16)	
#define BSP_RESET_LED_PIN_MASK			(0xf << 16)
#else
#define BSP_RESET_BTN_PIN				BSP_GPIO_PIN_C3
#define BSP_RESET_LED_PIN				BSP_GPIO_PIN_B7
#define BSP_RESET_BTN_PIN_MUX_SEL		BSP_PIN_MUX_SEL2
#define BSP_RESET_BTN_PIN_MUX			(0x6 << 4)
#define BSP_RESET_BTN_PIN_MASK			(0xf << 4)
#define BSP_RESET_LED_PIN_MUX_SEL		BSP_PIN_MUX_SEL2
#define BSP_RESET_LED_PIN_MUX			(0x8 << 24)			
#define BSP_RESET_LED_PIN_MASK			(0xf << 24)
#endif

#define BSP_GREEN_LED_PIN_MUX_SEL		BSP_PIN_MUX_SEL2
#define BSP_GREEN_LED_PIN_MUX			(0x6 << 4)			
#define BSP_GREEN_LED_PIN_MASK			(0xf << 4)
#define BSP_GREEN_LED_PIN				BSP_GPIO_PIN_C3
#define BSP_ORANGE_LED_PIN_MUX_SEL		BSP_PIN_MUX_SEL13
#define BSP_ORANGE_LED_PIN_MUX			(0x3 << 28)			
#define BSP_ORANGE_LED_PIN_MASK			(0xf << 28)
