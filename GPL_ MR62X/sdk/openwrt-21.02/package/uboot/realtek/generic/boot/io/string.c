...
/* A simple strcasecmp implemention. We need this for parsing our 
 * partition-table while we are handling the firmware recovery stuffs.
 * Added by JeromeWang, 2014-11-18 */
