...
rtk_api_ret_t dal_rtl8367c_port_macForceLinkExtSSC_set(rtk_port_t port, rtk_enable_t state);
rtk_api_ret_t dal_rtl8367c_port_macForceLinkExtSSC_get(rtk_port_t port, rtk_enable_t *pState);
rtk_api_ret_t dal_rtl8367c_port_duplexAutoChange_set(rtk_enable_t state);
rtk_api_ret_t dal_rtl8367c_port_duplexAutoChange_get(rtk_enable_t *pState);

/* Function Name:
 *      dal_rtl8367c_port_autoDownSpeed10M_set
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_port_autoDownSpeed10M_set(rtk_enable_t state);

/* Function Name:
 *      dal_rtl8367c_port_autoDownSpeed10M_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_port_autoDownSpeed10M_get(rtk_enable_t *pState);
