...
rtk_api_ret_t dal_rtl8367c_l2_floodPortMask_set(rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_init(void)
{
    rtk_api_ret_t retVal;
    rtk_uint32 port;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_addr_add(rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_addr_get(rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_addr_next_get(rtk_l2_read_method_t read_method, rtk_port_t port, rtk_uint32 *pAddress, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      method;
    rtl8367c_luttb  l2Table;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_addr_del(rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_mcastAddr_add(rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      method;
    rtl8367c_luttb  l2Table;
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
rtk_api_ret_t dal_rtl8367c_l2_mcastAddr_get(rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_mcastAddr_next_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_mcastAddr_next_get(rtk_uint32 *pAddress, rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
rtk_api_ret_t dal_rtl8367c_l2_mcastAddr_del(rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastAddr_add
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastAddr_add(rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastAddr_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastAddr_get(rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastAddr_next_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastAddr_next_get(rtk_uint32 *pAddress, rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
    rtk_uint32      tmpAddress;
    ...
    do
    {
        l2Table.address = tmpAddress;
        if ((retVal = rtl8367c_getAsicL2LookupTb(LUTREADMETHOD_NEXT_L3MC, &l2Table)) != RT_ERR_OK)
            return retVal;

        if(l2Table.address < tmpAddress)
            return RT_ERR_L2_ENTRY_NOTFOUND;

        tmpAddress = l2Table.address + 1;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastAddr_del
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastAddr_del(rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipVidMcastAddr_add
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_add(rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipVidMcastAddr_get
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_get(rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 *      as pAddress to call this API again for dumping all IP multicast entries is LUT.
 */
rtk_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_next_get(rtk_uint32 *pAddress, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
    rtk_uint32      tmpAddress;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipVidMcastAddr_del
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_del(rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
...
/* Function Name:
 *      dal_rtl8367c_l2_ucastAddr_flush
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ucastAddr_flush(rtk_l2_flushCfg_t *pConfig)
{
    rtk_api_ret_t   retVal;
    rtk_uint32 phyPort;
    ...
    if(pConfig->flushByVid == ENABLED)
    {
        ...
        {
            if ((retVal = rtl8367c_setAsicLutForceFlush(1 << phyPort)) != RT_ERR_OK)
                return retVal;
        }
        else
            return RT_ERR_INPUT;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_table_clear(void)
{
    rtk_api_ret_t   retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_table_clearStatus_get
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_table_clearStatus_get(rtk_l2_clearStatus_t *pStatus)
{
    rtk_api_ret_t   retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_flushLinkDownPortAddrEnable_set
 * Description:
 ...
 *      - ENABLED
 */
rtk_api_ret_t dal_rtl8367c_l2_flushLinkDownPortAddrEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_flushLinkDownPortAddrEnable_get
 * Description:
 ...
 *      - ENABLED
 */
rtk_api_ret_t dal_rtl8367c_l2_flushLinkDownPortAddrEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_agingEnable_set
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_agingEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_agingEnable_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_agingEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitLearningCnt_set
 * Description:
 ...
 *      to 2112.
 */
rtk_api_ret_t dal_rtl8367c_l2_limitLearningCnt_set(rtk_port_t port, rtk_mac_cnt_t mac_cnt)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitLearningCnt_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_limitLearningCnt_get(rtk_port_t port, rtk_mac_cnt_t *pMac_cnt)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitSystemLearningCnt_set
 * Description:
 ...
 *      to 2112.
 */
rtk_api_ret_t dal_rtl8367c_l2_limitSystemLearningCnt_set(rtk_mac_cnt_t mac_cnt)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitSystemLearningCnt_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_limitSystemLearningCnt_get(rtk_mac_cnt_t *pMac_cnt)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitLearningCntAction_set
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_limitLearningCntAction_set(rtk_port_t port, rtk_l2_limitLearnCntAction_t action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitLearningCntAction_get
 * Description:
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t dal_rtl8367c_l2_limitLearningCntAction_get(rtk_port_t port, rtk_l2_limitLearnCntAction_t *pAction)
{
    rtk_api_ret_t retVal;
    rtk_uint32 action;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitSystemLearningCntAction_set
 * Description:
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntAction_set(rtk_l2_limitLearnCntAction_t action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitSystemLearningCntAction_get
 * Description:
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntAction_get(rtk_l2_limitLearnCntAction_t *pAction)
{
    rtk_api_ret_t retVal;
    rtk_uint32 action;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitSystemLearningCntPortMask_set
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntPortMask_set(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
...
/* Function Name:
 *      dal_rtl8367c_l2_limitSystemLearningCntPortMask_get
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntPortMask_get(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
...
/* Function Name:
 *      dal_rtl8367c_l2_learningCnt_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_learningCnt_get(rtk_port_t port, rtk_mac_cnt_t *pMac_cnt)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_floodPortMask_set
 * Description:
 ...
 *      - FLOOD_BC
 */
rtk_api_ret_t dal_rtl8367c_l2_floodPortMask_get(rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
...
/* Function Name:
 *      dal_rtl8367c_l2_localPktPermit_set
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_localPktPermit_set(rtk_port_t port, rtk_enable_t permit)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_localPktPermit_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_localPktPermit_get(rtk_port_t port, rtk_enable_t *pPermit)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_aging_set(rtk_l2_age_time_t aging_time)
{
    rtk_uint32 i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_aging_get(rtk_l2_age_time_t *pAging_time)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastAddrLookup_set(rtk_l2_ipmc_lookup_type_t type)
{
    rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastAddrLookup_get
 * Description:
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastAddrLookup_get(rtk_l2_ipmc_lookup_type_t *pType)
{
    rtk_api_ret_t       retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastForwardRouterPort_set
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastForwardRouterPort_set(rtk_enable_t enabled)
{
    rtk_api_ret_t       retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastForwardRouterPort_get
 * Description:
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastForwardRouterPort_get(rtk_enable_t *pEnabled)
{
    rtk_api_ret_t       retVal;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastGroupEntry_add
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastGroupEntry_add(ipaddr_t ip_addr, rtk_uint32 vid, rtk_portmask_t *pPortmask)
{
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastGroupEntry_del
 * Description:
 ...
 *      Delete an entry from IP Multicast group table.
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastGroupEntry_del(ipaddr_t ip_addr, rtk_uint32 vid)
{
    rtk_int32       index;
    ipaddr_t        group_addr;
    rtk_uint32      group_vid;
...
/* Function Name:
 *      dal_rtl8367c_l2_ipMcastGroupEntry_get
 * Description:
 ...
 *      Delete an entry from IP Multicast group table.
 */
rtk_api_ret_t dal_rtl8367c_l2_ipMcastGroupEntry_get(ipaddr_t ip_addr, rtk_uint32 vid, rtk_portmask_t *pPortmask)
{
    rtk_int32       index;
    ipaddr_t        group_addr;
    rtk_uint32      group_vid;
 ...
 */
rtk_api_ret_t dal_rtl8367c_l2_entry_get(rtk_l2_addr_table_t *pL2_entry)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
