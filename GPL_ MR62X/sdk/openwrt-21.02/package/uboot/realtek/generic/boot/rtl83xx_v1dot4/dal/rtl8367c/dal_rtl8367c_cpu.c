 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_enable_set(rtk_enable_t enable)
{
 ...
 *      - CPU_INSERT_TO_NONE
 */
rtk_api_ret_t dal_rtl8367c_cpu_tagPort_set(rtk_port_t port, rtk_cpu_insert_t mode)
{
    rtk_api_ret_t retVal;
    rtk_uint32 phyPort;
    ...
    if ((retVal = rtl8367c_setAsicCputagPortmask(1<<phyPort)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicCputagTrapPort(phyPort)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_enable_get(rtk_enable_t *pEnable)
 ...
 *      - CPU_INSERT_TO_NONE
 */
rtk_api_ret_t dal_rtl8367c_cpu_tagPort_get(rtk_port_t *pPort, rtk_cpu_insert_t *pMode)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_awarePort_set(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_awarePort_get(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmsk;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_tagPosition_set(rtk_cpu_position_t position)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_tagPosition_get(rtk_cpu_position_t *pPosition)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_tagLength_set(rtk_cpu_tag_length_t length)
{
    rtk_api_ret_t retVal;
    ...
    if (length >= CPU_LEN_4BYTES_PRIORITY)
        return RT_ERR_INPUT;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_tagLength_get(rtk_cpu_tag_length_t *pLength)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_priRemap_set(rtk_pri_t int_pri, rtk_pri_t new_pri)
{
    rtk_api_ret_t retVal;
 ...
 *      Priority of CPU tag assignment for internal asic priority, and it is used for queue usage and packet scheduling.
 */
rtk_api_ret_t dal_rtl8367c_cpu_priRemap_get(rtk_pri_t int_pri, rtk_pri_t *pNew_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_acceptLength_set(rtk_cpu_rx_length_t length)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_cpu_acceptLength_get(rtk_cpu_rx_length_t *pLength)
{
    rtk_api_ret_t retVal;
