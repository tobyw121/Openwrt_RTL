...
#define IPV6_MULTICAST_MAC(mac) ((mac[0]==0x33)&&(mac[1]==0x33))
...
struct net_bridge
{
	...
	u16				default_pvid;
#endif
//#if defined(CONFIG_RTL_819X)&&(defined(CONFIG_BRIDGE_IGMP_SNOOPING)||defined (CONFIG_RTL_IGMP_SNOOPING))
...
struct net_bridge_fdb_entry *br_fdb_find_rcu(struct net_bridge *br,
						 ...
						 __u16 vid);
#if defined (CONFIG_RTL_IGMP_SNOOPING)
int br_fdb_create(struct net_bridge *br,struct net_bridge_port *source,
		  const unsigned char *addr, __u16 vid);
#endif
