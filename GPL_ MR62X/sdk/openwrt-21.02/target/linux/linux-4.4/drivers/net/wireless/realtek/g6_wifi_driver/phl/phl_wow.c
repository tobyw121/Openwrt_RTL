...
static void _phl_wow_set_int_hdl_rx(struct phl_info_t *phl_info)
{
#ifdef CONFIG_SYNC_INTERRUPT
	struct rtw_phl_evt_ops *evt_ops = &phl_info->phl_com->evt_ops;
#endif /* CONFIG_SYNC_INTERRUPT */

	rtw_hal_init_int_default_value(phl_info->phl_com, phl_info->hal, INT_SET_OPT_WOW_RESUME_HNDL_RX);
...
static void _phl_wow_set_int_resume_done(struct phl_info_t *phl_info)
{
#ifdef CONFIG_SYNC_INTERRUPT
	struct rtw_phl_evt_ops *evt_ops = &phl_info->phl_com->evt_ops;
#endif /* CONFIG_SYNC_INTERRUPT */
	...
	rtw_hal_init_int_default_value(phl_info->phl_com, phl_info->hal, INT_SET_OPT_WOW_RESUME_DONE);
...
enum rtw_phl_status phl_wow_deinit_precfg(struct phl_wow_info *wow_info)
{
	...
	_phl_wow_set_int_hdl_rx(phl_info);
...
enum rtw_phl_status phl_wow_deinit_postcfg(struct phl_wow_info *wow_info)
{
	...
	_phl_wow_set_int_resume_done(phl_info);
