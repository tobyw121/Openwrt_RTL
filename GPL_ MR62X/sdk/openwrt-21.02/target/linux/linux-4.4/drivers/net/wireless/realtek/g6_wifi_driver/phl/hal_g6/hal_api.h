...
enum rtw_hal_status rtw_hal_trigger_bus_err(void *hal);
...
void
rtw_hal_dl_all_ext_para_file(struct rtw_phl_com_t *phl_com, char *ic_name, void *hal);
...
enum rtw_hal_status
rtw_hal_ra_update(void *hal, struct rtw_phl_stainfo_t * sta);
u8 rtw_hal_get_sta_rssi(struct rtw_phl_stainfo_t *sta);
u8 rtw_hal_get_sta_rssi_bcn(struct rtw_phl_stainfo_t *sta);

enum rtw_hal_status
rtw_hal_update_cctrl_tbl(void *hal, struct rtw_phl_stainfo_t *sta);

enum rtw_hal_status
rtw_hal_update_dctrl_tbl_pn(void *hal, struct rtw_phl_stainfo_t *sta, u64 pn);
...
/**
 * rtw_hal_set_edca() - setup EDCA parameter
 * @hal:	struct hal_info_t *
 * @wrole:	struct rtw_wifi_role_t *
 * @ac:		Access Category, 0:BE, 1:BK, 2:VI, 3:VO, 4:MG, 5:BCN
...
/**
 * rtw_hal_get_edca() - Get EDCA parameter
 * @hal:	struct hal_info_t *
 * @wrole:	struct rtw_wifi_role_t *
 * @ac:		Access Category, 0:BE, 1:BK, 2:VI, 3:VO, 4:MG, 5:BCN
 * @param:	AIFS:BIT[7:0], CWMIN:BIT[11:8], CWMAX:BIT[15:12],
 ...
 */
enum rtw_hal_status
rtw_hal_get_edca(void *hal, struct rtw_wifi_role_t *wrole, u8 ac, u32 *edca);
...
u16 rtw_hal_tx_res_query_sw(void *hal, void*txbd, u8 dma_ch, u16 *host_idx, u16 *hw_idx);
...
#ifdef PHL_RXSC_ISR
u16 rtw_hal_rx_isr_check(void *hal, u8 dma_ch);
#endif
...
rtw_hal_handle_rx_buffer(struct rtw_phl_com_t *phl_com, void* hal,
                         struct rtw_rx_buf *rxbuf, u32 buf_size,
                         struct rtw_phl_rx_pkt *rxpkt);
#ifdef CONFIG_RTW_HW_RX_AMSDU_CUT
enum rtw_hal_status
rtw_hal_check_next_msdu(struct rtw_phl_com_t *phl_com, void* hal,
                        struct rtw_rx_buf *rxbuf, u32 buf_size,
                        struct rtw_phl_rx_pkt *rxpkt);
void
rtw_hal_rewind_rx_tag(struct rtw_phl_com_t *phl_com, void* hal, u8 ch_idx);
...
void rtw_hal_reset_chdef(void *hal, u8 band_idx);
...
void rtw_hal_acs_mntr_trigger(void *hal, void *parm);
...
enum rtw_hal_status rtw_hal_ltr_sw_trigger(void *hal, enum rtw_pcie_ltr_state state);

#ifdef RTW_WKARD_DYNAMIC_LTR
void rtw_hal_ltr_sw_ctrl_ntfy(void *hal, bool benable);
bool rtw_hal_ltr_is_sw_ctrl(void *hal);
u8 rtw_hal_ltr_get_cur_state(void *hal);
u32 rtw_hal_ltr_get_last_trigger_time(void *hal);
void rtw_hal_ltr_update_stats(void *hal, bool clear);
u32 rtw_hal_ltr_get_tri_cnt(void *hal, enum rtw_pcie_ltr_state state);
void rtw_hal_ltr_sw_ctrl(void *hal, bool benable);
#endif
...
void
rtw_hal_bf_get_gid_pid(void *hal, struct rtw_phl_stainfo_t *sta, u8* gid , u8* pid);

void
rtw_hal_bf_set_gid_pid(void *hal, struct rtw_phl_stainfo_t *sta, u8 gid , u8 pid);

enum rtw_hal_status
rtw_hal_bf_set_fix_mode(void *hal, u16 macid, bool mu, bool he);
enum rtw_hal_status
...
enum rtw_hal_status
rtw_hal_get_hw_cnt(void *hal_info, enum rtw_hal_cnt_type cnt_type, u32 *oval);
/******************************************************************************
 *
 * BTC APIs
 *
...
enum rtw_hal_status rtw_hal_dfs_pause_tx(void *hinfo,
	u8 band_idx, bool off_ch, u8 reason);
/*****************************************************************************/
...
enum rtw_hal_status
rtw_hal_getpkt(struct rtw_phl_com_t *phl_com, void *hal, u8 macid, u8 pkttype);
...
s8
rtw_hal_get_tx_pwr_by_txrate (void *hal, enum channel_width bw, u8 mcs_idx);

void rtw_hal_get_mac_version(char *ver_str, u16 len);
void rtw_hal_get_fw_ver(void *hal, char *ver_str, u16 len);
u32 rtw_hal_get_radio_ver(void *hal);
...
#ifdef CONFIG_RTW_DEBUG_BCN_TX
void
rtw_hal_debug_bcn_tx(void *hal, u32 fail_cnt);
#endif /* CONFIG_RTW_DEBUG_BCN_TX */

#ifdef CONFIG_RTW_DEBUG_TX_RPT
void
rtw_hal_debug_tx_report(void *hal, u32 rpt_cnt);
...
void
rtw_hal_start_h2c_agg(void *hal);
enum rtw_hal_status
rtw_hal_stop_h2c_agg(void *hal, u8 tx);
#endif /* CONFIG_ENABLE_MAC_H2C_AGG */
/******************************************************************************
 *
 * Packet Offload APIs
 *
...
enum rtw_hal_status rtw_hal_watchdog(struct rtw_phl_com_t *phl_com, void *hal);
...
enum rtw_hal_status rtw_hal_fill_txdesc(void *hal, struct rtw_xmit_req *treq,
					u8 *wd_buf, u32 *wd_len);
u32
rtw_hal_get_hw_seq(void *hal, u32 macid, u8 tid);
...
void rtw_hal_flash_set_para_path(void *hal);
...
enum rtw_hal_status
rtw_hal_set_macid_pkt_drop(void *hal, u16 macid, u8 sel, u8 port, u8 mbssid);

enum rtw_hal_status
rtw_hal_hiq_drop(void *hal, u8 port, u8 mbssid);

enum rtw_hal_status
rtw_hal_set_hiq_drop(void *hal, u8 port, u8 mbssid);

enum rtw_hal_status
rtw_hal_rel_hiq_drop(void *hal, u8 port, u8 mbssid);
...
rtw_hal_mac_mu_set_dl_grp_info(void *hal,
					struct rtw_phl_mac_ss_dl_grp_upd *tbl);
enum rtw_hal_status
rtw_hal_mac_set_ul_grp_info(void *phl);
...
enum rtw_hal_status
rtw_hal_query_txsts_rpt(void *hal, u16 macid0, u16 macid1);
...
void rtw_hal_reset_rf_path(void *hal);
enum rtw_hal_status
rtw_hal_upd_sta_tx(void *hal, struct rtw_phl_stainfo_t *sta,
		enum rf_path path);
enum rtw_hal_status
...
void rtw_hal_rf_set_regulation(void *hal, u8 regular_idx);
void rtw_hal_bb_adjust_ref_offset(void *hal, s16 offset, u8 phy_idx);
void rtw_hal_rf_set_power_to_struct(void *hal, enum phl_phy_idx phy, s8 dbm);
void rtw_hal_rf_tssi_do_slope(void *hal);
void rtw_hal_rf_tssi_finish_slope(void *hal);
u32 rtw_hal_rf_tssi_get_cw(void *hal, enum rf_path path);
void rtw_hal_rf_tssi_current_slope_apply(void *hal,
					 u32 gain_diff, u32 cw_diff, enum rf_path path);
void rtw_hal_rf_tssi_slope_apply(void *hal,
				 u32 gain_1st, u32 gain_2nd,
				 u32 cw_1st, u32 cw_2nd, enum rf_path path,
				 u32* gain_diff, u32* cw_diff);
void rtw_hal_rf_get_efuse_ex(struct rtw_hal_com_t *hal_com, enum phl_phy_idx phy_idx);
...
#ifdef CONFIG_RTW_HW_RX_AMSDU_CUT
enum rtw_hal_status rtw_hal_enable_rx_hdr_conv(struct rtw_phl_com_t *phl_com,
                                               void *hal);
enum rtw_hal_status rtw_hal_disable_rx_hdr_conv(struct rtw_phl_com_t *phl_com,
                                                void *hal);
enum rtw_hal_status rtw_hal_enable_rx_amsdu_cut(struct rtw_phl_com_t *phl_com,
                                                void *hal);
enum rtw_hal_status rtw_hal_disable_rx_amsdu_cut(struct rtw_phl_com_t *phl_com,
                                                 void *hal);
#endif /* CONFIG_RTW_HW_RX_AMSDU_CUT */

enum rtw_hal_status
rtw_hal_get_thermal(void *hal, u8 rfpath, u8 *thermal);

#ifdef CONFIG_PHL_DRV_HAS_NVM
enum rtw_hal_status
rtw_hal_extract_efuse_info(void *hal, u8 *efuse_map, enum rtw_efuse_info info_type,
