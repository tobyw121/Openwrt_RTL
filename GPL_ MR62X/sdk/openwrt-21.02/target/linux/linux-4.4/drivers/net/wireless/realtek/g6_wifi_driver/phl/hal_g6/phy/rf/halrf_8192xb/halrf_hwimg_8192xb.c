...
#include "halrf_hwimg_raw_data_8192xb.h"
#include "halrf_hwimg_nctl_raw_data_8192xb.h"

bool halrf_check_cond_8192xb(struct rf_info *rf, u32 para_opt)
{
...
u32
halrf_get_8192xb_nctl_reg_ver(void)
{
	return 0x9;
}

u32
halrf_get_8192xb_radio_reg_ver(void)
{
	return RF_RELEASE_VERSION_8192XB;
}

void halrf_config_8192xb_store_radio_a_reg(struct rf_info *rf,
					u32 addr, u32 data)
{
...
void halrf_config_8192xb_store_radio_b_reg(struct rf_info *rf,
					u32 addr, u32 data)
{
	struct halrf_radio_info *radio = &rf->radio_info;
...
void halrf_config_8192xb_write_radio_a_reg_to_fw(struct rf_info *rf)
{
	struct halrf_radio_info *radio = &rf->radio_info;
...
void halrf_config_8192xb_write_radio_b_reg_to_fw(struct rf_info *rf)
{
	struct halrf_radio_info *radio = &rf->radio_info;
...
void halrf_config_8192xb_radio_to_fw(struct rf_info *rf)
{
	halrf_config_8192xb_write_radio_a_reg_to_fw(rf);
	halrf_config_8192xb_write_radio_b_reg_to_fw(rf);
}

void halrf_config_8192xb_nctl_reg(struct rf_info *rf)
{
#if 1
	u32	i = 0;
	u32	array_len = 0x0;
...
//5. iqkdpk clk&rst
	...
	array_len = sizeof(array_mp_8192xb_nctl_reg) / sizeof(u32);
	array = (u32 *) &array_mp_8192xb_nctl_reg;
	...
	while ((i + 1) < array_len) {
		v1 = array[i];
		v2 = array[i + 1];
		halrf_cfg_rf_nctl_8192xb(rf, v1, MASKDWORD, v2);
		i += 2;
	}
#if 0
	halrf_wrf(rf, RF_PATH_A, 0xec, MASKRF, 0x00400);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00003);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00030);
	halrf_wrf(rf, RF_PATH_A, 0xec, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0xec, MASKRF, 0x00004);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00067);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00001);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00066);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00002);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00065);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00003);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00064);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00004);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00063);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00005);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00062);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00006);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00061);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00007);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00060);
	halrf_wrf(rf, RF_PATH_A, 0xec, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x4e, MASKRF, 0x20000);
	halrf_wrf(rf, RF_PATH_B, 0xec, MASKRF, 0x00400);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00003);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00030);
	halrf_wrf(rf, RF_PATH_B, 0xec, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0xec, MASKRF, 0x00004);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00067);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00001);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00066);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00002);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00065);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00003);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00064);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00004);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00063);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00005);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00062);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00006);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00061);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00007);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00060);
	halrf_wrf(rf, RF_PATH_B, 0xec, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x3f, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x4e, MASKRF, 0x20000);
#endif
#if 0
	//92XB_ReWrite_TXIQK_SEL_RF.txt_reg
	halrf_wrf(rf, RF_PATH_A, 0x100ee, MASKRF, 0x00400);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x01000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x02000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x03000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x04000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x05000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x06003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x07003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x08000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x09000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x0a000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x0b000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x0c000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x0d000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x0e003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x0f003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x10000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x11000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x12000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x13000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x14000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x15000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x16003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x17003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x18000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x19000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x1a000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x1b000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x1c000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x1d000);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x1e003);
	halrf_wrf(rf, RF_PATH_A, 0x10030, MASKRF, 0x1f003);
	halrf_wrf(rf, RF_PATH_A, 0x100ee, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x100ee, MASKRF, 0x00400);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x01000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x02000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x03000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x04000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x05000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x06003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x07003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x08000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x09000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x0a000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x0b000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x0c000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x0d000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x0e003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x0f003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x10000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x11000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x12000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x13000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x14000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x15000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x16003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x17003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x18000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x19000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x1a000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x1b000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x1c000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x1d000);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x1e003);
	halrf_wrf(rf, RF_PATH_B, 0x10030, MASKRF, 0x1f003);
	halrf_wrf(rf, RF_PATH_B, 0x100ee, MASKRF, 0x00000);
#endif
#endif
}

bool halrf_sel_headline_8192xb(struct rf_info *rf, u32 *array, u32 array_len,
			      u8 *headline_size, u8 *headline_idx)
{
	...
	*headline_size = 0;
	...
	compare_target = ((rfe_drv & 0xff) << 16) | (DONT_CARE_8192XB & 0xff);
...
void halrf_flag_2_default_8192xb(bool *is_matched, bool *find_target)
{
	*is_matched = true;
	*find_target = false;
}
...
void
halrf_config_8192xb_radio_a_reg(struct rf_info *rf, enum phl_phy_idx phy)
{
	struct rtw_hal_com_t *hal = rf->hal_com;
	struct halrf_radio_info *radio = &rf->radio_info;
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8192xb_radioa) / sizeof(u32);
		array = (u32 *)array_mp_8192xb_radioa;
	}

	RF_DBG(rf, DBG_RF_INIT, "RFCR_form_folder=%d, len=%d\n",
	       is_form_folder, array_len);

	if (!halrf_sel_headline_8192xb(rf, array, array_len, &h_size, &h_idx)) {
	...
	halrf_flag_2_default_8192xb(&is_matched, &find_target);
	while ((i + 1) < array_len) {
		v1 = array[i];
		v2 = array[i + 1];
		i += 2;
		...
		default:
			if (is_matched) {
				halrf_cfg_rf_radio_a_8192xb(rf, v1, v2);
				halrf_config_8192xb_store_radio_a_reg(rf, v1, v2);
			}
			break;
		}
	}
...
void
halrf_config_8192xb_radio_b_reg(struct rf_info *rf, enum phl_phy_idx phy)
{
	struct rtw_hal_com_t *hal = rf->hal_com;
	struct halrf_radio_info *radio = &rf->radio_info;
	struct rtw_para_info_t *phy_reg_info = NULL;
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8192xb_radiob) / sizeof(u32);
		array = (u32 *)array_mp_8192xb_radiob;
	}
	...
	while ((i + 1) < array_len) {
		...
		default:
			if (is_matched) {
				halrf_cfg_rf_radio_b_8192xb(rf, v1, v2);
				halrf_config_8192xb_store_radio_b_reg(rf, v1, v2);
			}
			break;
		}
	}
...
void
halrf_config_8192xb_store_power_by_rate(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8192xb_txpwr_byrate) / sizeof(u32);
		array = (u32 *)array_mp_8192xb_txpwr_byrate;
	}
...
void
halrf_config_8192xb_store_power_limit(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8192xb_txpwr_lmt) / sizeof(struct halrf_tx_pw_lmt);
		array = array_mp_8192xb_txpwr_lmt;
...
void
halrf_config_8192xb_store_power_limit_ru(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8192xb_txpwr_lmt_ru) / sizeof(struct halrf_tx_pw_lmt_ru);
		array = array_mp_8192xb_txpwr_lmt_ru;
...
void
halrf_config_8192xb_store_pwr_track(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (is_form_folder) {
		...
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2ga_p,
			(void *)delta_swingidx_mp_2ga_p_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2ga_n,
			(void *)delta_swingidx_mp_2ga_n_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2gb_p,
			(void *)delta_swingidx_mp_2gb_p_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2gb_n,
			(void *)delta_swingidx_mp_2gb_n_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);

		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2g_cck_a_p,
			(void *)delta_swingidx_mp_2g_cck_a_p_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2g_cck_a_n,
			(void *)delta_swingidx_mp_2g_cck_a_n_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2g_cck_b_p,
			(void *)delta_swingidx_mp_2g_cck_b_p_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2g_cck_b_n,
			(void *)delta_swingidx_mp_2g_cck_b_n_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE);

		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_5ga_p,
			(void *)delta_swingidx_mp_5ga_p_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE * 3);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_5ga_n,
			(void *)delta_swingidx_mp_5ga_n_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE * 3);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_5gb_p,
			(void *)delta_swingidx_mp_5gb_p_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE * 3);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_5gb_n,
			(void *)delta_swingidx_mp_5gb_n_txpwrtrkssi_8192xb,
			DELTA_SWINGIDX_SIZE * 3);
	}
}

void
_halrf_config_rfe_xtal_track_table_8192xb(struct rf_info *rf)
{
#if 0
	...
	hal_mem_cpy(hal, xtal_trk->delta_swing_xtal_table_idx_p,
		(void *)delta_swing_xtal_mp_p_txxtaltrack_8192xb,
		DELTA_SWINGIDX_SIZE);
	hal_mem_cpy(hal, xtal_trk->delta_swing_xtal_table_idx_n,
		(void *)delta_swing_xtal_mp_n_txxtaltrack_8192xb,
		DELTA_SWINGIDX_SIZE);
#endif
}

void
halrf_config_8192xb_store_xtal_track(struct rf_info *rf,
	enum phl_phy_idx phy)
{
#if 0
	...
	if (is_form_folder) {
		...
		_halrf_config_rfe_xtal_track_table_8192xb(rf);
	}
#else
	_halrf_config_rfe_xtal_track_table_8192xb(rf);
#endif
