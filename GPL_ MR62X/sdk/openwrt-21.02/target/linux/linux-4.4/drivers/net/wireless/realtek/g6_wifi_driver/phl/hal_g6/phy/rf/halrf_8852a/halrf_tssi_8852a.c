					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (rfe_type > 50) {
		if (channel >= 1 && channel <= 14)
			halrf_wrf(rf, path, 0x6d, 0x00004, 0x1);
		else
			halrf_wrf(rf, path, 0x6d, 0x00080, 0x1);
	}
}
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	halrf_wreg(rf, 0x12a8, 0x00000001, 0x1);
	halrf_wreg(rf, 0x12a8, 0x0000000e, 0x2);
	halrf_wreg(rf, 0x32a8, 0x00000001, 0x1);
	halrf_wreg(rf, 0x32a8, 0x0000000e, 0x2);
	halrf_wreg(rf, 0x12bc, 0x000000f0, 0x5);
	halrf_wreg(rf, 0x12bc, 0x00000f00, 0x5);
	halrf_wreg(rf, 0x12bc, 0x000f0000, 0x5);
	halrf_wreg(rf, 0x12bc, 0x0000f000, 0x5);
	/*halrf_wreg(rf, 0x120c, 0x000000ff, 0x33);*/
	/*halrf_wreg(rf, 0x12c0, 0x0ff00000, 0x33);*/
	halrf_wreg(rf, 0x32bc, 0x000000f0, 0x5);
	halrf_wreg(rf, 0x32bc, 0x00000f00, 0x5);
	halrf_wreg(rf, 0x32bc, 0x000f0000, 0x5);
	halrf_wreg(rf, 0x32bc, 0x0000f000, 0x5);
	/*halrf_wreg(rf, 0x320c, 0x000000ff, 0x33);*/
	/*halrf_wreg(rf, 0x32c0, 0x0ff00000, 0x33);*/
	halrf_wreg(rf, 0x0300, 0xff000000, 0x19);
	halrf_wreg(rf, 0x0304, 0x000000ff, 0x19);
	halrf_wreg(rf, 0x0304, 0x0000ff00, 0x1d);
	halrf_wreg(rf, 0x0314, 0xffff0000, 0x2044);
	halrf_wreg(rf, 0x0318, 0x0000ffff, 0x2042);
	halrf_wreg(rf, 0x0318, 0xffff0000, 0x2002);
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (path == RF_PATH_A) {
		halrf_wreg(rf, 0x5800, 0x000000ff, 0x7f);
		halrf_wreg(rf, 0x5800, 0x0000ff00, 0x80);
		halrf_wreg(rf, 0x5800, 0x003f0000, 0x3f);
		/*halrf_wreg(rf, 0x5800, 0x0fc00000, 0x0);*/
		halrf_wreg(rf, 0x5800, 0x10000000, 0x0);
		halrf_wreg(rf, 0x5800, 0x20000000, 0x0);
		halrf_wreg(rf, 0x5800, 0xc0000000, 0x0);
		/*Debug power cw setting with Dino*/
		/*halrf_wreg(rf, 0x5804, 0x000001ff, 0x040);*/
		/*halrf_wreg(rf, 0x5804, 0x07fc0000, 0xac);*/
		halrf_wreg(rf, 0x5804, 0xf8000000, 0x00);
		/*halrf_wreg(rf, 0x5808, 0x000001ff, 0x040);*/
		/*halrf_wreg(rf, 0x5808, 0x07fc0000, 0xac);*/
		halrf_wreg(rf, 0x580c, 0x0000007f, 0x40);
		halrf_wreg(rf, 0x580c, 0x00007f00, 0x40);
		halrf_wreg(rf, 0x580c, 0x00008000, 0x0);
		halrf_wreg(rf, 0x580c, 0x0fff0000, 0x000);
		halrf_wreg(rf, 0x5810, 0x000001ff, 0x000);
		halrf_wreg(rf, 0x5810, 0x00000200, 0x0);
		halrf_wreg(rf, 0x5810, 0x0000fc00, 0x00);
		halrf_wreg(rf, 0x5810, 0x00010000, 0x1);
		halrf_wreg(rf, 0x5810, 0x00fe0000, 0x00);
		halrf_wreg(rf, 0x5810, 0x01000000, 0x1);
		halrf_wreg(rf, 0x5810, 0x06000000, 0x0);
		halrf_wreg(rf, 0x5810, 0x38000000, 0x3);
		halrf_wreg(rf, 0x5810, 0x40000000, 0x1);
		halrf_wreg(rf, 0x5810, 0x80000000, 0x0);
		halrf_wreg(rf, 0x5814, 0x000003ff, 0x000);
		halrf_wreg(rf, 0x5814, 0x00000c00, 0x0);
		...
		if (rfe_type <= 50)
			halrf_wreg(rf, 0x5814, 0x003c0000, 0x0);

		halrf_wreg(rf, 0x5814, 0x01c00000, 0x0);
		halrf_wreg(rf, 0x5814, 0x18000000, 0x0);
		halrf_wreg(rf, 0x5814, 0xe0000000, 0x0);
		halrf_wreg(rf, 0x5818, 0x000000ff, 0x00);
		halrf_wreg(rf, 0x5818, 0x0001ff00, 0x018);
		halrf_wreg(rf, 0x5818, 0x03fe0000, 0x016);
		halrf_wreg(rf, 0x5818, 0xfc000000, 0x00);
		halrf_wreg(rf, 0x581c, 0x000003ff, 0x280);
		halrf_wreg(rf, 0x581c, 0x000ffc00, 0x200);
		halrf_wreg(rf, 0x581c, 0x00100000, 0x0);

		if (rfe_type <= 50) {
			halrf_wreg(rf, 0x581c, 0x01e00000, 0x8);
			halrf_wreg(rf, 0x581c, 0x01e00000, 0xe);
			halrf_wreg(rf, 0x581c, 0x1e000000, 0x8);
			halrf_wreg(rf, 0x581c, 0x1e000000, 0xe);
		}

		halrf_wreg(rf, 0x581c, 0x20000000, 0x0);
		halrf_wreg(rf, 0x5820, 0x00000fff, 0x080);
		halrf_wreg(rf, 0x5820, 0x0000f000, 0xf);
		halrf_wreg(rf, 0x5820, 0x001f0000, 0x00);
		halrf_wreg(rf, 0x5820, 0xffe00000, 0x000);
		...
		halrf_wreg(rf, 0x5828, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5830, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5830, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5838, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5838, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5840, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5840, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5848, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5848, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5850, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5850, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5858, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5858, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x5860, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x5860, 0x7fc00000, 0x000);
		halrf_wreg(rf, 0x5860, 0x80000000, 0x0);
		halrf_wreg(rf, 0x5864, 0x000003ff, 0x1ff);
		halrf_wreg(rf, 0x5864, 0x000ffc00, 0x200);
		halrf_wreg(rf, 0x5864, 0x03f00000, 0x00);
		halrf_wreg(rf, 0x5864, 0x04000000, 0x0);
		halrf_wreg(rf, 0x5898, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x589c, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x58a0, 0x000000ff, 0xfd);
		halrf_wreg(rf, 0x58a0, 0x0000ff00, 0xe5);
		halrf_wreg(rf, 0x58a0, 0x00ff0000, 0xcd);
		halrf_wreg(rf, 0x58a0, 0xff000000, 0xb5);
		halrf_wreg(rf, 0x58a4, 0x000000ff, 0x16);
		halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
		halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x000);
		halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
		halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x000);
		halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
		halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
		halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x000);
		halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x000);
		if (bb_version < 0x28)
			halrf_wreg(rf, 0x58b0, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x58b4, 0x0000001f, 0x00);
		halrf_wreg(rf, 0x58b4, 0x00000020, 0x0);
		halrf_wreg(rf, 0x58b4, 0x000001c0, 0x0);
		halrf_wreg(rf, 0x58b4, 0x00000200, 0x0);
		halrf_wreg(rf, 0x58b4, 0x0000f000, 0x2);
		halrf_wreg(rf, 0x58b4, 0x00ff0000, 0x00);
		...
		halrf_wreg(rf, 0x58bc, 0x000000ff, 0x7f);
		halrf_wreg(rf, 0x58bc, 0x0000ff00, 0x80);
		halrf_wreg(rf, 0x58bc, 0x00030000, 0x3);

		/*GNT_WL==0 & 0x58bc[18]==1, Bypass TSSI*/
		/*GNT_BT==1 & 0x58bc[20]==1, Bypass TSSI*/
		/*GNT_BT_TX==1 & 0x58bc[22]==1, Bypass TSSI*/

		halrf_wreg(rf, 0x58bc, 0x000c0000, 0x1);
		if (phl_is_mp_mode(rf->phl_com)) {
			halrf_wreg(rf, 0x58bc, 0x00300000, 0x3);
			halrf_wreg(rf, 0x58bc, 0x00c00000, 0x3);
		} else {
			halrf_wreg(rf, 0x58bc, 0x00300000, 0x2);
			halrf_wreg(rf, 0x58bc, 0x00c00000, 0x2);
		}

		halrf_wreg(rf, 0x58bc, 0x07000000, 0x7);
		halrf_wreg(rf, 0x58c0, 0x00fe0000, 0x3f);
		halrf_wreg(rf, 0x58c0, 0xff000000, 0x00);
		halrf_wreg(rf, 0x58c4, 0x0003ffff, 0x3ffff);
		halrf_wreg(rf, 0x58c4, 0x3ffc0000, 0x000);
		halrf_wreg(rf, 0x58c4, 0xc0000000, 0x0);
		halrf_wreg(rf, 0x58c8, 0x00ffffff, 0x000000);
		halrf_wreg(rf, 0x58c8, 0xf0000000, 0x0);
		halrf_wreg(rf, 0x58cc, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x58d0, 0x00001fff, 0x0101);
		halrf_wreg(rf, 0x58d0, 0x0001e000, 0x4);
		halrf_wreg(rf, 0x58d0, 0x03fe0000, 0x100);
		halrf_wreg(rf, 0x58d0, 0x04000000, 0x0);
		...
		if (channel <= 14) {
			if (rfe_type > 50) {
				halrf_wreg(rf, 0x58d8, 0x000001ff, 0x18c);
				halrf_wreg(rf, 0x58d8, 0x0003fe00, 0x000);
			} else {
				halrf_wreg(rf, 0x58d8, 0x000001ff, 0x13c);
				halrf_wreg(rf, 0x58d8, 0x0003fe00, 0x05c);
			}
		} else {
			if (rfe_type > 50) {
				halrf_wreg(rf, 0x58d8, 0x000001ff, 0x18c);
				...
				halrf_wreg(rf, 0x58d8, 0x000001ff, 0x15c);
				halrf_wreg(rf, 0x58d8, 0x0003fe00, 0x05c);
			} else {
		...
		halrf_wreg(rf, 0x58d8, 0x000c0000, 0x2);
		halrf_wreg(rf, 0x58d8, 0xfff00000, 0x800);
		halrf_wreg(rf, 0x58dc, 0x000000ff, 0x7f);
		halrf_wreg(rf, 0x58dc, 0x0000ff00, 0x80);
		halrf_wreg(rf, 0x58dc, 0x00010000, 0x0);
		halrf_wreg(rf, 0x58dc, 0x3ff00000, 0x000);
		halrf_wreg(rf, 0x58dc, 0x80000000, 0x1);
		halrf_wreg(rf, 0x58f0, 0x000001ff, 0x1ff);
		halrf_wreg(rf, 0x58f0, 0x0003fe00, 0x000);
		halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
		halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
		halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
		halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
	} else {
		halrf_wreg(rf, 0x7800, 0x000000ff, 0x7f);
		halrf_wreg(rf, 0x7800, 0x0000ff00, 0x80);
		halrf_wreg(rf, 0x7800, 0x003f0000, 0x3f);
		/*halrf_wreg(rf, 0x7800, 0x0fc00000, 0x0);*/
		halrf_wreg(rf, 0x7800, 0x10000000, 0x0);
		halrf_wreg(rf, 0x7800, 0x20000000, 0x0);
		halrf_wreg(rf, 0x7800, 0xc0000000, 0x0);
		/*Debug power cw setting with Dino*/
		/*halrf_wreg(rf, 0x7804, 0x000001ff, 0x040);*/
		/*halrf_wreg(rf, 0x7804, 0x07fc0000, 0xac);*/
		halrf_wreg(rf, 0x7804, 0xf8000000, 0x00);
		/*halrf_wreg(rf, 0x7808, 0x000001ff, 0x040);*/
		/*halrf_wreg(rf, 0x7808, 0x07fc0000, 0xac);*/
		halrf_wreg(rf, 0x780c, 0x0000007f, 0x40);
		halrf_wreg(rf, 0x780c, 0x00007f00, 0x40);
		halrf_wreg(rf, 0x780c, 0x00008000, 0x0);
		halrf_wreg(rf, 0x780c, 0x0fff0000, 0x000);
		halrf_wreg(rf, 0x7810, 0x000001ff, 0x000);
		halrf_wreg(rf, 0x7810, 0x00000200, 0x0);
		halrf_wreg(rf, 0x7810, 0x0000fc00, 0x00);
		halrf_wreg(rf, 0x7810, 0x00010000, 0x1);
		halrf_wreg(rf, 0x7810, 0x00fe0000, 0x00);
		halrf_wreg(rf, 0x7810, 0x01000000, 0x1);
		halrf_wreg(rf, 0x7810, 0x06000000, 0x0);
		halrf_wreg(rf, 0x7810, 0x38000000, 0x3);
		halrf_wreg(rf, 0x7810, 0x40000000, 0x1);
		halrf_wreg(rf, 0x7810, 0x80000000, 0x0);
		halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
		halrf_wreg(rf, 0x7814, 0x00000c00, 0x0);
		...
		if (rfe_type <= 50)
			halrf_wreg(rf, 0x7814, 0x003c0000, 0x0);

		halrf_wreg(rf, 0x7814, 0x01c00000, 0x0);
		halrf_wreg(rf, 0x7814, 0x18000000, 0x0);
		halrf_wreg(rf, 0x7814, 0xe0000000, 0x0);
		halrf_wreg(rf, 0x7818, 0x000000ff, 0x00);
		halrf_wreg(rf, 0x7818, 0x0001ff00, 0x018);
		halrf_wreg(rf, 0x7818, 0x03fe0000, 0x016);
		halrf_wreg(rf, 0x7818, 0xfc000000, 0x00);
		halrf_wreg(rf, 0x781c, 0x000003ff, 0x280);
		halrf_wreg(rf, 0x781c, 0x000ffc00, 0x200);
		halrf_wreg(rf, 0x781c, 0x00100000, 0x0);

		if (rfe_type <= 50) {
			halrf_wreg(rf, 0x781c, 0x01e00000, 0x8);
			halrf_wreg(rf, 0x781c, 0x01e00000, 0xe);
			halrf_wreg(rf, 0x781c, 0x1e000000, 0x8);
			halrf_wreg(rf, 0x781c, 0x1e000000, 0xe);
		}

		halrf_wreg(rf, 0x781c, 0x20000000, 0x0);
		halrf_wreg(rf, 0x7820, 0x00000fff, 0x080);
		halrf_wreg(rf, 0x7820, 0x0000f000, 0x0);
		halrf_wreg(rf, 0x7820, 0x001f0000, 0x00);
		halrf_wreg(rf, 0x7820, 0xffe00000, 0x000);
		...
		halrf_wreg(rf, 0x7828, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7830, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7830, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7838, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7838, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7840, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7840, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7848, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7848, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7850, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7850, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7858, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7858, 0x7fc00000, 0x000);

		halrf_wreg(rf, 0x7860, 0x003ff000, 0x000);
		halrf_wreg(rf, 0x7860, 0x7fc00000, 0x000);
		halrf_wreg(rf, 0x7860, 0x80000000, 0x0);
		halrf_wreg(rf, 0x7864, 0x000003ff, 0x1ff);
		halrf_wreg(rf, 0x7864, 0x000ffc00, 0x200);
		halrf_wreg(rf, 0x7864, 0x03f00000, 0x00);
		halrf_wreg(rf, 0x7864, 0x04000000, 0x0);
		halrf_wreg(rf, 0x7898, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x789c, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x78a0, 0x000000ff, 0xfd);
		halrf_wreg(rf, 0x78a0, 0x0000ff00, 0xe5);
		halrf_wreg(rf, 0x78a0, 0x00ff0000, 0xcd);
		halrf_wreg(rf, 0x78a0, 0xff000000, 0xb5);
		halrf_wreg(rf, 0x78a4, 0x000000ff, 0x16);
		halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
		halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x000);
		halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
		halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x000);
		halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
		halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
		halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x000);
		halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x000);
		if (bb_version < 0x28)
			halrf_wreg(rf, 0x78b0, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x78b4, 0x0000001f, 0x00);
		halrf_wreg(rf, 0x78b4, 0x00000020, 0x0);
		halrf_wreg(rf, 0x78b4, 0x000001c0, 0x0);
		halrf_wreg(rf, 0x78b4, 0x00000200, 0x0);
		halrf_wreg(rf, 0x78b4, 0x0000f000, 0x2);
		halrf_wreg(rf, 0x78b4, 0x00ff0000, 0x00);
		...
		halrf_wreg(rf, 0x78bc, 0x000000ff, 0x7f);
		halrf_wreg(rf, 0x78bc, 0x0000ff00, 0x80);
		halrf_wreg(rf, 0x78bc, 0x00030000, 0x3);

		/*GNT_WL==0 & 0x78bc[18]==1, Bypass TSSI*/
		/*GNT_BT==1 & 0x78bc[20]==1, Bypass TSSI*/
		/*GNT_BT_TX==1 & 0x78bc[22]==1, Bypass TSSI*/

		halrf_wreg(rf, 0x78bc, 0x000c0000, 0x1);
		if (phl_is_mp_mode(rf->phl_com)) {
			halrf_wreg(rf, 0x78bc, 0x00300000, 0x3);
			halrf_wreg(rf, 0x78bc, 0x00c00000, 0x3);
		} else {
			halrf_wreg(rf, 0x78bc, 0x00300000, 0x2);
			halrf_wreg(rf, 0x78bc, 0x00c00000, 0x2);
		}

		halrf_wreg(rf, 0x78bc, 0x07000000, 0x7);
		halrf_wreg(rf, 0x78c0, 0x00fe0000, 0x3f);
		halrf_wreg(rf, 0x78c0, 0xff000000, 0x00);
		halrf_wreg(rf, 0x78c4, 0x0003ffff, 0x3ffff);
		halrf_wreg(rf, 0x78c4, 0x3ffc0000, 0x000);
		halrf_wreg(rf, 0x78c4, 0xc0000000, 0x0);
		halrf_wreg(rf, 0x78c8, 0x00ffffff, 0x000000);
		halrf_wreg(rf, 0x78c8, 0xf0000000, 0x0);
		halrf_wreg(rf, 0x78cc, MASKDWORD, 0x00000000);
		halrf_wreg(rf, 0x78d0, 0x00001fff, 0x0101);
		halrf_wreg(rf, 0x78d0, 0x0001e000, 0x4);
		halrf_wreg(rf, 0x78d0, 0x03fe0000, 0x100);
		halrf_wreg(rf, 0x78d0, 0x04000000, 0x0);
		...
		if (channel <= 14) {
			if (rfe_type > 50) {
				halrf_wreg(rf, 0x78d8, 0x000001ff, 0x18c);
				halrf_wreg(rf, 0x78d8, 0x0003fe00, 0x000);
			} else {
				halrf_wreg(rf, 0x78d8, 0x000001ff, 0x13c);
				halrf_wreg(rf, 0x78d8, 0x0003fe00, 0x05c);
			}
		} else {
			if (rfe_type > 50) {
				halrf_wreg(rf, 0x78d8, 0x000001ff, 0x18c);
				...
				halrf_wreg(rf, 0x78d8, 0x000001ff, 0x15c);
				halrf_wreg(rf, 0x78d8, 0x0003fe00, 0x05c);
			} else {
		...
		halrf_wreg(rf, 0x78d8, 0x000c0000, 0x2);
		halrf_wreg(rf, 0x78d8, 0xfff00000, 0x800);
		halrf_wreg(rf, 0x78dc, 0x000000ff, 0x7f);
		halrf_wreg(rf, 0x78dc, 0x0000ff00, 0x80);
		halrf_wreg(rf, 0x78dc, 0x00010000, 0x0);
		halrf_wreg(rf, 0x78dc, 0x3ff00000, 0x000);
		halrf_wreg(rf, 0x78dc, 0x80000000, 0x1);
		halrf_wreg(rf, 0x78f0, 0x000001ff, 0x1ff);
		halrf_wreg(rf, 0x78f0, 0x0003fe00, 0x000);
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (path == RF_PATH_A) {
		halrf_wreg(rf, 0x58a0, MASKDWORD, 0x000000fc);
		halrf_wreg(rf, 0x58e4, 0x0000007f, 0x20);
	} else {
		halrf_wreg(rf, 0x78a0, MASKDWORD, 0x000000fc);
		halrf_wreg(rf, 0x78e4, 0x0000007f, 0x20);
	}
}
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	halrf_wreg(rf, r_tssi_adc[path], 0x0fff0000, 0x000);
	halrf_wreg(rf, r_tssi_dck[path], 0x00001000, 0x1);
	halrf_wreg(rf, r_tssi_dck[path], 0x00002000, 0x1);
	halrf_wreg(rf, r_tssi_dck[path], 0x00004000, 0x1);
	halrf_wreg(rf, r_tssi_dck[path], 0x00038000, 0x5);

	if (rfe_type <= 50)
		halrf_wreg(rf, r_tssi_dck[path], 0x003c0000, 0x3);

	halrf_wreg(rf, r_tssi_dck[path], 0x18000000, 0x0);
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	halrf_wreg(rf, secret_test_mode[path], 0x08000000, 0x1);
	halrf_wreg(rf, r_tx_gain_scale[path], 0xf0000000, 0x7);
	halrf_wreg(rf, tx_gain_post[path], 0x000c0000, 0x1);
	halrf_wreg(rf, tx_gain_post[path], 0xfff00000, 0x400);
#endif
}
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (path == RF_PATH_A) {
		...
		halrf_wreg(rf, 0x58cc, 0x00000007, 0x0);
		halrf_wreg(rf, 0x58cc, 0x00000038, 0x1);
		halrf_wreg(rf, 0x58cc, 0x000001c0, 0x2);
		halrf_wreg(rf, 0x58cc, 0x00000e00, 0x3);
		halrf_wreg(rf, 0x5828, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x5898, 0x000000ff, 0x40);
		halrf_wreg(rf, 0x5830, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x5898, 0x0000ff00, 0x40);
		halrf_wreg(rf, 0x5838, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x5898, 0x00ff0000, 0x40);
		halrf_wreg(rf, 0x5840, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x5898, 0xff000000, 0x40);
		halrf_wreg(rf, 0x5848, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x589c, 0x000000ff, 0x40);
		halrf_wreg(rf, 0x5850, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x589c, 0x0000ff00, 0x40);
		halrf_wreg(rf, 0x5858, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x589c, 0x00ff0000, 0x40);
		halrf_wreg(rf, 0x5860, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x589c, 0xff000000, 0x40);
	} else {
		halrf_wreg(rf, 0x781c, 0x00100000, 0x0);
		halrf_wreg(rf, 0x78cc, 0x00001000, 0x1);
		halrf_wreg(rf, 0x78cc, 0x00000007, 0x0);
		halrf_wreg(rf, 0x78cc, 0x00000038, 0x1);
		halrf_wreg(rf, 0x78cc, 0x000001c0, 0x2);
		halrf_wreg(rf, 0x78cc, 0x00000e00, 0x3);
		halrf_wreg(rf, 0x7828, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x7898, 0x000000ff, 0x40);
		halrf_wreg(rf, 0x7830, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x7898, 0x0000ff00, 0x40);
		halrf_wreg(rf, 0x7838, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x7898, 0x00ff0000, 0x40);
		halrf_wreg(rf, 0x7840, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x7898, 0xff000000, 0x40);
		halrf_wreg(rf, 0x7848, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x789c, 0x000000ff, 0x40);
		halrf_wreg(rf, 0x7850, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x789c, 0x0000ff00, 0x40);
		halrf_wreg(rf, 0x7878, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x789c, 0x00ff0000, 0x40);
		halrf_wreg(rf, 0x7860, 0x7fc00000, 0x040);
		halrf_wreg(rf, 0x789c, 0xff000000, 0x40);
	}
}
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (path == RF_PATH_A) {
		...
		halrf_wreg(rf, 0x5820, 0x0000f000, 0x1);
		halrf_wreg(rf, 0x581c, 0x000003ff, 0x280);
		halrf_wreg(rf, 0x581c, 0x000ffc00, 0x200);
		halrf_wreg(rf, 0x58b8, 0x007f0000, 0x00);
		halrf_wreg(rf, 0x58b8, 0x7f000000, 0x00);
		...
		halrf_wreg(rf, 0x7820, 0x0000f000, 0x1);
		halrf_wreg(rf, 0x781c, 0x000003ff, 0x280);
		halrf_wreg(rf, 0x781c, 0x000ffc00, 0x200);
		halrf_wreg(rf, 0x78b8, 0x007f0000, 0x00);
		halrf_wreg(rf, 0x78b8, 0x7f000000, 0x00);
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (path == RF_PATH_A) {
		...
		if (rfe_type == 51 || rfe_type == 53) {
			if (channel >= 1 && channel <= 14) {
				/*SKY85333*/
				halrf_wrf(rf, RF_PATH_A, 0xdf, 0x00400, 0x1);
				//halrf_wrf(rf, RF_PATH_A, 0x6e, 0xfffff, 0x45a7c);
				halrf_wreg(rf, 0x5820, 0x40000000, 0x1);
				//halrf_wreg(rf, 0x5814, 0x003c0000, 0x3);
				//halrf_wreg(rf, 0x581c, 0x01e00000, 0x3);
				//halrf_wreg(rf, 0x581c, 0x1e000000, 0x3);
				//halrf_wreg(rf, 0x5824, 0x0003ffff, 0x00654);
				//halrf_wreg(rf, 0x5824, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5828, 0x00000fff, 0x0c0);
				//halrf_wreg(rf, 0x582c, 0x0003ffff, 0x00654);
				//halrf_wreg(rf, 0x582c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5830, 0x00000fff, 0x0c0);
				//halrf_wreg(rf, 0x5834, 0x0003ffff, 0x00654);
				//halrf_wreg(rf, 0x5834, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5838, 0x00000fff, 0x0c0);
				//halrf_wreg(rf, 0x583c, 0x0003ffff, 0x006e2);
				//halrf_wreg(rf, 0x583c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5840, 0x00000fff, 0x0c6);
				//halrf_wreg(rf, 0x5844, 0x0003ffff, 0x006e2);
				//halrf_wreg(rf, 0x5844, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5848, 0x00000fff, 0x0c6);
				//halrf_wreg(rf, 0x584c, 0x0003ffff, 0x006e2);
				//halrf_wreg(rf, 0x584c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5850, 0x00000fff, 0x0c6);
				//halrf_wreg(rf, 0x5854, 0x0003ffff, 0x00654);
				//halrf_wreg(rf, 0x5854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5858, 0x00000fff, 0x0bd);
				//halrf_wreg(rf, 0x585c, 0x0003ffff, 0x00654);
				//halrf_wreg(rf, 0x585c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5860, 0x00000fff, 0x0bd);
			} else {
				/*SKY85747*/
				halrf_wrf(rf, RF_PATH_A, 0xdf, 0x00200, 0x1);
				//halrf_wrf(rf, RF_PATH_A, 0x6f, 0xfffff, 0x56a7c);
				halrf_wreg(rf, 0x5820, 0x40000000, 0x1);
				//halrf_wreg(rf, 0x5814, 0x003c0000, 0x0);
				//halrf_wreg(rf, 0x581c, 0x01e00000, 0x4);
				//halrf_wreg(rf, 0x581c, 0x1e000000, 0x4);
				//halrf_wreg(rf, 0x5824, 0x0003ffff, 0x001c0);
				//halrf_wreg(rf, 0x5824, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5828, 0x00000fff, 0x115);
				//halrf_wreg(rf, 0x582c, 0x0003ffff, 0x001c0);
				//halrf_wreg(rf, 0x582c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5830, 0x00000fff, 0x115);
				//halrf_wreg(rf, 0x5834, 0x0003ffff, 0x001c0);
				//halrf_wreg(rf, 0x5834, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5838, 0x00000fff, 0x115);
				//halrf_wreg(rf, 0x583c, 0x0003ffff, 0x001c0);
				//halrf_wreg(rf, 0x583c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5840, 0x00000fff, 0x122);
				//halrf_wreg(rf, 0x5844, 0x0003ffff, 0x001c0);
				//halrf_wreg(rf, 0x5844, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5848, 0x00000fff, 0x122);
				//halrf_wreg(rf, 0x584c, 0x0003ffff, 0x001c0);
				//halrf_wreg(rf, 0x584c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5850, 0x00000fff, 0x122);
				//halrf_wreg(rf, 0x5854, 0x0003ffff, 0x115f2);
				//halrf_wreg(rf, 0x5854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5858, 0x00000fff, 0x121);
				//halrf_wreg(rf, 0x585c, 0x0003ffff, 0x115f2);
		...
		if (rfe_type == 52 || rfe_type == 54) {
			if (channel >= 1 && channel <= 14) {
				/*RTC66204*/
				halrf_wrf(rf, RF_PATH_A, 0xdf, 0x00400, 0x1);
				//halrf_wrf(rf, RF_PATH_A, 0x6e, 0xfffff, 0x55a7c);
				halrf_wreg(rf, 0x5820, 0x40000000, 0x0);
				//halrf_wreg(rf, 0x5814, 0x003c0000, 0x2);
				//halrf_wreg(rf, 0x581c, 0x01e00000, 0x4);
				//halrf_wreg(rf, 0x581c, 0x1e000000, 0x4);
				//halrf_wreg(rf, 0x5824, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x5824, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5828, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x582c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x582c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5830, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x5834, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x5834, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5838, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x583c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x583c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5840, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x5844, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x5844, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5848, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x584c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x584c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5850, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x5854, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x5854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5858, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x585c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x585c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5860, 0x00000fff, 0x1e8);				
			} else {
				/*RTC66504*/
				halrf_wrf(rf, RF_PATH_A, 0xdf, 0x00200, 0x1);
				//halrf_wrf(rf, RF_PATH_A, 0x6f, 0xfffff, 0x45a7c);
				halrf_wreg(rf, 0x5820, 0x40000000, 0x0);
				//halrf_wreg(rf, 0x5814, 0x003c0000, 0x2);
				//halrf_wreg(rf, 0x581c, 0x01e00000, 0x4);
				//halrf_wreg(rf, 0x581c, 0x1e000000, 0x4);
				//halrf_wreg(rf, 0x5824, 0x0003ffff, 0x1fa43);
				//halrf_wreg(rf, 0x5824, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x5828, 0x00000fff, 0x225);
				//halrf_wreg(rf, 0x582c, 0x0003ffff, 0x1fa43);
				//halrf_wreg(rf, 0x582c, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x5830, 0x00000fff, 0x225);
				//halrf_wreg(rf, 0x5834, 0x0003ffff, 0x1fa43);
				//halrf_wreg(rf, 0x5834, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x5838, 0x00000fff, 0x225);
				//halrf_wreg(rf, 0x583c, 0x0003ffff, 0x20845);
				//halrf_wreg(rf, 0x583c, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x5840, 0x00000fff, 0x231);
				//halrf_wreg(rf, 0x5844, 0x0003ffff, 0x20845);
				//halrf_wreg(rf, 0x5844, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x5848, 0x00000fff, 0x231);
				//halrf_wreg(rf, 0x584c, 0x0003ffff, 0x20845);
				//halrf_wreg(rf, 0x584c, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x5850, 0x00000fff, 0x231);
				//halrf_wreg(rf, 0x5854, 0x0003ffff, 0x115f2);
				//halrf_wreg(rf, 0x5854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x5858, 0x00000fff, 0x121);
				//halrf_wreg(rf, 0x585c, 0x0003ffff, 0x115f2);
		...
		if (rfe_type == 51 || rfe_type == 53) {
			if (channel >= 1 && channel <= 14) {
				/*SKY85333*/
				halrf_wrf(rf, RF_PATH_B, 0xdf, 0x00400, 0x1);
				//halrf_wrf(rf, RF_PATH_B, 0x6e, 0xfffff, 0x45a7c);
				halrf_wreg(rf, 0x7820, 0x40000000, 0x1);
				//halrf_wreg(rf, 0x7814, 0x003c0000, 0x3);
				//halrf_wreg(rf, 0x781c, 0x01e00000, 0x3);
				//halrf_wreg(rf, 0x781c, 0x1e000000, 0x3);
				//halrf_wreg(rf, 0x7824, 0x0003ffff, 0x0078f);
				//halrf_wreg(rf, 0x7824, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7828, 0x00000fff, 0x0c0);
				//halrf_wreg(rf, 0x782c, 0x0003ffff, 0x0078f);
				//halrf_wreg(rf, 0x782c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7830, 0x00000fff, 0x0c0);
				//halrf_wreg(rf, 0x7834, 0x0003ffff, 0x0078f);
				//halrf_wreg(rf, 0x7834, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7838, 0x00000fff, 0x0c0);
				//halrf_wreg(rf, 0x783c, 0x0003ffff, 0x00815);
				//halrf_wreg(rf, 0x783c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7840, 0x00000fff, 0x0c7);
				//halrf_wreg(rf, 0x7844, 0x0003ffff, 0x00815);
				//halrf_wreg(rf, 0x7844, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7848, 0x00000fff, 0x0c7);
				//halrf_wreg(rf, 0x784c, 0x0003ffff, 0x00815);
				//halrf_wreg(rf, 0x784c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7850, 0x00000fff, 0x0c7);
				//halrf_wreg(rf, 0x7854, 0x0003ffff, 0x0078f);
				//halrf_wreg(rf, 0x7854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7858, 0x00000fff, 0x0bd);
				//halrf_wreg(rf, 0x785c, 0x0003ffff, 0x0078f);
				//halrf_wreg(rf, 0x785c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7860, 0x00000fff, 0x0bd);
			} else {
				/*SKY85747*/
				halrf_wrf(rf, RF_PATH_B, 0xdf, 0x00200, 0x1);
				//halrf_wrf(rf, RF_PATH_B, 0x6f, 0xfffff, 0x56a7c);
				halrf_wreg(rf, 0x7820, 0x40000000, 0x1);
				//halrf_wreg(rf, 0x7814, 0x003c0000, 0x0);
				//halrf_wreg(rf, 0x781c, 0x01e00000, 0x4);
				//halrf_wreg(rf, 0x781c, 0x1e000000, 0x4);
				//halrf_wreg(rf, 0x7824, 0x0003ffff, 0x0019f);
				//halrf_wreg(rf, 0x7824, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7828, 0x00000fff, 0x110);
				//halrf_wreg(rf, 0x782c, 0x0003ffff, 0x0019f);
				//halrf_wreg(rf, 0x782c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7830, 0x00000fff, 0x110);
				//halrf_wreg(rf, 0x7834, 0x0003ffff, 0x0019f);
				//halrf_wreg(rf, 0x7834, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7838, 0x00000fff, 0x110);
				//halrf_wreg(rf, 0x783c, 0x0003ffff, 0x0019f);
				//halrf_wreg(rf, 0x783c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7840, 0x00000fff, 0x11e);
				//halrf_wreg(rf, 0x7844, 0x0003ffff, 0x0019f);
				//halrf_wreg(rf, 0x7844, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7848, 0x00000fff, 0x11e);
				//halrf_wreg(rf, 0x784c, 0x0003ffff, 0x0019f);
				//halrf_wreg(rf, 0x784c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7850, 0x00000fff, 0x11e);
				//halrf_wreg(rf, 0x7854, 0x0003ffff, 0x115f2);
				//halrf_wreg(rf, 0x7854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7858, 0x00000fff, 0x121);
				//halrf_wreg(rf, 0x785c, 0x0003ffff, 0x115f2);
		...
		if (rfe_type == 52 || rfe_type == 54) {
			if (channel >= 1 && channel <= 14) {
				/*RTC66024*/
				halrf_wrf(rf, RF_PATH_B, 0xdf, 0x00400, 0x1);
				//halrf_wrf(rf, RF_PATH_B, 0x6e, 0xfffff, 0x55a7c);
				halrf_wreg(rf, 0x7820, 0x40000000, 0x0);
				//halrf_wreg(rf, 0x7814, 0x003c0000, 0x2);
				//halrf_wreg(rf, 0x781c, 0x01e00000, 0x4);
				//halrf_wreg(rf, 0x781c, 0x1e000000, 0x4);
				//halrf_wreg(rf, 0x7824, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x7824, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7828, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x782c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x782c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7830, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x7834, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x7834, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7838, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x783c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x783c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7840, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x7844, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x7844, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7848, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x784c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x784c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7850, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x7854, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x7854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7858, 0x00000fff, 0x1e8);
				//halrf_wreg(rf, 0x785c, 0x0003ffff, 0x19b08);
				//halrf_wreg(rf, 0x785c, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7860, 0x00000fff, 0x1e8);					
			} else {
				/*RTC66504*/
				halrf_wrf(rf, RF_PATH_B, 0xdf, 0x00200, 0x1);
				//halrf_wrf(rf, RF_PATH_B, 0x6f, 0xfffff, 0x45a7c);
				halrf_wreg(rf, 0x7820, 0x40000000, 0x0);
				//halrf_wreg(rf, 0x7814, 0x003c0000, 0x2);
				//halrf_wreg(rf, 0x781c, 0x01e00000, 0x4);
				//halrf_wreg(rf, 0x781c, 0x1e000000, 0x4);
				//halrf_wreg(rf, 0x7824, 0x0003ffff, 0x1eeba);
				//halrf_wreg(rf, 0x7824, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x7828, 0x00000fff, 0x21c);
				//halrf_wreg(rf, 0x782c, 0x0003ffff, 0x1eeba);
				//halrf_wreg(rf, 0x782c, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x7830, 0x00000fff, 0x21c);
				//halrf_wreg(rf, 0x7834, 0x0003ffff, 0x1eeba);
				//halrf_wreg(rf, 0x7834, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x7838, 0x00000fff, 0x21c);
				//halrf_wreg(rf, 0x783c, 0x0003ffff, 0x1fa43);
				//halrf_wreg(rf, 0x783c, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x7840, 0x00000fff, 0x227);
				//halrf_wreg(rf, 0x7844, 0x0003ffff, 0x1fa43);
				//halrf_wreg(rf, 0x7844, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x7848, 0x00000fff, 0x227);
				//halrf_wreg(rf, 0x784c, 0x0003ffff, 0x1fa43);
				//halrf_wreg(rf, 0x784c, 0x3ffc0000, 0xffb);
				//halrf_wreg(rf, 0x7850, 0x00000fff, 0x227);
				//halrf_wreg(rf, 0x7854, 0x0003ffff, 0x115f2);
				//halrf_wreg(rf, 0x7854, 0x3ffc0000, 0x000);
				//halrf_wreg(rf, 0x7858, 0x00000fff, 0x121);
				//halrf_wreg(rf, 0x785c, 0x0003ffff, 0x115f2);
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (path == RF_PATH_A) {
		halrf_wreg(rf, 0x5820, 0x80000000, 0x0);
		halrf_wreg(rf, 0x5818, 0x18000000, 0x0);
		...
		halrf_wreg(rf, 0x7820, 0x80000000, 0x0);
		halrf_wreg(rf, 0x7818, 0x18000000, 0x0);
					...
					enum phl_phy_idx phy, enum rf_path path)
{
	...
	if (phl_is_mp_mode(rf->phl_com)) {
		if (tssi_info->tssi_type[phy] == TSSI_ON) {
			if (rf->phl_com->dev_cap.rfe_type >= 50)
				halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00003800, 0x2);
			else
				halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00003800, 0x4);
		} else if (tssi_info->tssi_type[phy] == TSSI_CAL)
			halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00003800, 0x0);
	}

	halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00004000, 0x0);
	halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00004000, 0x1);
	halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00004000, 0x0);
	halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x00008000, 0x0);
	halrf_wreg(rf, txagc_offset_mv_avg_rpt_sel[path], 0x000f0000, 0x0);
}
...
{		
	...
	if (path == RF_PATH_A) {
		if (channel >= 1 && channel <= 14) {
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1d0);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x1e8);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x00b);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x000);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x088);
		} else if (channel >= 36 && channel <= 64) {
			halrf_wreg(rf, 0x5814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1d7);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x1fb);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x005);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x087);
		} else if (channel >= 100 && channel <= 144) {
			halrf_wreg(rf, 0x5814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1d8);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x1fc);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x006);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x084);
		} else if (channel >= 149 && channel <= 177) {
			halrf_wreg(rf, 0x5814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1e5);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x00a);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x011);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x083);
		}
	} else {
		if (channel >= 1 && channel <= 14) {
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			...
			halrf_wreg(rf, 0x78f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x1cc);
			halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x1e2);
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x005);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x000);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x089);
		} else if (channel >= 36 && channel <= 64) {	
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x78f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x1d5);
			halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x1fc);
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x005);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x083);
		} else if (channel >= 100 && channel <= 144) {
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x78f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x1dc);
			halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x002);
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x00b);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x082);
		} else if (channel >= 149 && channel <= 177) {
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x78f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x1f0);
			halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x016);
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x01f);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x080);
		}
	}
}
...
{		
	...
	if (path == RF_PATH_A) {
		if (channel >= 1 && channel <= 14) {
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1e1);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x005);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x025);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x092);
		} else if (channel >= 100 && channel <= 144) {
			halrf_wreg(rf, 0x5814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1dc);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x000);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x020);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x08e);
		} else if (channel >= 149 && channel <= 177) {
			halrf_wreg(rf, 0x5814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x58f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x58f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x58a4, 0x03fe0000, 0x1e0);
			halrf_wreg(rf, 0x58a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58a8, 0x0003fe00, 0x005);
			halrf_wreg(rf, 0x58a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x58ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x58ac, 0x0003fe00, 0x025);
			halrf_wreg(rf, 0x58ac, 0x07fc0000, 0x08b);
		}
	} else {
		if (channel >= 1 && channel <= 14) {
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			...
			halrf_wreg(rf, 0x78f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x1db);
			halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x002);
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x020);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x08f);
		} else if (channel >= 100 && channel <= 144) {
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x021);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x08c);
		} else if (channel >= 149 && channel <= 177) {
			halrf_wreg(rf, 0x7814, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000003ff, 0x000);
			halrf_wreg(rf, 0x78f4, 0x000ffc00, 0x000);
			...
			halrf_wreg(rf, 0x78f8, 0x000ffc00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x0001ff00, 0x000);
			halrf_wreg(rf, 0x78a4, 0x03fe0000, 0x1d6);
			halrf_wreg(rf, 0x78a8, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78a8, 0x0003fe00, 0x1fc);
			halrf_wreg(rf, 0x78a8, 0x07fc0000, 0x000);
			halrf_wreg(rf, 0x78ac, 0x000001ff, 0x000);
			halrf_wreg(rf, 0x78ac, 0x0003fe00, 0x01c);
			halrf_wreg(rf, 0x78ac, 0x07fc0000, 0x088);
		}
	}
}
						...
						enum phl_phy_idx phy)
{
	...
	halrf_wreg(rf, addr_cck_long[path], addr_cck_bitmask[path],
			(u32)(tmp & 0x3ff));
	halrf_wreg(rf, addr_cck_short[path], addr_cck_bitmask[path],
			(u32)(tmp & 0x3ff));
	...
	halrf_wreg(rf, addr_mcs_20m[path], addr_mcs_bitmask[path],
		(u32)(tmp & 0x3ff));
	halrf_wreg(rf, addr_mcs_40m[path], addr_mcs_bitmask[path],
		(u32)(tmp & 0x3ff));
	halrf_wreg(rf, addr_mcs_80m[path], addr_mcs_bitmask[path],
		(u32)(tmp & 0x3ff));
	halrf_wreg(rf, addr_mcs_80m_80m[path], addr_mcs_bitmask[path],
		(u32)(tmp & 0x3ff));
	halrf_wreg(rf, addr_mcs_5m[path], addr_mcs_bitmask[path],
		(u32)(tmp & 0x3ff));
	halrf_wreg(rf, addr_mcs_10m[path], addr_mcs_bitmask[path],
		(u32)(tmp & 0x3ff));
					...
					enum phl_phy_idx phy, bool hwtx_en)
{
	...
	if (rf->hal_com->dbcc_en)
		...
		_halrf_do_tssi_8852a(rf, phy, hwtx_en);
}
					...
					enum phl_phy_idx phy_idx, s32 xdbm)
{
	...
	if ((tssi_info->tssi_type[phy_idx] == TSSI_OFF && phl_is_mp_mode(rf->phl_com)) || ch > 14) {
		for (i = RF_PATH_A; i < TSSI_PATH_MAX_8852A; i++) {
			tssi_info->tssi_tracking_check[i] = false;
			tssi_info->extra_ofst[i] = 0;
		...
		RF_DBG(rf, DBG_RF_TX_PWR_TRACK, "tssi_info->tssi_type[phy_idx]=%d ch=%d Return !!!\n",
			tssi_info->tssi_type[phy_idx], ch);
		return;
	}
