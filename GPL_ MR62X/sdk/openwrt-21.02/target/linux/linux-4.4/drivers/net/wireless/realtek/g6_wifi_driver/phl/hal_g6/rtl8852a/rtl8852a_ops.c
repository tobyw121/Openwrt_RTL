 ...
 *
 *****************************************************************************/
#define _RTL8852A_OPS_C_
#include "../hal_headers.h"
#include "rtl8852a_hal.h"

static void read_chip_version_8852a(struct rtw_phl_com_t *phl_com,
					...
					struct hal_info_t *hal)
{
	...
	/*** initialize section ***/
	ops->read_chip_version = read_chip_version_8852a;
	ops->hal_cfg_fw = hal_cfg_fw_8852a;
	...
	ops->dbg_tx_rpt = hal_debug_tx_report_8852a;
