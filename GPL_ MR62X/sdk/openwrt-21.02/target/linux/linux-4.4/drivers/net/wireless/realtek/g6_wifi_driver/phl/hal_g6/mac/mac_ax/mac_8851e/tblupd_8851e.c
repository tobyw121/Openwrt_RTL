...
u32 mac_f2p_test_cmd_8851e(struct mac_ax_adapter *adapter,
...
u32 mac_upd_dctl_info_8851e(struct mac_ax_adapter *adapter,
...
void _set_role_cctrl_v1_8851e(struct mac_ax_adapter *adapter,
...
void mac_upd_role_cctrl_v1_8851e(struct mac_ax_adapter *adapter,
				 struct rtw_hal_mac_ax_cctl_info *info,
				 struct rtw_hal_mac_ax_cctl_info *mask, u8 macid)
{
	...
	_set_role_cctrl_v1_8851e(adapter, info, mask, &role->info.c_info);
}

u32 mac_upd_cctl_info_8851e(struct mac_ax_adapter *adapter,
			    struct rtw_hal_mac_ax_cctl_info *info,
			    struct rtw_hal_mac_ax_cctl_info *mask,
			    u8 macid, u8 operation)
{
	...
	mac_upd_role_cctrl_v1_8851e(adapter, info, mask, macid);
...
u32 mac_init_cctl_info_8851e(struct mac_ax_adapter *adapter, u8 macid)
{
...
#if MAC_AX_FEATURE_DBGPKG
u32 cctl_info_debug_write_8851e(struct mac_ax_adapter *adapter,
				struct fwcmd_cctlinfo_ud *tbl,
				u8 macid)
{
	u32 val;
...
u32 dctl_info_debug_write_8851e(struct mac_ax_adapter *adapter,
				struct fwcmd_dctlinfo_ud_v1 *tbl,
				u8 macid)
{
...
u32 mac_ss_dl_grp_upd_8851e(struct mac_ax_adapter *adapter,
