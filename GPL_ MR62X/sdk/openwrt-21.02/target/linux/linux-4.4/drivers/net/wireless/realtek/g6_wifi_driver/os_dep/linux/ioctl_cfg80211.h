...
void rtw_ready_on_remain_ch_cb(_adapter *padapter);
#endif
...
#if !defined(CONFIG_VERSION) && (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 26)) && (LINUX_VERSION_CODE < KERNEL_VERSION(4, 7, 0))
