...
struct mac_fw_msg fw_log_8852b[] = {
	...
	{MSG_8852B_WLANDUMP_44, "MACID %d WD count BE:%d BK:%d VI:%d VO:%d\n"},
	...
	{MSG_8852B_ROLE_16, "[FAIL] search role fail in RoleConnect!\n"},
	{MSG_8852B_ROLE_17, "[FAIL] search role fail in RoleDisConnect!\n"},
	...
	{MSG_8852B_ROLE_21, "[FAIL] Create Role Fail!\n"},
	...
	{MSG_8852B_PORT_00, "Assert at file: %s\n"},
	{MSG_8852B_PORT_01, "not send c2hHalt\n"},
	{MSG_8852B_PORT_02, "Assert at line: %d\n"},
	...
	{MSG_8852B_HCI_00, "Wrong MDIO PCIe Input, input speed: %x\n"},
	{MSG_8852B_HCI_01, "MDIO Read Fail, addr: %x\n"},
	{MSG_8852B_HCI_02, "MDIO Write Fail, addr: %x\n"},
	{MSG_8852B_HCI_03, "Init PCIE Card Loss\n"},
	{MSG_8852B_HCI_04, "MDIO Write Fail\n"},
	{MSG_8852B_HCI_05, "G1_PHY_3F4: %x\n"},
	{MSG_8852B_HCI_06, "G1_PHY_3C4: %x\n"},
	{MSG_8852B_HCI_07, "G1_PHY_3D4: %x\n"},
	{MSG_8852B_HCI_08, "G1_PHY_204: %x\n"},
	{MSG_8852B_HCI_09, "Card Loss\n"},
	{MSG_8852B_HCI_10, "DBG_38: %X, DBG_39: %X, DBG_3C: %X\n"},
	{MSG_8852B_HCI_11, "DBG_23: %X, MAC_3F0: %X, MAC_F8: %X\n"},
	{MSG_8852B_HCI_12, "DBG_F0: %X\n"},
	{MSG_8852B_HCI_13, "[CtrlPCIEACHDMA]ch map empty\n"},
	{MSG_8852B_HCI_14, "[CtrlPCIEACHDMA]Read PCIE MIO fail\n"},
	{MSG_8852B_HCI_15, "[CtrlPCIEACHDMA]Write PCIE MIO fail\n"},
	{MSG_8852B_H2CPKT_0, "content = %x  %x  %x  %x\n"},
	{MSG_8852B_H2CPKT_2, "size mismatch while deaggregating H2C\n"},
	{MSG_8852B_H2CPKT_3, "First H2C Enqueue\n"},
	{MSG_8852B_H2CPKT_4, "Get free H2C node fail\n"},
	{MSG_8852B_H2CPKT_5, "Get free H2C node fail\n"},
	{MSG_8852B_H2CPKT_6, "_InitH2CPktPoolRAMComm: H2C ptr is null!!!\n"},
	{MSG_8852B_H2CPKT_7, "_InitH2CPktPoolRAMComm: H2C queue is full!!!\n"},
	{MSG_8852B_H2CPKT_8, "H2C is null!!!\n"},
	{MSG_8852B_H2CPKT_9, "H2C Dequeue\n"},
	{MSG_8852B_H2CPKT_10, "H2CPKT dequeue fail\n"},
	{MSG_8852B_H2CPKT_11, "H2CPktEnQueueRAMComm\n"},
	{MSG_8852B_H2CPKT_12, "H2C header len %d & rx bd info len %d mismatch\n"},
	{MSG_8852B_H2CPKT_13, "H2CPKT enqueue fail\n"},
	{MSG_8852B_H2CPKT_14, "H2CPktNodeFreeRAMComm\n"},
	{MSG_8852B_H2CPKT_15, "Wrong H2C pool class: %d\n"},
	{MSG_8852B_H2CPKT_16, "H2CPktNodeFreeRAMComm: class %d H2C queue is full!!!\n"},
	{MSG_8852B_H2CPKT_17, "H2CPktNodeAllocRAMComm\n"},
	{MSG_8852B_H2CPKT_18, "H2CPkt length is too large\n"},
	{MSG_8852B_H2CPKT_19, "H2C node pool is empty\n"},
	{MSG_8852B_H2CPKT_20, "H2C node is valid\n"},
	{MSG_8852B_H2CPKT_21, "H2C Enqueue\n"},
	{MSG_8852B_H2CPKT_22, "H2CPKT get lock fail\n"},
	{MSG_8852B_H2CPKT_23, "H2C size is inconsistent\n"},
	{MSG_8852B_H2CPKT_24, "H2C node is NULL\n"},
	{MSG_8852B_H2CPKT_25, "H2CPKT get lock fail\n"},
	{MSG_8852B_H2CPKT_26, "H2CPKT return lock fail\n"},
	{MSG_8852B_H2C2HREG_0, "AXIDMA Stop Failed\n"},
	{MSG_8852B_H2C2HREG_1, "Should never get here\n"},
	{MSG_8852B_TWT_00, "TWT init fail, ALLOC NULL\n"},
	{MSG_8852B_TWT_01, "TWT init fail, create timer fail\n"},
	{MSG_8852B_TWT_02, "TWT init fail, create twtc2hLock fail\n"},
	{MSG_8852B_TWT_03, "TWT id %d invalid\n"},
	{MSG_8852B_TWT_04, "[TSF]invalid port %d\n"},
	{MSG_8852B_TWT_05, "add TWT[%d] h2c already valid\n"},
	{MSG_8852B_TWT_06, "add TWT h2c Role idx srch fail B%dP%d\n"},
	{MSG_8852B_TWT_07, "add TWT[%d] h2c Role idx %d exist\n"},
	{MSG_8852B_TWT_08, "add TWT done, port %x, itvl %d, dur %d\n"},
	{MSG_8852B_TWT_09, "[TWT]enable PCIE ACH%d DMA fail\n"},
	{MSG_8852B_TWT_10, "del TWT h2c Role srch fail B%dP%d\n"},
	{MSG_8852B_TWT_11, "del TWT h2c Role %d not match srch idx %d\n"},
	{MSG_8852B_TWT_12, "del TWT h2c clr TWT[%d] COM info fail\n"},
	{MSG_8852B_TWT_13, "del TWT h2c clr TWT[%d] NIC info fail\n"},
	{MSG_8852B_TWT_14, "TWT timer start fail\n"},
	{MSG_8852B_TWT_15, "did not assign twt ul fix, force to all TF fix.\n"},
	{MSG_8852B_TWT_16, "stop TWT timer fail\n"},
	{MSG_8852B_TWT_17, "del TWT h2c clr TWT[%d] AP info fail\n"},
	{MSG_8852B_TWT_18, "TWT act %d, macid %d, id %d\n"},
	{MSG_8852B_TWT_19, "TWT sta num %d\n"},
	{MSG_8852B_TWT_20, "[TWT]get B%d port %d tsf fail\n"},
	{MSG_8852B_TWT_21, "[TWT%d]issue wake pkt fail %d-%d\n"},
	{MSG_8852B_TWT_22, "[TWT]enable PCIE ACH%d DMA fail\n"},
	{MSG_8852B_TWT_23, "[TWT]disable PCIE ACH%d DMA fail\n"},
	{MSG_8852B_TWT_24, "[TWT]Next start %X-%X, end %X-%X\n"},
	{MSG_8852B_TWT_25, "[TWT]TSF diff over u32\n"},
	{MSG_8852B_TWT_26, "[TWT]SP start early %X-%X, srt diff %d,dur diff %d, end diff %d\n"},
	...
	{MSG_8852B_MP_0, "error=%d\n"},
	{MSG_8852B_MP_1, "ips 0x1C err = 0x%08x\n"},
	{MSG_8852B_MP_2, "Wait Timeout ips status =0x%x, ips err = 0x%x\n"},
	{MSG_8852B_MP_3, "bit=%x"},
	{MSG_8852B_MP_4, "CMAC"},
	{MSG_8852B_MP_5, "ALL"},
	...
	{MSG_8852B_MPORT_00, "[MPORT]no tsf32 togl h2c content\n"},
	{MSG_8852B_MPORT_01, "[MPORT]tsf32 togl hdl only support band 0\n"},
	{MSG_8852B_MPORT_02, "[MPORT]port %d over max\n"},
	{MSG_8852B_MPORT_03, "[MPORT]B%dP%d tsf32 togl en %d no change\n"},
	{MSG_8852B_MPORT_04, "[MPORT]tsf32 toggle rpt hdl no input\n"},
	{MSG_8852B_MPORT_05, "[MPORT]tsf32 togl rpt c2h enq fail %d\n"},
	{MSG_8852B_MPORT_06, "[MPORT]tsf32 toggle hdl no input\n"},
	{MSG_8852B_MPORT_07, "[MPORT]B%dP%d tsf low %d not run\n"},
	{MSG_8852B_MPORT_08, "[MPORT]tsf32 toggle hdl add pstimer task fail\n"},
	{MSG_8852B_MPORT_09, "[MPORT]invalid port idx %d\n"},
	{MSG_8852B_MPORT_10, "[MPORT]invalid mbssid %d\n"},
	{MSG_8852B_MPORT_11, "[MPORT]invalid get cfg type %d\n"},
	{MSG_8852B_MPORT_12, "[MPORT]B%dP%d get port cfg%d fail %d\n"},
	{MSG_8852B_MPORT_13, "[MPORT]B%dP%d set port cfg%d val%d fail %d\n"},
	{MSG_8852B_MPORT_14, "[MPORT]sub space %d overflow\n"},
	{MSG_8852B_MPORT_15, "[MPORT]port init stat c2h enq fail %d\n"},
	{MSG_8852B_MPORT_16, "[MPORT]port cfg stat c2h enq fail %d\n"},
	{MSG_8852B_MPORT_17, "[MPORT]B%dP%d fast drop setup add ps timer fail %d\n"},
	{MSG_8852B_MPORT_18, "[MPORT]port deinit post fail %d\n"},
	{MSG_8852B_MPORT_19, "[MPORT]chk bcnq empty fail %d\n"},
	{MSG_8852B_MPORT_20, "[MPORT]fast bcn drop setup fail %d\n"},
	{MSG_8852B_MPORT_21, "[MPORT]port deinit patch fail %d\n"},
	{MSG_8852B_MPORT_22, "[MPORT]B%dP%d deinit patch add pstmr fail %d\n"},
	{MSG_8852B_MPORT_23, "[MPORT]B%dP%d deinit post fail %d\n"},
	{MSG_8852B_MPORT_24, "[MPORT]B%dP%d init post fail %d\n"},
	{MSG_8852B_MPORT_25, "[MPORT]send port init c2h %d\n"},
	{MSG_8852B_MPORT_26, "[MPORT]send port cfg c2h %d\n"},
	{MSG_8852B_MPORT_27, "[MPORT]Port deinit setup fail %d\n"},
	{MSG_8852B_MPORT_28, "[MPORT]illegal port cfg%d val %d\n"},
	{MSG_8852B_MPORT_29, "[MPORT]port cfg%d check fail %d\n"},
	{MSG_8852B_MPORT_30, "[MPORT]mbssid en invalid for P%d MB%d\n"},
	{MSG_8852B_MPORT_31, "[MPORT]mbssid %d over current max %d\n"},
	{MSG_8852B_MPORT_32, "[MPORT]port%d is not 0 or state%d is not AP\n"},
	{MSG_8852B_MPORT_33, "[MPORT]set max mbid num fail %d\n"},
	{MSG_8852B_MPORT_34, "[MPORT]invalid port cfg type %d\n"},
	{MSG_8852B_MPORT_35, "[MPORT]port init no input\n"},
	{MSG_8852B_MPORT_36, "[MPORT]B%dP%d mbid set fail %d\n"},
	{MSG_8852B_MPORT_37, "[MPORT]B%dP%d subspc set fail %d\n"},
	{MSG_8852B_MPORT_38, "[MPORT]no port init h2c content\n"},
	{MSG_8852B_MPORT_39, "[MPORT]port init setup fail %d\n"},
	{MSG_8852B_MPORT_40, "[MPORT]no port cfg h2c content\n"},
	{MSG_8852B_NULL_RESULT, "TxNull %d result(%d)!!!\n"},
	{MSG_8852B_MALLOC_1, "%x\t"},
	{MSG_8852B_MALLOC_2, "\t\t%u\t\t"},
	{MSG_8852B_MALLOC_3, "\t\t%u\n"},
	{MSG_8852B_MALLOC_4, "Fast heap\t%x\t%u\t\t%u\t%u\n"},
	{MSG_8852B_MALLOC_5, "Slow heap\t%x\t%u\t\t%u\t%u\n"},
	{MSG_8852B_MALLOC_6, "\t\t%u\t\t%u\t\t%u\n"},
	{MSG_8852B_MALLOC_7, "Don't support this mode!\n"},
	{MSG_8852B_MALLOC_8, "%s\t\t"},
	{MSG_8852B_MALLOC_9, "[Err][Phase%d]FastHeap(%u) is under threshold(%u)!\n"},
	{MSG_8852B_MALLOC_10, "[Phase%d]FastHeap(%u) is above threshold(%u)!\n"},
	{MSG_8852B_MALLOC_11, "[Err][Phase%d]SlowHeap(%u) is under threshold(%u)!\n"},
	{MSG_8852B_MALLOC_12, "[Phase%d]SlowHeap(%u) is above threshold(%u)!\n"},
	{MSG_8852B_MALLOC_13, "call %s return NULL\n"},
	{MSG_8852B_MALLOC_14, "exceed memory limit\n"},
	{MSG_8852B_MALLOC_15, " total: %d bytes\n cur used: %d bytes\n"},
	{MSG_8852B_MALLOC_16, "cur free: %d bytes\n release size exceed allocate size\n"},
	...
	{MSG_8852B_MCC_H2CADDMCCHDL_4, "[MCC] channel band type is None!\n"},
	{MSG_8852B_TASK_ERROR, "Task Error: %wx\n"},
	{MSG_8852B_GETMEDIASTS_1, "GetMediaStatusbyMacid fail, macid = %x!\n"},
	{MSG_8852B_SETMEDIASTS_1, "SetMediaStatusbyMacid: macid number >= 32, macid = %x!\n"},
	{MSG_8852B_SETMEDIASTS_2, "SetMediaStatusbyMacid: Role_idx error, macid = %x, role_idx = %x!\n"},
	...
	{MSG_8852B_HEAP_01, "%s\t\t"},
	{MSG_8852B_HEAP_02, "(%d)\t%d"},
	{MSG_8852B_HEAP_03, "%d\t\t%d\t\t%d\n"},
	{MSG_8852B_HEAP_04, "(%d)\t%d(%d)\t\t\t"},
	{MSG_8852B_HEAP_05, "(%d)\t"},
	{MSG_8852B_INTEGER_01, "%d\n"},
	{MSG_8852B_STRING_2, "%s\t"},
	{MSG_8852B_PS_DTIM_TIMER_OP_FAIL, "[ERR][LPS] Operation(%d) DTIM timer fail!! role_idx(%d)\n"},
	{MSG_8852B_PS_BCN_TIMER_OP_FAIL, "[ERR][LPS] Operation(%d) BCN timer fail!! role_idx(%d)\n"},
	{MSG_8852B_PS_TRX_TIMER_OP_FAIL, "[ERR][LPS] Operation(%d) TRX timer fail!! role_idx(%d)\n"},
	{MSG_8852B_MCC_CHECKREPLACEGROUP_1, "[MCC][REP] old_group:%d didn't start yet!\n"},
	{MSG_8852B_MCC_CHECKREPLACEGROUP_2, "[MCC][REP] group %d didn't running, and deleting...\n"},
	{MSG_8852B_MCC_CHECKREPLACEGROUP_3, "[MCC][REP] update to previous group: %d"},
	{MSG_8852B_MCC_CHECKREPLACEGROUP_4, "[MCC][REP] previous group:%d is running\n"},
	{MSG_8852B_MCC_CHECKREPLACEGROUP_5, "[MCC][REP] replace group: %d, stop macid: %d\n"},
	{MSG_8852B_PS_STATE_SHORTCUT, "=>PsStateShortCut\n"},
	{MSG_8852B_PS_DEBUG_DUMP_1, "[PS] Dump debug info after 32K\n"},
	{MSG_8852B_PS_DEBUG_DUMP_2, "[PS] Dump debug info after open RF\n"},
	{MSG_8852B_PS_DEBUG_DUMP_3, "[PS] Dump debug info after Rx normal mode\n"},
	{MSG_8852B_PS_DEBUG_DUMP_4, "[PS] Dump debug info before close RF\n"},
	{MSG_8852B_PROXY_MALLOC_FAIL, "[Proxy] Malloc fail, (ln %d)\n"},
	{MSG_8852B_PROXY_TX_ENQFAIL, "[Proxy] Enq fail, (ln %d)\n"},
	{MSG_8852B_PROXY_PKT_NOT_FOUND, "[Proxy] pkt not found, (ln %d)\n"},
	{MSG_8852B_PROXY_PTCL_DROP_BSSID, "[Proxy][Ptcl] Drop since bssid not match (incoming %x:%x:%x:%x:%x%x)\n"},
	{MSG_8852B_PROXY_PTCL_MATCH, "[Proxy][Ptcl] Match ipv%d service: %d (ln %d)\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_IPV4, "[Proxy][MDNS] Ipv4Pkt\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_IPV6, "[Proxy][MDNS] Ipv6Pkt\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_A, "[Proxy][MDNS] A rsp\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_AAAA, "[Proxy][MDNS] AAAA rsp\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_PTR, "[Proxy][MDNS] PTR rsp\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_NUMMACHINE, "[Proxy][MDNS] Machine * %d\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_NUMSERV, "[Proxy][MDNS] Serv * %d\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_NO, "[Proxy][MDNS]  #%d\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_SERVNAME, "[Proxy][MDNS]     Name\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_SERVRSP, "[Proxy][MDNS]     SRV rsp\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_SERYTRGT, "[Proxy][MDNS]     Target\n"},
	{MSG_8852B_PROXY_MDNS_DUMP_SERVTXT, "[Proxy][MDNS]     TXT rsp\n"},
	{MSG_8852B_PROXY_DUMPBUF, "[Proxy][Buf]       len (%d), addr: %x\n"},
	{MSG_8852B_PROXY_MDNS_RX_0, "[Proxy][MDNS] Machine (%x), Serv (%x), Target (%x), Type (%x) ==> isMDNS (%d), isMulticast (%d)\n"},
	{MSG_8852B_PROXY_MDNS_RX_1, "[Proxy][MDNS] Wake\n"},
	{MSG_8852B_PROXY_MDNS_TX_0, "[Proxy][MDNS] Issuing %d ans\n"},
	{MSG_8852B_PROXY_MDNS_TX_1, "[Proxy][MDNS] Write compress offset %x at loc %x (ln %d)\n"},
	{MSG_8852B_MCC_CHANGEROLE_9, "[MCC][Warning] TSF abnormal, cur_tsf = 0x%x, tsf = 0x%x\n"},
	{MSG_8852B_CSI_H2C_DBG_1, "[CSI] H2C. macid(%d), en(%d), period(%d)\n"},
	{MSG_8852B_CSI_H2C_DBG_2, "[CSI] H2C. retry_cnt(%d), Tx rate(%d), pkt_num(%d)\n"},
	{MSG_8852B_CSI_ROLE_NOT_EXIST, "[CSI][ERR] Role does not exist!\n"},
	{MSG_8852B_CSI_DUPLICATED_CMD, "[CSI][WARN] en(%d) command is duplicated!\n"},
	{MSG_8852B_CSI_INVALID_PARAM, "[CSI][ERR] Invalid param! en(%d),  period(%d), pkt_num(%d)\n"},
	{MSG_8852B_CSI_H2C_PKT_DUMP, "[CSI] H2C. Packet index(%d), packet id(%d)\n"},
	{MSG_8852B_CSI_PERIOD_TX_FAIL, "[CSI][ERR] Start period first Tx fail!\n"},
	{MSG_8852B_CSI_ADD_PSTIMER_FAIL, "[CSI][ERR] Add ps timer fail! role_idx(%d)\n"},
	{MSG_8852B_CSI_PREVIOUS_TX_RUNNING, "[CSI][WARN] Previous Tx interval is running\n"},
	{MSG_8852B_CSI_TX_DATA_FAIL, "[CSI][ERR] Tx DATA fail! ret_type(%d), result(%d)\n"},
	{MSG_8852B_CSI_READ_PKT_OFFLOAD_FAIL, "[CSI][ERR] Read pkt_idx(%d) fail!\n"},
	{MSG_8852B_CSI_TX_DATA, "[CSI] Tx DATA. role_idx(%d), pkt_idx(%d)\n"},
	{MSG_8852B_CSI_TX_DATA_CB, "[CSI] Tx DATA CB. role_idx(%d), pkt_idx(%d), ret_type(%d), result(%d)\n"},
	{MSG_8852B_CSI_FUNC_DISABLE, "[CSI] CSI is disabled! function(%d) no work\n"},
	{MSG_8852B_CSI_TX_INVALID_IDX, "[CSI][ERR] Tx with invalid pkt_idx(%d). Offloaded pkt_num(%d)\n"},
	{MSG_8852B_CSI_PROCESS_TIME, "[CSI][DBG] CSI process time (%d)\n"},
	{MSG_8852B_CSI_TX_DATA_CB_INVALID_IDX, "[CSI][ERR] Tx CB with invalid pkt_idx(%d). Offloaded pkt_num(%d)\n"},
	{MSG_8852B_SCAN_NOT_SUPPORT, "[Scan] Fw not support scanofld\n"},
	{MSG_8852B_SCAN_HSTCTRL_FAIL_CH_NOT_ALIGN, "[Scan][Hst] Fail since band is on ch %d but drv gives %d\n"},
	{MSG_8852B_SCAN_HSTCTRL_FAIL_CMD_UKN, "[Scan][Hst] Fail since cmd %d unknown\n"},
	{MSG_8852B_SCAN_ADD_FAIL_SIZE_ERR, "[Scan][Add] Fail since size from drv (%d) is smaller than fw define (%d)\n"},
	{MSG_8852B_SCAN_ADD_FAIL_NUM_ERR, "[Scan][Add] Fail since numofch is 0\n"},
	{MSG_8852B_SCAN_ADD_FAIL_MALLOC_FAIL, "[Scan][Add] Fail since malloc fail\n"},
	{MSG_8852B_SCAN_FAIL_SCANNING, "[Scan][Cfg] Start when scanning, abort\n"},
	{MSG_8852B_SCAN_FAIL_CHLIST_ERR, "[Scan][Cfg] Ch list empty, abort\n"},
	{MSG_8852B_SCAN_FAIL_NUMSSID_ERR, "[Scan][Cfg] Too much ssid (%d), abort\n"},
	{MSG_8852B_SCAN_FAIL_ROLE_ERR, "[Scan][Cfg] Role of (%d, %d) not found, abort\n"},
	{MSG_8852B_SCAN_ENTER_RX, "[Scan][En][Rx](%d) MAC ofdm(%d,%d,%d) cck(%d,%d,%d) / BB CCA ofdm(0x%x) cck(0x%x), CRC lega(0x%x) cck(0x%x), RXBLK(0x%x)\n"},
	{MSG_8852B_SCAN_LEAVE_RX, "[Scan][Lv][Rx](%d) MAC ofdm(%d,%d,%d) cck(%d,%d,%d) / BB CCA ofdm(0x%x) cck(0x%x), CRC lega(0x%x) cck(0x%x), RXBLK(0x%x)\n"},
	{MSG_8852B_SCAN_ENTER_TX, "[Scan][En][Tx](%d) MAC PPDU ofdm(%d) lcck(%d) scck(%d) / BB ofdm(0x%x) cck(0x%x) cck_frm_mac(0x%x) / RF addr0(0x%x)\n"},
	{MSG_8852B_SCAN_LEAVE_TX, "[Scan][Lv][Tx](%d) MAC PPDU ofdm(%d) lcck(%d) scck(%d) / BB ofdm(0x%x) cck(0x%x) cck_frm_mac(0x%x) / RF addr0(0x%x)\n"},
	{MSG_8852B_PS_RPWM_IMR_DUMP, "RPWM IMR is not enabled. IMR(0x%x) = 0x%x\n"},
	{MSG_8852B_OUTSRC_START, " out source delimiter start"},
	{MSG_8852B_BTC_0, "_setup_slot  new_ver:%d, ver:%d\n"},
	{MSG_8852B_BTC_1, "_check_bt_rfk_req(): mbx=%d, result=%d\n"},
	{MSG_8852B_BTC_2, "_send_offload_runinfo(): type:%d, run_cnt:%d\n"},
	{MSG_8852B_BTC_3, "_send_bt_info: len = %d\n"},
	{MSG_8852B_BTC_4, "_get_mbx30_rsp: Length=%x, data0=%x, data1=%x, data2=%x, data3=%x, data4=%x\n"},
	{MSG_8852B_BTC_5, "seq = %x, reg_val=%x\n"},
	{MSG_8852B_BTC_6, "_read_mreg\n"},
	{MSG_8852B_BTC_7, "_send_rpt(): cnt=%d, len=%d, type=%d, map=%x\n"},
	{MSG_8852B_BTC_8, "_tmr_btrfk(): BT RFK timeout!!\n"},
	{MSG_8852B_BTC_9, "_tmr_mon\n"},
	{MSG_8852B_BTC_10, "Aboart BT mailbox\n"},
	{MSG_8852B_BTC_11, "Mailbox dequeue fail\n"},
	{MSG_8852B_BTC_12, "_setup_rpt, enable=%x, para=%x, rpt_enable=%x\n"},
	{MSG_8852B_BTC_13, "_setup_slot->[Slot-%d Policy] dur:%d(modify:%x), tbl:%x, cxtype:%d\n"},
	{MSG_8852B_BTC_14, "_setup_mreg -> rid: %d, type: %d, byte: %d, offset: %x\n"},
	{MSG_8852B_BTC_15, "_setup_cxpolicy->[TDMA Policy] type:%d, rxflctrl:%d, txpause:%d, wtgle_n:%d, leak_n:%d, ext_ctrl=%d\n"},
	{MSG_8852B_BTC_16, "_setup_cxpolicy->[Slot-%d Policy] dur:%d(modify:%x), tbl:%x, cxtype:%d\n"},
	{MSG_8852B_BTC_17, "_setup_drvinfo(): type:%d, len=%d\n"},
	{MSG_8852B_BTC_18, "_setup_gpio_dbg(): phdl->gpio_dbg.en_map = %x\n"},
	{MSG_8852B_BTC_19, "_setup_gpio_dbg(): dbg_signal-%d ==> gpio-%d\n"},
	{MSG_8852B_BTC_20, "_setup_gpio_dbg(): enable dbg_signal-%d ==> gpio-%d\n"},
	{MSG_8852B_BTC_21, "_setup_bt: data0=%x, data1=%x, data2=%x, data3=%x\n"},
	{MSG_8852B_BTC_22, "mailbox enqueue fail\n"},
	{MSG_8852B_BTC_23, "mailbox: curr abalible bytes: %d\n"},
	{MSG_8852B_BTC_24, "[BTC], _update_bt_scbd return by invalid scbd value\n"},
	{MSG_8852B_BTC_25, "[BTC], _update_bt_info \n"},
	{MSG_8852B_BTC_26, "[BTC], _update_bt_info return by bt-info duplicate!!\n"},
	{MSG_8852B_BTC_27, "BTCoexMailboxSendComm return because mailbox not-avl (%x)\n"},
	{MSG_8852B_BTC_28, "BTCoexMailboxDataHDLComm: id = %d\n"},
	{MSG_8852B_BTC_29, "Recv H2C class: %d\n"},
	{MSG_8852B_BTC_30, "H2C Process status: %d\n"},
	{MSG_8852B_BTC_31, "cat: %d, class: %d, func: %d\n"},
	{MSG_8852B_BTC_32, "Wrong BTC AOAC state"},
	{MSG_8852B_BTC_33, "_evnt_wltmr: cycle.c_slot = %d!!\n"},
	{MSG_8852B_BTC_34, "_cx_policy_update\n"},
	{MSG_8852B_BTC_35, "_btc_gpio\n"},
	{MSG_8852B_BTC_36, "Coex exception: %x\n"},
	{MSG_8852B_BTC_37, "_enter: n_slot=%d, bt_relink=%d\n"},
	{MSG_8852B_BTC_38, "_enter-collision!!: n_slot=%d, last_slot=%d\n"},
	{MSG_8852B_BTC_39, "skip_cnt=%d\n"},
	{MSG_8852B_BTC_40, "tdma.type=%d, tdma_new.type=%d, c_slot=%d!!\n"},
	{MSG_8852B_BTC_41, "wait cycle_w2b to update cxpolicy!!\n"},
	{MSG_8852B_BTC_42, "BTCoexFCInitComm\n"},
	{MSG_8852B_BTC_43, "[FAIL] Create Role fail!\n"},
	{MSG_8852B_BTC_44, "[BTC], _set_bt_wl_ch_info():\n"},
	{MSG_8852B_BTC_45, "_set_policy(): policy_type:%x\n"},
	{MSG_8852B_BTC_46, "[BTC], _set_ant(): return by no change!!\n"},
	{MSG_8852B_BTC_47, "[BTC], _set_ant(): return by bt rfk!!\n"},
	{MSG_8852B_BTC_48, "[BTC], _set_ant(): return by wl rfk!!\n"},
	{MSG_8852B_BTC_49, "[BTC], _set_ant(): phy_map=%d, type=%d\n"},
	{MSG_8852B_BTC_50, "[BTC], _action_wl_only !!\n"},
	{MSG_8852B_BTC_51, "[BTC], _action_wl_init !!\n"},
	{MSG_8852B_BTC_52, "[BTC], _action_wl_off !!\n"},
	{MSG_8852B_BTC_53, "[BTC], _action_freerun !!\n"},
	{MSG_8852B_BTC_54, "[BTC], _action_bt_whql_test !!\n"},
	{MSG_8852B_BTC_55, "[BTC], _action_bt_rfk !!\n"},
	{MSG_8852B_BTC_56, "[BTC], _action_bt_off !!\n"},
	{MSG_8852B_BTC_57, "[BTC], _action_wl_5g !!\n"},
	{MSG_8852B_BTC_58, "[BTC], _action_wl_other !!\n"},
	{MSG_8852B_BTC_59, "[BTC], _action_wl_idle !!\n"},
	{MSG_8852B_BTC_60, "[BTC], _action_wl_nc !!\n"},
	{MSG_8852B_BTC_61, "[BTC], _action_wl_rfk !!\n"},
	{MSG_8852B_BTC_62, "[BTC], _set_action_by_bt !!\n"},
	{MSG_8852B_BTC_63, "[BTC], _run_coex(): run_reason = %s\n"},
	{MSG_8852B_BTC_64, "[BTC], _run_coex(): return for Manual CTRL!!\n"},
	{MSG_8852B_BTC_65, "[BTC], _run_coex(): return for Stop Coex DM!!\n"},
	{MSG_8852B_BTC_66, "[BTC], _run_coex(): return for WL init fail!!\n"},
	{MSG_8852B_BTC_67, "[BTC], _set_bt_tx_power(): level = %d\n"},
	{MSG_8852B_BTC_68, "[BTC], _set_bt_rx_gain(): level = %d\n"},
	{MSG_8852B_BTC_69, "[BTC], _set_bt_golden_rx_range(): p_id=%d, level=%d\n"},
	{MSG_8852B_TxEn, "[TxEn] rcode: %d, band: %d, tx_en: %x, tx_en_mask: %x, state: %x -> %x\n"},
	{MSG_8852B_MACIDPAUSE_AP_0, "[MACIDPAUSE] rcode: %d, pause_en: %08x%08x%08x%08x, pause_en_mask: %08x%08x%08x%08x\n"},
	{MSG_8852B_MACIDPAUSE_AP_1, "[MACIDPAUSE] original MACIDPauseFWInfo: %08x%08x%08x%08x\n"},
	{MSG_8852B_MACIDPAUSE_AP_2, "[MACIDPAUSE] MACIDPauseFWInfo: %08x%08x%08x%08x, MACIDPauseDRVInfo: %08x%08x%08x%08x, MACIDSleepFWInfo: %08x%08x%08x%08x\n"},
	{MSG_8852B_MACIDPAUSE_NIC, "[MACIDPAUSE] rcode: %d, pause_en: %08x, pause_en_mask: %08x, MACIDPauseFWInfo: %08x -> %08x, MACIDPauseDRVInfo: %08x, MACIDSleepFWInfo: %08x\n"},
	...
	{MSG_8852B_OUTSRC_BB_SURA_15, "[RA]init_rate_up:id:%d,try_num=%d,agg=%x\n"},
	...
	{MSG_8852B_OUTSRC_BB_SURA_22, "[RA,W]macid:%x,mode:%x,bw_idx:%x,mcs:%x,ss:%x\n"},
	{MSG_8852B_OUTSRC_BB_SURA_23, "[RA][TRY]PER=%x,RDR=%x,R4=%x, pre_tp=%d, next_tp=%d\n"},
	{MSG_8852B_OUTSRC_BB_SURA_24, "RSVD\n"},
	...
	{MSG_8852B_OUTSRC_BB_SURA_41, "[RA]GetTxSta:id:%d,try_num=%d,agg=%x\n"},
	...
	{MSG_8852B_OUTSRC_BB_SURA_60, "[LPS][After32K]OFDM_CCA=%d, CCK_CCA=%d, OFDM_OK=%d, CCK_OK=%d, OFDM_ERR=%d, CCK_ERR=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_61, "[LPS][OpenRF]OFDM_CCA=%d, CCK_CCA=%d, OFDM_OK=%d, CCK_OK=%d, OFDM_ERR=%d, CCK_ERR=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_62, "[LPS][NORMAL]OFDM_CCA=%d, CCK_CCA=%d, OFDM_OK=%d, CCK_OK=%d, OFDM_ERR=%d, CCK_ERR=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_63, "[LPS][After32K]Rx_path=%d, rssi_a=%d, rssi_b=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_64, "[LPS][OpenRF]Rx_path=%d, rssi_a=%d, rssi_b=%d, tx_path_dec=%d,tx_path_udp=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_65, "[LPS][NORMAL]Rx_path=%d, rssi_a=%d, rssi_b=%d,0x4860=%x, tx_path_dec=%d, tx_path_udp=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_66, "[LPS][CloseRF]OFDM_CCA=%d, CCK_CCA=%d, OFDM_OK=%d, CCK_OK=%d, OFDM_ERR=%d, CCK_ERR=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_67, "[LPS][CloseRF]Rx_path=%d, rssi_a=%d, rssi_b=%d,0x4860=%x"},
	{MSG_8852B_OUTSRC_BB_SURA_68, "[LPS][After32K]OFDM_TxEN=%d, OFDM_TxON=%d, CCK_TxEn=%d, CCK_TxON=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_69, "[LPS][OpenRF]OFDM_TxEN=%d, OFDM_TxON=%d, CCK_TxEn=%d, CCK_TxON=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_70, "[LPS][NORMAL]OFDM_TxEN=%d, OFDM_TxON=%d, CCK_TxEn=%d, CCK_TxON=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_71, "[LPS][CloseRF]OFDM_TxEN=%d, OFDM_TxON=%d, CCK_TxEn=%d, CCK_TxON=%d, tx_path_dec=%d, tx_path_udp=%d"},
	{MSG_8852B_OUTSRC_BB_SURA_72, "[LPS][After32K]0x12ac=%x, 0x12b0=%x, 0x12b8=%x, 0x32ac=%x, 0x32b0=%x, 0x32b8=%x, 0x35c=%x, 0x700=%x, tx_path_udp=%x"},
	{MSG_8852B_OUTSRC_BB_SURA_73, "[LPS][OpenRF]0x12ac=%x, 0x12b0=%x, 0x12b8=%x, 0x32ac=%x, 0x32b0=%x, 0x32b8=%x, 0x35c=%x, 0x700=%x"},
	{MSG_8852B_OUTSRC_BB_SURA_74, "[LPS][NORMAL]0x12ac=%x, 0x12b0=%x, 0x12b8=%x, 0x32ac=%x, 0x32b0=%x, 0x32b8=%x, 0x35c=%x, 0x700=%x"},
	{MSG_8852B_OUTSRC_BB_SURA_75, "[LPS][CloseRF]0x12ac=%x, 0x12b0=%x, 0x12b8=%x, 0x32ac=%x, 0x32b0=%x, 0x32b8=%x, 0x35c=%x, 0x700=%x"},
