...
#include "init_hv_8192xb.h"
#include "trx_desc_hv_8192xb.h"
...
#include "../fwcmd_hv.h"
#include "../gpio_hv.h"
#include "../../mac_ax/mac_8192xb/gpio_8192xb.h"
#include "../../mac_ax/mac_8192xb/coex_8192xb.h"
#include "../hw_hv.h"
#include "pwr_seq_hv_8192xb.h"
#include "btc_hv_8192xb.h"
#if MAC_AX_8192XB_SUPPORT

static struct hv_ax_ops hv8192xb_ops = {
	hv_tx_post_agg_8192xb /* tx_post_desc */,
	...
	hv_cfg_btc_dbg_port_8192xb /* cfg_btc_dbg_port */,
	hv_en_rtk_mode_8192xb /*en_btc_rtk_mode */,
	...
	mac_get_gpio_status_8192xb /* get_gpio_status */,
	...
	hv_run_pwr_seq_8192xb /* run_pwr_seq */,
	mac_read_lte_8192xb /* read_lte */,
	mac_write_lte_8192xb /* write_lte */,
	hv_c2h_log_test /* c2h_log_test */,
};

struct hv_ax_ops *get_hv_8192xb_ops(void)
{
	return &hv8192xb_ops;
}
