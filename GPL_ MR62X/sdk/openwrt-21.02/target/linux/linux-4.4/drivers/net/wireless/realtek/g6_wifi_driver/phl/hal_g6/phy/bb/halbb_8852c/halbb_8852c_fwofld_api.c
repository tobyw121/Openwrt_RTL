			    ...
			    enum phl_phy_idx phy_idx)
{
	...
	/*==== [Spur elimination] ====*/
	halbb_fw_set_reg_cmn(bb, 0x42AC, 0x70000000, 0x4, phy_idx, 0);
	halbb_fw_set_reg_cmn(bb, 0x42B0, MASKDWORD, 0xC4000000, phy_idx, 0);
	halbb_fw_set_reg_cmn(bb, 0x42B4, MASKDWORD, 0x40E7D03D, phy_idx, 0);
	halbb_fw_set_reg_cmn(bb, 0x42B8, MASKDWORD, 0x7D67D67D, phy_idx, 0);
	halbb_fw_set_reg_cmn(bb, 0x42BC, MASKDWORD, 0x7D67D65B, phy_idx, 0);
	halbb_fw_set_reg_cmn(bb, 0x42C0, MASKDWORD, 0x2802AF59, phy_idx, 0);
	if (band == BAND_ON_5G && central_ch == 153) {
		halbb_fw_set_reg(bb, 0x4c14, 0xfff, 0x210, 0);
		halbb_fw_set_reg(bb, 0x4CD8, 0xfff, 0x210, 0);
		halbb_fw_set_reg_cmn(bb, 0x42ac, 0xfff, 0x7c0, phy_idx, 0);
		halbb_fw_set_reg(bb, 0x4c14, BIT(12), 0x1, 0);
		halbb_fw_set_reg(bb, 0x4cd8, BIT(12), 0x1, 0);
		halbb_fw_set_reg_cmn(bb, 0x42c4, BIT(23), 0x1, phy_idx, 0);
	} else if (band == BAND_ON_5G && central_ch == 151) {
		halbb_fw_set_reg(bb, 0x4c14, 0xfff, 0x210, 0);
		halbb_fw_set_reg(bb, 0x4CD8, 0xfff, 0x210, 0);
		halbb_fw_set_reg_cmn(bb, 0x42ac, 0xfff, 0x40, phy_idx, 0);
		halbb_fw_set_reg(bb, 0x4c14, BIT(12), 0x1, 0);
		halbb_fw_set_reg(bb, 0x4cd8, BIT(12), 0x1, 0);
		halbb_fw_set_reg_cmn(bb, 0x42c4, BIT(23), 0x1, phy_idx, 0);
	} else if (band == BAND_ON_5G && central_ch == 155) {
		halbb_fw_set_reg(bb, 0x4c14, 0xfff, 0x2d0, 0);
		halbb_fw_set_reg(bb, 0x4CD8, 0xfff, 0x2d0, 0);
		halbb_fw_set_reg_cmn(bb, 0x42ac, 0xfff, 0x740, phy_idx, 0);
		halbb_fw_set_reg(bb, 0x4c14, BIT(12), 0x1, 0);
		halbb_fw_set_reg(bb, 0x4cd8, BIT(12), 0x1, 0);
		halbb_fw_set_reg_cmn(bb, 0x42c4, BIT(23), 0x1, phy_idx, 0);
	} else {
		halbb_fw_set_reg(bb, 0x4c14, BIT(12), 0x0, 0);
		halbb_fw_set_reg(bb, 0x4cd8, BIT(12), 0x0, 0);
		halbb_fw_set_reg_cmn(bb, 0x42c4, BIT(23), 0x0, phy_idx, 0);
	}
	/*==== [BTG Ctrl] ====*/
