...
void halrf_config_8852a_radio_a_reg(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8852a_radio_b_reg(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8852a_store_power_by_rate(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8852a_store_power_limit(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8852a_store_power_limit_ru(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8852a_store_pwr_track(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8852a_store_xtal_track(struct rf_info *rf, enum phl_phy_idx phy);
