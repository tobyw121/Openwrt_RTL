...
void _patch_swr_pfm2pwm_8851b(struct mac_ax_adapter *adapter)
{
	...
	/* 0x200[18:17]=2'b00*/
	val = MAC_REG_R32(R_AX_SPSLDO_ON_CTRL0);
	MAC_REG_W32(R_AX_SPSLDO_ON_CTRL0, val & ~(BIT(18)));
	val = MAC_REG_R32(R_AX_SPSLDO_ON_CTRL0);
	MAC_REG_W32(R_AX_SPSLDO_ON_CTRL0, val & ~(BIT(17)));

	/* 0x220[18:17]=2'b00*/
	val = MAC_REG_R32(R_AX_SPSANA_ON_CTRL0);
	MAC_REG_W32(R_AX_SPSANA_ON_CTRL0, val & ~(BIT(18)));
	val = MAC_REG_R32(R_AX_SPSANA_ON_CTRL0);
	MAC_REG_W32(R_AX_SPSANA_ON_CTRL0, val & ~(BIT(17)));
