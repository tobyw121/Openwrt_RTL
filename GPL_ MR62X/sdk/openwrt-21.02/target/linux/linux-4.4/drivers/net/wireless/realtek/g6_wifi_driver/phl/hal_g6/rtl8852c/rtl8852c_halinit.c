...
enum rtw_hal_status hal_get_flash_8852c(struct rtw_phl_com_t *phl_com,
					struct hal_info_t *hal,
					struct hal_init_info_t *init_info)
{
	/*enum rtw_hal_status hal_status = RTW_HAL_STATUS_FAILURE;
...
enum rtw_hal_status hal_config_beacon_8852c(struct rtw_phl_com_t *phl_com,
                                            struct hal_info_t *hal,
...
enum rtw_hal_status hal_update_beacon_8852c(struct rtw_phl_com_t *phl_com,
                                            struct hal_info_t *hal,
                                            struct rtw_bcn_entry *bcn_entry)
{
