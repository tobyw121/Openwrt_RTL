...
const struct btc_chip chip_8852c = {
	...
	0x0, /* chip para ver */
	0x6, /* desired bt_ver */
	0x06020000, /* desired wl_fw btc ver */
...
void _8852c_init_cfg(struct btc_t *btc)
{
	...
	if (module->ant.type == BTC_ANT_SHARED) {
		...
		_8852c_set_wl_trx_mask(btc, RF_PATH_A, BTC_BT_SS_GROUP, 0x5df);
		_8852c_set_wl_trx_mask(btc, RF_PATH_B, BTC_BT_SS_GROUP, 0x5df);
	}
