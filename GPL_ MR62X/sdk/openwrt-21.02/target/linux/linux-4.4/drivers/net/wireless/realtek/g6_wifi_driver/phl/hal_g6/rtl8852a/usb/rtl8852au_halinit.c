...
u32 hal_hci_cfg_8852au(struct rtw_phl_com_t *phl_com,
...
enum rtw_hal_status
hal_mp_init_8852au(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal_info)
{
	enum rtw_hal_status hal_status = RTW_HAL_STATUS_FAILURE;
	struct hal_init_info_t init_52au;
	...
	hal_status = hal_mp_init_8852a(phl_com, hal_info, &init_52au);
...
enum rtw_hal_status
hal_mp_deinit_8852au(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal_info)
{
	enum rtw_hal_status hal_status = RTW_HAL_STATUS_FAILURE;
	struct hal_init_info_t init_52au;
	...
	hal_status = hal_mp_deinit_8852a(phl_com, hal_info, &init_52au);

	if (RTW_HAL_STATUS_SUCCESS != hal_status) {

		PHL_ERR("hal_mp_deinit_8852au: status = %u\n", hal_status);
		return hal_status;
	}
