			   ...
			   bool force)
{
	...
	if (rf->phl_com->dev_state & BIT4) {
		...
		/*[LOK, IQK]*/
		halrf_iqk_trigger_g6(rf, phy_idx, force);

		/*[TSSI Trk]*/
		halrf_tssi_trigger_g6(rf, phy_idx, true);

		/*[DPK]*/
		halrf_dpk_trigger_g6(rf, phy_idx, force);
		halrf_fw_ntfy(rf, phy_idx);
	}
	halrf_tmac_tx_pause(rf, phy_idx, false);
	halrf_btc_rfk_ntfy(rf, (BIT(phy_idx) << 4), RF_BTC_CHLK, RFK_STOP);
...
enum rtw_hal_status halrf_iqk_trigger_g6(void *rf_void,
		       enum phl_phy_idx phy_idx,
		       bool force)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
...
void halrf_lck_trigger_g6(void *rf_void)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	struct rtw_hal_com_t *hal_i = rf->hal_com;
...
#ifdef RF_8832BRVT_SUPPORT
	case CHIP_WIFI6_8832BRVT:
		halrf_lck_tracking_8832brvts(rf);
		break;
#endif
...
enum rtw_hal_status halrf_dpk_trigger_g6(void *rf_void,
		       enum phl_phy_idx phy_idx,
		       bool force)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
...
enum rtw_hal_status halrf_tssi_trigger_g6(void *rf_void, enum phl_phy_idx phy_idx, bool hwtx_en)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	struct rtw_hal_com_t *hal_i = rf->hal_com;
...
#ifdef RF_8832BRVT_SUPPORT
	case CHIP_WIFI6_8832BRVT:
		halrf_txgapk_init_8832brvts(rf);
		break;
#endif
...
void halrf_dpk_switch_g6(void *rf_void, bool is_enable)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	...
	if (is_enable) {
		...
		halrf_dpk_trigger_g6(rf, HW_PHY_0, true);
...
s32 halrf_get_online_tssi_de_g6(void *rf_void, enum phl_phy_idx phy_idx, u8 path, s32 dbm, s32 puot)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
	struct rtw_hal_com_t *hal_i = rf->hal_com;
	s32 tmp = 0;
...
#ifdef RF_8832CRVU_SUPPORT
		case CHIP_WIFI6_8832CRVU:
			halrf_bf_config_rf_8832crvu(rf);
			break;
#endif

#ifdef RF_8832BRVT_SUPPORT
		case CHIP_WIFI6_8832BRVT:
			halrf_bf_config_rf_8832brvt(rf);
			break;
#endif
...
void halrf_watchdog_g6(void *rf_void)
{
	struct rf_info *rf = (struct rf_info *)rf_void;
...
enum rtw_hal_status halrf_iqk_tracking(void *rf_void)
{
	...
	case CHIP_WIFI6_8852A:
		...
		if (halrf_iqk_get_ther_rek(rf))
			halrf_iqk_trigger_g6(rf, 0x0, false);
#endif
	break;
#endif
#ifdef RF_8852B_SUPPORT
...
void halrf_psd_init_g6(void *rf_void, enum phl_phy_idx phy,
...
void halrf_psd_query_g6(void *rf_void, enum phl_phy_idx phy,
