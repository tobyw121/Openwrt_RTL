...
#define band_to_band_cap(band) (((band) < BAND_MAX) ? _band_to_band_cap[band] : 0)


extern const char *const _ch_width_str[];
#define ch_width_str(bw) (((bw) < CHANNEL_WIDTH_MAX) ? _ch_width_str[(bw)] : "CHANNEL_WIDTH_MAX")

extern const char *const _ch_offset_str[];
#define ch_offset_str(ofst) (((ofst) < CHAN_OFFSET_MAX) ? _ch_offset_str[(ofst)] : "CHAN_OFFSET_MAX")
