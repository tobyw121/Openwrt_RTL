...
#define RX_Q_RXBD_NUM_8197G             RX_Q_RXBD_NUM//256
...
#ifdef DMA_BUF_SEP
#define DESC_DMA_TXBD_PAGE_8197G	((TOTAL_NUM_TXBD_NO_BCN_8197G * sizeof(TX_BUFFER_DESCRIPTOR)))
#define DESC_DMA_TXDESC_PAGE_8197G	(TOTAL_NUM_TXBD_NO_BCN_8197G * SIZE_TXDESC_88XX_8197G)
#define DESC_DMA_BCN_PAGE_8197G		(((1+HAL_NUM_VWLAN) * TXBD_BEACON_OFFSET_MAX) + ((1+HAL_NUM_VWLAN) * SIZE_TXDESC_88XX_8197G))
#else
