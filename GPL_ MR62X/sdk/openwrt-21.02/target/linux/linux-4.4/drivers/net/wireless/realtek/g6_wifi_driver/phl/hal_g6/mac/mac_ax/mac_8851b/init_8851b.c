...
#include "../phy_misc.h"
#include "../h2c_agg.h"
#include "mac_priv_8851b.h"
#include "../dbcc.h"
#include "../beacon.h"
#include "coex_8851b.h"
#include "phy_rpt_8851b.h"
#include "hwamsdu_8851b.h"
...
#if MAC_AX_SDIO_SUPPORT
static struct mac_ax_intf_ops mac8851b_sdio_ops = {
	...
	sdio_pre_init_8851b, /* intf_pre_init */
	sdio_init, /* intf_init */
...
#if MAC_AX_USB_SUPPORT
static struct mac_ax_intf_ops mac8851b_usb_ops = {
	reg_read8_usb_8851b, /* reg_read8 */
	reg_write8_usb_8851b, /* reg_write8 */
	reg_read16_usb_8851b, /* reg_read16 */
	reg_write16_usb_8851b, /* reg_write16 */
	reg_read32_usb_8851b, /* reg_read32 */
	reg_write32_usb_8851b, /* reg_write32 */
	NULL, /* tx_allow_sdio */
	NULL, /* tx_cmd_addr_sdio */
	usb_pre_init_8851b, /* intf_pre_init */
	usb_init_8851b, /* intf_init */
	usb_deinit_8851b, /* intf_init */
	NULL, /* reg_read_n_sdio */
	get_bulkout_id_8851b, /*get_bulkout_id*/
	ltr_set_usb, /* ltr_set_pcie */
	u2u3_switch_8851b, /*u2u3_switch*/
	get_usb_mode, /*get_usb_mode*/
	get_usb_support_ability_8851b,/*get_usb_support_ability*/
	usb_tx_agg_cfg_8851b, /*usb_tx_agg_cfg*/
	usb_rx_agg_cfg_8851b, /*usb_rx_agg_cfg*/
	set_usb_wowlan_8851b, /*set_wowlan*/
	...
	usb_get_txagg_num_8851b, /*get_txagg_num*/
	...
	usb_get_rx_state_8851b, /*get_usb_rx_state*/
...
#if MAC_AX_PCIE_SUPPORT
static struct mac_ax_intf_ops mac8851b_pcie_ops = {
	...
	ctrl_txdma_ch_pcie_8851b, /*ctrl_txdma_ch*/
	clr_idx_all_pcie, /*clr_idx_all*/
	poll_txdma_ch_idle_pcie_8851b, /*poll_txdma_ch_idle*/
	poll_rxdma_ch_idle_pcie_8851b, /*poll_rxdma_ch_idle*/
	ctrl_txhci_pcie, /*ctrl_txhci*/
	ctrl_rxhci_pcie, /*ctrl_rxhci*/
	ctrl_dma_io_pcie, /*ctrl_dma_io*/
	get_io_stat_pcie_8851b, /* get_io_stat */
	pcie_get_txagg_num, /*get_txagg_num*/
	get_avail_txbd_8851b, /*get_avail_txbd*/
	get_avail_rxbd_8851b, /*get_avail_rxbd*/
...
static struct mac_ax_ops mac8851b_ops = {
	NULL, /* intf_ops */
	/*System level*/
	...
	mac_get_macaddr,
	mac_build_txdesc_8851b, /* build_txdesc */
	mac_refill_txdesc_8851b, /*refill txdesc*/
	mac_parse_rxdesc_8851b, /* parse_rxdesc */
	...
	/*TRX related*/
	mac_txdesc_len_8851b, /* txdesc_len */
	...
	mac_enable_cut_hwamsdu_8851b, /* enable_cut_hwamsdu */
	mac_cut_hwamsdu_chk_mpdu_len_en_8851b, /* enable cut-amsdu chk mpdu size*/
	...
	mac_hdr_conv_rx_en_8851b, /* enable rx mac hdr conversion*/
	mac_hdr_conv_rx_en_driv_info_hdr_8851b, /*en rx hdr conv driver info*/
	...
	mac_is_txq_empty_8851b, /*is_txq_empty*/
	mac_is_rxq_empty_8851b, /*is_rxq_empty*/
	...
	mac_patch_rx_rate_8851b, /*for patch rx rate*/
	mac_get_wp_offset_8851b, /* wd offload for wp_offset, called while forming metadata */
	...
	mac_pinmux_set_func_8851b, /* pinmux_set_func */
	mac_pinmux_free_func, /* pinmux_free_func */
	mac_sel_uart_tx_pin, /* sel_uart_tx_pin */
	mac_sel_uart_rx_pin, /* sel_uart_rx_pin */
	mac_gpio_init_8851b, /* gpio_init */
	mac_set_gpio_func_8851b, /* set_gpio_func */
	...
	mac_coex_init_8851b, /* coex_init */
	mac_read_coex_reg_8851b, /* coex_read */
	mac_write_coex_reg_8851b, /* coex_write */
	...
	mac_cfg_per_pkt_phy_rpt_8851b, /* cfg_per_pkt_phy_rpt */
#if MAC_AX_FEATURE_DBGPKG
...
static struct mac_ax_hw_info mac8851b_hw_info = {
	0, /* done */
	MAC_AX_CHIP_ID_8851B, /* chip_id */
	0xFF, /* cv */
	0, /* acv */
	0xFF, /* fv */
	...
	pwr_on_seq_8851b, /* pwr_on_seq */
	pwr_off_seq_8851b, /* pwr_off_seq */
	PWR_SEQ_VER_8851B, /* pwr_seq_ver */
	196608, /* fifo_size */
	32, /* macid_num */
	5, /* port_num */
	4, /* mbssid_num */
...
struct mac_ax_ft_status mac_8851b_ft_status[] = {
	{MAC_AX_FT_DUMP_EFUSE, MAC_AX_STATUS_IDLE, NULL, 0},
	{MAC_AX_FT_MAX, MAC_AX_STATUS_ERR, NULL, 0},
};

static struct mac_ax_adapter mac_8851b_adapter =  {
	&mac8851b_ops, /* ops */
	NULL, /* drv_adapter */
	NULL, /* phl_adapter */
	NULL, /* pltfm_cb */
...
struct mac_ax_adapter *get_mac_8851b_adapter(enum mac_ax_intf intf,
					     ...
					     struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	hal_mem_cpy(drv_adapter, adapter, &mac_8851b_adapter,
		    sizeof(struct mac_ax_adapter));
	...
	case MAC_AX_INTF_SDIO:
		adapter->ops->intf_ops = &mac8851b_sdio_ops;
		pwr_info->intf_pwr_switch = sdio_pwr_switch;
		break;
#endif
#if MAC_AX_USB_SUPPORT
	case MAC_AX_INTF_USB:
		adapter->ops->intf_ops = &mac8851b_usb_ops;
		pwr_info->intf_pwr_switch = usb_pwr_switch;
		break;
#endif
#if MAC_AX_PCIE_SUPPORT
	case MAC_AX_INTF_PCIE:
		adapter->ops->intf_ops = &mac8851b_pcie_ops;
					     ...
					     struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	pltfm_cb->rtl_memcpy(drv_adapter, adapter, &mac_8851b_adapter,
		     sizeof(struct mac_ax_adapter));
...
u32 dmac_func_en_8851b(struct mac_ax_adapter *adapter)
{
	...
	val32 = (B_AX_MAC_SEC_CLK_EN | B_AX_DISPATCHER_CLK_EN |
		 ...
		 B_AX_WD_RLS_CLK_EN | B_AX_BBRPT_CLK_EN | B_AX_AXIDMA_CLK_EN);
...
u32 dmac_func_pre_en_8851b(struct mac_ax_adapter *adapter)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32;
	...
	val32 = (B_AX_DISPATCHER_CLK_EN | B_AX_AXIDMA_CLK_EN);
	MAC_REG_W32(R_AX_DMAC_CLK_EN, val32);
