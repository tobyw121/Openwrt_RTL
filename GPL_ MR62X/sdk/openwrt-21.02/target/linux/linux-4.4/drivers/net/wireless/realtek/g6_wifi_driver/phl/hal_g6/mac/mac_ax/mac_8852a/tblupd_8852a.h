...
#ifndef _TABLEUPD_H2C_8852A_H_
#define _TABLEUPD_H2C_8852A_H_

#include "../../type.h"
#include "../fwcmd.h"
#if MAC_AX_8852A_SUPPORT
/*--------------------Define MACRO--------------------------------------*/
#define CCTL_NTX_PATH_EN_8852A		3
...
/**
 * @brief mac_init_cctl_info_8852a
 *
 * @param *adapter
 * @param *macid
 ...
 * @retval u32
 */
u32 mac_init_cctl_info_8852a(struct mac_ax_adapter *adapter, u8 macid);
/**
 * @}
 * @}
 */
