...
void halbb_ccx_top_setting_init(struct bb_info *bb)
{
	...
	halbb_set_reg_phy0_1(bb, cr->ccx_trig_opt, cr->ccx_trig_opt_m, 0);
...
void halbb_ccx_trigger(struct bb_info *bb, u8 func_sel)
{
	...
	halbb_set_reg_phy0_1(bb, cr->ifs_clm_clr, cr->ifs_clm_clr_m, false);
	halbb_set_reg_phy0_1(bb, cr->clm_en, cr->clm_en_m, false);
	if (func_sel & NHM_SEL)
		halbb_set_reg_phy0_1(bb, cr->nhm_en, cr->nhm_en_m, false);

	halbb_set_reg_phy0_1(bb, cr->edcca_clm_en, cr->edcca_clm_en_m, false);
	halbb_set_reg_phy0_1(bb, cr->ifs_clm_clr, cr->ifs_clm_clr_m, true);
	halbb_set_reg_phy0_1(bb, cr->clm_en, cr->clm_en_m, true);
	if (func_sel & NHM_SEL)
		halbb_set_reg_phy0_1(bb, cr->nhm_en, cr->nhm_en_m, true);

	halbb_set_reg_phy0_1(bb, cr->edcca_clm_en, cr->edcca_clm_en_m, true);
...
void halbb_ccx_ext_loss_update(struct bb_info *bb)
{
	...
	BB_DBG(bb, DBG_ENV_MNTR,
	       ...
	       bb->dbg_buf, ext_loss[0], ext_loss[1], ext_loss[2], ext_loss[3], ccx_ext_loss, env->ccx_ext_loss_update);
#elif (defined(HALBB_COMPILE_ABOVE_2SS))
	BB_DBG(bb, DBG_ENV_MNTR,
	       "ext_loss{avg, a, b} = {%s, %s, %s} dB, ccx_ext_loss = %s dB, ccx_ext_loss_update = %d\n",
	       bb->dbg_buf, ext_loss[0], ext_loss[1], ccx_ext_loss, env->ccx_ext_loss_update);
#else
...
void halbb_nhm_get_fw_result_c2h(struct bb_info *bb, u8 *c2h)
{
	struct bb_env_mntr_info *env = &bb->bb_env_mntr_i;
...
void halbb_nhm_set_th_reg(struct bb_info *bb)
{
	...
	if (((bb->ic_type == BB_RTL8852A) || (bb->ic_type == BB_RTL8852B) ||
		...
		halbb_set_reg_phy0_1(bb, cr->nhm_th0, cr->nhm_th0_m,
			env->nhm_th[0]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th1, cr->nhm_th1_m,
			env->nhm_th[1]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th2, cr->nhm_th2_m,
			env->nhm_th[2]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th3, cr->nhm_th3_m,
			env->nhm_th[3]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th4, cr->nhm_th4_m,
			env->nhm_th[4]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th5, cr->nhm_th5_m,
			env->nhm_th[5]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th6, cr->nhm_th6_m,
			env->nhm_th[6]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th7, cr->nhm_th7_m,
			env->nhm_th[7]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th8, cr->nhm_th8_m,
			env->nhm_th[8]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->nhm_th9, cr->nhm_th9_m,
			env->nhm_th[9]-env->ccx_ext_loss);
		if ((bb->ic_type == BB_RTL8852A) || (bb->ic_type == BB_RTL8852B) ||
			(bb->ic_type == BB_RTL8852C))
			halbb_set_reg_phy0_1(bb, cr->nhm_th10, cr->nhm_th10_m,
...
bool halbb_nhm_set(struct bb_info *bb, struct ccx_para_info *para)
{
	...
	if (para->nhm_incld_cca != env->nhm_include_cca) {
		halbb_set_reg_phy0_1(bb, cr->nhm_inclu_cca,
				       cr->nhm_inclu_cca_m,
				       para->nhm_incld_cca);
	...
	if ((bb->ic_type != BB_RTL8852A) && (bb->ic_type != BB_RTL8852B)) {
		...
		if (para->nhm_nav_en != env->nhm_nav_en) {
			halbb_set_reg_phy0_1(bb, cr->nhm_nav_en,
					     cr->nhm_nav_en_m,
					     para->nhm_nav_en);
			BB_DBG(bb, DBG_ENV_MNTR,
		...
		if (para->nhm_rssi_th_en != env->nhm_rssi_th_en) {
			halbb_set_reg_phy0_1(bb, cr->nhm_rssi_th_en,
					     cr->nhm_rssi_th_en_m,
					     para->nhm_rssi_th_en);
			BB_DBG(bb, DBG_ENV_MNTR,
		...
		if (para->nhm_rssi_th != env->nhm_rssi_th) {
			halbb_set_reg_phy0_1(bb, cr->nhm_rssi_th,
					     cr->nhm_rssi_th_m,
					     para->nhm_rssi_th);
			BB_DBG(bb, DBG_ENV_MNTR,
...
bool halbb_clm_set(struct bb_info *bb, struct ccx_para_info *para)
{
	...
	if ((bb->ic_type != BB_RTL8852A) && (bb->ic_type != BB_RTL8852B)) {
		...
		if (para->clm_nav_en != env->clm_nav_en) {
			halbb_set_reg_phy0_1(bb, cr->clm_nav_en,
					     cr->clm_nav_en_m,
					     para->clm_nav_en);
			BB_DBG(bb, DBG_ENV_MNTR,
		...
		if (para->clm_rssi_th_en != env->clm_rssi_th_en) {
			halbb_set_reg_phy0_1(bb, cr->clm_rssi_th_en,
					     cr->clm_rssi_th_en_m,
					     para->clm_rssi_th_en);
			BB_DBG(bb, DBG_ENV_MNTR,
		...
		if (para->clm_rssi_th != env->clm_rssi_th) {
			halbb_set_reg_phy0_1(bb, cr->clm_rssi_th,
					     cr->clm_rssi_th_m,
					     para->clm_rssi_th);
			BB_DBG(bb, DBG_ENV_MNTR,
...
void halbb_fahm_hw_trigger(struct bb_info *bb)
{
	...
	halbb_set_reg_phy0_1(bb, cr->fahm_en, cr->fahm_en_m, false);
	halbb_set_reg_phy0_1(bb, cr->fahm_en, cr->fahm_en_m, true);
...
void halbb_fahm_set_th_reg(struct bb_info *bb)
{
	...
	if (((bb->ic_type == BB_RTL8852A) || (bb->ic_type == BB_RTL8852B) ||
		...
		halbb_set_reg_phy0_1(bb, cr->fahm_th0, cr->fahm_th0_m,
				       env->fahm_th[0]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th1, cr->fahm_th1_m,
				       env->fahm_th[1]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th2, cr->fahm_th2_m,
				       env->fahm_th[2]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th3, cr->fahm_th3_m,
				       env->fahm_th[3]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th4, cr->fahm_th4_m,
				       env->fahm_th[4]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th5, cr->fahm_th5_m,
				       env->fahm_th[5]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th6, cr->fahm_th6_m,
				       env->fahm_th[6]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th7, cr->fahm_th7_m,
				       env->fahm_th[7]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th8, cr->fahm_th8_m,
				       env->fahm_th[8]-env->ccx_ext_loss);
		halbb_set_reg_phy0_1(bb, cr->fahm_th9, cr->fahm_th9_m,
...
bool halbb_fahm_set(struct bb_info *bb, struct fahm_para_info *para)
{
	...
	if (mntr_time != env->fahm_mntr_time) {
		halbb_ccx_ms_2_period_unit(bb, mntr_time, &period,
					   &unit_idx);
...
void halbb_env_mntr_cmn_log(struct bb_info *bb)
{
	...
	BB_DBG(bb, DBG_CMN, "=== CLM/IFS_CLM/EDCCA_CLM rpt ===\n");
	if ((env->ccx_watchdog_result & CCX_SEL_EXCLU_NHM_FAHM) == CCX_FAIL) {
		BB_DBG(bb, DBG_CMN, "Env_mntr get CCX result failed!\n");
		BB_DBG(bb, DBG_CMN,
	...
	BB_DBG(bb, DBG_CMN, "=== NHM rpt ===\n");
	if (((env->ccx_watchdog_result & NHM_SEL) == CCX_FAIL) &&
	    (env->nhm_app != NHM_FW_CTRL)) {
		BB_DBG(bb, DBG_CMN,
		       "Env_mntr get NHM result failed! NHM APP=%d\n",
		       env->nhm_app);
	} else {
		BB_DBG(bb, DBG_CMN,
		       "{Tx, Idle, CCA_p20} = {%d, %d, %d} %%\n",
	...
	BB_DBG(bb, DBG_CMN, "=== FAHM rpt ===\n");
	if ((env->fahm_watchdog_result == false) && (env->fahm_app != FAHM_DIG)) {
		BB_DBG(bb, DBG_CMN,
		       "Env_mntr get FAHM result failed! FAHM APP=%d\n",
		       env->fahm_app);
		return;
	}
...
void halbb_env_mntr_log(struct bb_info *bb, u32 dbg_comp)
{
	...
	BB_DBG(bb, DBG_ENV_MNTR, "=== CLM/IFS_CLM/EDCCA_CLM rpt ===\n");
	if ((env->ccx_watchdog_result & CCX_SEL_EXCLU_NHM_FAHM) == CCX_FAIL) {
		BB_DBG(bb, DBG_ENV_MNTR, "Env_mntr get CCX result failed!\n");
		BB_DBG(bb, DBG_ENV_MNTR,
		       "APP:{CLM, IFS_CLM, EDCCA} = {%d, %d, %d}\n",
		       env->clm_app, env->ifs_clm_app, env->edcca_clm_app);
	} else {
	...
	BB_DBG(bb, DBG_ENV_MNTR, "=== NHM rpt ===\n");
	if (((env->ccx_watchdog_result & NHM_SEL) == CCX_FAIL) &&
	    (env->nhm_app != NHM_FW_CTRL)) {
		BB_DBG(bb, DBG_ENV_MNTR,
		       "Env_mntr get NHM result failed! NHM APP=%d\n",
	...
	BB_DBG(bb, DBG_ENV_MNTR, "=== FAHM rpt ===\n");
	if ((env->fahm_watchdog_result == false) && (env->fahm_app != FAHM_DIG)) {
		BB_DBG(bb, DBG_ENV_MNTR,
		       "Env_mntr get FAHM result failed! FAHM APP=%d\n",
		       env->fahm_app);
			...
			char *output, u32 *_out_len)
{
	...
	if ((_os_strcmp(input[1], help) == 0)) {
		...
		halbb_env_mntr_get_bg_result(bb, &rpt, HW_PHY_0);
		...
		BB_DBG_CNSL(out_len, used, output + used, out_len - used,
			    "=== Current parameters ===\n");
		BB_DBG_CNSL(out_len, used, output + used, out_len - used,
			    "rac_lv = %d, edcca_opt_bw_idx = %d\n",
			    env->ccx_rac_lv, env->ccx_edcca_opt_bw_idx);
		BB_DBG_CNSL(out_len, used, output + used, out_len - used,
		...
		if (var[0] == 1) {
			...
			para.mntr_time = (u16)var[1];
			fahm_para.fahm_mntr_time = (u16)var[1];
		}
	...
	if (is_show_fahm_rpt) {
		...
		if ((bb->ic_type == BB_RTL8852A) ||
			...
			BB_DBG_CNSL(out_len, used, output + used, out_len - used,
				    ...
				    fahm_rpt.fahm_pwr,
				    5 * (env->fahm_pwr_0p5 & 0x1),
				    fahm_rpt.fahm_rpt[10], fahm_rpt.fahm_rpt[9],
				    fahm_rpt.fahm_rpt[8], fahm_rpt.fahm_rpt[7],
				    fahm_rpt.fahm_rpt[6], fahm_rpt.fahm_rpt[5],
				    fahm_rpt.fahm_rpt[4], fahm_rpt.fahm_rpt[3],
				    fahm_rpt.fahm_rpt[2], fahm_rpt.fahm_rpt[1],
				    fahm_rpt.fahm_rpt[0]);
		} else {
			BB_DBG_CNSL(out_len, used, output + used, out_len - used,
				    "%-18s[%.2d  %.2d  %.2d  %.2d  %.2d  %.2d  %.2d  %.2d  %.2d  %.2d  %.2d]\n",
