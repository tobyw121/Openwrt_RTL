...
#ifdef CONFIG_RTW_HAS_PLATFORM_PRE_CONFIG
#include "rtw_pltfm_preconf.h"
#endif

#include "autoconf.h"

#ifdef CONFIG_RTW_HAS_PLATFORM_POST_CONFIG
#include "rtw_pltfm_postconf.h"
#endif

/* Convert core configuration to PHL's */
...
#ifndef CONFIG_DFS
#define CONFIG_DFS 1 // 1=on: 0=off
#define CONFIG_DFS_CUSTOMER_CHAN_SEL

#ifdef CONFIG_DFS_CUSTOMER_CHAN_SEL
#define CONFIG_DFS_CHAN_SEL_R_SHORTEST_WAIT
//#define CONFIG_DFS_CHAN_SEL_G_RANDOM
#endif
#endif
	...
	#define CONFIG_RTW_DFS_REGION_DOMAIN 3 //"0:UNKNOWN, 1:FCC, 2:MKK, 3:ETSI"
	#endif

	#define CONFIG_DFS_CSA_IE
#else
...
/* Force Disable CONFIG_TXPWR_LIMIT */
...
#define MACID_NUM_SW_LIMIT (64 + 1)
 ...
 */
	...
	#endif
	#ifndef CONFIG_RTW_DACS
		#define CONFIG_RTW_PACS
...
#ifdef CONFIG_RTW_OWE
#define CONFIG_HAPD_OWE
#endif
#define DIRECT_HAPD_RSN_IE

#ifndef CONFIG_PROBEREQ_ADD_HT_VHT_HE
#define CONFIG_PROBEREQ_ADD_HT_VHT_HE
#endif

#if defined(CONFIG_RTW_MULTI_AP) && (CONFIG_DFS)
#define CONFIG_RTW_MULTI_AP_DFS_EN 1
#else
#define CONFIG_RTW_MULTI_AP_DFS_EN 0
#endif
