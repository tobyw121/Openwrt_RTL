...
enum rtw_hal_status
rtw_hal_mac_set_nav_padding(struct hal_info_t *hal_info,
					u8 band, u8 nav_pad_en, u8 over_txop_en, u16 nav_padding);
...
enum rtw_hal_status
rtw_hal_mac_parse_fwc2h(void *hal, void *c, void *fw_c2h_sts);
