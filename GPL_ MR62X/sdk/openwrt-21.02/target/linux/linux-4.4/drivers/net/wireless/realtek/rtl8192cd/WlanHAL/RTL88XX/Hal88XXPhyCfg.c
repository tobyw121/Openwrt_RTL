...
unsigned int HAL_assign_lmt_reg_value(IN  HAL_PADAPTER	Adapter, unsigned int reg_offset, char max_idx, unsigned char max_idx2)
{
	...
	if (reg_offset == REG_BB_TXAGC_A_CCK1_MCS32_N) {
		...
		//if (GetChipIDMIMO88XX(Adapter) == RF_2T2R)
...
#if IS_RTL8814A_SERIES || IS_RTL8198F_SERIES
    if ((GET_CHIP_VER(Adapter) == VERSION_8814A)||(GET_CHIP_VER(Adapter) == VERSION_8198F)) {
        if(Adapter->pshare->txpwr_lmt_HT3S == 0)
            lmt_valid = 0;
    }
#endif
#if IS_RTL8198F_SERIES
	if (GET_CHIP_VER(Adapter) == VERSION_8198F) {
		if(Adapter->pshare->txpwr_lmt_HT4S == 0)
			lmt_valid = 0;

		if((Adapter->pshare->txpwr_lmt_VHT1S == 0)
			||(Adapter->pshare->txpwr_lmt_VHT2S == 0)
			||(Adapter->pshare->txpwr_lmt_VHT3S == 0)
			||(Adapter->pshare->txpwr_lmt_VHT4S == 0))
			lmt_valid = 0;
	}
#endif
...
#if IS_RTL8814A_SERIES || IS_RTL8822B_SERIES|| IS_RTL8821C_SERIES	
...
void TxLMT_CCK_Jaguar_N(IN  HAL_PADAPTER	Adapter)
{
	...
	char	lmt_pg_idx_cck_A=0x00,lmt_pg_idx_cck_B=0x00;

	char	max_lmt_idx_cck_A = 0;
...
#if (IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES || IS_RTL8812F_SERIES || IS_RTL8198F_SERIES || IS_RTL8814B_SERIES || IS_RTL8812F_SERIES || IS_RTL8197G_SERIES)
...
)
{
	if(txRate <= ODM_RATE11M){
		...
		Adapter->pshare->phw->CurrentTxAgcOFDM[txPathIdx][txRate - ODM_RATE6M] = power;	
	}else if(txRate <= ODM_RATEMCS31 ){
		Adapter->pshare->phw->CurrentTxAgcMCS[txPathIdx][txRate - ODM_RATEMCS0] = power;	
	}else if(txRate <= ODM_RATEVHTSS4MCS9){
		Adapter->pshare->phw->CurrentTxAgcVHT[txPathIdx][txRate - ODM_RATEVHTSS1MCS0] = power;	
	}
}
#endif

#if (IS_RTL8198F_SERIES)||(IS_RTL8814B_SERIES) || (IS_RTL8822C_SERIES) || (IS_RTL8812F_SERIES)|| (IS_RTL8197G_SERIES)
void TxPG_CCK_NEW
(
	IN  HAL_PADAPTER                Adapter
)
{
	...
	for(path=start;path<=end;path++){
		pTxAgcOffset = Adapter->pshare->phw->CCKTxAgc;
		for(rate=TX_AGC_CCK_1M;rate<=TX_AGC_CCK_11M;rate++){
			...
			Adapter->pshare->phw->CurrentTxAgcCCK[path][rate] = HAL_POWER_RANGE_CHECK_NEW(Adapter->pshare->phw->CurrentTxAgcCCK[path][rate]);
...
#if IS_RTL8198F_SERIES
		if(IS_HARDWARE_TYPE_8198F(Adapter)){		
		phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_CCK_1M),rate);
		}else
#endif
#if IS_RTL8197G_SERIES
		if(IS_HARDWARE_TYPE_8197G(Adapter)){		
		phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_CCK_1M),rate);
		}else
#endif

		{
			...
			if(IS_HARDWARE_TYPE_8814B(Adapter)){
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_CCK_1M),rate);
			}
#endif
		}			
	}
...
//	char power;
	...
	for(path=start;path<=end;path++){
		...
		pTxAgcOffset = Adapter->pshare->phw->OFDMTxAgcOffset;
		...
		for(rate=TX_AGC_OFDM_6M;rate<=TX_AGC_OFDM_54M;rate++){
			...
			Adapter->pshare->phw->CurrentTxAgcOFDM[path][rate-TX_AGC_OFDM_6M] = HAL_POWER_RANGE_CHECK_NEW(Adapter->pshare->phw->CurrentTxAgcOFDM[path][rate-TX_AGC_OFDM_6M]);
...
#if IS_RTL8197G_SERIES
			if(IS_HARDWARE_TYPE_8197G(Adapter)){
				phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),rate);
			}else
#endif
#if IS_RTL8198F_SERIES
			if(IS_HARDWARE_TYPE_8198F(Adapter)){
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),rate);
			}else
#endif
#if IS_RTL8822C_SERIES	
			if(IS_HARDWARE_TYPE_8822C(Adapter)){
				phydm_write_txagc_1byte_8822c((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),rate);
			}else
#endif
#if IS_RTL8812F_SERIES	
			if(IS_HARDWARE_TYPE_8812F(Adapter)){
				phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),rate);
			}else
#endif
			{
#if IS_RTL8814B_SERIES	
			if(IS_HARDWARE_TYPE_8814B(Adapter)){
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),rate);
			}
#endif
        	}
		}
	...
	for(path=start;path<=end;path++){
		...
		pTxAgcOffset = Adapter->pshare->phw->MCSTxAgcOffset;
		
		for(rate=TX_AGC_HT_NSS1_MCS0;rate<=TX_AGC_HT_NSS4_MCS31;rate++){
			...
			Adapter->pshare->phw->CurrentTxAgcMCS[path][rate-TX_AGC_HT_NSS1_MCS0] = HAL_POWER_RANGE_CHECK_NEW(Adapter->pshare->phw->CurrentTxAgcMCS[path][rate-TX_AGC_HT_NSS1_MCS0]);
...
#if IS_RTL8197G_SERIES		
			if(IS_HARDWARE_TYPE_8197G(Adapter)){
				phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),rate);
			}else 
#endif			
#if IS_RTL8198F_SERIES			
			if(IS_HARDWARE_TYPE_8198F(Adapter)){
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),rate);
			}else 
#endif
#if IS_RTL8822C_SERIES
			if(IS_HARDWARE_TYPE_8822C(Adapter)){
				phydm_write_txagc_1byte_8822c((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),rate);
			}else
#endif		
#if IS_RTL8812F_SERIES
			if(IS_HARDWARE_TYPE_8812F(Adapter)){
				phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),rate);
			}else
#endif		
			{
#if IS_RTL8814B_SERIES
			if(IS_HARDWARE_TYPE_8814B(Adapter)){		
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),rate);				
			}
#endif		
        	}
		}
	...
	for(path=start;path<=end;path++){
		...
		pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
		
		for(rate=TX_AGC_VHT_NSS1_MCS0;rate<=TX_AGC_VHT_NSS4_MCS9;rate++){
			...
			if( rate == TX_AGC_VHT_NSS1_MCS8 || rate == TX_AGC_VHT_NSS1_MCS9 \
				...
				|| rate == TX_AGC_VHT_NSS4_MCS8 || rate == TX_AGC_VHT_NSS4_MCS9)
				Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0] -= (unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0);
			else
				Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0] += (unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0);
			Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0] = HAL_POWER_RANGE_CHECK_NEW(Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0]);
...
#if IS_RTL8198F_SERIES				
				if(IS_HARDWARE_TYPE_8198F(Adapter)){
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),rate);
				}else 
#endif
#if IS_RTL8822C_SERIES
				if(IS_HARDWARE_TYPE_8822C(Adapter)){
					phydm_write_txagc_1byte_8822c((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),rate);
				}else
#endif		
#if IS_RTL8812F_SERIES
				if(IS_HARDWARE_TYPE_8812F(Adapter)){
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),rate);
				}else
#endif		
				{
#if IS_RTL8814B_SERIES
				if(IS_HARDWARE_TYPE_8814B(Adapter)){				
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),rate);					
				}
#endif		
				}
			}else{
...
#if IS_RTL88XX_AC || IS_RTL88XX_MAC_V3
...
{
    if (GetChipIDMIMO88XX(Adapter) == RF_1T1R) {
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 0);
	} else if (GetChipIDMIMO88XX(Adapter) == RF_2T2R) {
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 0);
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 1);
    } else if (GetChipIDMIMO88XX(Adapter) == RF_3T3R) {
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 0);
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 1);
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 2);
    } else if (GetChipIDMIMO88XX(Adapter) == RF_4T4R) {
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 0);
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 1);
        TxLMT_OFDM_Jaguar_PathX_AC(Adapter, 2);
...
#if (IS_RTL8198F_SERIES	|| IS_RTL8814B_SERIES || IS_RTL8812F_SERIES || IS_RTL8197G_SERIES)
void TxLMT_OFDM_Jaguar_NEW(IN  HAL_PADAPTER	Adapter)
{
...
//	unsigned char	idx_vht_1ss_mcs7 =0;
//	unsigned char	idx_vht_2ss_mcs7 =0;
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)	
	unsigned char	idx_vht_3ss_mcs7 =0;    
	unsigned char	idx_vht_4ss_mcs7 =0; 
#endif
	short			lmt_pg_idx_ofdm = 0;
	short			lmt_pg_idx_ht1s, lmt_pg_idx_ht2s = 0;
	short			lmt_pg_idx_vht1s, lmt_pg_idx_vht2s = 0;
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)
	short	        lmt_pg_idx_ht3s, lmt_pg_idx_ht4s = 0;
	short	        lmt_pg_idx_vht3s, lmt_pg_idx_vht4s = 0;
#endif
	char	max_lmt_idx_ofdm = 0;
	char	max_lmt_idx_ht1s, max_lmt_idx_ht2s = 0;
	char	max_lmt_idx_vht1s, max_lmt_idx_vht2s = 0;
	...
	{
		tssi_lmt = POWER_MIN_CHECK(Adapter->pshare->tgpwr_HT1S_NEW , Adapter->pshare->txpwr_lmt_HT1S);
		//printk(">>>>>>>>>>> %s tssi_lmt = min(%d %d) = %d dBm\n", __FUNCTION__, Adapter->pshare->tgpwr_HT1S_NEW, Adapter->pshare->txpwr_lmt_HT1S, tssi_lmt/4);
		lmt_pg_idx_ofdm = Adapter->pshare->txpwr_lmt_OFDM - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->OFDMTxAgcOffset[7]);
		lmt_pg_idx_ht1s = Adapter->pshare->txpwr_lmt_HT1S - Adapter->pshare->tgpwr_HT1S_NEW;
		lmt_pg_idx_ht2s = Adapter->pshare->txpwr_lmt_HT2S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->MCSTxAgcOffset[15]);
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)
		lmt_pg_idx_ht3s = Adapter->pshare->txpwr_lmt_HT3S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->MCSTxAgcOffset[23]);
		lmt_pg_idx_ht4s = Adapter->pshare->txpwr_lmt_HT4S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->MCSTxAgcOffset[31]);
#endif
		lmt_pg_idx_vht1s = Adapter->pshare->txpwr_lmt_VHT1S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->VHTTxAgcOffset[7]);
		lmt_pg_idx_vht2s = Adapter->pshare->txpwr_lmt_VHT2S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->VHTTxAgcOffset[17]);
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)
		lmt_pg_idx_vht3s = Adapter->pshare->txpwr_lmt_VHT3S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->VHTTxAgcOffset[27]);
		lmt_pg_idx_vht4s = Adapter->pshare->txpwr_lmt_VHT4S - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->VHTTxAgcOffset[37]);
#endif
	}
	else
	{
	lmt_pg_idx_ofdm = Adapter->pshare->txpwr_lmt_OFDM - Adapter->pshare->tgpwr_OFDM_NEW;
	lmt_pg_idx_ht1s = Adapter->pshare->txpwr_lmt_HT1S - Adapter->pshare->tgpwr_HT1S_NEW;
	lmt_pg_idx_ht2s = Adapter->pshare->txpwr_lmt_HT2S - Adapter->pshare->tgpwr_HT2S_NEW;
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)	
	lmt_pg_idx_ht3s = Adapter->pshare->txpwr_lmt_HT3S - Adapter->pshare->tgpwr_HT3S_NEW;
	lmt_pg_idx_ht4s = Adapter->pshare->txpwr_lmt_HT4S - Adapter->pshare->tgpwr_HT4S_NEW;
#endif	
	lmt_pg_idx_vht1s = Adapter->pshare->txpwr_lmt_VHT1S - Adapter->pshare->tgpwr_VHT1S_NEW;
	lmt_pg_idx_vht2s = Adapter->pshare->txpwr_lmt_VHT2S - Adapter->pshare->tgpwr_VHT2S_NEW;
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)	
	lmt_pg_idx_vht3s = Adapter->pshare->txpwr_lmt_VHT3S - Adapter->pshare->tgpwr_VHT3S_NEW;
	lmt_pg_idx_vht4s = Adapter->pshare->txpwr_lmt_VHT4S - Adapter->pshare->tgpwr_VHT4S_NEW;
#endif

#if 0	
			printk("lmt_pg_idx_ofdm=%d = (txpwr_lmt_OFDM=%d - tgpwr_OFDM_NEW=%d)\n",lmt_pg_idx_ofdm, Adapter->pshare->txpwr_lmt_OFDM, Adapter->pshare->tgpwr_OFDM_NEW);
			printk("lmt_pg_idx_ht1s=%d = (txpwr_lmt_HT1S=%d - tgpwr_HT1S_NEW=%d)\n",lmt_pg_idx_ht1s, Adapter->pshare->txpwr_lmt_HT1S, Adapter->pshare->tgpwr_HT1S_NEW);
			printk("lmt_pg_idx_ht2s=%d = (txpwr_lmt_HT2S=%d - tgpwr_HT2S_NEW=%d)\n",lmt_pg_idx_ht2s, Adapter->pshare->txpwr_lmt_HT2S, Adapter->pshare->tgpwr_HT2S_NEW);
			printk("lmt_pg_idx_ht3s=%d = (txpwr_lmt_HT3S=%d - tgpwr_HT3S_NEW=%d)\n",lmt_pg_idx_ht3s, Adapter->pshare->txpwr_lmt_HT3S, Adapter->pshare->tgpwr_HT3S_NEW);
			printk("lmt_pg_idx_ht4s=%d = (txpwr_lmt_HT4S=%d - tgpwr_HT4S_NEW=%d)\n",lmt_pg_idx_ht4s, Adapter->pshare->txpwr_lmt_HT4S, Adapter->pshare->tgpwr_HT4S_NEW);
			printk("lmt_pg_idx_vht1s=%d = (txpwr_lmt_VHT1S=%d - tgpwr_VHT1S_NEW=%d)\n",lmt_pg_idx_vht1s, Adapter->pshare->txpwr_lmt_VHT1S, Adapter->pshare->tgpwr_VHT1S_NEW);
			printk("lmt_pg_idx_vht2s=%d = (txpwr_lmt_VHT2S=%d - tgpwr_VHT2S_NEW=%d)\n",lmt_pg_idx_vht2s, Adapter->pshare->txpwr_lmt_VHT2S, Adapter->pshare->tgpwr_VHT2S_NEW);
			printk("lmt_pg_idx_vht3s=%d = (txpwr_lmt_VHT3S=%d - tgpwr_VHT3S_NEW=%d)\n",lmt_pg_idx_vht3s, Adapter->pshare->txpwr_lmt_VHT3S, Adapter->pshare->tgpwr_VHT3S_NEW);
			printk("lmt_pg_idx_vht4s=%d = (txpwr_lmt_VHT4S=%d - tgpwr_VHT4S_NEW=%d)\n",lmt_pg_idx_vht4s, Adapter->pshare->txpwr_lmt_VHT4S, Adapter->pshare->tgpwr_VHT4S_NEW);
#endif
	}
 	/* Cal Max tx pwr idx for each path */
	for(bPathXEnIdx = start; bPathXEnIdx <= end ; bPathXEnIdx++ ){
		...
		max_lmt_idx_ht4s = lmt_pg_idx_ht4s + HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, TX_AGC_HT_NSS4_MCS31-TX_AGC_HT_NSS1_MCS0);
		max_lmt_idx_ht4s = POWER_MIN_INDEX(max_lmt_idx_ht4s);
#endif
		max_lmt_idx_vht1s = lmt_pg_idx_vht1s + HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, TX_AGC_VHT_NSS1_MCS7-TX_AGC_VHT_NSS1_MCS0);
		max_lmt_idx_vht1s = POWER_MIN_INDEX(max_lmt_idx_vht1s);
		...
		max_lmt_idx_vht4s = lmt_pg_idx_vht4s + HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, TX_AGC_VHT_NSS4_MCS7-TX_AGC_VHT_NSS1_MCS0);
		max_lmt_idx_vht4s = POWER_MIN_INDEX(max_lmt_idx_vht4s);
#endif		
#if 0	// Debug message
		printk("=================Path %d====================\n",bPathXEnIdx);
		printk("max_lmt_idx_ofdm=0x%x =(lmt_pg_idx_ofdm=%d + HAL_VAR_CurrentTxAgcOFDM(%d, TX_AGC_OFDM_54M-TX_AGC_OFDM_6M)=%d)\n",max_lmt_idx_ofdm, lmt_pg_idx_ofdm, bPathXEnIdx, HAL_VAR_CurrentTxAgcOFDM(bPathXEnIdx, TX_AGC_OFDM_54M-TX_AGC_OFDM_6M));
		printk("max_lmt_idx_ht1s=0x%x =(lmt_pg_idx_ht1s=%d + HAL_VAR_CurrentTxAgcMCS(%d, TX_AGC_HT_NSS1_MCS7-TX_AGC_HT_NSS1_MCS0)=%d)\n",max_lmt_idx_ht1s, lmt_pg_idx_ht1s, bPathXEnIdx, HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, TX_AGC_HT_NSS1_MCS7-TX_AGC_HT_NSS1_MCS0));
		printk("max_lmt_idx_ht2s=0x%x =(lmt_pg_idx_ht2s=%d + HAL_VAR_CurrentTxAgcMCS(%d, TX_AGC_HT_NSS2_MCS15-TX_AGC_HT_NSS1_MCS0)=%d)\n",max_lmt_idx_ht2s, lmt_pg_idx_ht2s, bPathXEnIdx, HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, TX_AGC_HT_NSS2_MCS15-TX_AGC_HT_NSS1_MCS0));
		printk("max_lmt_idx_ht3s=0x%x =(lmt_pg_idx_ht3s=%d + HAL_VAR_CurrentTxAgcMCS(%d, TX_AGC_HT_NSS3_MCS23-TX_AGC_HT_NSS1_MCS0)=%d)\n",max_lmt_idx_ht3s, lmt_pg_idx_ht3s, bPathXEnIdx, HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, TX_AGC_HT_NSS3_MCS23-TX_AGC_HT_NSS1_MCS0));
		printk("max_lmt_idx_ht4s=0x%x =(lmt_pg_idx_ht4s=%d + HAL_VAR_CurrentTxAgcMCS(%d, TX_AGC_HT_NSS4_MCS31-TX_AGC_HT_NSS1_MCS0)=%d)\n",max_lmt_idx_ht4s, lmt_pg_idx_ht4s, bPathXEnIdx, HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, TX_AGC_HT_NSS4_MCS31-TX_AGC_HT_NSS1_MCS0));
		printk("max_lmt_idx_vht1s=0x%x =(lmt_pg_idx_vht1s=%d + HAL_VAR_CurrentTxAgcVHT(%d, TX_AGC_VHT_NSS1_MCS7-TX_AGC_VHT_NSS1_MCS0)=%d)\n",max_lmt_idx_vht1s, lmt_pg_idx_vht1s, bPathXEnIdx, HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, TX_AGC_VHT_NSS1_MCS7-TX_AGC_VHT_NSS1_MCS0));
		printk("max_lmt_idx_vht2s=0x%x =(lmt_pg_idx_vht2s=%d + HAL_VAR_CurrentTxAgcVHT(%d, TX_AGC_VHT_NSS2_MCS7-TX_AGC_VHT_NSS1_MCS0)=%d)\n",max_lmt_idx_vht2s, lmt_pg_idx_vht2s, bPathXEnIdx, HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, TX_AGC_VHT_NSS2_MCS7-TX_AGC_VHT_NSS1_MCS0));
		printk("max_lmt_idx_vht3s=0x%x =(lmt_pg_idx_vht3s=%d + HAL_VAR_CurrentTxAgcVHT(%d, TX_AGC_VHT_NSS3_MCS7-TX_AGC_VHT_NSS1_MCS0)=%d)\n",max_lmt_idx_vht3s, lmt_pg_idx_vht3s, bPathXEnIdx, HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, TX_AGC_VHT_NSS3_MCS7-TX_AGC_VHT_NSS1_MCS0));
		printk("max_lmt_idx_vht4s=0x%x =(lmt_pg_idx_vht4s=%d + HAL_VAR_CurrentTxAgcVHT(%d, TX_AGC_VHT_NSS4_MCS7-TX_AGC_VHT_NSS1_MCS0)=%d)\n",max_lmt_idx_vht4s, lmt_pg_idx_vht4s, bPathXEnIdx, HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, TX_AGC_VHT_NSS4_MCS7-TX_AGC_VHT_NSS1_MCS0));
#endif

	

		/* set OFDM power index */
		for(rate = ODM_RATE6M; rate <= ODM_RATE54M; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcOFDM(bPathXEnIdx, rate-ODM_RATE6M), max_lmt_idx_ofdm)));
		}
		/* set MCS 1/2/3/4 SS power index */
		for(rate = ODM_RATEMCS0; rate <= ODM_RATEMCS7; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, rate-ODM_RATEMCS0), max_lmt_idx_ht1s)));
		}

		for(rate = ODM_RATEMCS8; rate <= ODM_RATEMCS15; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, rate-ODM_RATEMCS0), max_lmt_idx_ht2s)));
		}
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)
		for(rate = ODM_RATEMCS16; rate <= ODM_RATEMCS23; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, rate-ODM_RATEMCS0), max_lmt_idx_ht3s)));
		}

		for(rate = ODM_RATEMCS24; rate <= ODM_RATEMCS31; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, rate-ODM_RATEMCS0), max_lmt_idx_ht4s)));
		}
#endif
		/* set VHT 1/2/3/4 SS power index */
		for(rate = ODM_RATEVHTSS1MCS0; rate <= ODM_RATEVHTSS1MCS9; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, rate-ODM_RATEVHTSS1MCS0), max_lmt_idx_vht1s)));
		}

		for(rate = ODM_RATEVHTSS2MCS0; rate <= ODM_RATEVHTSS2MCS9; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, rate-ODM_RATEVHTSS1MCS0), max_lmt_idx_vht2s)));
		}
#if defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814B)
		for(rate = ODM_RATEVHTSS3MCS0; rate <= ODM_RATEVHTSS3MCS9; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, rate-ODM_RATEVHTSS1MCS0), max_lmt_idx_vht3s)));
			//printk("max_lmt_idx_ht1s %x , HAL_VAR_CurrentTxAgcMCS(0%x, 0x%x) %x , Min %x \n",max_lmt_idx_ht1s,bPathXEnIdx,rate,HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, rate),(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcMCS(bPathXEnIdx, rate), max_lmt_idx_ht1s)));
		}

		for(rate = ODM_RATEVHTSS4MCS0; rate <= ODM_RATEVHTSS4MCS9; rate++){
			set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcVHT(bPathXEnIdx, rate-ODM_RATEVHTSS1MCS0), max_lmt_idx_vht4s)));
		}
#endif
	}
...
#if IS_RTL8198F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8198F)
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),lmt_pg_idx_ofdm),rate);
#endif
#if IS_RTL8814B_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8814B)
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),lmt_pg_idx_ofdm),rate);
#endif
#if IS_RTL8197G_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8197G) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable) 
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M)), Adapter->pshare->txpwr_lmt_OFDM) - tssi_lmt, rate);
				else
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),lmt_pg_idx_ofdm),rate);
			}	
#endif
#if IS_RTL8812F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable) 
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M)), Adapter->pshare->txpwr_lmt_OFDM) - tssi_lmt, rate);
				else
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M),lmt_pg_idx_ofdm),rate);
			}	
#endif
		}
...
#if IS_RTL8198F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8198F)
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht1s),rate);
#endif
#if IS_RTL8814B_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8814B)
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht1s),rate);
#endif
#if IS_RTL8197G_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8197G) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable) 			
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)), Adapter->pshare->txpwr_lmt_HT1S) - tssi_lmt, rate);
				else 
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht1s),rate);
			}
#endif
#if IS_RTL8812F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable) 				
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)), Adapter->pshare->txpwr_lmt_HT1S) - tssi_lmt, rate);
				else
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht1s),rate);
			}
#endif
		}
...
#if IS_RTL8198F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8198F)
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht2s),rate);
#endif
#if IS_RTL8814B_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8814B)
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht2s),rate);
#endif
#if IS_RTL8197G_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8197G) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable) 
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)), Adapter->pshare->txpwr_lmt_HT2S) - tssi_lmt, rate);
				else			
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht2s),rate);
			}
#endif
#if IS_RTL8812F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable) 
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)), Adapter->pshare->txpwr_lmt_HT2S) - tssi_lmt, rate);
				else			
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht2s),rate);
			}
#endif
		}
		...
		for(rate = ODM_RATEMCS16; rate <= ODM_RATEMCS23; rate++){
...
#if IS_RTL8198F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8198F)
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht3s),rate);
#endif
#if IS_RTL8814B_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8814B)
			...
			if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable)
					...
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht3s),rate);
			}
#endif
		}
		...
		for(rate = ODM_RATEMCS24; rate <= ODM_RATEMCS31; rate++){
...
#if IS_RTL8198F_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8198F)
				phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht4s),rate);
#endif
#if IS_RTL8814B_SERIES
			if(GET_CHIP_VER(Adapter) == VERSION_8814B)
			...
			if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
				if (Adapter->pmib->dot11RFEntry.tssi_enable)
					...
					phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0),lmt_pg_idx_ht4s),rate);
			}
#endif
		}
		/* set VHT 1/2/3/4 SS power index */
		for(rate = ODM_RATEVHTSS1MCS0; rate <= ODM_RATEVHTSS1MCS9; rate++){
			pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
			if(rate >= ODM_RATEVHTSS1MCS8){	
#if IS_RTL8198F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8198F)
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht1s),rate);
#endif
#if IS_RTL8814B_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8814B)
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht1s),rate);
#endif
#if IS_RTL8812F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
					if (Adapter->pmib->dot11RFEntry.tssi_enable) 
						phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW - (unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)), Adapter->pshare->txpwr_lmt_VHT1S) - tssi_lmt, rate);
					else
						phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht1s),rate);
				}
#endif
			} else {
#if IS_RTL8198F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8198F)
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht1s),rate);
#endif
#if IS_RTL8814B_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8814B)
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht1s),rate);
#endif
#if IS_RTL8812F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
					if (Adapter->pmib->dot11RFEntry.tssi_enable) 
						...
						phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht1s),rate);
				}
#endif
			}
		}
		...
		for(rate = ODM_RATEVHTSS2MCS0; rate <= ODM_RATEVHTSS2MCS9; rate++){
			pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
			if(rate >= ODM_RATEVHTSS2MCS8){
#if IS_RTL8198F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8198F)
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht2s),rate);
#endif
#if IS_RTL8814B_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8814B)
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht2s),rate);
#endif
#if IS_RTL8812F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
					if (Adapter->pmib->dot11RFEntry.tssi_enable) 
						phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW - (unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)), Adapter->pshare->txpwr_lmt_VHT2S) - tssi_lmt, rate);
					else
						phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht2s),rate);
				}
#endif
			} else {
#if IS_RTL8198F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8198F)
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht2s),rate);
#endif
#if IS_RTL8814B_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8814B)
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht2s),rate);
#endif
#if IS_RTL8812F_SERIES
				if(GET_CHIP_VER(Adapter) == VERSION_8812F) {
					if (Adapter->pmib->dot11RFEntry.tssi_enable) 
						...
						phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht2s),rate);
				}	
#endif
			}
		}
	...
	if(GET_CHIP_VER(Adapter) == VERSION_8198F) {	
		for(rate = ODM_RATEVHTSS3MCS0; rate <= ODM_RATEVHTSS3MCS9; rate++){
			pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
			if(rate >= ODM_RATEVHTSS3MCS8)
			phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht3s),rate);
			else
			phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht3s),rate);
		}

		for(rate = ODM_RATEVHTSS4MCS0; rate <= ODM_RATEVHTSS4MCS9; rate++){
			pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
			if(rate >= ODM_RATEVHTSS4MCS8)
			phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht4s),rate);
			else
			phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht4s),rate);
		}
	}
#endif
	...
	if(GET_CHIP_VER(Adapter) == VERSION_8814B) {	
		for(rate = ODM_RATEVHTSS3MCS0; rate <= ODM_RATEVHTSS3MCS9; rate++){
			pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
			if(rate >= ODM_RATEVHTSS3MCS8)
			phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht3s),rate);
			else
			phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht3s),rate);
		}

		for(rate = ODM_RATEVHTSS4MCS0; rate <= ODM_RATEVHTSS4MCS9; rate++){
			pTxAgcOffset = Adapter->pshare->phw->VHTTxAgcOffset;
			if(rate >= ODM_RATEVHTSS4MCS8)
			phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)+(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((-1)*(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht4s),rate);
			else
			phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8814b((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0),lmt_pg_idx_vht4s),rate);
		}
	}
#endif
...
void TxLMT_CCK_Jaguar_NEW(IN  HAL_PADAPTER	Adapter)
{

	// unsigned char	bPathXEnIdx, rate;
	unsigned char	bPathXEnIdx, rate, tssi_lmt=0;
	char			max_lmt_idx_cck, start, end; 
	short	        lmt_pg_idx_cck;
	char 			*pTxAgcOffset;
#if 0
if(IS_HARDWARE_TYPE_8197G(Adapter)) 
	if(Adapter->pmib->dot11RFEntry.tssi_enable)
	...
	if (Adapter->pmib->dot11RFEntry.tssi_enable)
		lmt_pg_idx_cck = Adapter->pshare->txpwr_lmt_CCK - (Adapter->pshare->tgpwr_HT1S_NEW + Adapter->pshare->phw->CCKTxAgc[3]);
	else
		lmt_pg_idx_cck = Adapter->pshare->txpwr_lmt_CCK - Adapter->pshare->tgpwr_CCK_NEW;
	tssi_lmt = POWER_MIN_CHECK(Adapter->pshare->tgpwr_HT1S_NEW , Adapter->pshare->txpwr_lmt_HT1S);
	//Cal Max tx pwr idx for CCK
	for(bPathXEnIdx = start; bPathXEnIdx <= end ; bPathXEnIdx++ ){
		...
		//printk("max_lmt_idx_cck=%d =(lmt_pg_idx_cck=%d + HAL_VAR_CurrentTxAgcCCK(%d, TX_AGC_CCK_11M)=%d)\n",max_lmt_idx_cck, lmt_pg_idx_cck, bPathXEnIdx, HAL_VAR_CurrentTxAgcCCK(bPathXEnIdx, TX_AGC_CCK_11M));
		/* set CCK power index */
		for(rate = ODM_RATE1M; rate <= ODM_RATE11M; rate++){
		    set_current_tx_agc(Adapter,bPathXEnIdx,rate,POWER_RANGE_CHECK_NEW(POWER_MIN_CHECK(HAL_VAR_CurrentTxAgcCCK(bPathXEnIdx, rate), max_lmt_idx_cck)));
		}
...
#if IS_RTL8198F_SERIES
		if(GET_CHIP_VER(Adapter) == VERSION_8198F) {		
			phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8198f((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate),lmt_pg_idx_cck),rate);
		}
#endif
#if IS_RTL8197G_SERIES 
		 if (GET_CHIP_VER(Adapter) == VERSION_8197G){
			//printk(">>>>> rate[%d] tgpwr_HT1S_NEW[%d] txpwr_lmt_CCK[%d] tssi_lmt[%d] offset[%d]\n", rate, Adapter->pshare->tgpwr_HT1S_NEW, Adapter->pshare->txpwr_lmt_CCK, tssi_lmt, (unsigned char)*(pTxAgcOffset+rate-TX_AGC_CCK_1M));
			if (Adapter->pmib->dot11RFEntry.tssi_enable) 
				phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)), POWER_MIN_CHECK((Adapter->pshare->tgpwr_HT1S_NEW + (unsigned char)*(pTxAgcOffset+rate-TX_AGC_CCK_1M)), Adapter->pshare->txpwr_lmt_CCK) - tssi_lmt, rate);
			else
				phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),config_phydm_read_txagc_diff_8197g((&(Adapter->pshare->_dmODM)),rate)-(unsigned char)*(pTxAgcOffset+rate)+POWER_MIN_CHECK((unsigned char)*(pTxAgcOffset+rate),lmt_pg_idx_cck),rate);
		}
#endif
...
#endif
#endif // #if IS_RTL88XX_AC || IS_RTL88XX_MAC_V3
#endif // #ifdef TXPWR_LMT
...
#if IS_RTL8198F_SERIES || IS_RTL8814B_SERIES
	if ((IS_HARDWARE_TYPE_8198F(Adapter)||IS_HARDWARE_TYPE_8814B(Adapter)) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) 
		def_power_value = 0x32;
#endif
#if IS_RTL8812F_SERIES
	if ( IS_HARDWARE_TYPE_8812F(Adapter) )
		def_power_value = 0x54;
#endif
#if IS_RTL8197G_SERIES
	if ( IS_HARDWARE_TYPE_8197G(Adapter) )
		def_power_value = 0x5a;
#endif
#ifdef HIGH_POWER_EXT_PA		
	if (Adapter->pshare->rf_ft_var.use_ext_pa)
		def_power_value = 0x16;
#endif
    ...
    for (i = 0; i < 4; i++) {
        if (bPathXEn[i]) {
...
#endif
#if IS_RTL8822B_SERIES || IS_RTL8821C_SERIES //eric-8822
			...
			if ( IS_HARDWARE_TYPE_8198F(Adapter)) {
				...
				config_phydm_write_txagc_ref_8198f((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATEVHTSS4MCS9;rate++){ 	
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),0,rate);
					set_current_tx_agc(Adapter,i,rate,def_power_value);
				}
			...
			if ( IS_HARDWARE_TYPE_8822C(Adapter)) {
				...
				config_phydm_write_txagc_ref_8822c((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATEVHTSS2MCS9;rate++){ 	
					config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),0,0,0,0,rate);
					set_current_tx_agc(Adapter,i,rate,def_power_value);
				}
			...
			if ( IS_HARDWARE_TYPE_8812F(Adapter)) {
				if(Adapter->pmib->dot11RFEntry.tssi_enable)
						def_power_value = halrf_get_tssi_codeword_for_txindex((&(Adapter->pshare->_dmODM)));
				config_phydm_write_txagc_ref_8812f((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATEVHTSS2MCS9;rate++){ 	
					config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),0,0,0,0,rate);
					set_current_tx_agc(Adapter,i,rate,def_power_value);
				}
			...
			if ( IS_HARDWARE_TYPE_8814B(Adapter)) {
				if(Adapter->pmib->dot11RFEntry.tssi_enable)
						def_power_value = halrf_get_tssi_codeword_for_txindex((&(Adapter->pshare->_dmODM)));
				config_phydm_write_txagc_ref_8814b((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_OFDM);
				for (rate=ODM_RATE6M; rate<=ODM_RATEVHTSS4MCS9;rate++){ 	
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),0,rate);
					set_current_tx_agc(Adapter,i,rate,def_power_value);
				}
			} else 
#endif
			...
			if ( IS_HARDWARE_TYPE_8197G(Adapter)) {
				if(Adapter->pmib->dot11RFEntry.tssi_enable)
						def_power_value = halrf_get_tssi_codeword_for_txindex((&(Adapter->pshare->_dmODM)));
				config_phydm_write_txagc_ref_8197g((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATEMCS15;rate++){ 	
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),0,rate);
					set_current_tx_agc(Adapter,i,rate,def_power_value);
				}
...
{
	u1Byte tmp_TPI = 0;
	u1Byte pwr_40_1s = 0, ch_idx_ht40 = 0, ch_idx_vht80 = 0;
    ...
    u1Byte i;
#if (IS_RTL8822C_SERIES) || (IS_RTL8812F_SERIES) ||  (IS_RTL8814B_SERIES)
	 u1Byte rate;
#endif
...
#endif
#if defined(CONFIG_WLAN_HAL_8814BE)
	s1Byte HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_X[4] = {HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_A(ch_idx), HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_B(ch_idx), HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_C(ch_idx), HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_D(ch_idx)};		
	s1Byte HAL_VAR_pwrdiff_5G_80BW4S_160BW4S_X[4] = {HAL_VAR_pwrdiff_5G_80BW4S_160BW4S_A(ch_idx), HAL_VAR_pwrdiff_5G_80BW4S_160BW4S_B(ch_idx), HAL_VAR_pwrdiff_5G_80BW4S_160BW4S_C(ch_idx), HAL_VAR_pwrdiff_5G_80BW4S_160BW4S_D(ch_idx)};		
#endif
#if CFG_HAL_POWER_PERCENT_ADJUSTMENT
	signed char pwrdiff_percent = HAL_PwrPercent2PwrLevel(Adapter->pmib->dot11RFEntry.power_percent);
#endif
    if (GetChipIDMIMO88XX(Adapter) == RF_4T4R) {
        bPathXEn[0] = 1;
        bPathXEn[1] = 1;
        bPathXEn[2] = 1;
        bPathXEn[3] = 1;
    ...
    else if (GetChipIDMIMO88XX(Adapter) == RF_1T1R) {
        bPathXEn[0] = 1;
        bPathXEn[1] = 0;
        bPathXEn[2] = 0;
        bPathXEn[3] = 0;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if(bPathXEn[i]) {
            ...
            if (( IS_HARDWARE_TYPE_8814A(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE))||
				...
				( IS_HARDWARE_TYPE_8821C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE))){
                PHYSetTxPower88XX(Adapter, TX_AGC_OFDM_6M, TX_AGC_OFDM_54M, i, tmp_TPI);
            } else
#endif
#if (IS_RTL8822C_SERIES)
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			config_phydm_write_txagc_ref_8822c((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
				
			for (rate=ODM_RATE6M; rate<=ODM_RATE54M; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_ofdm_1t,diff_ofdm_1t,diff_ofdm_1t,diff_ofdm_1t,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_ofdm_1t);
			}
		}else
#endif
#if (IS_RTL8812F_SERIES)
		if ( IS_HARDWARE_TYPE_8812F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			if(Adapter->pmib->dot11RFEntry.tssi_enable){
					diff_ofdm_1t= 0;
				}
			config_phydm_write_txagc_ref_8812f((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
				
			for (rate=ODM_RATE6M; rate<=ODM_RATE54M; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_ofdm_1t,diff_ofdm_1t,diff_ofdm_1t,diff_ofdm_1t,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_ofdm_1t);
			}
		}else
#endif
#if (IS_RTL8814B_SERIES)
			if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
				if(Adapter->pmib->dot11RFEntry.tssi_enable){					
						diff_ofdm_1t= 0;
					}
				config_phydm_write_txagc_ref_8814b((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATE54M; rate++){
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_ofdm_1t,rate);
					set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_ofdm_1t);
				}
			}else
#endif
	...
	if (HAL_VAR_CurrentChannelBW == 0) {
		...
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s);
			}
			for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s);
		...
		if ( IS_HARDWARE_TYPE_8812F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s);
			}
			for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,diff_bw20_1s,rate);
			...
			if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
				...
				for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s,rate);
					set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s);
				}
				for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
					phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s,rate);
		...
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s);
			}
			for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s);
		...
		if ( IS_HARDWARE_TYPE_8812F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s);
			}
			for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,diff_bw20_1s + diff_bw20_2s,rate);
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s);
					}
					for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,rate);
		...
		if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS16; rate<=ODM_RATEMCS23; rate++){
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s);
			}
			for (rate=ODM_RATEVHTSS3MCS0; rate<=ODM_RATEVHTSS3MCS9; rate++){
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s);
...
#if defined(CONFIG_WLAN_HAL_8814BE)
		//PATH i, BW20-4S
		diff_bw20_4s = (HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_X[i] & 0x0f);
		diff_bw20_4s = convert_diff_88XX_AC(diff_bw20_4s);
		//tmp_TPI = pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s;
		...
		if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS24; rate<=ODM_RATEMCS31; rate++){
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s);
			}
			for (rate=ODM_RATEVHTSS4MCS0; rate<=ODM_RATEVHTSS4MCS9; rate++){
				phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s);
	...
	//3 40M
		...
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),0,0,0,0,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s);
			}
			for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),0,0,0,0,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s);
		...
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s);
			}
			for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s);
		...
		if ( IS_HARDWARE_TYPE_8812F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s);
			}
			for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,diff_bw40_2s,rate);
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw40_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s);
					}
					for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw40_2s,rate);
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS16; rate<=ODM_RATEMCS23; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s + diff_bw40_3s);
					}
					for (rate=ODM_RATEVHTSS3MCS0; rate<=ODM_RATEVHTSS3MCS9; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s + diff_bw40_3s);
...
#if defined(CONFIG_WLAN_HAL_8814BE)
				//PATH i, BW40-4S
				diff_bw40_4s = ((HAL_VAR_pwrdiff_5G_40BW4S_20BW4S_X[i] & 0xf0) >> 4);
				diff_bw40_4s = convert_diff_88XX_AC(diff_bw40_4s);
				//tmp_TPI = pwr_40_1s + diff_bw40_2s + diff_bw40_3s + diff_bw40_4s;
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS24; rate<=ODM_RATEMCS31;rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s + diff_bw40_4s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s + diff_bw40_3s + diff_bw40_4s);
					}
					for (rate=ODM_RATEVHTSS4MCS0; rate<=ODM_RATEVHTSS4MCS9;rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s + diff_bw40_4s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s + diff_bw40_3s + diff_bw40_4s);
	...
	//3 80M
	else if (HAL_VAR_CurrentChannelBW == 2 || HAL_VAR_CurrentChannelBW == 4) {
		...
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			config_phydm_write_txagc_ref_8822c((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
			for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
				phydm_write_txagc_1byte_8822c((&(Adapter->pshare->_dmODM)),diff_bw80_1s,rate);
				set_current_tx_agc(Adapter,i,rate,tmp_TPI);
			}
			for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
				phydm_write_txagc_1byte_8822c((&(Adapter->pshare->_dmODM)),diff_bw80_1s,rate);
				set_current_tx_agc(Adapter,i,rate,tmp_TPI);
		...
		if ( IS_HARDWARE_TYPE_8812F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			config_phydm_write_txagc_ref_8812f((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
			for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
				phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),diff_bw80_1s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s);
			}
			for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
				phydm_write_txagc_1byte_8812f((&(Adapter->pshare->_dmODM)),diff_bw80_1s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s);
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					config_phydm_write_txagc_ref_8814b((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
					for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s);
					}
					for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s,rate);
		...
		if ( IS_HARDWARE_TYPE_8822C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,rate);
				set_current_tx_agc(Adapter,i,rate,tmp_TPI);
			}
			for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
				config_phydm_write_txagc_diff_8822c((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,rate);
		...
		if ( IS_HARDWARE_TYPE_8812F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
			...
			for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s);
			}
			for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
				config_phydm_write_txagc_diff_8812f((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,diff_bw80_1s + diff_bw80_2s,rate);
				set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s);
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s);
					}
					for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s,rate);
			   ...
			   if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
				   ...
				   for (rate=ODM_RATEMCS16; rate<=ODM_RATEMCS23; rate++){
					   phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s + diff_bw80_3s,rate);
					   set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s +diff_bw80_3s);
				   }
				   for (rate=ODM_RATEVHTSS3MCS0; rate<=ODM_RATEVHTSS3MCS9; rate++){
					   phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s + diff_bw80_3s,rate);
					   set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s +diff_bw80_3s);
...
#endif
               {
...
#if defined(CONFIG_WLAN_HAL_8814BE)
				//PATH i, BW40-4S
				diff_bw80_4s = ((HAL_VAR_pwrdiff_5G_80BW4S_160BW4S_X[i] & 0xf0) >> 4);
				diff_bw80_4s = convert_diff_88XX_AC(diff_bw80_4s);
				tmp_TPI = pwr_40_1s + diff_bw80_1s + diff_bw80_2s + diff_bw80_3s + diff_bw80_4s;
				...
				if ( IS_HARDWARE_TYPE_8814B(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS24; rate<=ODM_RATEMCS31;rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s + diff_bw80_3s + diff_bw80_4s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s + diff_bw80_3s + diff_bw80_4s);
					}
					for (rate=ODM_RATEVHTSS4MCS0; rate<=ODM_RATEVHTSS4MCS9;rate++){
						phydm_write_txagc_1byte_8814b((&(Adapter->pshare->_dmODM)),diff_bw80_1s + diff_bw80_2s + diff_bw80_3s + diff_bw80_4s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw80_1s + diff_bw80_2s + diff_bw80_3s + diff_bw80_4s);
...
)
{
	...
	u1Byte pwrdiffHT20 = HAL_VAR_pwrdiffHT20(ch_idx);
	u1Byte pwrdiffOFDM = HAL_VAR_pwrdiffOFDM(ch_idx);
...
#if defined(CONFIG_WLAN_HAL_8198F)
	 s1Byte HAL_VAR_pwrdiff_40BW4S_20BW4S_X[4] = {HAL_VAR_pwrdiff_40BW4S_20BW4S_A(ch_idx), HAL_VAR_pwrdiff_40BW4S_20BW4S_B(ch_idx), 
		HAL_VAR_pwrdiff_40BW4S_20BW4S_C(ch_idx), HAL_VAR_pwrdiff_40BW4S_20BW4S_D(ch_idx)
		};  
#endif
#endif
#if CFG_HAL_POWER_PERCENT_ADJUSTMENT
...
#endif
#if (IS_RTL8198F_SERIES)
			if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
				config_phydm_write_txagc_ref_8198f((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATE54M; rate++){
					phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_ofdm_1t,rate);
					set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_ofdm_1t);
				}
			}else
#endif
#if (IS_RTL8197G_SERIES)
			if ( IS_HARDWARE_TYPE_8197G(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
				diff_ofdm_1t = (pwrdiffOFDM & 0x0f);
				diff_ofdm_1t = convert_diff_88XX_AC(diff_ofdm_1t);
				if(Adapter->pmib->dot11RFEntry.tssi_enable){
						diff_ofdm_1t= 0;
					}
				config_phydm_write_txagc_ref_8197g((&(Adapter->pshare->_dmODM)),pwr_40_1s,i,PDM_OFDM);
				
				for (rate=ODM_RATE6M; rate<=ODM_RATE54M; rate++){
					phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),diff_ofdm_1t,rate);
					set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_ofdm_1t);
				}
			}else
#endif
        ...
        for (i = 0; i < 4; i++) {
            if(bPathXEn[i]) {   
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s);
					}
					for (rate=ODM_RATEVHTSS1MCS0; rate<=ODM_RATEVHTSS1MCS9; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s,rate);
...
#if (IS_RTL8197G_SERIES)
				if ( IS_HARDWARE_TYPE_8197G(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					diff_bw20_1s = ((pwrdiffHT20 & 0xf0) >> 4);
					diff_bw20_1s = convert_diff_88XX_AC(diff_bw20_1s);
					if(Adapter->pmib->dot11RFEntry.tssi_enable){
							diff_bw20_1s= 0;
						}
					...
					for (rate=ODM_RATEMCS0; rate<=ODM_RATEMCS7; rate++){
						phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),diff_bw20_1s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s);
					}
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s);
					}
					for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,rate);
				...
				if ( IS_HARDWARE_TYPE_8197G(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					diff_bw20_2s = (pwrdiffHT40_2S & 0x0f);
					diff_bw20_2s = convert_diff_88XX_AC(diff_bw20_2s);
					if(Adapter->pmib->dot11RFEntry.tssi_enable){
							diff_bw20_1s= 0;
							diff_bw20_2s= 0;
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s);
					}
               ...
               if ( IS_HARDWARE_TYPE_8814A(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) {
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS16; rate<=ODM_RATEMCS23; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s);
					}
					for (rate=ODM_RATEVHTSS3MCS0; rate<=ODM_RATEVHTSS3MCS9; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s,rate);
...
#if defined(CONFIG_WLAN_HAL_8198F)
				//PATH i, BW20-4S
				diff_bw20_4s = (HAL_VAR_pwrdiff_40BW4S_20BW4S_X[i] & 0x0f);
				diff_bw20_4s = convert_diff_88XX_AC(diff_bw20_4s);
				//tmp_TPI = pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s;
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS24; rate<=ODM_RATEMCS31; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s);
					}
					for (rate=ODM_RATEVHTSS4MCS0; rate<=ODM_RATEVHTSS4MCS9; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw20_1s + diff_bw20_2s + diff_bw20_3s + diff_bw20_4s,rate);
        ...
        for (i = 0; i < 4; i++) {
            if(bPathXEn[i]) {
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw40_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s);
					}
					for (rate=ODM_RATEVHTSS2MCS0; rate<=ODM_RATEVHTSS2MCS9; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw40_2s,rate);
				...
				if ( IS_HARDWARE_TYPE_8197G(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					diff_bw40_2s = ((pwrdiffHT40_2S & 0xf0) >> 4);
					diff_bw40_2s = convert_diff_88XX_AC(diff_bw40_2s);
					if(Adapter->pmib->dot11RFEntry.tssi_enable){
							diff_bw40_2s = 0;
						}
					...
					for (rate=ODM_RATEMCS8; rate<=ODM_RATEMCS15; rate++){
						phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),diff_bw40_2s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s);
					}
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS16; rate<=ODM_RATEMCS23; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s + diff_bw40_3s);
					}
					for (rate=ODM_RATEVHTSS3MCS0; rate<=ODM_RATEVHTSS3MCS9; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s,rate);
...
#if defined(CONFIG_WLAN_HAL_8198F)
				//PATH i, BW40-4S
				diff_bw40_4s = ((HAL_VAR_pwrdiff_40BW4S_20BW4S_X[i] & 0xf0) >> 4);
				diff_bw40_4s = convert_diff_88XX_AC(diff_bw40_4s);
				//tmp_TPI = pwr_40_1s + diff_bw40_2s + diff_bw40_3s + diff_bw40_4s;
				...
				if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)){
					...
					for (rate=ODM_RATEMCS24; rate<=ODM_RATEMCS31;rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s + diff_bw40_4s,rate);
						set_current_tx_agc(Adapter,i,rate,pwr_40_1s + diff_bw40_2s + diff_bw40_3s + diff_bw40_4s);
					}
					for (rate=ODM_RATEVHTSS4MCS0; rate<=ODM_RATEVHTSS4MCS9;rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),diff_bw40_2s + diff_bw40_3s + diff_bw40_4s,rate);
...
)
{
                ...
                if ((IS_HARDWARE_TYPE_8821C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE))) {
			return;                
                } 
#endif
...
)
{
...
#if CFG_HAL_POWER_PERCENT_ADJUSTMENT
    pwrdiff_percent = HAL_PwrPercent2PwrLevel(HAL_VAR_power_percent);
#endif
	...
	for(path=start;path<=end;path++){
		...
		for(rate=TX_AGC_CCK_1M;rate<=TX_AGC_CCK_11M;rate++){
			//printk("CurrentTxAgcCCK[%d][%d]=%x + %x = ",path,rate,Adapter->pshare->phw->CurrentTxAgcCCK[path][rate],(unsigned char)*(pTxAgcOffset+rate));
			Adapter->pshare->phw->CurrentTxAgcCCK[path][rate] += (unsigned char)*(pTxAgcOffset+rate);
			Adapter->pshare->phw->CurrentTxAgcCCK[path][rate] = HAL_POWER_RANGE_CHECK(Adapter->pshare->phw->CurrentTxAgcCCK[path][rate]+pwrdiff_percent);
...
)
{
	...
	for(path=start;path<=end;path++){
		...
		for(rate=TX_AGC_OFDM_6M;rate<=TX_AGC_OFDM_54M;rate++){
			//printk("CurrentTxAgcOFDM[%d][%d]=%x + %x = ",path,rate-TX_AGC_OFDM_6M,Adapter->pshare->phw->CurrentTxAgcOFDM[path][rate-TX_AGC_OFDM_6M],(unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M));
			Adapter->pshare->phw->CurrentTxAgcOFDM[path][rate-TX_AGC_OFDM_6M] += (unsigned char)*(pTxAgcOffset+rate-TX_AGC_OFDM_6M);
			Adapter->pshare->phw->CurrentTxAgcOFDM[path][rate-TX_AGC_OFDM_6M] = HAL_POWER_RANGE_CHECK(Adapter->pshare->phw->CurrentTxAgcOFDM[path][rate-TX_AGC_OFDM_6M]+pwrdiff_percent);
	...
	for(path=start;path<=end;path++){
		...
		for(rate=TX_AGC_HT_NSS1_MCS0;rate<=TX_AGC_HT_NSS3_MCS23;rate++){
			//printk("CurrentTxAgcMCS[%d][%d]=%x + %x = ",path,rate-TX_AGC_HT_NSS1_MCS0,Adapter->pshare->phw->CurrentTxAgcMCS[path][rate-TX_AGC_HT_NSS1_MCS0],(unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0));
			Adapter->pshare->phw->CurrentTxAgcMCS[path][rate-TX_AGC_HT_NSS1_MCS0] += (unsigned char)*(pTxAgcOffset+rate-TX_AGC_HT_NSS1_MCS0);
			Adapter->pshare->phw->CurrentTxAgcMCS[path][rate-TX_AGC_HT_NSS1_MCS0] = HAL_POWER_RANGE_CHECK(Adapter->pshare->phw->CurrentTxAgcMCS[path][rate-TX_AGC_HT_NSS1_MCS0]+pwrdiff_percent);
	...
	for(path=start;path<=end;path++){
		...
		for(rate=TX_AGC_VHT_NSS1_MCS0;rate<=TX_AGC_VHT_NSS3_MCS9;rate++){
			...
			if( rate == TX_AGC_VHT_NSS1_MCS8 || rate == TX_AGC_VHT_NSS1_MCS9 \
				...
				Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0] += (unsigned char)*(pTxAgcOffset+rate-TX_AGC_VHT_NSS1_MCS0);
			Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0] = HAL_POWER_RANGE_CHECK(Adapter->pshare->phw->CurrentTxAgcVHT[path][rate-TX_AGC_VHT_NSS1_MCS0]+pwrdiff_percent);
...
)
{
    ...
    u1Byte HAL_VAR_pwrlevelCCK_X[4] = {HAL_VAR_pwrlevelCCK_A(channel - 1), HAL_VAR_pwrlevelCCK_B(channel - 1), 			
		...
		u1Byte HAL_VAR_pwrlevelHT40_1S_X[4] = {HAL_VAR_pwrlevelHT40_1S_A(channel - 1), HAL_VAR_pwrlevelHT40_1S_B(channel - 1), 
		HAL_VAR_pwrlevelHT40_1S_C(channel - 1), HAL_VAR_pwrlevelHT40_1S_D(channel - 1)
		};

#if IS_RTL8198F_SERIES || IS_RTL8197G_SERIES
	if ( (IS_HARDWARE_TYPE_8198F(Adapter) || IS_HARDWARE_TYPE_8197G(Adapter)) && (IS_HAL_TEST_CHIP(Adapter)==FALSE))
		def_power_value = 100; //0~127
#endif

#ifdef HIGH_POWER_EXT_PA		
	if (Adapter->pshare->rf_ft_var.use_ext_pa)
		def_power_value = 0x12;
#endif	
    ...
    if (GetChipIDMIMO88XX(Adapter) == RF_1T1R) {
...
#if IS_RTL8814A_SERIES || IS_RTL8821C_SERIES
            if ( (IS_HARDWARE_TYPE_8814A(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) ||
                 (IS_HARDWARE_TYPE_8821C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) ) {
        ...
        bPathXEn[2] = 0;
        bPathXEn[3] = 0;
        if ( ((HAL_VAR_pwrlevelCCK_A(ch_idx) == 0) || (HAL_VAR_pwrlevelCCK_B(ch_idx) == 0)) && (Adapter->pmib->dot11RFEntry.tssi_enable == 0) ) {
			...
			if ( IS_HARDWARE_TYPE_8197G(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) {
				...
				for (i=RF_PATH_A; i<=RF_PATH_B;i++){		
					config_phydm_write_txagc_ref_8197g((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_CCK);					
					for (rate=ODM_RATE1M; rate<=ODM_RATE11M; rate++){
						phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),0,rate);
						set_current_tx_agc(Adapter,i,rate,def_power_value);
					}
        ...
        if ((HAL_VAR_pwrlevelCCK_A(ch_idx) == 0)||(HAL_VAR_pwrlevelCCK_B(ch_idx) == 0)		
			...
			if ( IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) {
				for (i=RF_PATH_A; i<RF_PATH_MAX;i++){		
					config_phydm_write_txagc_ref_8198f((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_CCK);					
					for (rate=ODM_RATE1M; rate<=ODM_RATE11M; rate++){
						phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),0,rate);
						set_current_tx_agc(Adapter,i,rate,def_power_value);
					}
	...
	if (phy_band == PHY_BAND_2G) {
        ...
        for(i = 0; i < 4; i++) {
            ...
            if(bPathXEn[i]) {
#if IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES	
                if ( ((IS_HARDWARE_TYPE_8814A(Adapter)|| IS_HARDWARE_TYPE_8822B(Adapter)) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) ||
                     (IS_HARDWARE_TYPE_8821C(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE)) ) {
				...
				if ( (IS_HARDWARE_TYPE_8198F(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE))) {
						...
						config_phydm_write_txagc_ref_8198f((&(Adapter->pshare->_dmODM)),HAL_VAR_pwrlevelCCK_X[i]?HAL_VAR_pwrlevelCCK_X[i]:0x12,i,PDM_CCK);					
						for (rate=ODM_RATE1M; rate<=ODM_RATE11M; rate++){
							phydm_write_txagc_1byte_8198f((&(Adapter->pshare->_dmODM)),0,rate);
							set_current_tx_agc(Adapter,i,rate,HAL_VAR_pwrlevelCCK_X[i]?HAL_VAR_pwrlevelCCK_X[i]:0x12);
						}
				...
				if ( (IS_HARDWARE_TYPE_8197G(Adapter) && (IS_HAL_TEST_CHIP(Adapter)==FALSE))) {
						if(Adapter->pmib->dot11RFEntry.tssi_enable){
							if ((HAL_VAR_pwrlevelHT40_1S_A(ch_idx)== 0)||(HAL_VAR_pwrlevelHT40_1S_B(ch_idx) == 0))
								...
								def_power_value = HAL_VAR_pwrlevelHT40_1S_X[i];
							config_phydm_write_txagc_ref_8197g((&(Adapter->pshare->_dmODM)),def_power_value,i,PDM_CCK);	
						}else
							config_phydm_write_txagc_ref_8197g((&(Adapter->pshare->_dmODM)),HAL_VAR_pwrlevelCCK_X[i]?HAL_VAR_pwrlevelCCK_X[i]:0x12,i,PDM_CCK);			
						for (rate=ODM_RATE1M; rate<=ODM_RATE11M; rate++){
							phydm_write_txagc_1byte_8197g((&(Adapter->pshare->_dmODM)),0,rate);
							if(Adapter->pmib->dot11RFEntry.tssi_enable)
							set_current_tx_agc(Adapter,i,rate,def_power_value);
...
#if IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES	
		if(IS_HARDWARE_TYPE_8814A(Adapter) || IS_HARDWARE_TYPE_8822B(Adapter) || IS_HARDWARE_TYPE_8821C(Adapter)){
			TxPG_CCK_8814(Adapter);
		}else
#endif
#if IS_RTL8198F_SERIES || IS_RTL8197G_SERIES	
		if(IS_HARDWARE_TYPE_8198F(Adapter) || IS_HARDWARE_TYPE_8197G(Adapter)){
			TxPG_CCK_NEW(Adapter);			
		}else
#endif
...
)
{
	...
	if (Adapter->pmib->dot11RFEntry.tssi_enable) {
#if IS_RTL8198F_SERIES || IS_RTL8814B_SERIES || IS_RTL8822C_SERIES || IS_RTL8812F_SERIES || IS_RTL8197G_SERIES
		if(IS_HARDWARE_TYPE_8198F(Adapter)||IS_HARDWARE_TYPE_8814B(Adapter)||IS_HARDWARE_TYPE_8822C(Adapter)||IS_HARDWARE_TYPE_8812F(Adapter)||IS_HARDWARE_TYPE_8197G(Adapter)){
			TxPG_OFDM_NEW(Adapter);
#ifdef TXPWR_LMT
			if (!Adapter->pshare->rf_ft_var.disable_txpwrlmt) {
				if (HAL_check_lmt_valid(Adapter, phy_band)) {					
					TxLMT_OFDM_Jaguar_NEW(Adapter);
				}
			}
#endif
		}
...
#endif			
#if IS_RTL8198F_SERIES || IS_RTL8814B_SERIES || IS_RTL8812F_SERIES || IS_RTL8197G_SERIES
			if(IS_HARDWARE_TYPE_8198F(Adapter)||IS_HARDWARE_TYPE_8814B(Adapter)||IS_HARDWARE_TYPE_8812F(Adapter)||IS_HARDWARE_TYPE_8197G(Adapter))
				TxLMT_OFDM_Jaguar_NEW(Adapter);
			else
#endif	
...
)
{
	...
	if(IS_HARDWARE_TYPE_8822C(Adapter)) {
		HAL_SAVE_INT_AND_CLI(flags);
		config_phydm_write_rf_reg_8822c((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data);
		HAL_RESTORE_INT(flags);
		delay_us(2);
		return;
	}
	...
	if(IS_HARDWARE_TYPE_8812F(Adapter)) {
		HAL_SAVE_INT_AND_CLI(flags);
		config_phydm_write_rf_reg_8812f((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data);
		HAL_RESTORE_INT(flags);
		//check rf reg 0x18, if not the same, write again
		if(RegAddr == 0x18 && ((BitMask & (BIT8|BIT16)) == (BIT8|BIT16))){
			delay_us(6);
			for(i = 0; i < 2; i++){
				data_after = config_phydm_read_rf_reg_8812f((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask);
				if(data_after != (Data & BitMask)){
					HAL_SAVE_INT_AND_CLI(flags);
					config_phydm_write_rf_reg_8812f((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data);
					HAL_RESTORE_INT(flags);
					delay_us(6);
	...
	if(IS_HARDWARE_TYPE_8821C(Adapter)) {
		HAL_SAVE_INT_AND_CLI(flags);
		config_phydm_write_rf_reg_8821c((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data);
		HAL_RESTORE_INT(flags);
		return;
	}
#endif
        ...
        if(IS_HARDWARE_TYPE_8814BE(Adapter)) {
            HAL_SAVE_INT_AND_CLI(flags);
            config_phydm_write_rf_reg_8814b((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data); //yllin8814B
            HAL_RESTORE_INT(flags);
            return;
        }
#endif
...
)
{
	...
	return;
        ...
        if(IS_HARDWARE_TYPE_8814BE(Adapter)) {
            HAL_SAVE_INT_AND_CLI(flags);
            //config_phydm_write_rf_reg_8814b((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data); //yllin8814B
            config_phydm_write_rf_syn_8814b((&(Adapter->pshare->_dmODM)), eRFPath, RegAddr, BitMask, Data);
            HAL_RESTORE_INT(flags);
            return;
        }
#endif
...
{
	int bandwidth_odm = CHANNEL_WIDTH_20;

	switch (bandwidth) {
		case CHANNEL_WIDTH_5:
			bandwidth_odm = CHANNEL_WIDTH_5;
			break;
		case CHANNEL_WIDTH_10:
			bandwidth_odm = CHANNEL_WIDTH_10;
			break;
		case CHANNEL_WIDTH_20:
			bandwidth_odm = CHANNEL_WIDTH_20;
			break;
		case CHANNEL_WIDTH_40:
			bandwidth_odm = CHANNEL_WIDTH_40;
			break;
		case CHANNEL_WIDTH_80:
			bandwidth_odm = CHANNEL_WIDTH_80;
			break;
		case CHANNEL_WIDTH_160:
			bandwidth_odm = CHANNEL_WIDTH_160;
			break;
		case CHANNEL_WIDTH_80_80:
			bandwidth_odm = CHANNEL_WIDTH_80_80;
			break;
	}
...
)
{
	...
	u1Byte dataSC = 0;
	u1Byte SCSettingOf80 = 0;
	u1Byte SCSettingOf40 = 0;
	u1Byte SCSettingOf20 = 0;
    u1Byte Current_band;
    u1Byte channel,channel2;
	...
	if(IS_HARDWARE_TYPE_8814B(Adapter)) {
		...
		//dataSC = ( SCSettingOf20 | (SCSettingOf40 << 4) | (SCSettingOf80 << 8)); 
		...
		HAL_RTL_W8(0x487, SCSettingOf80);
		
#if 0		
		if(Adapter->pshare->CurrentChannelBW == CHANNEL_WIDTH_80_80){
			if(Adapter->pmib->dot11RFEntry.dot11channel<Adapter->pmib->dot11RFEntry.dot11channel2){
				channel = Adapter->pmib->dot11RFEntry.dot11channel;
				channel2 =  Adapter->pmib->dot11RFEntry.dot11channel2;
			}else{
				channel = Adapter->pmib->dot11RFEntry.dot11channel2;
				channel2 =  Adapter->pmib->dot11RFEntry.dot11channel;
			}
			config_phydm_ch_80p80_8814b((&(Adapter->pshare->_dmODM)), channel, channel2, SCSettingOf20);
		}else	
#endif
			config_phydm_switch_bw_8814b((&(Adapter->pshare->_dmODM)), SCSettingOf20, bandwidth_odm);
...
#endif
		//else
			//config_phydm_trx_mode_8822b((&(Adapter->pshare->_dmODM)), (BB_PATH_A|BB_PATH_B), (BB_PATH_A|BB_PATH_B), Adapter->pmib->dot11RFEntry.tx2path);
...
#if CFG_HAL_MP_TEST
		if(Adapter->pshare->rf_ft_var.mp_specific)
			config_phydm_trx_mode_8822c((&(Adapter->pshare->_dmODM)), Adapter->pshare->mp_antenna_tx, Adapter->pshare->mp_antenna_rx, 0);
#endif
		//else
			//config_phydm_trx_mode_8822c((&(Adapter->pshare->_dmODM)), (BB_PATH_A|BB_PATH_B), (BB_PATH_A|BB_PATH_B), Adapter->pmib->dot11RFEntry.tx2path);
			
		config_phydm_switch_bandwidth_8822c((&(Adapter->pshare->_dmODM)), SCSettingOf20, bandwidth_odm);
...
#if CFG_HAL_MP_TEST
		if(Adapter->pshare->rf_ft_var.mp_specific)
			config_phydm_trx_mode_8812f((&(Adapter->pshare->_dmODM)), Adapter->pshare->mp_antenna_tx, Adapter->pshare->mp_antenna_rx, 0);
#endif
		//else
			//config_phydm_trx_mode_8812f((&(Adapter->pshare->_dmODM)), (BB_PATH_A|BB_PATH_B), (BB_PATH_A|BB_PATH_B), Adapter->pmib->dot11RFEntry.tx2path);
			
		config_phydm_switch_bandwidth_8812f((&(Adapter->pshare->_dmODM)), SCSettingOf20, bandwidth_odm);
...
#if CFG_HAL_MP_TEST
		if(Adapter->pshare->rf_ft_var.mp_specific)
			config_phydm_trx_mode_8821c((&(Adapter->pshare->_dmODM)), Adapter->pshare->mp_antenna_tx, Adapter->pshare->mp_antenna_rx, 0);
		else
#endif			
			config_phydm_trx_mode_8821c((&(Adapter->pshare->_dmODM)), (BB_PATH_A|BB_PATH_B), (BB_PATH_A|BB_PATH_B), 0);
			
		config_phydm_switch_bandwidth_8821c((&(Adapter->pshare->_dmODM)), SCSettingOf20, bandwidth_odm);
    ...
    if (IS_HARDWARE_TYPE_8814A(Adapter) && !IS_HAL_TEST_CHIP(Adapter)){
        unsigned int rfPathA = phy_query_rf_reg(Adapter, RF88XX_PATH_A, 0x1c, 0xffffffff, 1);
...
)
{
	...
	if (channel <= 14) {
       ...
       if ((GET_CHIP_VER(Adapter) == VERSION_8814A)||(GET_CHIP_VER(Adapter) == VERSION_8814B)) {
	...
	// set channel number
	curMaxRFPath = get_curMaxRFPath(Adapter) ? get_curMaxRFPath(Adapter) : RF88XX_PATH_MAX;
	...
	if (HAL_VAR_CURRENTCHANNELBW == CHANNEL_WIDTH_80) {
		if (channel <= 48)
			val = 42;
		else if (channel <= 64)
			val = 58;
			...
			val = 171;
	} else if (HAL_VAR_CURRENTCHANNELBW == CHANNEL_WIDTH_40) {
		if (offset == 1)
			val -= 2;
		else
			val += 2;
	...
	)
{
	...
	MAC_REG_520 = phy_query_bb_reg( Adapter, 0x520, BIT_MASK_SET_MASKDWORD_COMMON);
	BB_REG_8FC = phy_query_bb_reg( Adapter, 0x8fc, BIT_MASK_SET_MASKDWORD_COMMON);
	BB_REG_808 = phy_query_bb_reg( Adapter, 0x808, BIT_MASK_SET_MASKDWORD_COMMON);
	phy_set_bb_reg(Adapter, 0x520, BIT_MASK_SET_MASKBYTE2_COMMON, 0x3f);

	//1 Step 2. Backup RXIQC & RXIQC = 0
	
	for(Search_index = 0; Search_index<4; Search_index++){
	    RXIQC[Search_index] = phy_query_bb_reg( Adapter, RXIQC_REG[0][Search_index], BIT_MASK_SET_MASKDWORD_COMMON);
        phy_set_bb_reg(Adapter, RXIQC_REG[0][Search_index], BIT_MASK_SET_MASKDWORD_COMMON, 0x0);
        phy_set_bb_reg(Adapter, RXIQC_REG[1][Search_index], BIT_MASK_SET_MASKDWORD_COMMON, 0x0);
	}
	...
	phy_set_bb_reg(Adapter, 0x8fc, BIT_MASK_SET_MASKDWORD_COMMON, 0x0);
	while(MAC_Active){
		MAC_Active = phy_query_bb_reg( Adapter, 0xfa0, BIT_MASK_SET_MASKDWORD_COMMON) & (0x803e0008);
		Search_index++;
	...
	phy_set_bb_reg(Adapter, 0x808, BIT_MASK_SET_MASKBYTE0_COMMON, 0x11);
	...
	phy_set_bb_reg(Adapter, 0xc60, BIT_MASK_SET_MASKDWORD_COMMON, 0x15800002);      //0xc60       0x15808002    
	phy_set_bb_reg(Adapter, 0xc60, BIT_MASK_SET_MASKDWORD_COMMON, 0x01808003);      //0xc60       0x01808003
	phy_set_bb_reg(Adapter, 0xe60, BIT_MASK_SET_MASKDWORD_COMMON, 0x15800002);      //0xe60      0x15808002    
	phy_set_bb_reg(Adapter, 0xe60, BIT_MASK_SET_MASKDWORD_COMMON, 0x01808003);      //0xe60      0x01808003    
	phy_set_bb_reg(Adapter, 0x1860, BIT_MASK_SET_MASKDWORD_COMMON, 0x15800002);    //0x1860    0x15808002    
	phy_set_bb_reg(Adapter, 0x1860, BIT_MASK_SET_MASKDWORD_COMMON, 0x01808003);    //0x1860    0x01808003    
	phy_set_bb_reg(Adapter, 0x1a60, BIT_MASK_SET_MASKDWORD_COMMON, 0x15800002);    //0x1a60    0x15808002        
	phy_set_bb_reg(Adapter, 0x1a60, BIT_MASK_SET_MASKDWORD_COMMON, 0x01808003);    //0x1a60    0x01808003    
	phy_set_bb_reg(Adapter, 0x764, BIT(10), 0x0);
	phy_set_bb_reg(Adapter, 0x804, BIT(2), 0x0);
	phy_set_bb_reg(Adapter, 0xc5c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D080058);     //0xc5c       0x00080058  // [19] =1 to turn off ADC  
	phy_set_bb_reg(Adapter, 0xe5c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D080058);    //0xe5c       0x00080058  // [19] =1 to turn off ADC     
	phy_set_bb_reg(Adapter, 0x185c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D080058);  //0x185c     0x00080058 // [19] =1 to turn off ADC    
	phy_set_bb_reg(Adapter, 0x1a5c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D080058);  //0x1a5c     0x00080058 // [19] =1 to turn off ADC       
	// power_on/clk_off 

	//phy_set_bb_reg(Adapter, 0x764, BIT(10), 0x1);

	phy_set_bb_reg(Adapter, 0xc5c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D000058);     //0xc5c       0x0D000058   // [19] =0 to turn on ADC    
	phy_set_bb_reg(Adapter, 0xe5c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D000058);    //0xe5c       0x0D000058  // [19] =0 to turn on ADC     
	phy_set_bb_reg(Adapter, 0x185c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D000058);  //0x185c     0x0D000058  // [19] =0 to turn on ADC     
	phy_set_bb_reg(Adapter, 0x1a5c, BIT_MASK_SET_MASKDWORD_COMMON,  0x0D000058);  //0x1a5c     0x0D000058 // [19] =0 to turn on ADC       

	// power_on/clk_on @ anapar_state=BT mode

	phy_set_bb_reg(Adapter, 0xc60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);      //0xc60 0x05808002 
	phy_set_bb_reg(Adapter, 0xe60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);      //0xe60 0x05808002           
	phy_set_bb_reg(Adapter, 0x1860, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);    //0x1860 0x05808002    
	phy_set_bb_reg(Adapter, 0x1a60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);    //0x1a60 0x05808002            
	phy_set_bb_reg(Adapter, 0x764, BIT(10), 0x1);
	phy_set_bb_reg(Adapter, 0x804, BIT(2), 0x1);
	// recover original setting @ anapar_state=BT mode                              
	phy_set_bb_reg(Adapter, 0xc60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);      //0xc60       0x05808036    
	phy_set_bb_reg(Adapter, 0xe60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);      //0xe60      0x05808036    
	phy_set_bb_reg(Adapter, 0x1860, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);    //0x1860    0x05808036    
	phy_set_bb_reg(Adapter, 0x1a60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05808032);    //0x1a60    0x05808036        
	phy_set_bb_reg(Adapter, 0xc60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05800002);      //0xc60       0x05800002    
	phy_set_bb_reg(Adapter, 0xc60, BIT_MASK_SET_MASKDWORD_COMMON, 0x07808003);      //0xc60       0x07808003
	phy_set_bb_reg(Adapter, 0xe60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05800002);      //0xe60      0x05800002    
	phy_set_bb_reg(Adapter, 0xe60, BIT_MASK_SET_MASKDWORD_COMMON, 0x07808003);      //0xe60      0x07808003    
	phy_set_bb_reg(Adapter, 0x1860, BIT_MASK_SET_MASKDWORD_COMMON, 0x05800002);    //0x1860    0x05800002    
	phy_set_bb_reg(Adapter, 0x1860, BIT_MASK_SET_MASKDWORD_COMMON, 0x07808003);    //0x1860    0x07808003    
	phy_set_bb_reg(Adapter, 0x1a60, BIT_MASK_SET_MASKDWORD_COMMON, 0x05800002);    //0x1a60    0x05800002        
	phy_set_bb_reg(Adapter, 0x1a60, BIT_MASK_SET_MASKDWORD_COMMON, 0x07808003);    //0x1a60    0x07808003     
	...
	phy_set_bb_reg(Adapter, 0x520, BIT_MASK_SET_MASKDWORD_COMMON, MAC_REG_520);
	phy_set_bb_reg(Adapter, 0x8fc, BIT_MASK_SET_MASKDWORD_COMMON, BB_REG_8FC);
	phy_set_bb_reg(Adapter, 0x808, BIT_MASK_SET_MASKDWORD_COMMON, BB_REG_808);
	for(Search_index = 0; Search_index<4; Search_index++){
        phy_set_bb_reg(Adapter, RXIQC_REG[0][Search_index], BIT_MASK_SET_MASKDWORD_COMMON, RXIQC[Search_index]);
        phy_set_bb_reg(Adapter, RXIQC_REG[1][Search_index], BIT_MASK_SET_MASKDWORD_COMMON, 0x01000000);
	}
	...
	if (Band == RF88XX_BAND_ON_2_4G) { // 2.4G band
		...
		if (GET_CHIP_VER(Adapter) == VERSION_8881A) {
			...
			if (Adapter->pshare->rf_ft_var.use_ext_pa && Adapter->pshare->rf_ft_var.use_ext_lna) {
				...
				case 10:
				case 11:
					panic_printk("TRSWITCH: RFE TYPE 2 or 4 or 8 or 10 or 11\n");
					PHY_SetBBReg_88XX(Adapter, 0x1994, 0xf, 0xf); // (ANTSW/ANTSWB controlled by S3)
					PHY_SetBBReg_88XX(Adapter, REG_GPIO_MUXCFG, 0x00f00000, 0xf); // (S3 RFE output enable) , 0x40[23:20]
...
)
{
	...
	if(IS_HARDWARE_TYPE_8822C(Adapter)) {
		...
		//eric-8822 ?? what shall MAC do during swchnl??
		config_phydm_switch_band_8822c((&(Adapter->pshare->_dmODM)), val);
		config_phydm_switch_channel_8822c((&(Adapter->pshare->_dmODM)), val);
		return;
	}
#endif
	...
	if(IS_HARDWARE_TYPE_8812F(Adapter)) {
		...
		//eric-8822 ?? what shall MAC do during swchnl??
		config_phydm_switch_band_8812f((&(Adapter->pshare->_dmODM)), val);
		config_phydm_switch_channel_8812f((&(Adapter->pshare->_dmODM)), val);
		return;
	}
#endif
	...
	if(IS_HARDWARE_TYPE_8821C(Adapter)) {
		...
		//eric-8822 ?? what shall MAC do during swchnl??
		config_phydm_switch_band_8821c((&(Adapter->pshare->_dmODM)), val);
		config_phydm_switch_channel_8821c((&(Adapter->pshare->_dmODM)), val);
		return;
	}
#endif
		...
		if(IS_HARDWARE_TYPE_8198F(Adapter)) {
			...
			if (HAL_VAR_CURRENTCHANNELBW == CHANNEL_WIDTH_40) {
				if (offset == 1)
					val -= 2;
				else
					val += 2;
			...
			//charlie
			config_phydm_switch_channel_8198f((&(Adapter->pshare->_dmODM)), val);
			return;
		}
#endif
			...
			if(IS_HARDWARE_TYPE_8814B(Adapter)) {
				...
				config_phydm_switch_band_8814b((&(Adapter->pshare->_dmODM)), val);
				config_phydm_switch_channel_8814b((&(Adapter->pshare->_dmODM)), val);
				return;
			}
#endif
...
#if (IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8822C_SERIES || IS_RTL8821C_SERIES || IS_RTL8198F_SERIES || IS_RTL8814B_SERIES || IS_RTL8812F_SERIES || IS_RTL8197G_SERIES)
...
)
{
	...
	if(IS_HARDWARE_TYPE_8822B(Adapter)) {
		for (i = txRateStart; i <= txRateEnd; i++) {
			...
			set_current_tx_agc(Adapter,tx_path_idx,i,def_power);
		}
		return;
	}
#endif
	...
	if(IS_HARDWARE_TYPE_8821C(Adapter)) {
		for (i = txRateStart; i <= txRateEnd; i++) {
			phydm_write_txagc_1byte_8821c((&(Adapter->pshare->_dmODM)), defPower, txPathIdx, i);
			set_current_tx_agc(Adapter,tx_path_idx,i,def_power);
		}
		return;
	}
...
#if (RTL8822C_SUPPORT == 1)  
	if(IS_HARDWARE_TYPE_8822C(Adapter)) {
		config_phydm_write_txagc_ref_8822c((&(Adapter->pshare->_dmODM)), defPower, txPathIdx, PDM_CCK);
		config_phydm_write_txagc_ref_8822c((&(Adapter->pshare->_dmODM)), defPower, txPathIdx, PDM_OFDM);
		set_current_tx_agc(Adapter,tx_path_idx,i,def_power);
		return;
	}
#endif
...
#if (RTL8812F_SUPPORT == 1)  
		if(IS_HARDWARE_TYPE_8812F(Adapter)) {	
			config_phydm_write_txagc_ref_8812f((&(Adapter->pshare->_dmODM)), defPower, txPathIdx, PDM_CCK);
			config_phydm_write_txagc_ref_8812f((&(Adapter->pshare->_dmODM)), defPower, txPathIdx, PDM_OFDM);
			for (i = txRateStart; i <= txRateEnd; i++) {
				set_current_tx_agc(Adapter,tx_path_idx,i,def_power);
			}
			return;
    ...
    for (i = txRateStart; i <= txRateEnd; i++) {
		...
		set_current_tx_agc(Adapter,tx_path_idx,i,def_power); /* Path, Rate, Power */
    }
}
#endif
...
)
{
	...
	if (eRFPath == RF88XX_PATH_A) {
		...
		if (REG_VALUE_32K == tmplong2)
			return (REG_VALUE_32K & BIT_MASK_SET_MASKDWORD_COMMON);
#endif
...
#ifdef CONFIG_POWER_SAVE
		if ((REG_VALUE_32K & BIT_MASK_SET_MASK20BITS_COMMON) == Original_Value) {
			printk("[%s] error!! ignore cmd due to 32K(addr=0x%x)\n", __func__, RegAddr);
			dump_stack();
...
)
{
	...
	if ((HAL_VAR_CurrentChannelBW == CHANNEL_WIDTH_20) || is_coexist) {
    ...
    // cal HT rate diff
	base = pwrlevelHT40_1S_A;
	if (HAL_VAR_CurrentChannelBW == CHANNEL_WIDTH_20) {
...
printk92E(IN  HAL_PADAPTER    Adapter)
{
	...
	printk("RF TRX_BW RF PathB 0x18=%x \n", phy_query_rf_reg(Adapter, 1, 0x18, 0xffffffff, 1));
...
)
{
	...
	if(IS_HARDWARE_TYPE_8197G(Adapter)) {
		...
		//charlie
		config_phydm_switch_channel_8197g((&(Adapter->pshare->_dmODM)), val);
...
)
{
	...
	case CHANNEL_WIDTH_20:
		...
		if (GET_CHIP_VER(Adapter) == VERSION_8192F)
			PHY_SetBBReg_88XX(Adapter, 0x948, BIT8, 0x1);
#endif
...
#ifdef CONFIG_WLAN_HAL_8192FE
		if (GET_CHIP_VER(Adapter) == VERSION_8192F) {
			PHY_SetBBReg_88XX(Adapter, 0x948, BIT8, 0x0);
			val = 2;
		}
		else
#endif
...
)
{
	...
	if (ThermalValue != HAL_VAR_THERMALVALUE) {
		...
		if (HAL_VAR_PHYBANDSELECT == PHY_BAND_2G) {
			...
			RT_TRACE(COMP_POWER_TRACKING, DBG_LOUD, ("ofdm_swing_table_92e[(unsigned int)OFDM_index[0]] = %x \n", ofdm_swing_table_92e[(unsigned int)OFDM_index[0]]));
			RT_TRACE(COMP_POWER_TRACKING, DBG_LOUD, ("ofdm_swing_table_92e[(unsigned int)OFDM_index[1]] = %x \n", ofdm_swing_table_92e[(unsigned int)OFDM_index[1]]));
			...
			if (X != 0) {
				...
				phy_set_bb_reg(Adapter, REG_BB_OFDM0_XATXIQIMBALANC_N, BIT_MASK_SET_MASKDWORD_COMMON, value32);

				value32 = (ele_C & 0x000003C0) >> 6;
				phy_set_bb_reg(Adapter, REG_BB_OFDM0_XCTXAFE_N, BIT_MASK_SET_MASKH4BITS_COMMON, value32);

				value32 = ((X * ele_D) >> 7) & 0x01;
				phy_set_bb_reg(Adapter, REG_BB_OFDM0_ECCATHRESHOLD_N, BIT(24), value32);

			} else {
				phy_set_bb_reg(Adapter, REG_BB_OFDM0_XATXIQIMBALANC_N, BIT_MASK_SET_MASKDWORD_COMMON, ofdm_swing_table_92e[(unsigned int)OFDM_index[0]]);
				phy_set_bb_reg(Adapter, REG_BB_OFDM0_XCTXAFE_N, BIT_MASK_SET_MASKH4BITS_COMMON, 0x00);
				phy_set_bb_reg(Adapter, REG_BB_OFDM0_ECCATHRESHOLD_N, BIT(24), 0x00);
			}
			...
			if (rf == 2) {
				...
				if (X != 0) {
					...
					value32 = (ele_D << 22) | ((ele_C & 0x3F) << 16) | ele_A;
					phy_set_bb_reg(Adapter, REG_BB_OFDM0_XBTXIQIMBALANCE_N, BIT_MASK_SET_MASKDWORD_COMMON, value32);

					value32 = (ele_C & 0x000003C0) >> 6;
					phy_set_bb_reg(Adapter, REG_BB_OFDM0_XDTXAFE_N, BIT_MASK_SET_MASKH4BITS_COMMON, value32);

					value32 = ((X * ele_D) >> 7) & 0x01;
					phy_set_bb_reg(Adapter, REG_BB_OFDM0_ECCATHRESHOLD_N, BIT(28), value32);

				} else {
					phy_set_bb_reg(Adapter, REG_BB_OFDM0_XBTXIQIMBALANCE_N, BIT_MASK_SET_MASKDWORD_COMMON, ofdm_swing_table_92e[(unsigned int)OFDM_index[1]]);
					phy_set_bb_reg(Adapter, REG_BB_OFDM0_XDTXAFE_N, BIT_MASK_SET_MASKH4BITS_COMMON, 0x00);
					phy_set_bb_reg(Adapter, REG_BB_OFDM0_ECCATHRESHOLD_N, BIT(28), 0x00);
				}
			...
			if (delta > 3) {
				...
				if (priv->pshare->rf_ft_var.mp_specific) {
					if ((OPMODE & WIFI_MP_CTX_BACKGROUND) && !(OPMODE & WIFI_MP_CTX_PACKET))
						...
						phy_iq_calibrate_8192e(&(priv->pshare->_dmODM), false);
				} else
#endif
					phy_iq_calibrate_8192e(&(priv->pshare->_dmODM), false);
			}
...
)
{
	...
	if (channel != 14) {
		HAL_RTL_W8( 0xa22, cck_swing_table_ch1_ch13_92e[CCK_index][0]);
		HAL_RTL_W8( 0xa23, cck_swing_table_ch1_ch13_92e[CCK_index][1]);
		HAL_RTL_W8( 0xa24, cck_swing_table_ch1_ch13_92e[CCK_index][2]);
		HAL_RTL_W8( 0xa25, cck_swing_table_ch1_ch13_92e[CCK_index][3]);
		HAL_RTL_W8( 0xa26, cck_swing_table_ch1_ch13_92e[CCK_index][4]);
		HAL_RTL_W8( 0xa27, cck_swing_table_ch1_ch13_92e[CCK_index][5]);
		HAL_RTL_W8( 0xa28, cck_swing_table_ch1_ch13_92e[CCK_index][6]);
		HAL_RTL_W8( 0xa29, cck_swing_table_ch1_ch13_92e[CCK_index][7]);
	} else {
		HAL_RTL_W8( 0xa22, cck_swing_table_ch14_92e[CCK_index][0]);
		HAL_RTL_W8( 0xa23, cck_swing_table_ch14_92e[CCK_index][1]);
		HAL_RTL_W8( 0xa24, cck_swing_table_ch14_92e[CCK_index][2]);
		HAL_RTL_W8( 0xa25, cck_swing_table_ch14_92e[CCK_index][3]);
		HAL_RTL_W8( 0xa26, cck_swing_table_ch14_92e[CCK_index][4]);
		HAL_RTL_W8( 0xa27, cck_swing_table_ch14_92e[CCK_index][5]);
		HAL_RTL_W8( 0xa28, cck_swing_table_ch14_92e[CCK_index][6]);
		HAL_RTL_W8( 0xa29, cck_swing_table_ch14_92e[CCK_index][7]);
	}
