...
//#if defined(CONFIG_VW_REFINE) || defined(CONFIG_ONE_TXQ)
	...
	RTW_PHL_STATUS_RES_FULL,     /* 15 */
//#endif
	#ifdef CONFIG_RTW_HW_RX_AMSDU_CUT
	RTW_PHL_STATUS_FRAME_ENQ,
	#endif /* CONFIG_RTW_HW_RX_AMSDU_CUT */
};
#define is_cmd_enqueue(psts)	((psts == RTW_PHL_STATUS_CMD_SUCCESS) || \
				 (psts == RTW_PHL_STATUS_CMD_TIMEOUT) || \
				 (psts == RTW_PHL_STATUS_CMD_ERROR) || \
				 (psts == RTW_PHL_STATUS_CMD_DROP) || \
				 (psts == RTW_PHL_STATUS_CMD_CANNOT_IO))

#define is_cmd_failure(psts)	((psts) != RTW_PHL_STATUS_SUCCESS && (psts) != RTW_PHL_STATUS_CMD_SUCCESS)
