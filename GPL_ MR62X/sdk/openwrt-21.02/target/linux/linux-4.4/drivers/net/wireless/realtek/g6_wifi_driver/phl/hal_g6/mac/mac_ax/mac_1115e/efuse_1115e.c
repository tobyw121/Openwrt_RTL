...
u32 switch_efuse_bank_1115e(struct mac_ax_adapter *adapter,
...
void enable_efuse_sw_pwr_cut_1115e(struct mac_ax_adapter *adapter,
				   bool is_write)
{
	u16 val16;
	u8 val8;
...
void disable_efuse_sw_pwr_cut_1115e(struct mac_ax_adapter *adapter,
				    bool is_write)
{
	u16 value16;
	u8 value8;
