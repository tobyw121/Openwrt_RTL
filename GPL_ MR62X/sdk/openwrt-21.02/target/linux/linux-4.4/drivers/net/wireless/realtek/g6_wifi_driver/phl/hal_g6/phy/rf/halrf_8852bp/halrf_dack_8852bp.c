...
void halrf_afe_init_8852bp(struct rf_info *rf)
{
...
void halrf_dack_init_8852bp(struct rf_info *rf)
{
}

void halrf_drck_8852bp(struct rf_info *rf)
{
	u32 c;
	u32 rck_d;
...
void halrf_addck_backup_8852bp(struct rf_info *rf)
{
...
void halrf_addck_reload_8852bp(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	/*S0*/
...
void halrf_dack_backup_s0_8852bp(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	u8 i;
//	u32 temp;
...
void halrf_dack_backup_s1_8852bp(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	u8 i;
//	u32 temp;
...
void halrf_dack_reload_by_path_8852bp(struct rf_info *rf, enum rf_path path)
{
	struct halrf_dack_info *dack = &rf->dack;
	u8 i;
	u32 oft;
...
void halrf_dack_reload_8852bp(struct rf_info *rf, enum rf_path path)
{
	u32 oft;
	...
	halrf_dack_reload_by_path_8852bp(rf, path);
	halrf_wreg(rf, 0xc004 + oft, 0x3, 0x0);
	halrf_wreg(rf, 0xc024 + oft, 0x3, 0x0);
}

void halrf_check_addc_8852bp(struct rf_info *rf, enum rf_path path)
{
...
void halrf_addck_8852bp(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	u32 c;
	/*S0*/
	...
	halrf_check_addc_8852bp(rf, RF_PATH_A);
	/*average 128 times*/
//	halrf_wreg(rf, 0xc0f4, BIT(7) | BIT(6), 0x3);
	...
	halrf_check_addc_8852bp(rf, RF_PATH_B);
	/*average 128 times*/
...
void halrf_check_dadc_8852bp(struct rf_info *rf, enum rf_path path)
{
	halrf_wreg(rf, 0x032c, BIT(30), 0x0);
	halrf_wreg(rf, 0x030c, 0x0f000000, 0xf);
	halrf_wreg(rf, 0x030c, 0x0f000000, 0x3);
	...
	halrf_check_addc_8852bp(rf, path);
	if (path == RF_PATH_A) {
...
void halrf_dack_8852bp_s0(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	u32 c = 0;
...
//	halrf_check_dadc_8852bp(rf, RF_PATH_A);

	/*backup here*/
	halrf_dack_backup_s0_8852bp(rf);
//	halrf_dack_reload_8852bp(rf, RF_PATH_A);
	/*step 17*/
	halrf_wreg(rf, 0x12b8, BIT(30), 0x0);
}

void halrf_dack_8852bp_s1(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	u32 c = 0;
...
//	halrf_wreg(rf, 0xc124, BIT(31) | BIT(30), 0x0);
	...
	halrf_check_dadc_8852bp(rf, RF_PATH_B);
	/*backup here*/
	halrf_dack_backup_s1_8852bp(rf);
//	halrf_dack_reload_8852bp(rf, RF_PATH_B);
	/*step 17*/
	halrf_wreg(rf, 0x32b8, BIT(30), 0x0);
}

void halrf_dack_8852bp(struct rf_info *rf)
{
	halrf_dack_8852bp_s0(rf);
	halrf_dack_8852bp_s1(rf);
}

void halrf_dack_dump_8852bp(struct rf_info *rf)
{
	struct halrf_dack_info *dack = &rf->dack;
	u8 i;
	u8 t;
...
void halrf_dac_cal_8852bp(struct rf_info *rf, bool force)
{
	struct halrf_dack_info *dack = &rf->dack;
	u32 rf0_0, rf1_0;
	u8 phy_map;
...
#if 1	
	halrf_afe_init_8852bp(rf);
	halrf_drck_8852bp(rf);
...
//	halrf_btc_rfk_ntfy(rf, phy_map, RF_BTC_DACK, RFK_ONESHOT_START);
	halrf_addck_8852bp(rf);
//	halrf_btc_rfk_ntfy(rf, phy_map, RF_BTC_DACK, RFK_ONESHOT_STOP);
	halrf_addck_backup_8852bp(rf);
	halrf_addck_reload_8852bp(rf);
...
//	halrf_btc_rfk_ntfy(rf, phy_map, RF_BTC_DACK, RFK_ONESHOT_START);
	halrf_dack_8852bp(rf);
//	halrf_btc_rfk_ntfy(rf, phy_map, RF_BTC_DACK, RFK_ONESHOT_STOP);
	halrf_dack_dump_8852bp(rf);
	dack->dack_done = true;
