...
enum halrf_ic {
	...
	RF_RTL8851B	=	BIT(9),
	RF_RTL8922A	=	BIT(10),
	RF_RTL8832CRVU	=	BIT(11),	
	RF_RTL8832BRVT	=	BIT(12),
};
...
#define RF_AX_2SS		(RF_RTL8852A | RF_RTL8852B | RF_RTL8852C |\
				 RF_RTL8832BR | RF_RTL8192XB | RF_RTL8852BP | RF_RTL8832CRVU | RF_RTL8832BRVT)
#define RF_AX_3SS		0
...
#define KPATH 4
       ...
       defined(RF_8832CRVU_SUPPORT) || defined(RF_8832BRVT_SUPPORT) )
#define KPATH 2
#else
#define KPATH 1
#endif
