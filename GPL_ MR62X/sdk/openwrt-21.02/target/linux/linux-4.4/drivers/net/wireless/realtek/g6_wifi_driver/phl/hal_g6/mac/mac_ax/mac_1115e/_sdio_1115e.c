...
u32 get_sdio_rx_req_len_1115e(struct mac_ax_adapter *adapter, u32 *rx_req_len)
{
	...
	val32 = PLTFM_SDIO_CMD53_R32(R_BE_SDIO_RX_REQ_LEN);
	*rx_req_len = GET_FIELD(val32, B_BE_RX_REQ_LEN);
...
void w_indir_cmd53_sdio_1115e(struct mac_ax_adapter *adapter, u32 adr,
