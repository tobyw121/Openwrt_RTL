...
void halbb_cfg_rf_reg_8192xb(struct bb_info *bb, u32 addr, u32 data,
			     enum rf_path rf_path, u32 reg_addr)
{
}

void halbb_cfg_rf_radio_a_8192xb(struct bb_info *bb, u32 addr, u32 data)
{
}

void halbb_cfg_rf_radio_b_8192xb(struct bb_info *bb, u32 addr, u32 data)
{
}

void halbb_cfg_bb_phy_8192xb(struct bb_info *bb, u32 addr, u32 data,
...
void halbb_cfg_bb_gain_8192xb(struct bb_info *bb, u32 addr, u32 data)
{
