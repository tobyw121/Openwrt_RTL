...
#include "../h2c_agg.h"
#include "../mac_priv.h"
#include "mac_priv_8192xb.h"
#include "trx_desc_8192xb.h"
#include "../dbcc.h"
#include "../beacon.h"
#include "coex_8192xb.h"
#include "phy_rpt_8192xb.h"
#include "hwamsdu_8192xb.h"
#include "hdr_conv_rx_8192xb.h"
...
#if MAC_AX_SDIO_SUPPORT
static struct mac_ax_intf_ops mac8192xb_sdio_ops = {
	...
	sdio_pre_init_8192xb, /* intf_pre_init */
	sdio_init, /* intf_init */
...
#if MAC_AX_USB_SUPPORT
static struct mac_ax_intf_ops mac8192xb_usb_ops = {
	reg_read8_usb_8192xb, /* reg_read8 */
	reg_write8_usb_8192xb, /* reg_write8 */
	reg_read16_usb_8192xb, /* reg_read16 */
	reg_write16_usb_8192xb, /* reg_write16 */
	reg_read32_usb_8192xb, /* reg_read32 */
	reg_write32_usb_8192xb, /* reg_write32 */
	NULL, /* tx_allow_sdio */
	NULL, /* tx_cmd_addr_sdio */
	usb_pre_init_8192xb, /* intf_pre_init */
	usb_init_8192xb, /* intf_init */
	usb_deinit_8192xb, /* intf_deinit */
	NULL, /* reg_read_n_sdio */
	get_bulkout_id_8192xb, /*get_bulkout_id*/
	ltr_set_usb, /* ltr_set_pcie */
	u2u3_switch_8192xb, /*u2u3_switch*/
	get_usb_mode, /*get_usb_mode*/
	get_usb_support_ability_8192xb,/*get_usb_support_ability*/
	usb_tx_agg_cfg_8192xb, /*usb_tx_agg_cfg*/
	usb_rx_agg_cfg_8192xb, /*usb_rx_agg_cfg*/
	set_usb_wowlan_8192xb, /*set_wowlan*/
	...
	usb_get_txagg_num_8192xb, /*get_txagg_num*/
	...
	usb_get_rx_state_8192xb, /*get_usb_rx_state*/
...
#if MAC_AX_PCIE_SUPPORT
static struct mac_ax_intf_ops mac8192xb_pcie_ops = {
	...
	ctrl_txdma_ch_pcie_8192xb, /*ctrl_txdma_ch*/
	clr_idx_all_pcie, /*clr_idx_all*/
	poll_txdma_ch_idle_pcie_8192xb, /*poll_txdma_ch_idle*/
	poll_rxdma_ch_idle_pcie_8192xb, /*poll_rxdma_ch_idle*/
	ctrl_txhci_pcie, /*ctrl_txhci*/
	ctrl_rxhci_pcie, /*ctrl_rxhci*/
	ctrl_dma_io_pcie, /*ctrl_dma_io*/
	get_io_stat_pcie_8192xb, /* get_io_stat */
	pcie_get_txagg_num, /*get_txagg_num*/
	get_avail_txbd_8192xb, /*get_avail_txbd*/
	get_avail_rxbd_8192xb, /*get_avail_rxbd*/
...
static struct mac_ax_ops mac8192xb_ops = {
	NULL, /* intf_ops */
	/*System level*/
	...
	mac_get_macaddr,
	mac_build_txdesc_8192xb, /* build_txdesc */
	mac_refill_txdesc_8192xb, /* refill_txdesc */
	mac_parse_rxdesc_8192xb, /* parse_rxdesc */
	...
	mac_dump_efuse_ofld,
	mac_efuse_ofld_map,
	mac_upd_dctl_info_8192xb, /* update dmac ctrl info */
	mac_upd_cctl_info_8192xb, /* update cmac ctrl info */
	...
	mac_sta_add_key_8192xb, /* add station key */
	mac_sta_del_key_8192xb, /* del station key */
	mac_sta_search_key_idx, /* search station key index */
	mac_sta_hw_security_support, /* control hw security support */
	mac_sta_keycam_backup_8192xb, /* sta keycam backup restore control */
	mac_set_mu_table, /*set mu score table*/
	mac_ss_dl_grp_upd_8192xb, /* update SS dl group info*/
	...
	/*TRX related*/
	mac_txdesc_len_8192xb, /* txdesc_len */
	...
	mac_enable_cut_hwamsdu_8192xb, /* enable_cut_hwamsdu */
	mac_cut_hwamsdu_chk_mpdu_len_en_8192xb, /* enable cut-amsdu chk mpdu size*/
	...
	mac_hdr_conv_rx_en_8192xb, /* enable rx mac hdr conversion*/
	mac_hdr_conv_rx_en_driv_info_hdr_8192xb, /*en rx hdr conv driver info*/
	...
	mac_is_txq_empty_8192xb, /*is_txq_empty*/
	mac_is_rxq_empty_8192xb, /*is_rxq_empty*/
	...
	mac_patch_rx_rate_8192xb, /*for patch rx rate*/
	mac_get_wp_offset_8192xb, /* wd offload for wp_offset, called while forming metadata */
	/*frame exchange related*/
	mac_upd_mudecision_para, /* upd_ba_infotbl */
	mac_mu_sta_upd, /* upd_mu_sta */
	mac_upd_ul_fixinfo, /* upd_ul_fixinfo */
	NULL,
	mac_f2p_test_cmd_8192xb, /*f2p test cmd para*/
	...
	mac_pinmux_set_func_8192xb, /* pinmux_set_func */
	mac_pinmux_free_func, /* pinmux_free_func */
	mac_sel_uart_tx_pin, /* sel_uart_tx_pin */
	mac_sel_uart_rx_pin, /* sel_uart_rx_pin */
	mac_gpio_init_8192xb, /* gpio_init */
	mac_set_gpio_func_8192xb, /* set_gpio_func */
	...
	mac_coex_init_8192xb, /* coex_init */
	mac_read_coex_reg_8192xb, /* coex_read */
	mac_write_coex_reg_8192xb, /* coex_write */
	...
	mac_cfg_per_pkt_phy_rpt_8192xb, /* cfg_per_pkt_phy_rpt */
#if MAC_AX_FEATURE_DBGPKG
...
static struct mac_ax_hw_info mac8192xb_hw_info = {
	0, /* done */
	MAC_AX_CHIP_ID_8192XB, /* chip_id */
	0xFF, /* cv */
	0, /* acv */
	0xFF, /* fv */
	...
	pwr_on_seq_8192xb, /* pwr_on_seq */
	pwr_off_seq_8192xb, /* pwr_off_seq */
	PWR_SEQ_VER_8192XB, /* pwr_seq_ver */
	458752, /* fifo_size */
...
struct mac_ax_ft_status mac_8192xb_ft_status[] = {
	{MAC_AX_FT_DUMP_EFUSE, MAC_AX_STATUS_IDLE, NULL, 0},
	{MAC_AX_FT_MAX, MAC_AX_STATUS_ERR, NULL, 0},
};

static struct mac_ax_adapter mac_8192xb_adapter = {
	&mac8192xb_ops, /* ops */
	NULL, /* drv_adapter */
	NULL, /* phl_adapter */
	NULL, /* pltfm_cb */
...
struct mac_ax_adapter *get_mac_8192xb_adapter(enum mac_ax_intf intf,
					      ...
					      struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	hal_mem_cpy(drv_adapter, adapter, &mac_8192xb_adapter,
		    sizeof(struct mac_ax_adapter));
	...
	case MAC_AX_INTF_SDIO:
		adapter->ops->intf_ops = &mac8192xb_sdio_ops;
		pwr_info->intf_pwr_switch = sdio_pwr_switch;
		break;
#endif
#if MAC_AX_USB_SUPPORT
	case MAC_AX_INTF_USB:
		adapter->ops->intf_ops = &mac8192xb_usb_ops;
		pwr_info->intf_pwr_switch = usb_pwr_switch;
		break;
#endif
#if MAC_AX_PCIE_SUPPORT
	case MAC_AX_INTF_PCIE:
		adapter->ops->intf_ops = &mac8192xb_pcie_ops;
					      ...
					      struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	pltfm_cb->rtl_memcpy(drv_adapter, adapter, &mac_8192xb_adapter,
		     sizeof(struct mac_ax_adapter));
	...
	pltfm_cb->rtl_memcpy(drv_adapter, hw_info, &mac8192xb_hw_info,
		sizeof(struct mac_ax_hw_info));
	...
	p = get_priv(adapter);
	*p = get_mac_8192xb_priv_ops(intf);
...
u32 dmac_func_en_8192xb(struct mac_ax_adapter *adapter)
{
...
u32 dmac_func_pre_en_8192xb(struct mac_ax_adapter *adapter)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32;
