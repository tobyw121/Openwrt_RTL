...
static struct mac_ax_dbg_port_info dbg_port_cmac_dma2_c0 = {
	R_AX_RX_CTRL2,
	MAC_AX_BYTE_SEL_4,
	B_AX_RX_DBG_SEL_SH,
	B_AX_RX_DBG_SEL_MSK,
	...
	R_AX_RX_DEBUG_OUT,
	MAC_AX_BYTE_SEL_4,
	B_AX_RXDMA_DBG_OUT_SH,
	B_AX_RXDMA_DBG_OUT_MSK
};

static struct mac_ax_dbg_port_info dbg_port_cmac_dma2_c1 = {
	R_AX_RX_CTRL2_C1,
	MAC_AX_BYTE_SEL_4,
	B_AX_RX_DBG_SEL_SH,
	B_AX_RX_DBG_SEL_MSK,
		       ...
		       struct mac_ax_dbg_port_info **info, u32 sel)
{
	...
	case MAC_AX_DBG_PORT_SEL_CMAC_DMA2_C0:
		*info = &dbg_port_cmac_dma2_c0;
		PLTFM_MSG_ALWAYS("Enable CMAC DMA C0 dbgport: 0xc810[24:19].\n");
		val32 = MAC_REG_R32(R_AX_DBG_CTRL);
		val32 = SET_CLR_WORD(val32, CMAC_DMA_DBG_SEL_C0, B_AX_DBG_SEL0);
		val32 = SET_CLR_WORD(val32, CMAC_DMA_DBG_SEL_C0, B_AX_DBG_SEL1);
		MAC_REG_W32(R_AX_DBG_CTRL, val32);
		val32 = MAC_REG_R32(R_AX_TXDMA_DBG);
		val32 = val32 | B_AX_TXDMA_DBG_EN;
		MAC_REG_W32(R_AX_TXDMA_DBG, val32);
		val32 = MAC_REG_R32(R_AX_RXDMA_CTRL_0);
		val32 = val32 | B_AX_RXDMA_DBGOUT_EN;
		MAC_REG_W32(R_AX_RXDMA_CTRL_0, val32);
		break;
	case MAC_AX_DBG_PORT_SEL_CMAC_DMA2_C1:
		*info = &dbg_port_cmac_dma2_c1;
		val32 = MAC_REG_R32(R_AX_DBG_CTRL);
		val32 = SET_CLR_WORD(val32, CMAC_DMA_DBG_SEL_C1, B_AX_DBG_SEL0);
		val32 = SET_CLR_WORD(val32, CMAC_DMA_DBG_SEL_C1, B_AX_DBG_SEL1);
		MAC_REG_W32(R_AX_DBG_CTRL, val32);
		val32 = MAC_REG_R32(R_AX_TXDMA_DBG_C1);
		val32 = val32 | B_AX_TXDMA_DBG_EN;
		MAC_REG_W32(R_AX_TXDMA_DBG_C1, val32);
		val32 = MAC_REG_R32(R_AX_RXDMA_CTRL_0_C1);
		val32 = val32 | B_AX_RXDMA_DBGOUT_EN;
		MAC_REG_W32(R_AX_RXDMA_CTRL_0_C1, val32);
		PLTFM_MSG_ALWAYS("Enable CMAC DMA C1 dbgport: 0xe810[24:19].\n");
		break;
	default:
