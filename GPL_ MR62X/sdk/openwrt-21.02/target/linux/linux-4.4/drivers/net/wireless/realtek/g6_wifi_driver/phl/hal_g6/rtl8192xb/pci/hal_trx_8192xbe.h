 ...
 *
 *****************************************************************************/
#ifndef _HAL_TX_8192XBE_H_
#define _HAL_TX_8192XBE_H_

#define MAX_RX_TAG_VALUE 0x1FFF

#define ACH0_QUEUE_IDX_8192XBE 0x0
#define ACH1_QUEUE_IDX_8192XBE 0x1
#define ACH2_QUEUE_IDX_8192XBE 0x2
#define ACH3_QUEUE_IDX_8192XBE 0x3
#define ACH4_QUEUE_IDX_8192XBE 0x4
#define ACH5_QUEUE_IDX_8192XBE 0x5
#define ACH6_QUEUE_IDX_8192XBE 0x6
#define ACH7_QUEUE_IDX_8192XBE 0x7
#define MGQ_B0_QUEUE_IDX_8192XBE 0x8
#define HIQ_B0_QUEUE_IDX_8192XBE 0x9
#define MGQ_B1_QUEUE_IDX_8192XBE 0xa
#define HIQ_B1_QUEUE_IDX_8192XBE 0xb
#define FWCMD_QUEUE_IDX_8192XBE	0xc

#define RX_QUEUE_IDX_8192XBE	0x10
#define RP_QUEUE_IDX_8192XBE	0x11
...
#define TX_DMA_CHANNEL_ENTRY_8192XBE 13
/* RXQ * 1 + RPQ * 1 */
#define RX_DMA_CHANNEL_ENTRY_8192XBE 2
...
/* Addr Info */
#define ADDR_INFO_LEN_WIDTH_8192XBE	(11)
#define MAX_SUB_PKT_SIZE_8192XBE	((u32)BIT(ADDR_INFO_LEN_WIDTH_8192XBE) - 1)
#define SET_ADDR_INFO_LEN(__addr_info, __value) \
	SET_BITS_TO_LE_2BYTE(__addr_info + 0x00, 0, 11, __value)
#define SET_ADDR_INFO_ADDR_HIGH_SEL(__addr_info, __value) \
	SET_BITS_TO_LE_2BYTE(__addr_info + 0x00, 11, 4, __value)
#define SET_ADDR_INFO_LS(__addr_info, __value) \
	SET_BITS_TO_LE_2BYTE(__addr_info + 0x00, 15, 1, __value)
#define SET_ADDR_INFO_ADDR_LOW_LSB(__addr_info, __value) \
	SET_BITS_TO_LE_2BYTE(__addr_info + 0x02, 0, 16, __value)
#define SET_ADDR_INFO_ADDR_LOW_MSB(__addr_info, __value) \
	SET_BITS_TO_LE_2BYTE(__addr_info + 0x04, 0, 16, __value)

/* Addr Info */
#define GET_ADDR_INFO_LEN(__addr_info) \
	LE_BITS_TO_2BYTE(__addr_info + 0x00, 0, 11)
#define GET_ADDR_INFO_ADDR_HIGH_SEL(__addr_info) \
	LE_BITS_TO_2BYTE(__addr_info + 0x00, 11, 4)
#define GET_ADDR_INFO_LS(__addr_info) \
	LE_BITS_TO_2BYTE(__addr_info + 0x00, 15, 1)
#define GET_ADDR_INFO_ADDR_LOW_LSB(__addr_info) \
	LE_BITS_TO_2BYTE(__addr_info + 0x02, 0, 16)
#define GET_ADDR_INFO_ADDR_LOW_MSB(__addr_info) \
	LE_BITS_TO_2BYTE(__addr_info + 0x04, 0, 16)
