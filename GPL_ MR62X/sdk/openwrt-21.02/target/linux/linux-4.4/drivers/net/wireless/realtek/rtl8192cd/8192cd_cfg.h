...
#elif 1 //defined(CONFIG_RTK_MULTI_AP_R3)
#define PRE_ALLOCATED_MMPDU		128
#define PRE_ALLOCATED_BUFSIZE	((1920+128)/4)		// 1920 bytes long should be enough for DPP messages! Declare as unsigned int
#else
