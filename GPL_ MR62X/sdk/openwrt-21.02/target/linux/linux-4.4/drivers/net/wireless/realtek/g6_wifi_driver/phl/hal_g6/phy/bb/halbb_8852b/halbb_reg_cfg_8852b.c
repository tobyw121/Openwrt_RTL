...
void halbb_cfg_bb_gain_8852bp(struct bb_info *bb, u32 addr, u32 data)
{
	struct bb_gain_info *gain = &bb->bb_gain_i;
	u8 cfg_type = (u8)((addr & 0xff000000) >> 24);
	enum bb_band_t band_idx = (enum bb_band_t)((addr & 0xff0000) >> 16);
	...
	if (cfg_type == 0)
		bb->bb_gain_i.gain_chk = true;
	else if (cfg_type == 2)
		bb->bb_gain_i.bypass_gain_chk = true;
	else if (cfg_type ==3)
		bb->bb_gain_i.op1db_chk = true;
}
