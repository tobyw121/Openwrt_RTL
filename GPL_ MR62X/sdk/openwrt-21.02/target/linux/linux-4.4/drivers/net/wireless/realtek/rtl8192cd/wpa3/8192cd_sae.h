...
enum sae_state {
	SAE_NOTHING,	/*initial status*/
	SAE_COMMITTED,
	SAE_CONFIRMED,	/*sent confirm to peer*/
	SAE_ACCEPTED,	/*reveived peer's confirm*/
	SAE_REJECTED,
};
...
struct candidate {
	...
	unsigned long t0;
	unsigned long t1;//for pmk cache expire
...
#define AP_MODE_SUPPORT_GROUP_NUM 3
#endif
