...
static struct iwpriv_arg mib_table[] = {
	...
	{"tx_mode_auto",		INT_T,		0,													_MIB_OFFSET(tx_mode_auto),					_SIZE(registrypriv.wifi_mib.tx_mode_auto),		0,		NULL},
#endif
	...
	{"lifetime",			INT_T,		0,													_MIB_OFFSET(lifetime),						_SIZE(registrypriv.wifi_mib.lifetime),			1000,		core_mib_lifetime},
	...
	{"txbf",				INT_T,		0,													_MIB_OFFSET(txbf),							_SIZE(registrypriv.wifi_mib.txbf),				1,		NULL},
...
#endif
	{"sleep_q_max_num", 	INT_T, 	0,													_MIB_OFFSET(sleep_q_max_num),				_SIZE(registrypriv.wifi_mib.sleep_q_max_num),	2048,		NULL},
	...
	{"dig_opmode",			BYTE_T,		0,													_MIB_OFFSET(dig_opmode),			_SIZE(registrypriv.wifi_mib.dig_opmode),	1	,	core_mib_set_dig_opmode},
	{"res_txreq",			INT_T,		0,	_MIB_OFFSET(res_txreq),	_SIZE(registrypriv.wifi_mib.res_txreq), 		16, 		NULL},/* RESERVE_TXREQ */
};
...
void default_WMM_para_g6(_adapter *padapter)
{
...
void init_WMM_Para_Element_g6(_adapter *padapter, unsigned char *temp, unsigned long len)
{
...
void dynamic_EDCA_para_g6(_adapter *padapter) {
...
int rtw_mib_set(struct net_device *dev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra)
{
	...
	case BYTE_T:
		{
			//byte_val = (unsigned char)_atoi_g6(arg_val, 10);
