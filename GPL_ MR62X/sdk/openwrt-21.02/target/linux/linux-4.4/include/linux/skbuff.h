...
//Try to reduce memory usage, if wifi using txbd
#define RTL_PRIV_DATA_SIZE		0
#endif

#ifndef CONFIG_RTL_CUSTOM_PASSTHRU
#define CONFIG_RTL_CUSTOM_PASSTHRU
#endif
#if defined(CONFIG_RTL_QOS_PATCH)  || defined(CONFIG_RTK_VOIP_QOS)|| defined(CONFIG_RTK_VLAN_WAN_TAG_SUPPORT) ||defined(CONFIG_RTL_HW_QOS_SUPPORT_WLAN) || defined(CONFIG_RTL_NIC_QUEUE) || defined(CONFIG_RTL_CUSTOM_PASSTHRU)||defined(CONFIG_RTL_8021Q_VLAN_SUPPORT_MULTI_PHY_VIR_WAN)
#define	QOS_PATCH_HIGH_QUEUE_PRIO	7
#define	QOS_PATCH_RX_FROM_LOCAL		0xff
#define QOS_PATCH_RX_FROM_WIRELESS      7
#if defined(CONFIG_RTK_VLAN_WAN_TAG_SUPPORT) || defined(CONFIG_RTL_NIC_QUEUE) 
...
#define PKT_TYPE_OFFSET()	offsetof(struct sk_buff, __pkt_type_offset)
	...
	__u8			extra_flag; /* bit for guestnetwork br-filter check by tp */
#endif
...
//#endif
	...
	union {
		...
		__u32		secmark;
#endif
#if defined(CONFIG_RTL_ISP_MULTI_WAN_SUPPORT) || defined(CONFIG_RTL_SUPPORT_SMUX_DEV_TEST) || defined(CONFIG_RTL_ENABLE_OVERSEA_L2_ACCELERATE)
...
/* end of IMPROVE_QOS and CONFIG_NET_SCHED */
	...
	__u32 l2tp_flag;
	struct net_device	*rx_l2tp_dev;
	__u32 pptp_flag;
	struct net_device	*rx_pptp_dev;
#endif
	...
	__u16			srcVlanPriority:3;
        ...
        __u8 vlan_passthrough_saved_tag[4];
#endif
...
#if defined(CONFIG_RTL_819X)
extern void dev_kfree_skb_any2(struct sk_buff *skb);
#endif
...
/*more header room for l2tp/pptp/ipv6 tunnel in fastpath*/
