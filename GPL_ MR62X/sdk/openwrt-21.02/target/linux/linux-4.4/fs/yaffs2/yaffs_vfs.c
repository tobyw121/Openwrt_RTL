						     ...
						     void *data, int silent)
{
	...
	yaffs_trace(YAFFS_TRACE_ALWAYS,
		"yaffs_internal_read_super: Using yaffs%d", yaffs_version);
	yaffs_trace(YAFFS_TRACE_ALWAYS,
		"yaffs_internal_read_super: block size %d", (int)(sb->s_blocksize));
	...
	if (!dev || !context) {
		...
		yaffs_trace(YAFFS_TRACE_ALWAYS,
			"yaffs_internal_read_super: Failed trying to allocate struct yaffs_dev."
		);
		return NULL;
	}
	...
	yaffs_trace(YAFFS_TRACE_OS,
		"yaffs_internal_read_super: guts initialised %s",
	...
	yaffs_trace(YAFFS_TRACE_OS, "yaffs_internal_read_super: got root inode");
	...
	yaffs_trace(YAFFS_TRACE_ALWAYS,
		"yaffs_internal_read_super: is_checkpointed %d",
		dev->is_checkpointed);

	yaffs_trace(YAFFS_TRACE_ALWAYS, "yaffs_internal_read_super: done");
	return sb;
}
