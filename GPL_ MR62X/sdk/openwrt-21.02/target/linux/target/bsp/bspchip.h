...
#define BSP_TC0_IRQ	    (BSP_IRQ_ICTL_BASE + 7)
...
#define BSP_UART0_RBR_8197F       (BSP_UART0_BASE + 0x024)
#define BSP_UART0_THR_8197F       (BSP_UART0_BASE + 0x024)
#define BSP_UART0_RBR_8197F_VG    (BSP_UART0_BASE + 0x000)
#define BSP_UART0_THR_8197F_VG    (BSP_UART0_BASE + 0x000)

extern unsigned int bsp_uart0_rbr, bsp_uart0_thr;
#define BSP_UART0_RBR       (bsp_uart0_rbr)
#define BSP_UART0_THR       (bsp_uart0_thr)
...
#define BSP_ECO_SN              (SYSTEM_REG_BASE + 0x0)
...
/* For wifi GPIO usage */
#define RTK_WIFI_GPIO_0	0
#define RTK_WIFI_GPIO_1	1
#define RTK_WIFI_GPIO_2	2
#define RTK_WIFI_GPIO_6	6
#define RTK_WIFI_GPIO_8	8
