...
#define DROP_BY_PPS 0x1
#define DROP_BY_BPS 0x2
#define RATELIMIT_INDEX_FOR_MCAST 0
#define RATELIMIT_INDEX_FOR_UNKONWN_UNICAST 1
#endif

#if defined(CONFIG_RTL_8197F) && (defined(CONFIG_RTL_8367R_SUPPORT) || defined(CONFIG_RTL_83XX_SUPPORT))
/*	for RTL819X+RTL8367R/RTL83XX series, only port0 and port6 of RTL819X are used.
	enlarge FC threshold for performace under RTL819X+RTL8367R/RTL83XX series.	*/
#define CONFIG_RTL_FC_THRES_REFINE_FOR_PERFORMANCE 1
#endif
...
enum PORT_NUM
{
    ...
    PN_PORT_7,
    PN_PORT_8,
    PN_PORT_END = PN_PORT_8
};

enum PORT_MASK
{
    PM_PORT_0 = (1<<PN_PORT_0),
    PM_PORT_1 = (1<<PN_PORT_1),
    PM_PORT_2 = (1<<PN_PORT_2),
    PM_PORT_3 = (1<<PN_PORT_3),
    PM_PORT_4 = (1<<PN_PORT_4),
    PM_PORT_5 = (1<<PN_PORT_5),
    PM_PORT_6 = (1<<PN_PORT_6),
    PM_PORT_7 = (1<<PN_PORT_7),
    PM_PORT_8 = (1<<PN_PORT_8),
    PM_PORT_ALL = ((1<<PN_PORT_0)|(1<<PN_PORT_1)|(1<<PN_PORT_2)|(1<<PN_PORT_3)|(1<<PN_PORT_4)|(1<<PN_PORT_5)|
                          (1<<PN_PORT_6)|(1<<PN_PORT_7)|(1<<PN_PORT_8))
};
typedef struct {
...
#endif
int32 rtl865x_restoreDscpRemark(char *dev_name, int flag);
int32 rtl865x_restoreVlanRemark(char *dev_name);
#endif
...
extern int rtk_port_phyReg_get(uint32 phyNo, uint32 phyAddr, uint32 *pRegData);
...
#define GPIO_RESET_97FN			BSP_GPIO_PIN_H2		// GPIO_H2
#else
