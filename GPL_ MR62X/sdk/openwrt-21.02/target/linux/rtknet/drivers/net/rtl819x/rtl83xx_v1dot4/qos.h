...
/*Types of priority selection*/
typedef enum rtk_qos_pri_sel_e
{
    QOS_PRIDEC_PORT = 0,
    QOS_PRIDEC_ACL,
    QOS_PRIDEC_DSCP,
...
typedef enum rtk_qos_scheduling_type_e
{
    ...
    RTK_QOS_WRR,        /* Weighted-Round-Robin */
    SCHEDULING_TYPE_END
 ...
 */
extern rtk_api_ret_t rtk_qos_schedulingType_set(rtk_qos_scheduling_type_t queueType);
 ...
 */
extern rtk_api_ret_t rtk_qos_schedulingType_get(rtk_qos_scheduling_type_t *pQueueType);
