...
#define RTL83XX_LAN1        3	
#define RTL83XX_LAN2        4
...
#define CF_RXDESC_OFFSET                      18
#define CF_RXDESC_MASK                        (0x3f<<18)
#define CF_TXDESC_OFFSET                      12
#define CF_TXDESC_MASK                        (0x3f<<12)
...
#define CF_RMD_MLT_TAG_OFFSET                  (27) 
#define CF_RMD_MLT_TAG_MASK                    (0x3 << 27)
#define CF_RMD_DP_ZERO                         (1 << 26)
#define CF_ROUTER_MD_TYPE_OFFSET               (24) 
#define CF_ROUTER_MD_TYPE_MASK                 (0x3 << 24)
#define CF_DUMMY_VID_OFFSET                    (12) 
#define CF_DUMMY_VID_MASK                      (0xFFF << 12)
#define CF_CPUTAG_PRIO_OFFSET                  (8) 
#define CF_CPUTAG_PRIO_MASK                    (0xF << 8) 
#define CF_RMD_TAG_OFFSET                      (6) 
#define CF_RMD_TAG_MASK                        (0x3 << 6)
#define CF_VD2_ROUTER                          (1 << 5)
#define CF_VD2_PHY                             (1 << 4)
#define CPU_DTX_HP							   (1 << 3)
#define CF_RMD_IPM_TAG_OFFSET                  (1) 
#define CF_RMD_IPM_TAG_MASK                    (0x3 << 1) 
...
#define CF_FIX_IPG_OFFSET                   (12)
#define CF_FIX_IPG_MASK                     (0x3f<<12)
...
#define L2LEARNLIMIT0			(0x88+ALE_BASE)       /* l2 learning number limitation*/
...
#define IP6ArpAgingDisable					(1<<8)				  /* 0=Enable IPv6 Arp table aging. 1=disable */
...
#define EN_MCAST_DIF						(1<<18)
#define EN_MCASTV6_DIF						(1<<26)
#endif
...
#define EN_PGS                              (1<<31)               /* Enable per-group setting each queue's QLEN_GAP[7:0] */
#define QLEN_GAPG2_OFFSET					(16)				  /* Per-Queue physical length gap Register for queue Group#2 */	
#define QLEN_GAPG2_MASK						(0xff<<16)			  /* Per-Queue physical length gap Register for queue Group#2 */
#define QLEN_GAPG1_OFFSET					(8)					  /* Per-Queue physical length gap Register for queue Group#1 */	
#define QLEN_GAPG1_MASK						(0xff<<8)			  /* Per-Queue physical length gap Register for queue Group#1 */
#define QLEN_GAPG0_OFFSET					(0)					  /* Per-Queue physical length gap Register for queue Group#0 */	
#define QLEN_GAPG0_MASK						(0xff<<0)			  /* Per-Queue physical length gap Register for queue Group#0 */
...
#if defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8197F)
#define IQ_DSC_FCOFF_OFFSET                 (16)                   /* Offset for input Queue Flow control turn OFF descriptor threshold */
#define IQ_DSC_FCOFF_MASK                   (0xff<<16)             /* Mask for input Queue Flow control turn OFF descriptor threshold */
#define IQ_DSC_FCON_OFFSET                (0)                   /* Offset for input Queue Flow control turn ON descriptor threshold */
#define IQ_DSC_FCON_MASK                  (0xff<<0)             /* Mask for input Queue Flow control turn ON descriptor threshold */
#else
#define IQ_DSC_FCOFF_OFFSET                 (8)                   /* Offset for input Queue Flow control turn OFF descriptor threshold */
#define IQ_DSC_FCOFF_MASK                   (0xff<<8)             /* Mask for input Queue Flow control turn OFF descriptor threshold */
#define IQ_DSC_FCON_OFFSET                (0)                   /* Offset for input Queue Flow control turn ON descriptor threshold */
#define IQ_DSC_FCON_MASK                  (0xff<<0)             /* Mask for input Queue Flow control turn ON descriptor threshold */
#endif
...
/* PSRP6_RW - CPU Port Status Register */
#define CMAC_PAUSE_NICTX_FIFO_OFFSET        (7)                   /* CPORT CMAC pause to NIC configuration */
#define CMAC_PAUSE_NICTX_FIFO_MASK          (1<<7)
#define C_FC_OFFSET                         (5)                   /* cport pause ability indication */
#define C_FC_MASK                           (3<<5)
#define C_LINK_OFFSET                       (4)                   /* cport link indication */
#define C_LINK_MASK                         (1<<4)
#define CF_CPU_FCTL_OFFSET                  (3)                   /* Configure to enable NIC tx pause ability */
#define CF_CPU_FCTL_MASK                    (1<<3)
...
#if defined(CONFIG_RTL_8197F)
#define METER_COUNTER_UNNIT					4							/* 4 bytes */
...
#define EUUSCS								(1<<0)						/* even port Unknown Unicast Storm Control Selection */
#define EUMSCS								(1<<1)						/* even port Unknown Multicast Storm Control Selection */
#define EASCS								(1<<2)						/* even port ARP Storm Control Selection */
#define EDSCS								(1<<3)						/* even port DHCP Storm Control Selection */
#define EIMSCS								(1<<4)						/* even port IGMP/MLD Storm Control Selection */

#define EUUSCM								(3<<6)						/* even port Unknown Unicast Storm counter meter */
#define EUMSCM								(3<<8)						/* even port Unknown Multicast Storm counter meter */
#define EASCM								(3<<10)						/* even port Unknown ARP Storm counter meter */
#define EDSCM								(3<<12)						/* even port Unknown DHCP Storm counter meter */
#define EIMSCM								(3<<14)						/* even port Unknown IGMP/MLD Storm counter meter */

#define EUUSCM_OFFSET						(6)	
#define EUMSCM_OFFSET						(8)
#define EASCM_OFFSET						(10)
#define EDSCM_OFFSET						(12)
#define EIMSCM_OFFSET						(14)
...
#define OUUSCM								(3<<22)						/* odd port Unknown Unicast Storm counter meter */
#define OUMSCM								(3<<24)						/* odd port Unknown Multicast Storm counter meter */
#define OASCM								(3<<26)						/* odd port Unknown ARP Storm counter meter */
#define ODSCM								(3<<28)						/* odd port Unknown DHCP Storm counter meter */
#define OIMSCM								(3<<30)						/* odd port Unknown IGMP/MLD Storm counter meter */

#define OUUSCM_OFFSET						(22)
#define OUMSCM_OFFSET						(24)
#define OASCM_OFFSET						(26)
#define ODSCM_OFFSET						(28)
#define OIMSCM_OFFSET						(30)
...
#define EMTR_THR_MASK						(0xFFFF)					/* meter thredshold mask for even counter */
#define OMTR_THR_MASK						(0xFFFF << 16)				/* meter thredshold mask for odd counter */
...
#define IGPRIVCR0							(0x68+EXTMAC_BASE) 			/* Ingress Port Private Flow Control Register 0 */
#define IGPRIVCR1							(0x6C+EXTMAC_BASE) 			/* Ingress Port Private Flow Control Register 1 */
#define IGPRIVCR2							(0x70+EXTMAC_BASE) 			/* Ingress Port Private Flow Control Register 2 */
#define IGPRIVCR3							(0x74+EXTMAC_BASE) 			/* Ingress Port Private Flow Control Register 3 */
...
#define CF_TX_IPG_OFFSET                       (16)
#define CF_TX_IPG_MASK                         (0xF<<16)
#define FRC_Pn_EEE_GELITE                      (1<<12)        /* MAC EEE ability for 500M port, or Advertise 500M EEE capable */
#define SW_LINK_OK                             (1<<10)
#define SW_EEE_CAP                             (1<<9)
#define SW_FULL_DUPLEX                         (1<<8)
#define SW_RX_PAUSE_ABI                        (1<<7)
#define SW_TX_PAUSE_ABI                        (1<<6)
#define SW_SPEED_OFFSET                        (4)
#define SW_SPEED_MASK                          (3<<4)
#define CF_500M_CHK_DONE                       (1<<2)
...
/* IGPRIVCR0 ~ IGPRIVCR3 */
#define P_PRIVATE_FCOFF_OFFSET                 (16)
#define P_PRIVATE_FCOFF_MASK                   (0x3FF<<16)
#define P_PRIVATE_FCON_OFFSET                  (0)
#define P_PRIVATE_FCON_MASK                    (0x3FF<<0)
...
#define V6DSCPRMK0					(0x030+IPV6_BASE)			/* IPv6 DSCP Remarking Control Register */
#define V6DSCPRMK1					(0x034+IPV6_BASE)

#define MultiCastv6MTU_OFFSET		(0)
#define MultiCastv6MTU_MASK			(0x7fff)
#define V6DSCPCR0					(0x014+IPV6_BASE)
#define V6DSCPCR1					(0x018+IPV6_BASE)
#define V6DSCPCR2					(0x01C+IPV6_BASE)
#define V6DSCPCR3					(0x020+IPV6_BASE)
#define V6DSCPCR4					(0x024+IPV6_BASE)
#define V6DSCPCR5					(0x028+IPV6_BASE)
#define V6DSCPCR6					(0x02C+IPV6_BASE)
#define v6DSCP_PRI_OFFSET			(4)
#define v6DSCP_PRI_MASK 			(0xf)
