...
#define IS_RESERVE_MULTICAST_DHCPV6_ADDR_V6(ipv6addr) 	(((ipv6addr[0] & 0xFFFFFFFF)==0xff020000)&&((ipv6addr[1] & 0xFFFFFFFF)==0x00000000)&&((ipv6addr[2] & 0xFFFFFFFF)==0x00000000)&&((ipv6addr[3] & 0xFFFFFFFF)==0x00010002)) 
...
#define MAX_SUPPORT_PORT_NUMBER 20
#else
...
#define DEFAULT_MAX_TP_GROUP_COUNT			256
...
#define DEFAULT_TP_MULTICAST_GROUP_EXPIRE_TIME 	15
...
#ifdef CONFIG_NEW_IGMP_IMPLEMENTATION
struct tp_multicast_group_entry
{
	struct tp_multicast_group_entry *previous;
	struct tp_multicast_group_entry *next;             /*Pointer of next group entry*/
	uint32 ipVersion;
	...
	/* Whether to disable hardware acceleration */
	uint32 need_block;
