 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_init(rtk_queue_num_t queueNum)
{
    ...
    {
    #if defined CONFIG_TPLINK_QOS
		for(queue=1;queue<=8;queue++){
			if ((retVal = rtl8367c_setAsicPriorityToQIDMappingTable(queue - 1, priority, g_prioritytToQid[queue - 1][priority])) != RT_ERR_OK)
           		return retVal;
		}
	#else
 ...
 *      - PRIDEC_SA
 */
rtk_api_ret_t dal_rtl8367c_qos_priSel_set(rtk_qos_priDecTbl_t index, rtk_priority_select_t *pPriDec)
{
    rtk_api_ret_t retVal;
    rtk_uint32 port_pow;
 ...
 *      - PRIDEC_SA,
 */
rtk_api_ret_t dal_rtl8367c_qos_priSel_get(rtk_qos_priDecTbl_t index, rtk_priority_select_t *pPriDec)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_1pPriRemap_set(rtk_pri_t dot1p_pri, rtk_pri_t int_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_1pPriRemap_get(rtk_pri_t dot1p_pri, rtk_pri_t *pInt_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpPriRemap_set(rtk_dscp_t dscp, rtk_pri_t int_pri)
{
    rtk_api_ret_t retVal;
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpPriRemap_get(rtk_dscp_t dscp, rtk_pri_t *pInt_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_portPri_set(rtk_port_t port, rtk_pri_t int_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_portPri_get(rtk_port_t port, rtk_pri_t *pInt_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_queueNum_set(rtk_port_t port, rtk_queue_num_t queue_num)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_queueNum_get(rtk_port_t port, rtk_queue_num_t *pQueue_num)
{
    rtk_api_ret_t retVal;
    rtk_uint32 qidx;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_priMap_set(rtk_queue_num_t queue_num, rtk_qos_pri2queue_t *pPri2qid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pri;
 ...
 *      The queue number is from 1 to 8.
 */
rtk_api_ret_t dal_rtl8367c_qos_priMap_get(rtk_queue_num_t queue_num, rtk_qos_pri2queue_t *pPri2qid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pri;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_schedulingQueue_set(rtk_port_t port, rtk_qos_queue_weights_t *pQweights)
{
    rtk_api_ret_t retVal;
    rtk_uint32 qid;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_schedulingQueue_get(rtk_port_t port, rtk_qos_queue_weights_t *pQweights)
{
    rtk_api_ret_t retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t dal_rtl8367c_qos_1pRemarkEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t dal_rtl8367c_qos_1pRemarkEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_1pRemark_set(rtk_pri_t int_pri, rtk_pri_t dot1p_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_1pRemark_get(rtk_pri_t int_pri, rtk_pri_t *pDot1p_pri)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_1pRemarkSrcSel_set(rtk_qos_1pRmkSrc_t type)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_qos_1pRemarkSrcSel_get(rtk_qos_1pRmkSrc_t *pType)
{
    rtk_api_ret_t retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemarkEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemarkEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemark_set(rtk_pri_t int_pri, rtk_dscp_t dscp)
{
    rtk_api_ret_t retVal;
...
rtk_api_ret_t dal_rtl8367c_qos_dscpRemark_get(rtk_pri_t int_pri, rtk_dscp_t *pDscp)
{
    rtk_api_ret_t retVal;
 ...
 *      priority to TX DSCP value.
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemarkSrcSel_set(rtk_qos_dscpRmkSrc_t type)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemarkSrcSel_get(rtk_qos_dscpRmkSrc_t *pType)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemark2Dscp_set(rtk_dscp_t dscp, rtk_dscp_t rmkDscp)
{
    rtk_api_ret_t retVal;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_qos_dscpRemark2Dscp_get(rtk_dscp_t dscp, rtk_dscp_t *pDscp)
{
    rtk_api_ret_t retVal;
 ...
 *      The API can set priority of port assignments for queue usage and packet scheduling.
 */
rtk_api_ret_t dal_rtl8367c_qos_portPriSelIndex_set(rtk_port_t port, rtk_qos_priDecTbl_t index)
{
    rtk_api_ret_t retVal;
 ...
 *      The API can get priority of port assignments for queue usage and packet scheduling.
 */
rtk_api_ret_t dal_rtl8367c_qos_portPriSelIndex_get(rtk_port_t port, rtk_qos_priDecTbl_t *pIndex)
{
    rtk_api_ret_t retVal;
