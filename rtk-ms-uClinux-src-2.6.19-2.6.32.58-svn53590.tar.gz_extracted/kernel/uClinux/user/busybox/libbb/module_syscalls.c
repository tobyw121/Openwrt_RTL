...
int decry_module(void *first, void *second, void *third, void *fourth, void *fifth)
{
#ifndef __NR_decry_module
#warning This kernel does not support the decry_module syscall
#warning -> The decry_module system call is being stubbed out...
    errno=ENOSYS;
    return -1;
#else
    return(syscall(__NR_decry_module, first, second, third, fourth, fifth));
#endif
}
