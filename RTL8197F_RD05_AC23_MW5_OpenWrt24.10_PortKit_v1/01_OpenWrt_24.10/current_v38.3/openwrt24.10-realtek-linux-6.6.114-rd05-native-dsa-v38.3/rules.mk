...
FAKEROOT:=$(if $(wildcard $(STAGING_DIR_HOST)/bin/fakeroot),$(STAGING_DIR_HOST)/bin/fakeroot,fakeroot)
...
NINJA = \
	...
	$(if $(wildcard $(STAGING_DIR_HOST)/bin/ninja),$(STAGING_DIR_HOST)/bin/ninja,ninja) \
