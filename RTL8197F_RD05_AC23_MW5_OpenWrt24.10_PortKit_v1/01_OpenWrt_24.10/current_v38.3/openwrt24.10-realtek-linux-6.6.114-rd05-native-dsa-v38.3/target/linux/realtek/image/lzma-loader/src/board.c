...
/*
 * The original OpenWrt realtek lzma-loader source was inherited from
 * AR7xxx/AR9xxx and used UART_BASE 0xb8020000.  That is wrong for the
 * RTL8197F-VG used by Xiaomi R4/RD05.  The vendor BSP places UART0 at
 * physical 0x18147000, i.e. uncached KSEG1 0xb8147000, with standard
 * 16550-style 32-bit register spacing on the VG variant.
 */
...
{
	/* Never let early loader diagnostics hard-hang the boot path. */
