...
r8389_watchdog_mode_set(uint32 unit, drv_watchdog_mode_t mode)
{
    switch (mode) 
    {
        case WATCHDOG_MODE_NORMAL:
    		ioal_mem32_field_write(unit, RTL8389_RESET_GLOBAL_CONTROL_ADDR, RTL8389_RESET_GLOBAL_CONTROL_WDOG_NMI_EN_OFFSET, RTL8389_RESET_GLOBAL_CONTROL_WDOG_NMI_EN_MASK, 0);
            break;

        case WATCHDOG_MODE_INTERRUPT:
    		ioal_mem32_field_write(unit, RTL8389_SWITCH_INTERRUPT_CONTROL0_ADDR, RTL8389_SWITCH_INTERRUPT_CONTROL0_WDOG_IE_OFFSET, RTL8389_SWITCH_INTERRUPT_CONTROL0_WDOG_IE_MASK, 1);
    		ioal_mem32_field_write(unit, RTL8389_RESET_GLOBAL_CONTROL_ADDR, RTL8389_RESET_GLOBAL_CONTROL_WDOG_NMI_EN_OFFSET, RTL8389_RESET_GLOBAL_CONTROL_WDOG_NMI_EN_MASK, 1);
            break;
    ...
    return RT_ERR_OK;
} /* end of r8389_watchdog_mode_set */
...
r8389_watchdog_mode_get(uint32 unit, drv_watchdog_mode_t *pMode)
{
    ...
    /* Get watchdog mode */
    ioal_mem32_field_read(unit, RTL8389_RESET_GLOBAL_CONTROL_ADDR, RTL8389_RESET_GLOBAL_CONTROL_WDOG_NMI_EN_OFFSET, RTL8389_RESET_GLOBAL_CONTROL_WDOG_NMI_EN_MASK, &temp);
    if (0 == temp)
    {
    ...
    return RT_ERR_OK;
} /* end of r8389_watchdog_mode_get */
...
r8389_watchdog_scale_set(uint32 unit, drv_watchdog_scale_t scale)
{
    ...
    switch (scale)
    {
        case WATCHDOG_SCALE_1:                     /* fire after 1.6 sec */
            newWDTCNR = (newWDTCNR | WDT_SCALE_1); /* 2b 00, 2^15 */
            break;

        case WATCHDOG_SCALE_2:                     /* fire after 3.2 sec */
            newWDTCNR = (newWDTCNR | WDT_SCALE_2); /* 2b 01, 2^16 */
            break;

        case WATCHDOG_SCALE_3:                     /* fire after 6.5 sec */
            newWDTCNR = (newWDTCNR | WDT_SCALE_3); /* 2b 10, 2^17 */
            break;

        case WATCHDOG_SCALE_4:                     /* fire after 13.1 sec */
    ...
    return RT_ERR_OK;
} /* end of r8389_watchdog_scale_set */
...
r8389_watchdog_scale_get(uint32 unit, drv_watchdog_scale_t *pScale)
{
    ...
    *pScale = (REG32(WDTCNR) & WDT_SCALE_MASK) >> WDT_SCALE_OFFSET;
    ...
    return RT_ERR_OK;
} /* end of r8389_watchdog_scale_get */
...
r8389_watchdog_enable_set(uint32 unit, uint32 enable)
{
    ...
    return RT_ERR_OK;
} /* end of r8389_watchdog_enable_set */
...
r8389_watchdog_enable_get(uint32 unit, uint32 *pEnable)
{
    ...
    return RT_ERR_OK;
} /* end of r8389_watchdog_enable_get */
