...
ioal_init(uint32 unit)
{
    ...
    else if ((RTL8330M_CHIP_ID == chip_id) || (RTL8332M_CHIP_ID == chip_id) ||
             (RTL8380M_CHIP_ID == chip_id) || (RTL8382M_CHIP_ID == chip_id))
    {
        pUserReg = osal_mmap(MEM_DEV_NAME, RTL8380_DMA_PHYS_BASE, RTL8380_DMA_MEM_SIZE);
    }  
    else if ((RTL8352M_CHIP_ID == chip_id) || (RTL8353M_CHIP_ID == chip_id) ||
             (RTL8390M_CHIP_ID == chip_id) || (RTL8392M_CHIP_ID == chip_id) ||
             (RTL8393M_CHIP_ID == chip_id) || (RTL8396M_CHIP_ID == chip_id))
    {
    ...
    if ((RTL8352M_CHIP_ID == chip_id) || (RTL8353M_CHIP_ID == chip_id) ||
        (RTL8390M_CHIP_ID == chip_id) || (RTL8392M_CHIP_ID == chip_id) ||
        (RTL8393M_CHIP_ID == chip_id) || (RTL8396M_CHIP_ID == chip_id))
    {
