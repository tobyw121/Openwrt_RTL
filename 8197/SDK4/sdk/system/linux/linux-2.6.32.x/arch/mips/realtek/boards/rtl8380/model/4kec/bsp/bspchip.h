...
#define RTL8380ES_TC1DATA			(BSP_TIMER0_BASE + 0x04)
   #define RTL8380ES_TCD_OFFSET		8
#define RTL8380ES_TC0CNT			(BSP_TIMER0_BASE + 0x08)
#define RTL8380ES_TC1CNT			(BSP_TIMER0_BASE + 0x0C)
#define RTL8380ES_TCCNR			(BSP_TIMER0_BASE + 0x10)
