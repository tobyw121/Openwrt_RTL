...
#define BAUDRATE        38400  /* ex. 19200 or 38400 or 57600 or 115200 */                                /* For Early Debug */
...
#define RTL8390ES_TC1DATA			(BSP_TIMER0_BASE + 0x04)
   #define RTL8390ES_TCD_OFFSET		8
#define RTL8390ES_TC0CNT			(BSP_TIMER0_BASE + 0x08)
#define RTL8390ES_TC1CNT			(BSP_TIMER0_BASE + 0x0C)
#define RTL8390ES_TCCNR			(BSP_TIMER0_BASE + 0x10)
