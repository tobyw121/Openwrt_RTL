 ...
 * Symbol Definition
 */
#define rtl8389_shutdown_irq      rtl8389_disable_irq
#define rtl8389_mask_and_ack_irq  rtl8389_disable_irq

static void rtl8389_enable_irq(unsigned int irq);
static void rtl8389_disable_irq(unsigned int irq);
static void rtl8389_end_irq(unsigned int irq);
static unsigned int rtl8389_startup_irq(unsigned int irq);
...
static struct irq_chip irq_type = {
    .typename = "RTL8389",
    .startup = rtl8389_startup_irq,
    .shutdown = rtl8389_shutdown_irq,
    .enable = rtl8389_enable_irq,
    .disable = rtl8389_disable_irq,
    .ack = rtl8389_mask_and_ack_irq,
    .end = rtl8389_end_irq,
};
...
/*
 *   RTL8389 Interrupt Scheme (Subject to change)
 *
