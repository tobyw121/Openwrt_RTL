...
mac_probe(uint32 unit)
{
    ...
    if( (RTL8330M_CHIP_ID == hal_ctrl[unit].chip_id ||RTL8332M_CHIP_ID == hal_ctrl[unit].chip_id ||
	   RTL8380M_CHIP_ID == hal_ctrl[unit].chip_id ||RTL8382M_CHIP_ID == hal_ctrl[unit].chip_id) &&
