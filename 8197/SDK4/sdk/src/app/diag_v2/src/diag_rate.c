    ...
    uint32_t *qid_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        ...
        if (RT_ERR_OK == rtk_rate_egrQueueFixedBandwidthEnable_get(unit, port, *qid_ptr, &enable))
        {
            if (ENABLED == enable)
            {
    ...
    char **port_ptr)
{
    ...
    else
    {
        ...
        DIAG_UTIL_PORTMASK_SCAN(portlist, port)
        {
            ...
            DIAG_UTIL_ERR_CHK(rtk_rate_stormControlRate_get(unit, port, type, &rate), ret);
            diag_util_printf("  %8d ", rate);
            DIAG_UTIL_ERR_CHK(rtk_rate_portStormControlBurstSize_get(unit, port, type, &rate), ret);
            diag_util_printf("  %8d", rate);
            diag_util_mprintf("\n");
        }
    }
 ...
 */
cparser_result_t cparser_cmd_storm_control_set_broadcast_multicast_unicast_port_all_burst_size_size(cparser_context_t *context,
    char **port_ptr,
    uint32_t *size_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_STORM_CONTROL_SET_BROADCAST_MULTICAST_PORT_ALL_COUNTING_MODE_BYTE_PACKET
/*
 * storm-control set ( broadcast | multicast ) ( <PORT_LIST:port> | all ) counting-mode ( byte | packet )
 */
cparser_result_t cparser_cmd_storm_control_set_broadcast_multicast_port_all_counting_mode_byte_packet(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_broadcast_multicast_port_all_counting_mode_byte_packet */
#endif

#ifdef CMD_STORM_CONTROL_SET_UNKNOWN_MULTICAST_PORT_ALL_COUNTING_MODE_BYTE_PACKET
/*
 * storm-control set unknown-multicast ( <PORT_LIST:port> | all ) counting-mode ( byte | packet )
 */
cparser_result_t cparser_cmd_storm_control_set_unknown_multicast_port_all_counting_mode_byte_packet(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_unknown_multicast_port_all_counting_mode_byte_packet */
#endif

#ifdef CMD_STORM_CONTROL_SET_UNKNOWN_UNICAST_PORT_ALL_COUNTING_MODE_BYTE_PACKET
/*
 * storm-control set unknown-unicast ( <PORT_LIST:port> | all ) counting-mode ( byte | packet )
 */
cparser_result_t cparser_cmd_storm_control_set_unknown_unicast_port_all_counting_mode_byte_packet(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_unknown_unicast_port_all_counting_mode_byte_packet */
#endif

#ifdef CMD_STORM_CONTROL_SET_BROADCAST_MULTICAST_PORT_ALL_STATE_DISABLE_ENABLE
/*
 * storm-control set ( broadcast | multicast ) ( <PORT_LIST:port> | all ) state ( disable | enable )
 */
cparser_result_t cparser_cmd_storm_control_set_broadcast_multicast_port_all_state_disable_enable(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_broadcast_multicast_port_all_state_disable_enable */
#endif

#ifdef CMD_STORM_CONTROL_SET_UNKNOWN_MULTICAST_PORT_ALL_STATE_DISABLE_ENABLE
/*
 * storm-control set unknown-multicast ( <PORT_LIST:port> | all ) state ( disable | enable )
 */
cparser_result_t cparser_cmd_storm_control_set_unknown_multicast_port_all_state_disable_enable(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_unknown_multicast_port_all_state_disable_enable */
#endif

#ifdef CMD_STORM_CONTROL_SET_UNKNOWN_UNICAST_PORT_ALL_STATE_DISABLE_ENABLE
/*
 * storm-control set unknown-unicast ( <PORT_LIST:port> | all ) state ( disable | enable )
 */
cparser_result_t cparser_cmd_storm_control_set_unknown_unicast_port_all_state_disable_enable(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_unknown_unicast_port_all_state_disable_enable */
#endif
...
#ifdef CMD_BANDWIDTH_GET_INGRESS_PORT_ALL_QUEUE_ID
/*
* bandwidth get ingress ( <PORT_LIST:port> | all ) <UINT:queue_id>
*/
cparser_result_t cparser_cmd_bandwidth_get_ingress_port_all_queue_id(cparser_context_t *context,
    char **port_ptr,
    uint32_t *queue_id_ptr)
{
    uint32          unit = 0;
    ...
    {
        diag_util_mprintf("Port %2d :\n", port);
        DIAG_UTIL_ERR_CHK(rtk_rate_igrQueueBwCtrlEnable_get(unit, port, queue_id, &enable), ret);
        if (ENABLED == enable)
        {
        ...
        DIAG_UTIL_ERR_CHK(rtk_rate_igrQueueBwCtrlRate_get(unit, port, queue_id, &rate), ret);
        diag_util_mprintf("\tRate (Queue %d) : %d (0x%x)\n", queue_id, rate, rate);

        DIAG_UTIL_ERR_CHK(rtk_rate_igrQueueBwCtrlExceed_get(unit, port, queue_id, &exceed), ret);
        diag_util_mprintf("\tExceed(Queue %d) : %d\n", queue_id, exceed);
    }
...
#ifdef CMD_BANDWIDTH_SET_INGRESS_PORT_ALL_QUEUE_QUEUE_ID_STATE_DISABLE_ENABLE
/*
* bandwidth set ingress ( <PORT_LIST:port> | all ) queue <UINT:queue_id> state ( disable | enable )
*/
cparser_result_t cparser_cmd_bandwidth_set_ingress_port_all_queue_queue_id_state_disable_enable(cparser_context_t *context,
    char **port_ptr,
    uint32_t *queue_id_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        DIAG_UTIL_ERR_CHK(rtk_rate_igrQueueBwCtrlEnable_set(unit, port, queue_id, enable), ret);
    }
...
#ifdef CMD_BANDWIDTH_SET_INGRESS_PORT_ALL_QUEUE_QUEUE_ID_RATE_RATE
/*
* bandwidth set ingress ( <PORT_LIST:port> | all ) queue <UINT:queue_id> rate <UINT:rate>
*/
cparser_result_t cparser_cmd_bandwidth_set_ingress_port_all_queue_queue_id_rate_rate(cparser_context_t *context,
    char **port_ptr,
    uint32_t *queue_id_ptr,
    uint32_t *rate_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        DIAG_UTIL_ERR_CHK(rtk_rate_igrQueueBwCtrlRate_set(unit, port, queue_id, rate_value), ret);
    }
...
#ifdef CMD_BANDWIDTH_RESET_INGRESS_QUEUE_METER_EXCEED_PORT_ALL_QUEUE_QUEUE_ID 
/*
* bandwidth reset ingress meter-exceed ( <PORT_LIST:port> | all ) queue <UINT:queue_id>
*/
cparser_result_t cparser_cmd_bandwidth_reset_ingress_meter_exceed_port_all_queue_queue_id(cparser_context_t *context,
    char **port_ptr,
    uint32_t *queue_id_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        DIAG_UTIL_ERR_CHK(rtk_rate_igrQueueBwCtrlExceed_reset(unit, port, *queue_id_ptr), ret);
    }
...
#ifdef CMD_STORM_CONTROL_GET_BROADCAST_MULTICAST_UNICAST_PORT_ALL
/*
*storm-control get ( broadcast | multicast | unicast ) ( <PORT_LIST:port> | all )
*/
cparser_result_t cparser_cmd_storm_control_get_broadcast_multicast_unicast_port_all(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    ...
    if (DIAG_OM_GET_FAMILYID(RTL8390_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL8380_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL8330_FAMILY_ID))
    {
    ...
    {
        diag_util_mprintf(" Port |   Rate   | Burst Size | Meter Exceed\n");
        diag_util_mprintf("=============================================\n");
    }  

    if (DIAG_OM_GET_FAMILYID(RTL8380_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL8330_FAMILY_ID))
    {
        if (RT_ERR_OK != (ret=rtk_rate_stormControlBurstSize_get(unit, type, &burst)))
        {
            diag_util_mprintf(" ret = %d\n", ret);
            return CPARSER_NOT_OK;
        }
    }
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        ...
        if (DIAG_OM_GET_FAMILYID(RTL8390_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL8380_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL8330_FAMILY_ID))
        {
            if(RT_ERR_OK == rtk_rate_stormControlEnable_get(unit, port, type, &enable))
            {
                diag_util_mprintf("  %s ", ((enable == ENABLED) ? "enable" : "disable"));
            }
            else
            {
                diag_util_mprintf(" Not Support ");
        ...
        if (RT_ERR_OK == rtk_rate_stormControlRate_get(unit, port, type, &rate))
        {
            diag_util_mprintf("  %8d ", rate);
        }
        else
        ...
        if (!(DIAG_OM_GET_FAMILYID(RTL8380_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL8330_FAMILY_ID)))
            ret = rtk_rate_portStormControlBurstSize_get(unit, port, type, &burst);
        else
            ret = RT_ERR_OK;

        if (ret == RT_ERR_OK)
        {
            diag_util_mprintf("  %8d", burst);
        }
        else
        {
            diag_util_mprintf(" Not Support ");
        ...
        if (RT_ERR_OK == rtk_rate_stormControlExceed_get(unit, port, type, &isExceed))
        {
            diag_util_mprintf("  %s ", (TRUE == isExceed)?"  Exceed  ":" Not-exceed ");
        }
        else
...
#ifdef CMD_STORM_CONTROL_GET_UNKNOWN_MULTICAST_PORT_ALL
/*
*storm-control get unknown-multicast ( <PORT_LIST:port> | all )
*/
cparser_result_t cparser_cmd_storm_control_get_unknown_multicast_port_all(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    uint32      rate = 0, burst =0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        ...
        if (RT_ERR_OK == rtk_rate_portStormControlBurstSize_get(unit, port, type, &burst))
        {
            diag_util_mprintf("  %8d", burst);
        }
        else
...
#ifdef CMD_STORM_CONTROL_GET_UNKNOWN_UNICAST_PORT_ALL
/*
*storm-control get unknown-unicast ( <PORT_LIST:port> | all )
*/
cparser_result_t cparser_cmd_storm_control_get_unknown_unicast_port_all(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    uint32      rate = 0, burst =0;
...
#ifdef CMD_STORM_CONTROL_SET_BROADCAST_MULTICAST_UNICAST_PORT_ALL_RATE_RATE
/*
 * storm-control set ( broadcast | multicast | unicast ) ( <PORT_LIST:port> | all ) rate <UINT:rate>
 */
cparser_result_t cparser_cmd_storm_control_set_broadcast_multicast_unicast_port_all_rate_rate(cparser_context_t *context,
    char **port_ptr,
    uint32_t *rate_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_STORM_CONTROL_SET_UNKNOWN_MULTICAST_PORT_ALL_RATE_RATE
/*
 * storm-control set unknown-multicast ( <PORT_LIST:port> | all ) rate <UINT:rate>
 */
cparser_result_t cparser_cmd_storm_control_set_unknown_multicast_port_all_rate_rate(cparser_context_t *context,
    char **port_ptr,
    uint32_t *rate_ptr)
{
    uint32      unit = 0;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_unknown_multicast_port_all_rate_rate */
#endif

#ifdef CMD_STORM_CONTROL_SET_UNKNOWN_UNICAST_PORT_ALL_RATE_RATE
/*
 * storm-control set unknown-unicast ( <PORT_LIST:port> | all ) rate <UINT:rate>
 */
cparser_result_t cparser_cmd_storm_control_set_unknown_unicast_port_all_rate_rate(cparser_context_t *context,
    char **port_ptr,
    uint32_t *rate_ptr)
{
    uint32      unit = 0;
    ...
    return CPARSER_OK;
} /* end of cparser_cmd_storm_control_set_unknown_unicast_port_all_rate_rate */
#endif

#ifdef CMD_STORM_CONTROL_SET_UNICAST_MULTICAST_PORT_ALL_STATE_DISABLE_ENABLE
/*
*storm-control set ( broadcast | multicast | unicast ) ( <PORT_LIST:port> | all ) state ( disable | enable )
*/
cparser_result_t cparser_cmd_storm_control_set_broadcast_multicast_unicast_port_all_state_disable_enable(cparser_context_t *context,
    char **port_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
