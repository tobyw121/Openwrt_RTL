 ...
 */
cparser_result_t cparser_cmd_smi_set_smi_group_sck_port_sck_port_sck_pin_sck_pin_sda_port_sda_port_sda_pin_sda_pin_type_smi_type_chipid_smi_chipid_delay_smi_delay(cparser_context_t *context,
    uint32_t *smi_group_ptr,
    uint32_t *sck_port_ptr,
    uint32_t *sck_pin_ptr,
    uint32_t *sda_port_ptr,
    ...
    uint32_t *smi_delay_ptr)
{
    ...
    DIAG_UTIL_PARAM_RANGE_CHK((smi_group_ptr == NULL), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((*smi_group_ptr >= SMI_DEVICE_MAX), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((sck_port_ptr == NULL), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((*sck_port_ptr >= GPIO_PORT_END), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((sck_pin_ptr == NULL), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((*sck_pin_ptr > GPIO_PIN_MAX), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((sda_port_ptr == NULL), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((*sda_port_ptr >= GPIO_PORT_END), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((sda_pin_ptr == NULL), CPARSER_ERR_INVALID_PARAMS);
    DIAG_UTIL_PARAM_RANGE_CHK((*sda_pin_ptr > GPIO_PIN_MAX), CPARSER_ERR_INVALID_PARAMS);
    ...
    DIAG_UTIL_ERR_CHK(drv_smi_init(*sck_port_ptr, *sck_pin_ptr, *sda_port_ptr, *sda_pin_ptr, *smi_group_ptr), ret);
