...
#ifdef CMD_VLAN_CREATE_VID
cparser_result_t cparser_cmd_vlan_create_vid(cparser_context_t *context,
    uint32_t *vid_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_VLAN_DESTROY_VID
cparser_result_t cparser_cmd_vlan_destroy_vid(cparser_context_t *context,
    uint32_t *vid_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_VLAN_VID_FILTER_ID_FID
cparser_result_t cparser_cmd_vlan_set_vlan_vid_filter_id_fid(cparser_context_t *context,
    uint32_t *vid_ptr,
    uint32_t *fid_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_VLAN_SET_VLAN_VID_MEMBER_MEMBER_PORTS_TAGGED_PORTS_NONE
/*
 *   vlan set vlan <UINT:vid> member <PORT_LIST:member_ports> ( <PORT_LIST:tagged_ports> | none ) 
 */
cparser_result_t cparser_cmd_vlan_set_vlan_vid_member_member_ports_tagged_ports_none(cparser_context_t *context,
    uint32_t *vid_ptr,
    char **member_port_bitmap_ptr,
    char **tagged_port_bitmap_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    rtk_portmask_t  member_portmask;
    rtk_portmask_t  tagged_portmask;
    ...
    if ((ret = diag_util_str2LPortMask((uint8 *)*member_port_bitmap_ptr, &member_portmask)) != RT_ERR_OK)
    {
        diag_util_printf("member port list ERROR!\n");
        RT_ERR(ret, (MOD_DIAGSHELL), "port list=%s", *member_port_bitmap_ptr);
        return ret;
    }
    
    if('n' == TOKEN_CHAR(6, 0)){
        
        memset(&tagged_portmask,0,sizeof(rtk_portmask_t));

    }else{
    
        if ((ret = diag_util_str2LPortMask((uint8 *)*tagged_port_bitmap_ptr, &tagged_portmask)) != RT_ERR_OK)
        {
            diag_util_printf("tagged member port list ERROR!\n");
            RT_ERR(ret, (MOD_DIAGSHELL), "port list=%s", *tagged_port_bitmap_ptr);
            return ret;
        }

    }
    
    RTK_PORTMASK_XOR(tagged_portmask, member_portmask);
    
    if ((ret = rtk_vlan_port_set(unit, *vid_ptr, &member_portmask, &tagged_portmask)) != RT_ERR_OK)
    {
        DIAG_ERR_PRINT(ret);
        return CPARSER_NOT_OK;
    } 
...
#ifdef CMD_VLAN_SET_VLAN_VID_MSTI_MST_ID
cparser_result_t cparser_cmd_vlan_set_vlan_vid_msti_mst_id(cparser_context_t *context,
    uint32_t *vid_ptr,
    uint32_t *mst_id_ptr)
{
    uint32      unit = 0;
    ...
    if ((ret = rtk_vlan_stg_set(unit, *vid_ptr, *mst_id_ptr)) != RT_ERR_OK)
    {
        DIAG_ERR_PRINT(ret);
        return CPARSER_NOT_OK;
    } 
...
#ifdef CMD_VLAN_SET_ACCEPT_FRAME_TYPE_PORTS_ALL_ALL_TAGGED_ONLY_UNTAGGED_ONLY
cparser_result_t cparser_cmd_vlan_set_accept_frame_type_ports_all_all_tagged_only_untagged_only(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_ACCEPT_FRAME_TYPE_OUTER_PORTS_ALL_ALL_TAGGED_ONLY_UNTAGGED_ONLY
cparser_result_t cparser_cmd_vlan_set_accept_frame_type_outer_ports_all_all_tagged_only_untagged_only(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_INGRESS_FILTER_PORTS_ALL_STATE_ENABLE_DISABLE
/*
 * vlan set ingress-filter ( <PORT_LIST:ports> | all) state ( enable | disable )
 */
cparser_result_t cparser_cmd_vlan_set_ingress_filter_ports_all_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_FILTER_PORTS_ALL_STATE_ENABLE_DISABLE
/*
 * vlan set egress-filter ( <PORT_LIST:ports> | all) state ( enable | disable )
 */
cparser_result_t cparser_cmd_vlan_set_egress_filter_ports_all_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_VLAN_LEAKY_PORTS_ALL_STATE_ENABLE_DISABLE
/*
 * vlan set vlan-leaky ( <PORT_LIST:ports> | all) state ( enable | disable )
 */
cparser_result_t cparser_cmd_vlan_set_vlan_leaky_ports_all_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    fp_port = rtk_vlan_mcastLeakyPortEnable_set;
...
#ifdef CMD_VLAN_SET_INGRESS_FILTER_SYSTEM_STATE_ENABLE_DISABLE
cparser_result_t cparser_cmd_vlan_set_ingress_filter_system_state_enable_disable(cparser_context_t *context)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_VLAN_LEAKY_SYSTEM_STATE_ENABLE_DISABLE
cparser_result_t cparser_cmd_vlan_set_vlan_leaky_system_state_enable_disable(cparser_context_t *context)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    int32       (*fp_sys)(uint32, rtk_enable_t);
...
#ifdef CMD_VLAN_SET_PVID_PORTS_ALL_PVID
cparser_result_t cparser_cmd_vlan_set_pvid_ports_all_pvid(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *pvid_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_VLAN_SET_PVID_OUTER_PORTS_ALL_PVID
cparser_result_t cparser_cmd_vlan_set_pvid_outer_ports_all_pvid(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *pvid_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_VLAN_SET_PROTOCOL_VLAN_GROUP_INDEX_FRAME_TYPE_ETHERNET_SNAP_LLC_OTHER_FRAME_VALUE
cparser_result_t cparser_cmd_vlan_set_protocol_vlan_group_index_frame_type_ethernet_snap_llc_other_frame_value(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *frame_value_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    ...
    protoGroup.framevalue = *frame_value_ptr;
...
#ifdef CMD_VLAN_SET_PROTOCOL_VLAN_PORTS_ALL_GROUP_INDEX_VID_PRIORITY
/*
 * vlan set protocol-vlan ( <PORT_LIST:ports> | all ) group <UINT:index> <UINT:vid> <UINT:priority>
 */
cparser_result_t cparser_cmd_vlan_set_protocol_vlan_ports_all_group_index_vid_priority(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *index_ptr,
    uint32_t *vid_ptr,
...
#ifdef CMD_VLAN_SET_PROTOCOL_VLAN_PORTS_ALL_GROUP_INDEX_STATE_ENABLE_DISABLE
/*
 * vlan set protocol-vlan ( <PORT_LIST:ports> | all ) group <UINT:index> state ( enable | disable )
 */
cparser_result_t
cparser_cmd_vlan_set_protocol_vlan_ports_all_group_index_state_enable_disable(
        ...
        uint32_t *index_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_protocol_vlan_ports_all_group_index_state_enable_disable */
#endif

#ifdef CMD_VLAN_SET_PROTOCOL_VLAN_OUTER_PORTS_ALL_GROUP_INDEX_VID_PRIORITY_DEI
cparser_result_t cparser_cmd_vlan_set_protocol_vlan_outer_ports_all_group_index_vid_priority_dei(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *index_ptr,
    uint32_t *vid_ptr,
    uint32_t *priority_ptr,
...
#ifdef CMD_VLAN_SET_PROTOCOL_VLAN_PORTS_ALL_GROUP_INDEX_DISABLE
cparser_result_t cparser_cmd_vlan_set_protocol_vlan_ports_all_group_index_disable(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *index_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        if ((ret = rtk_vlan_portProtoVlan_get(unit, port, *index_ptr, &protoVlan_cfg)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
        protoVlan_cfg.valid = 0;
        if ((ret = rtk_vlan_portProtoVlan_set(unit, port, *index_ptr, &protoVlan_cfg)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
...
#ifdef CMD_VLAN_SET_PROTOCOL_VLAN_OUTER_PORTS_ALL_GROUP_INDEX_DISABLE
cparser_result_t cparser_cmd_vlan_set_protocol_vlan_outer_ports_all_group_index_disable(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *index_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        if ((ret = rtk_vlan_portOuterProtoVlan_get(unit, port, *index_ptr, &protoVlan_cfg)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
        protoVlan_cfg.valid = 0;
        if ((ret = rtk_vlan_portOuterProtoVlan_set(unit, port, *index_ptr, &protoVlan_cfg)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
...
#ifdef CMD_VLAN_SET_TPID_PORTS_ALL_TPID_IDX_TPID
cparser_result_t cparser_cmd_vlan_set_tpid_ports_all_tpid_idx_tpid(cparser_context_t *context,
    char **ports_ptr,
...
#ifdef CMD_VLAN_SET_INGRESS_PORTS_ALL_INNER_OUTER_IGNORE_STATE_ENABLE_DISABLE
cparser_result_t cparser_cmd_vlan_set_ingress_ports_all_inner_outer_ignore_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_INGRESS_PORTS_ALL_INNER_OUTER_TPID_TPID_IDX_MASK
cparser_result_t cparser_cmd_vlan_set_ingress_ports_all_inner_outer_tpid_tpid_idx_mask(cparser_context_t *context,
    char **ports_ptr,
...
#ifdef CMD_VLAN_SET_INGRESS_PORTS_ALL_EXTRA_TPID_TPID_IDX_MASK
cparser_result_t cparser_cmd_vlan_set_ingress_ports_all_extra_tpid_tpid_idx_mask(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *tpid_idx_mask_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_VLAN_SET_INGRESS_PORTS_ALL_EXTRA_STATE_ENABLE_DISABLE
cparser_result_t cparser_cmd_vlan_set_ingress_ports_all_extra_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_INGRESS_PORTS_ALL_KEEP_INNER_OUTER
/*
 * vlan set ingress ( <PORT_LIST:ports> | all ) keep { inner } { outer }
 */
cparser_result_t cparser_cmd_vlan_set_ingress_ports_all_keep_inner_outer(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_INGRESS_PORTS_ALL_INNER_OUTER_KEEP_TAG_STATE_ENABLE_DISABLE
/*
 * vlan set ingress ( <PORT_LIST:ports> | all ) ( inner | outer ) keep-tag state ( enable | disable )
 */
cparser_result_t
cparser_cmd_vlan_set_ingress_ports_all_inner_outer_keep_tag_state_enable_disable(
        cparser_context_t *context)
{
    uint32          unit = 0;
    int32           ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_ingress_ports_all_inner_outer_keep_tag_state_enable_disable */
#endif

#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_STATE_ENABLE_DISABLE
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_inner_outer_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_TPID_MODE_IGR_UNTAG_EGR_TAG_ALL_PACKETS
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_inner_outer_tpid_mode_igr_untag_egr_tag_all_packets(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_TPID_TPID_IDX
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_inner_outer_tpid_tpid_idx(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *tpid_idx_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_VID_SOURCE_ALE_ORIG_INNER_TAG_ORIG_OUTER_TAG
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_inner_outer_vid_source_ale_orig_inner_tag_orig_outer_tag(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_PRI_SOURCE_ORIG_INNER_TAG_ORIG_OUTER_TAG_NULL
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_inner_outer_pri_source_orig_inner_tag_orig_outer_tag_null(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_EXTRA_STATE_ENABLE_DISABLE
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_extra_state_enable_disable(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_KEEP_INNER_OUTER
/*
 * vlan set egress ( <PORT_LIST:ports> | all ) keep { inner } { outer }
 */
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_keep_inner_outer(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_KEEP_TAG_STATE_ENABLE_DISABLE
/*
 * vlan set egress ( <PORT_LIST:ports> | all ) ( inner | outer ) keep-tag state ( enable | disable )
 */
cparser_result_t
cparser_cmd_vlan_set_egress_ports_all_inner_outer_keep_tag_state_enable_disable(
        cparser_context_t *context)
{
    uint32          unit = 0;
    int32           ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_TAG_MODE_PORTS_ALL_ORIGINAL_KEEP_FORMAT_PRIORITY_TAG
cparser_result_t cparser_cmd_vlan_set_tag_mode_ports_all_original_keep_format_priority_tag(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_FORWARDING_MODE_VID_ALE_VLAN_MEMBER
cparser_result_t cparser_cmd_vlan_set_forwarding_mode_vid_ale_vlan_member(cparser_context_t *context,
    uint32_t *vid_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_VLAN_VID_PROFILE_INDEX_INDEX
/*
  * vlan set vlan <UINT:vid> profile-index <UINT:index>
  */
cparser_result_t cparser_cmd_vlan_set_vlan_vid_profile_index_index(cparser_context_t *context,
    uint32_t *vid_ptr,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
...
#ifdef CMD_VLAN_SET_PROFILE_INDEX_SA_LEARNING_STATE_ENABLE_DISABLE
/*
  * vlan set profile <UINT:index> sa-learning state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_profile_index_sa_learning_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_PROFILE_INDEX_L2_DLF_PM_IDX_IP4_DLF_PM_IDX_IP6_DLF_PM_IDX_PMASK_INDEX
/*
  * vlan set profile <UINT:index> ( l2-dlf-pm-idx| ip4-dlf-pm-idx | ip6-dlf-pm-idx ) <UINT:pmask_index>
  */
cparser_result_t cparser_cmd_vlan_set_profile_index_l2_dlf_pm_idx_ip4_dlf_pm_idx_ip6_dlf_pm_idx_pmask_index(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *pmask_index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
    rtk_vlan_profile_t profile;
    ...
    if('l' == TOKEN_CHAR(4, 0))
    {
        profile.l2_mcast_dlf_pm_idx = *pmask_index_ptr;
    }
    else if('i' == TOKEN_CHAR(4, 0))
    {
        if('4' == TOKEN_CHAR(4, 2))
            profile.ip4_mcast_dlf_pm_idx = *pmask_index_ptr;
        else
            profile.ip6_mcast_dlf_pm_idx = *pmask_index_ptr;
    }
...
#ifdef CMD_VLAN_SET_INGRESS_FILTER_ACTION_PORTS_ALL_FORWARD_DROP_TRAP
/*
  * vlan set ingress-filter-action ( <PORT_LIST:ports> | all ) ( forward | drop | trap )
  */
cparser_result_t cparser_cmd_vlan_set_ingress_filter_action_ports_all_forward_drop_trap(cparser_context_t *context)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
    rtk_port_t  port;
...
#ifdef CMD_VLAN_SET_PVID_MODE_INNER_OUTER_PORTS_ALL_ALL_UNTAG_ONLY_UNTAG_AND_PRIORITY_TAG
/*
  * vlan set pvid-mode ( inner | outer ) ( <PORT_LIST:ports> | all ) ( all | untag-only | untag-and-priority-tag )
  */
cparser_result_t cparser_cmd_vlan_set_pvid_mode_inner_outer_ports_all_all_untag_only_untag_and_priority_tag(cparser_context_t *context)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
    rtk_port_t  port;
...
#ifdef CMD_VLAN_SET_MAC_BASED_VLAN_INDEX_ENTRY_MAC_VID_PRIORITY
/*
  * vlan set mac-based-vlan <UINT:index> entry <MACADDR:mac> <UINT:vid> <UINT:priority>
  */
cparser_result_t
cparser_cmd_vlan_set_mac_based_vlan_index_entry_mac_vid_priority(
    cparser_context_t *context,
    uint32_t *index_ptr,
...
#ifdef CMD_VLAN_SET_MAC_BASED_VLAN_INDEX_STATE_ENABLE_DISABLE
/*
  * vlan set mac-based-vlan <UINT:index> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_mac_based_vlan_index_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_IP_SUBNET_BASED_VLAN_INDEX_ENTRY_SIP_SIPMASK_VID_PRIORITY
/*
  * vlan set ip-subnet-based-vlan <UINT:index> entry <IPV4ADDR:sip> <IPV4ADDR:sipmask> <UINT:vid> <UINT:priority>
  */
cparser_result_t cparser_cmd_vlan_set_ip_subnet_based_vlan_index_entry_sip_sipmask_vid_priority(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *sip_ptr,
...
#ifdef CMD_VLAN_SET_IP_SUBNET_BASED_VLAN_INDEX_STATE_ENABLE_DISABLE
/*
  * vlan set ip-subnet-based-vlan <UINT:index> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_ip_subnet_based_vlan_index_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_SET_TPID_INNER_OUTER_EXTRA_TPID_IDX_TPID
/*
  * vlan set tpid ( inner | outer | extra ) <UINT:tpid_idx> <HEX:tpid>
  */
cparser_result_t cparser_cmd_vlan_set_tpid_inner_outer_extra_tpid_idx_tpid(cparser_context_t *context,
    uint32_t *tpid_idx_ptr,
    uint32_t *tpid_ptr)
{
    uint32  unit = 0;
...
#ifdef CMD_VLAN_SET_EGRESS_PORTS_ALL_INNER_OUTER_STATUS_UNTAG_PRIORITY_TAG_TAG
/*
  * vlan set egress ( <PORT_LIST:ports> | all ) ( inner | outer ) status ( untag | priority-tag | tag )
  */
cparser_result_t cparser_cmd_vlan_set_egress_ports_all_inner_outer_status_untag_priority_tag_tag(cparser_context_t *context)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
    rtk_port_t  port;
...
/*
  * vlan set vlan-conversion ingress entry <UINT:index> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_ingress_entry_index_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
/*
  * vlan set vlan-conversion ingress entry <UINT:index> key vid <UINT:vid> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_ingress_entry_index_key_vid_vid_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *vid_ptr)
{
    uint32  unit = 0;
...
/*
  * vlan set vlan-conversion ingress entry <UINT:index> key priority <UINT:priority> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_ingress_entry_index_key_priority_priority_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *vid_ptr)
{
    uint32  unit = 0;
...
/*
  * vlan set vlan-conversion ingress entry <UINT:index> key port <UINT:port> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_ingress_entry_index_key_port_port_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *port_ptr)
{
    uint32  unit = 0;
...
#ifdef CMD_VLAN_SET_VLAN_CONVERSION_INGRESS_ENTRY_INDEX_DATA_VID_VID_FORCE_SHIFT
/*
  * vlan set vlan-conversion ingress entry <UINT:index> data vid <UINT:vid> ( force | shift )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_ingress_entry_index_data_vid_vid_force_shift(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *vid_ptr)
{
    uint32  unit = 0;
...
/*
  * vlan set vlan-conversion egress double-tag state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_egress_double_tag_state_enable_disable(cparser_context_t *context)
{
    uint32          unit = 0;
    int32           ret = RT_ERR_FAILED;
    rtk_enable_t    enable;
...
/*
  * vlan set vlan-conversion egress entry <UINT:index> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_egress_entry_index_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
/*
  * vlan set vlan-conversion egress entry <UINT:index> key vid <UINT:vid> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_egress_entry_index_key_vid_vid_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *vid_ptr)
{
    uint32  unit = 0;
...
/*
  * vlan set vlan-conversion egress entry <UINT:index> key priority <UINT:priority> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_egress_entry_index_key_priority_priority_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *priority_ptr)
{
    uint32  unit = 0;
...
/*
  * vlan set vlan-conversion egress entry <UINT:index> key port <UINT:port> state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_egress_entry_index_key_port_port_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *port_ptr)
{
    uint32  unit = 0;
...
#ifdef CMD_VLAN_SET_VLAN_CONVERSION_EGRESS_ENTRY_INDEX_DATA_VID_VID_FORCE_SHIFT
/*
  * vlan set vlan-conversion egress entry <UINT:index> data vid <UINT:vid> ( force | shift )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_conversion_egress_entry_index_data_vid_vid_force_shift(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *vid_ptr)
{
    uint32  unit = 0;
...
#ifdef CMD_VLAN_SET_VLAN_AGGREGATION_PORTS_ALL_STATE_ENABLE_DISABLE
/*
  * vlan set vlan-aggregation ( <PORT_LIST:ports> | all ) state ( enable | disable )
  */
cparser_result_t cparser_cmd_vlan_set_vlan_aggregation_ports_all_state_enable_disable(cparser_context_t *context)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    rtk_enable_t    enable;
...
#ifdef CMD_VLAN_GET_LEAKY_STP_FILTER
/*
 * vlan get leaky-stp-filter
 */
cparser_result_t
cparser_cmd_vlan_get_leaky_stp_filter(cparser_context_t *context)
{
    uint32          unit = 0;
    int32           ret = RT_ERR_FAILED;
    rtk_enable_t    enable;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_get_leaky_stp_filter */
#endif

#ifdef CMD_VLAN_SET_LEAKY_STP_FILTER_ENABLE_DISABLE
/*
 * vlan set leaky-stp-filter ( enable | disable )
 */
cparser_result_t
cparser_cmd_vlan_set_leaky_stp_filter_enable_disable(cparser_context_t *context)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_leaky_stp_filter_enable_disable */
#endif

#ifdef CMD_VLAN_GET_EXCEPT
/*
 * vlan get except
 */
cparser_result_t
cparser_cmd_vlan_get_except(cparser_context_t *context)
{
    uint32          unit = 0;
    int32           ret = RT_ERR_FAILED;
    rtk_action_t    action;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_get_except */
#endif

#ifdef CMD_VLAN_SET_EXCEPT_DROP_FORWARD_TRAP
/*
 * vlan set except ( drop | forward | trap )
 */
cparser_result_t
cparser_cmd_vlan_set_except_drop_forward_trap(cparser_context_t *context)
{
    uint32          unit = 0;
    int32           ret = RT_ERR_FAILED;
    rtk_action_t    action;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_except_drop_forward_trap */
#endif
...
cparser_cmd_vlan_get_vlan_conversion_ingress_default_action_ports_all(cparser_context_t *context)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_get_vlan_conversion_ingress_default_action_ports_all */
#endif
        ...
        cparser_context_t *context)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_vlan_conversion_ingress_default_action_ports_all_forward_drop */
#endif

#ifdef CMD_VLAN_CLEAR_VLAN_CONVERSION_INGRESS_ENTRY
/*
 * vlan clear vlan-conversion ingress entry
 */
cparser_result_t
cparser_cmd_vlan_clear_vlan_conversion_ingress_entry(
    cparser_context_t *context)
{
    uint32  unit;
    int32   ret;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_clear_vlan_conversion_ingress_entry */
#endif

#ifdef CMD_VLAN_CLEAR_VLAN_CONVERSION_EGRESS_ENTRY
/*
 * vlan clear vlan-conversion egress entry
 */
cparser_result_t
cparser_cmd_vlan_clear_vlan_conversion_egress_entry(
    cparser_context_t *context)
{
    uint32  unit;
    int32   ret;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_clear_vlan_conversion_egress_entry */
#endif
...
cparser_result_t cparser_cmd_vlan_dump_ip_subnet_based_vlan(cparser_context_t *context)
{
    ...
    diag_util_mprintf("Index | State   | Source IP Address |   Source IP Mask  | VID | Priority\n");
    diag_util_mprintf("------+---------+-------------------+-------------------+-----+----------\n");
    ...
    for(i=0; i<cnvt_entry_total; i++)
    {
        ...
        DIAG_UTIL_ERR_CHK(rtk_vlan_ipSubnetBasedVlan_get(unit, i, &valid, &sip, &sip_msk, &vid, &priority) , ret);

        if(vid != 0)
        {
            diag_util_mprintf("%6d|%8s|  %3d.%3d.%3d.%3d  |  %3d.%3d.%3d.%3d  |%5d|%5d\n", i, valid ? "ENABLED" : "DISABLED",\
                ((sip>>24) & 0xff), ((sip>>16) & 0xff), ((sip>>8) & 0xff), (sip&0xff),\
                ((sip_msk>>24) & 0xff), ((sip_msk>>16) & 0xff), ((sip_msk>>8) & 0xff), (sip_msk&0xff),\
                vid, priority);
        }
    }
...
#ifdef CMD_VLAN_GET_VLAN_VID
cparser_result_t cparser_cmd_vlan_get_vlan_vid(cparser_context_t *context,
    uint32_t *vid_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
    rtk_stg_t   stg;
    rtk_fid_t   fid;
    rtk_portmask_t  member_portmask, tag_portmask;
    ...
    if ((ret = rtk_vlan_port_get(unit, *vid_ptr, &member_portmask, &tag_portmask)) != RT_ERR_OK)
    {
        DIAG_ERR_PRINT(ret);
        return CPARSER_NOT_OK;
    } 

    RTK_PORTMASK_XOR(tag_portmask, member_portmask);
    
    diag_util_mprintf("Vlan %u \n", *vid_ptr);
    diag_util_lPortMask2str(port_list, &member_portmask);
    diag_util_mprintf("  Member\t: %s \n", port_list);
    diag_util_lPortMask2str(port_list, &tag_portmask);
    diag_util_mprintf("  Tag member\t: %s \n", port_list);
...
#ifdef CMD_VLAN_GET_ACCEPT_FRAME_TYPE_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_accept_frame_type_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_GET_ACCEPT_FRAME_TYPE_OUTER_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_accept_frame_type_outer_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_GET_INGRESS_FILTER_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_ingress_filter_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       (*fp_port)(uint32, rtk_port_t, rtk_enable_t *);
...
#ifdef CMD_VLAN_GET_EGRESS_FILTER_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_egress_filter_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       (*fp_port)(uint32, rtk_port_t, rtk_enable_t *);
...
#ifdef CMD_VLAN_GET_VLAN_LEAKY_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_vlan_leaky_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       (*fp_port)(uint32, rtk_port_t, rtk_enable_t *);
    ...
    fp_port = rtk_vlan_mcastLeakyPortEnable_get;
    diag_util_mprintf("Multicast leaky status of ports\n");
...
#ifdef CMD_VLAN_GET_INGRESS_FILTER_SYSTEM
cparser_result_t cparser_cmd_vlan_get_ingress_filter_system(cparser_context_t *context)
{
    uint32      unit = 0;
    int32       (*fp_sys)(uint32, rtk_enable_t *);
    rtk_enable_t    enable;
...
#ifdef CMD_VLAN_GET_VLAN_LEAKY_SYSTEM
cparser_result_t cparser_cmd_vlan_get_vlan_leaky_system(cparser_context_t *context)
{
    uint32      unit = 0;
    int32       (*fp_sys)(uint32, rtk_enable_t *);
    rtk_enable_t    enable;
...
#ifdef CMD_VLAN_GET_PVID_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_pvid_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    rtk_vlan_t  pvid;
...
#ifdef CMD_VLAN_GET_PVID_OUTER_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_pvid_outer_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    rtk_vlan_t  pvid;
...
#ifdef CMD_VLAN_GET_PROTOCOL_VLAN_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_protocol_vlan_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    uint32      ret;
...
#ifdef CMD_VLAN_GET_PROTOCOL_VLAN_OUTER_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_protocol_vlan_outer_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    uint32      group_id;
...
#ifdef CMD_VLAN_GET_TPID_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_tpid_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    uint32      group_id;
...
#ifdef CMD_VLAN_GET_INGRESS_EGRESS_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_ingress_egress_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    uint32      value, value2;
...
#ifdef CMD_VLAN_GET_TAG_MODE_PORTS_ALL
cparser_result_t cparser_cmd_vlan_get_tag_mode_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_GET_FORWARDING_MODE_VID
cparser_result_t cparser_cmd_vlan_get_forwarding_mode_vid(cparser_context_t *context,
    uint32_t *vid_ptr)
{
    uint32      unit = 0;
    int32       ret = RT_ERR_FAILED;
...
cparser_result_t cparser_cmd_vlan_dump_mac_based_vlan(cparser_context_t *context)
{
    ...
    diag_util_mprintf("Index | State   | Source MAC Address | VID | Priority\n");
    diag_util_mprintf("------+---------+--------------------+-----+----------\n");
    DIAG_OM_GET_CHIP_CAPACITY(unit, cnvt_entry_total, max_num_of_c2sc_entry);
    DIAG_OM_GET_CHIP_CAPACITY(unit, cnvt_entry_per_block, max_num_of_c2sc_blk_entry);
    ...
    for(i=0; i<cnvt_entry_total; i++)
    {
        ...
        DIAG_UTIL_ERR_CHK(rtk_vlan_macBasedVlan_get(unit, i, &valid, &smac, &vid, &priority) , ret);

        if(vid != 0)
        {
            diag_util_mprintf("%6d|%8s|  %02X:%02X:%02X:%02X:%02X:%02X |%5d|%5d\n", i, valid ? "ENABLED" : "DISABLED",\
                smac.octet[0],smac.octet[1], smac.octet[2],smac.octet[3],smac.octet[4],smac.octet[5], vid, priority);
        }
    }
...
#ifdef CMD_VLAN_GET_PROFILE_INDEX
/*
  * vlan get profile <UINT:index>
  */
cparser_result_t cparser_cmd_vlan_get_profile_index(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_GET_INGRESS_FILTER_ACTION_PORTS_ALL
/*
  * vlan get ingress-filter-action ( <PORT_LIST:ports> | all )
  */
cparser_result_t cparser_cmd_vlan_get_ingress_filter_action_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_GET_PVID_MODE_INNER_OUTER_PORTS_ALL
/*
  * vlan get pvid-mode ( inner | outer ) ( <PORT_LIST:ports> | all )
  */
cparser_result_t cparser_cmd_vlan_get_pvid_mode_inner_outer_ports_all(cparser_context_t *context,
    char **ports_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
...
#ifdef CMD_VLAN_GET_MAC_BASED_VLAN_INDEX
/*
  * vlan get mac-based-vlan <UINT:index>
  */
cparser_result_t cparser_cmd_vlan_get_mac_based_vlan_index(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
    ...
    diag_util_mprintf("Source MAC address   : %02X:%02X:%02X:%02X:%02X:%02X\n", \
...
#ifdef CMD_VLAN_GET_IP_SUBNET_BASED_VLAN_INDEX
/*
  * vlan get ip-subnet-based-vlan <UINT:index>
  */
cparser_result_t cparser_cmd_vlan_get_ip_subnet_based_vlan_index(cparser_context_t *context,
    uint32_t *index_ptr)
{
    uint32  unit = 0;
    int32   ret = RT_ERR_FAILED;
    ...
    diag_util_mprintf("State                : %s\n", valid ? "ENABLED" : "DISABLED");    
    diag_util_mprintf("Entry index          : %u\n", *index_ptr);
    diag_util_mprintf("Source IP address   : %3d.%3d.%3d.%3d\n", \
                        ((sip>>24) & 0xff), ((sip>>16) & 0xff), ((sip>>8) & 0xff), (sip&0xff));
    diag_util_mprintf("Source IP Mask   : %3d.%3d.%3d.%3d\n", \
                        ((sip_msk>>24) & 0xff), ((sip_msk>>16) & 0xff), ((sip_msk>>8) & 0xff), (sip_msk&0xff));
    diag_util_mprintf("VID                  : %u \n", vid);
    diag_util_mprintf("Priority             : %u\n", priority);
...
#ifdef CMD_VLAN_GET_VLAN_AGGREGATION_PORTS_ALL_STATE
/*
  * vlan get vlan-aggregation ( <PORT_LIST:ports> | all ) state
  */
cparser_result_t cparser_cmd_vlan_get_vlan_aggregation_ports_all_state(cparser_context_t *context)
{
    uint32          unit = 0;
    rtk_enable_t    enable;
    rtk_port_t      port;
    ...
    uint32_t *entry_index_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_get_vlan_conversion_egress_range_check_entry_index_vid */
#endif
    ...
    uint32_t *upper_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_vlan_conversion_egress_range_check_entry_index_vid_inner_outer_lower_upper */
#endif
    ...
    uint32_t *entry_index_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_get_vlan_conversion_egress_range_check_entry_index_vid_reverse_state */
#endif
    ...
    uint32_t *entry_index_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_vlan_set_vlan_conversion_egress_range_check_entry_index_vid_reverse_state_disable_enable */
#endif
