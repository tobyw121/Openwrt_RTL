...
#define DIG_HW		0
	...
	#if (DIG_HW == 1)
		#define DIG_TDMA_SUPPORT	1
	#else
		#define DIG_TDMA_SUPPORT	0
	#endif
#else
	#define DIG_TDMA_SUPPORT	0
#endif
...
//	u4Byte		Cnt_BW_LSC;	//Gary
	...
	u4Byte		Cnt_all_1sec;	
	u4Byte		Cnt_CCA_all_1sec;
	u4Byte		Cnt_Cck_fail_1sec;
...
#if (DIG_HW == 1)
#define		DM_DIG_MIN_AP_COVERAGE		((pDM_Odm->SupportICType & (ODM_RTL8812 | ODM_RTL8822B))?0x16:0x20)
#else
