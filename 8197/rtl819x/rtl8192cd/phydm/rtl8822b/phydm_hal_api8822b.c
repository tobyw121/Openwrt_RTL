	...
	)
{
	...
	else if ((pDM_Odm->RFEType == 0) || (pDM_Odm->RFEType == 3) || (pDM_Odm->RFEType == 5) || (pDM_Odm->RFEType == 8) || (pDM_Odm->RFEType == 10) || (pDM_Odm->RFEType == 12) || (pDM_Odm->RFEType == 13)) {
			/* iFEM */
			if (channel <= 14) {
				/* signal source */
				/*ODM_SetBBReg(pDM_Odm, 0xcb0, (bMaskByte2|bMaskLWord), 0x705770);
	...
	)
{
	...
	if ((is_efem_cca == true) && !(pDM_Odm->CutVersion == ODM_CUT_B))
