...
void
ODM_ReadAndConfig_MP_8814A_PHY_REG_PG_Type0(/* TC: Test Chip, MP: MP Chip*/
	IN   PDM_ODM_T  pDM_Odm
);
u4Byte ODM_GetVersion_MP_8814A_PHY_REG_PG_Type0(void);
...
void
ODM_ReadAndConfig_MP_8814A_PHY_REG_PG_Type4(/* TC: Test Chip, MP: MP Chip*/
	IN   PDM_ODM_T  pDM_Odm
);
u4Byte ODM_GetVersion_MP_8814A_PHY_REG_PG_Type4(void);
...
void
ODM_ReadAndConfig_MP_8814A_PHY_REG_PG_Type7(/* TC: Test Chip, MP: MP Chip*/
	IN   PDM_ODM_T  pDM_Odm
);
u4Byte ODM_GetVersion_MP_8814A_PHY_REG_PG_Type7(void);
