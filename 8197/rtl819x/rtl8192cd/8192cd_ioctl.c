...
//	{"mp_dig_enable",	RFFT_T, _OFFSET_RFFT(mp_dig_enable), _OFFSET_RFFT(mp_dig_enable), 0},
	...
	{"IGI_low",		ODM_DM_1UT,	_OFFSET_ODM_DM(IGI_LowerBound), _SIZE_ODM_DM(IGI_LowerBound), 0},
	{"IGI_high",	ODM_DM_1UT,	_OFFSET_ODM_DM(IGI_UpperBound), _SIZE_ODM_DM(IGI_UpperBound), 0},	
