...
#if defined(CONFIG_RTL_8197F) && !defined(CONFIG_RTL_8366SC_SUPPORT)
...
int RTL83XX_init(void)
{
    ...
    rtl83xx_setAsicReg(RTL83XX_REG_LED_CONFIGURATION, 0x906);
#else 
...
#if defined(CONFIG_RTL_8197F) && !(defined(CONFIG_RTL_8366SC_SUPPORT) || defined(CONFIG_RTL_8364NB_SUPPORT))
	// for EMI
    rtl83xx_setAsicReg(0x13C3, 0x0000);	
    rtl83xx_setAsicReg(0x13C4, 0x0000);	
    rtl83xx_setAsicReg(0x1d53, 0x0001);	
    rtl83xx_setAsicReg(0x1d55, 0x000f);	
    rtl83xx_setAsicReg(0x1d54, 0x05fa);	
    rtl83xx_setAsicReg(0x1d52, 0x2473);	
    rtl83xx_setAsicReg(0x1d5a, 0x0001);	
    rtl83xx_setAsicReg(0x1d5c, 0x000f);	
    rtl83xx_setAsicReg(0x1d5b, 0x05fa);	
    rtl83xx_setAsicReg(0x1d59, 0x2473);	

    rtk_port_rgmiiDelayExt_set(EXT_PORT_FOR_HOST, EXT0_RGMII_TX_DELAY_ENABLE_SSC, EXT0_RGMII_RX_DELAY_ENABLE_SSC); // change rxDelay to 5 to enhance the compatibility of 8197F and 8367RB	
#endif
...
int RTL83XX_vlan_set(void)
{
	...
	rtl83xx_setAsicLutLearnLimitNo(r8367_cpu_port,0);
