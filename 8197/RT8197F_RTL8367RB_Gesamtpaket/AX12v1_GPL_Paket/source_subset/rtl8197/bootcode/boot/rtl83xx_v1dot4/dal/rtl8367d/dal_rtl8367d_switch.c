...
/* Function Name:
 *      dal_rtl8367d_switch_greenEthernet_set
 * Description:
 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367d_switch_greenEthernet_set(rtk_enable_t enable)
{
    //rtk_api_ret_t retVal;
...
/* Function Name:
 *      dal_rtl8367d_switch_greenEthernet_get
 * Description:
 ...
 */
rtk_api_ret_t dal_rtl8367d_switch_greenEthernet_get(rtk_enable_t *pEnable)
{
    //rtk_api_ret_t retVal;
