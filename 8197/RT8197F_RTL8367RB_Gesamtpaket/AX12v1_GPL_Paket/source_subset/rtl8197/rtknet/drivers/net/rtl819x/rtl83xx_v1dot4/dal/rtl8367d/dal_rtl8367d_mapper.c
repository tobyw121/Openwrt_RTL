...
static dal_mapper_t dal_rtl8367d_mapper =
{
    ...
    .stat_port_get_in_out = dal_rtl8367d_port_get_in_out_octets,
    ...
    .stat_port_getSerial = dal_rtl8367d_stat_port_getSerial,
    ...
    .port_phyMdx_set = dal_rtl8367d_port_phyMdx_set,
    .port_phyMdx_get = dal_rtl8367d_port_phyMdx_get,
    .port_phyMdxStatus_get = dal_rtl8367d_port_phyMdxStatus_get,
    .port_phyTestMode_set = dal_rtl8367d_port_phyTestMode_set,
    .port_phyTestMode_get = dal_rtl8367d_port_phyTestMode_get,
    .port_duplexAutoChange_set = dal_rtl8367d_port_duplexAutoChange_set,
    .port_duplexAutoChange_get = dal_rtl8367d_port_duplexAutoChange_get,
    .port_macForceLinkExtSSC_set = dal_rtl8367d_port_macForceLinkExtSSC_set,
    .port_macForceLinkExtSSC_get = dal_rtl8367d_port_macForceLinkExtSSC_get,
    .port_autoDownSpeed10M_set = dal_rtl8367d_port_autoDownSpeed10M_set,
    .port_autoDownSpeed10M_get = dal_rtl8367d_port_autoDownSpeed10M_get,
