...
extern rtk_api_ret_t dal_rtl8367c_stat_port_getSerial(rtk_port_t port, rtk_stat_port_cntr_t *pPort_cntrs);
 ...
 *      Get all MIB counters of one port.
 */
extern rtk_api_ret_t dal_rtl8367c_port_get_in_out_octets(rtk_port_t port, rtk_stat_port_cntr_t *pPort_cntrs);
