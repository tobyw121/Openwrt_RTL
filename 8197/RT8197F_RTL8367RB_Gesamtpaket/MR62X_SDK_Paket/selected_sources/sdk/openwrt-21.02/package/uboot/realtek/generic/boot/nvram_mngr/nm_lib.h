...
/*leo TODO*/
#define NM_PTN_TABLE_BASE 0xfe0000
...
#elif NM_PTN_TABLE_BASE<0 || NM_PTN_TABLE_BASE>NM_FLASH_SIZE
	#error "NM_PTN_TABLE_BASE IS INVALID!"
#endif

#define NM_PTN_TABLE_SIZE 0x002000

#define NM_NVRAM_BASE 	0x000000

#ifndef NM_FLASH_SIZE
#define NM_FLASH_SIZE	0x1000000
#endif

#ifndef NM_PTN_NUM_MAX
...
#define NM_FWUP_IS_INTEGER	(1)
#define NM_FWUP_NOT_INTEGER	(0)
#define NM_FWUP_IS_DOUBLE_BOOT	(1)
#define NM_FWUP_NOT_DOUBLE_BOOT	(0)
/* ========= Debug Info =================================== */
// #define putstr(fmt, args...)   \
// do{\
//     char pos[200] = {0};\
//     sprintf(pos,fmt,##args);\
//     putstring(pos);\
// }while(0);

#define NM_DEBUG(fmt, args...) \
	prom_printf("[NM_Debug](%s) %05d: "fmt"\r\n", __FUNCTION__, __LINE__, ##args)
#define NM_ERROR(fmt, args...) \
	prom_printf("[NM_Error](%s) %05d: "fmt"\r\n", __FUNCTION__, __LINE__, ##args)
#define NM_INFO(fmt, args...) \
    prom_printf("[NM_Info](%s) %05d: "fmt"\r\n", __FUNCTION__, __LINE__, ##args)
...
typedef enum nm_fwup_upgrade_date_type
{
	...
	NM_FWUP_UPGRADE_DATA_TYPE_NO_CHANGE, /* 分区不被升级 */
...
typedef struct nm_ptn_extra_para
{
