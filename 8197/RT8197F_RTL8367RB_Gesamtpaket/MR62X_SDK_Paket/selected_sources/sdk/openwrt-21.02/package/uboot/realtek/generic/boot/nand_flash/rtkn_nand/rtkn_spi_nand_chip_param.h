...
/* ESMT F50L1G41B */
#define ESMT_RDID_F50L1G41B             (0xC801)
#define ESMT_DEVICE_ID_F50L1G41B        (0x01)
...
/* GD GD5F1GQ5UEY */
#define GD_RDID_GD5F1GQ5UEY				(0xC831)
#define GD_MANUFACTURER_ID				(0xC8)
#define GD_DEVICE_ID_GD5F1GQ5UEY     	(0x31)
...
#define BIWIN__MANUFACTURER_ID                  (0xBC)
#define BIWIN_DEVICE_ID_BWJX08M1G               (0xC1)

/* KIOXIA TC58CVG0S3HRAIJ*/
#define KIOXIA_RDID_TC58CVG0S3HRAIJ			(0x98E240)
#define KIOXIA_MANUFACTURER_ID				(0x98)
#define KIOXIA_DEVICE_ID_TC58CVG0S3HRAIJ	(0xE240)



#define DS35Q1GAxB 0xe571
#define DS_MANUFACTURER_ID 0xe5
#define DS_DEVICE_ID 0x71
...
static nand_chip_param_T nand_chip_id[] = 
{
...
#ifdef  CONFIG_MTD_NAND_RTK_DIE_ON_ECC 
	...
	/* KIOXIA */
	{
		.id = KIOXIA_RDID_TC58CVG0S3HRAIJ,
		.isLastPage = 0,
		.id_len = 3,
		.pagesize = 0x800,
		.oobsize = 64,
