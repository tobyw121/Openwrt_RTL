...
#define RTK_API_LOCK()      local_irq_save(irq_flags)
#define RTK_API_UNLOCK()     local_irq_restore(irq_flags)
#endif
...
#define RTK_MAX_BUF_PAGE_NUM                (rtk_switch_maxBufferPageNum_get())
