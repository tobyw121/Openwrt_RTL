...
#define RTK_QUE			1
#if defined(CONFIG_NET_WIRELESS_AGN) || defined (CONFIG_RTL8192SE) || defined(CONFIG_RTL8192CD) || defined(CONFIG_RTL8192CD_MODULE) || defined(CONFIG_WIFI5_BRSC)
...
#define	RTL_LANVLANID_2		3
#define	RTL_LANVLANID_3		4
#define	RTL_LANVLANID_4		5
#define RTL_LANVLANID_5		6
#endif
#endif
...
#define RTL_PS_WAN0_DEV_NAME RTL_PS_BR_WAN_DEV_NAME
#else
#define RTL_PS_WAN0_DEV_NAME RTL_DEV_NAME_NUM(RTL_PS_ETH_NAME,1)
#endif
#define RTL_PS_PPP0_DEV_NAME ppp_ext
...
#define RTL_LAN_DEVICE_NAME CONFIG_TP_LAN_BRIDGE_NAME
#define RTL_GW_WAN_DEVICE_NAME "br1"
#define RTL_WISP_WAN_DEVICE_NAME "wlan0"
#define RTL_BR_WAN_DEVICE_NAME CONFIG_TP_LAN_BRIDGE_NAME
#endif
...
extern __MIPS16  struct net_device *rtl_get_shortcut_dev(unsigned char *da);
...
#define RTL_TRAP_BR_SUBNET_PKT_FROM_WAN_TO_CPU 1
