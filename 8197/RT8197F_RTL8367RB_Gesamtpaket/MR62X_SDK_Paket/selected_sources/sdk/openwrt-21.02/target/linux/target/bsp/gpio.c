...
#if defined(CONFIG_RTL_8197F_VG_GPIO_V355I)
#define BSP_RESET_BTN_PIN		BSP_GPIO_PIN_E4
#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_E4

/* shared */
#define BSP_RESET_LED_PIN		BSP_GPIO_PIN_E3
#define BSP_WPS_LED_PIN		BSP_GPIO_PIN_E3

/* 8367R */
#define BSP_8367R_RST_PIN		BSP_GPIO_PIN_H2
#if defined(CONFIG_RTL_MDC_D1_MDIO_D7)
/* MDC, I2C clock */
#define BSP_8367R_I2C_PIN1		BSP_GPIO_PIN_D1
/* MDIO, I2C date */
#define BSP_8367R_I2C_PIN2		BSP_GPIO_PIN_D7
#else //MDC_D5_MDIO_D7
#define BSP_8367R_I2C_PIN1		BSP_GPIO_PIN_D5
#define BSP_8367R_I2C_PIN2		BSP_GPIO_PIN_D7
#endif

#define BSP_8367R_RST_PIN_97FN		BSP_GPIO_PIN_H2
#define BSP_8367R_I2C_PIN1_97FN		BSP_GPIO_PIN_H0

	#ifdef CONFIG_RTL_MDC_H0_MDIO_G7
	#define BSP_8367R_I2C_PIN2_97FN		BSP_GPIO_PIN_G7
	#else
	#define BSP_8367R_I2C_PIN2_97FN		BSP_GPIO_PIN_C3
	#endif
	
#elif defined(CONFIG_RTL_8197F_VG_GPIO_V612)
#define BSP_RESET_BTN_PIN		BSP_GPIO_PIN_C3
//#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_C1
#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_C3

/* shared */
#define BSP_RESET_LED_PIN		BSP_GPIO_PIN_B7
#define BSP_WPS_LED_PIN		BSP_GPIO_PIN_B7
#elif defined(CONFIG_RTL_8197F_VG_GPIO_V672)
/* shared */
#define BSP_RESET_BTN_PIN		BSP_GPIO_PIN_G6
#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_G6

/* shared */
#define BSP_RESET_LED_PIN		BSP_GPIO_PIN_H1
#define BSP_WPS_LED_PIN		BSP_GPIO_PIN_H1

#define BSP_RESET_WPS_BTN_PIN		BSP_GPIO_PIN_E1

/* shared */
#define BSP_ORANGE_LED_PIN		BSP_GPIO_PIN_G6
#define BSP_GREEN_LED_PIN		BSP_GPIO_PIN_C3
...
#elif defined(CONFIG_RTL_8197F_VG_GPIO_V622G)
/* shared */
#define BSP_RESET_BTN_PIN		BSP_GPIO_PIN_G6
#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_G6
/* shared */
...
#elif defined(CONFIG_RTL_8197F_GPIO_V672)
/* shared */
#define BSP_RESET_BTN_PIN		BSP_GPIO_PIN_G6
#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_G6
...
#endif
/* Button devices */
static struct gpio_keys_button keys_btn1[] = 
{
	{
		.code		= KEY_RESTART,
		.gpio		= BSP_RESET_WPS_BTN_PIN,
		.active_low	= 1,
		.desc		= "reset wps btn",
		.type		= EV_KEY,
	},
...
static struct gpio_keys_platform_data rtl_pdata_btn1 = {
	.buttons		= keys_btn1,
	.nbuttons 		= ARRAY_SIZE(keys_btn1),
	.poll_interval  = 50,
};
...
static int __init rtl819x_gpio_peripheral_init(void)
{
	...
	rtl_pdata_led1.gpio = BSP_ORANGE_LED_PIN;
#if !defined(CONFIG_P3_GPIO)
	rtl_pdata_led2.gpio = BSP_GREEN_LED_PIN;
#endif
//	rtl_pdata_btn1.gpio = BSP_RESET_WPS_BTN_PIN;
#if !defined(CONFIG_I2C_DESIGNWARE_PLATFORM)//joyce
#if !defined(CONFIG_P3_GPIO)
...
//		rtl_pdata_gpio2.gpio = BSP_8367R_I2C_PIN1; /* MDC */
//		rtl_pdata_gpio3.gpio = BSP_8367R_I2C_PIN2; /* MDIO */
	}
#endif
