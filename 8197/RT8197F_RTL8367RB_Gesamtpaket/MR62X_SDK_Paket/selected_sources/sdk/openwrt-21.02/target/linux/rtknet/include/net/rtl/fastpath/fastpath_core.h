...
void unregister_customRspStr(void);
 int  GenerateHTTP401(void *skb);
	...
	extern unsigned int ipv6_rtcache;
	extern int __init ipv6_fast_forward_table_init(void);
	extern void __exit ipv6_fast_forward_table_exit(void);
#endif
...
#define RTL_FASTPATH_PPP0_DEV_NAME	"l2tp-internet"
...
unsigned int rtl_nf_rtcache_in(int pf, struct sk_buff *skb,const void *entry_ct);
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3,10,0)
...
static inline int rtl_call_skb_ndo_start_xmit(struct sk_buff *skb)
{
