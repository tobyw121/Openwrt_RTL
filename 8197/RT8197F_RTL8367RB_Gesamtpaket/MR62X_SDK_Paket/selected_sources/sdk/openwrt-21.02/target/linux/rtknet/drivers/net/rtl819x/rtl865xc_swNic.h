...
#define RESERVERD_MBUF_RING_NUM			8
	...
	#else
	#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8812FE)
	#define MAX_PRE_ALLOC_RX_SKB		2560
...
#if defined(CONFIG_RTL_NIC_MULTI_TX_RING)
...
#define	NUM_TX_DESC_MR			NUM_TX_PKTHDR_DESC // 512, since we use 4 ring, may decrease NUM_TX_PKTHDR_DESC ?

#if (NUM_TX_DESC_MR != NUM_TX_PKTHDR_DESC)
#undef	NUM_TX_PKTHDR_DESC	
#define	NUM_TX_PKTHDR_DESC		NUM_TX_DESC_MR
#endif

#define	NUM_TX_PKTHDR_DESC1		NUM_TX_DESC_MR
#define	NUM_TX_PKTHDR_DESC2		NUM_TX_DESC_MR
#define	NUM_TX_PKTHDR_DESC3		NUM_TX_DESC_MR

#define	RTL_CPU_RX_RING_NUM			1

#define	ETH_REFILL_THRESHOLD1	0
#define	ETH_REFILL_THRESHOLD2	0
#define	ETH_REFILL_THRESHOLD3	0
#define	ETH_REFILL_THRESHOLD4	0
#define	ETH_REFILL_THRESHOLD5	0
...
#elif defined(RTL_MULTIPLE_RX_TX_RING)
...
#define	RTL8651_IOCTL_GETALLPORTSTATUS			2005
