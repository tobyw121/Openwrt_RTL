...
extern char ppp_ext[64];
extern int ppp_ext_len;
...
#define RTL865X_ACL_BR_SUBNET_FROM_WAN_USED	-19000
				...
				struct
				{
					...
					union
					{
						...
						struct
						{
							...
							uint8 	_MF:1,		//more fragments flag
...
#define NETIF_MAPPING_NUMBER 32
...
#else
#define RTL_BR_NAME CONFIG_TP_LAN_BRIDGE_NAME
#endif
...
#else
#define RTL_DRV_LAN_NETIF_NAME CONFIG_TP_LAN_BRIDGE_NAME
#endif
#else
...
#define RTL_DRV_WAN0_NETIF_NAME "br-wan"
#if defined(CONFIG_RTL_BR_WAN_VLAN_SUPPORT)
#define RTL_PS_BR_WAN_DEV_NAME	"br-wan"
#define RTL_DRV_BR_WAN_NETIF_NAME "br-wan"
#endif
...
#define RTL_DRV_PPP_NETIF_NAME "pppoe-internet"
#else
//#define RTL_DRV_PPP_NETIF_NAME "ppp0"
#define RTL_DRV_PPP_NETIF_NAME ppp_ext
#endif
...
*************************************/
#define	RTL_WANVLANID			1
#define	RTL_LANVLANID			2
#if defined(CONFIG_RTL_MULTIPLE_WAN)
#define	RTL_WAN_1_VLANID		10
#endif
	...
	#define	RTL8366RB_WANPORT		0x10
		...
		#define	RTL_LANPORT_MASK		0x12f
			...
			#define	RTL_LANPORT_MASK			0x108
			#define RTL_WANPORT_MASK			0x2
			#else
			#define RTL_WANPORT_MASK		0x04 //port0
			#define RTL_LANPORT_MASK		0x11b
			//#define RTL_WANPORT_MASK		0x01 //port0
...
#define	RTL_LANPORT_MASK		0x110
	...
	#ifndef RTL_LANPORT_MASK_1
		#if defined(CONFIG_RTL_EXCHANGE_PORTMASK)
		#define 	RTL_LANPORT_MASK_1		0x10
		#define 	RTL_LANPORT_MASK_2		0x8
		#define 	RTL_LANPORT_MASK_3		0x4
		#define 	RTL_LANPORT_MASK_4		0x2		
		#else
		#define 	RTL_LANPORT_MASK_1		0x8
		#define		RTL_LANPORT_MASK_2		0x4
		#define 	RTL_LANPORT_MASK_3		0x2
		#define 	RTL_LANPORT_MASK_4		0x1
		#endif
	#endif
#endif
