...
#define	EGRESS_BANDWIDTH_GRANULARITY_97H		0x400	/* 	1*1024	 */
#endif
#else
...
#if defined(CONFIG_TPLINK_QOS)
#define	EGRESS_BANDWIDTH_GRANULARITY_BITLEN_97H	10
#define EGRESS_BANDWIDTH_GRANULARITY_BYTELEN_97H EGRESS_BANDWIDTH_GRANULARITY_BITLEN_97H-3
#endif
#else
#if defined(CONFIG_RTL_8197F)
