...
#define MAX_BLACKLIST_MAC_NUM 32
#define DEL_BLACKLIST_MAC_FLAG	0
#define ADD_BLACKLIST_MAC_FLAG	1
#define CLEAR_BLACKLIST_MAC_FLAG 2

struct rtl865x_blackListMCastRecord
{
	uint8 mac[6];
	unsigned int valid;
};
...
#define CONFIG_IGMP_DEBUG 1
#if defined(CONFIG_IGMP_DEBUG)
extern int igmpsnoop_debug;
#define RTL_IGMP_PRINT(format, args...)\
	if(unlikely(igmpsnoop_debug))\
