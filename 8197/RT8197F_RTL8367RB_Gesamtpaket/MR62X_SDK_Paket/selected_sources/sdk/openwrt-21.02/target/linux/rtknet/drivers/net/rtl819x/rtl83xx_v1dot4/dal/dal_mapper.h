...
typedef struct dal_mapper_s {
    ...
    rtk_api_ret_t (*stat_port_get_in_out)(rtk_port_t, rtk_stat_port_cntr_t *);
    ...
    rtk_api_ret_t (*stat_port_getSerial)(rtk_port_t, rtk_stat_port_cntr_t *);
    ...
    rtk_api_ret_t (*port_duplexAutoChange_set)(rtk_enable_t);
    rtk_api_ret_t (*port_duplexAutoChange_get)(rtk_enable_t *);
    rtk_api_ret_t (*port_macForceLinkExtSSC_set)(rtk_port_t, rtk_enable_t);
    rtk_api_ret_t (*port_macForceLinkExtSSC_get)(rtk_port_t, rtk_enable_t *);
    rtk_api_ret_t (*port_autoDownSpeed10M_set)(rtk_enable_t);
    rtk_api_ret_t (*port_autoDownSpeed10M_get)(rtk_enable_t *);
