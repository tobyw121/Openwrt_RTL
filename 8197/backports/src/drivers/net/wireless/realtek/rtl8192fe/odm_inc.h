...
#if defined(DM_ODM_SUPPORT_TYPE)
...
#define		platform_stall_execution					odm_stall_execution

#if 0//ndef WLAN_HAL_INTERNAL_USED
#if defined(REG_ARFR0)
#undef  REG_ARFR0       /*redefined*/
#endif
#if defined(REG_ARFR1)
#undef  REG_ARFR1       /*redefined*/
#endif
#if defined(REG_ARFR2)
#undef  REG_ARFR2       /*redefined*/
#endif
#if defined(REG_ARFR3)
#undef  REG_ARFR3       /*redefined*/
#endif
