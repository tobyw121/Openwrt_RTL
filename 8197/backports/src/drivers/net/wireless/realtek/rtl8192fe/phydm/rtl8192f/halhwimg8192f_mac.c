...
const u32 array_mp_8192f_mac_reg[] = {
		0x420, 0x00000000,
		0x422, 0x00000078,
		0x428, 0x0000000A,
		0x429, 0x00000010,
	...
	0x9100000f,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000010,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000011,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000012,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000013,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000014,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000015,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
	0x91000016,	0x00000000,	0x40000000,	0x00000000,
		0x024, 0x000000DB,
...
void
odm_read_and_config_mp_8192f_mac_reg(struct dm_struct *dm)
{
	u32	i = 0;
	u8	c_cond;
	boolean	is_matched = true, is_skipped = false;
	u32	array_len =
			sizeof(array_mp_8192f_mac_reg) / sizeof(u32);
	u32	*array = (u32 *)array_mp_8192f_mac_reg;
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT(30))) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_mac_8192f(dm, v1, (u8)v2);
		}
		i = i + 2;
	}
}
...
u32
odm_get_version_mp_8192f_mac_reg(void)
{
		return 63;
}
