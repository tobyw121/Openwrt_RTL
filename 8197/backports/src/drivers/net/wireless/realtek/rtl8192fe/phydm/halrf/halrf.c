...
#if (RTL8723F_SUPPORT == 1)
    RF_DBG(dm, DBG_RF_TX_PWR_TRACK, "HALRF_Init tssi!\n");
    halrf_tssi_trigger(dm);
#endif
...
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#if (RTL8197F_SUPPORT == 1)	|| (RTL8192F_SUPPORT == 1) || (RTL8198F_SUPPORT == 1) ||(RTL8814B_SUPPORT == 1)
	struct dm_dpk_info *dpk_info = &dm->dpk_info;
#endif
	switch (dm->support_ic_type) {
#if (RTL8195B_SUPPORT == 1)
...
{
#if (RTL8822C_SUPPORT == 1) || (RTL8812F_SUPPORT == 1) || (RTL8814B_SUPPORT == 1) || (RTL8197G_SUPPORT == 1) || (RTL8723F_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
...
{
#if (RTL8822C_SUPPORT == 1) || (RTL8812F_SUPPORT == 1) || (RTL8197G_SUPPORT == 1) || (RTL8723F_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
...
{
#if (RTL8822C_SUPPORT == 1) || (RTL8814B_SUPPORT == 1) || (RTL8812F_SUPPORT == 1) || (RTL8197G_SUPPORT == 1) || (RTL8723F_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
...
{
#if (RTL8814B_SUPPORT == 1) || (RTL8822C_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
...
{
#if (RTL8814B_SUPPORT == 1) || (RTL8822C_SUPPORT == 1) || (RTL8812F_SUPPORT == 1) || (RTL8197G_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
#if (RTL8814B_SUPPORT == 1)
	if (dm->support_ic_type & ODM_RTL8814B) {
...
void halrf_tssi_clean_de(
	void *dm_void)
{
#if (RTL8812F_SUPPORT == 1) || (RTL8814B_SUPPORT == 1) || (RTL8197G_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
#if (RTL8812F_SUPPORT == 1)
	if (dm->support_ic_type & ODM_RTL8812F)
...
{
#if (RTL8822C_SUPPORT == 1) || (RTL8812F_SUPPORT == 1) || (RTL8814B_SUPPORT == 1) || (RTL8197G_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
