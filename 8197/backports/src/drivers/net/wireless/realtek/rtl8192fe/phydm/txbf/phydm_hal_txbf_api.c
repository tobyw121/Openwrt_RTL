...
#include "phydm_precomp.h"
	...
	RTL8822C_SUPPORT == 1 || RTL8198F_SUPPORT == 1 || RTL8814B_SUPPORT == 1 || RTL8812F_SUPPORT)
...
void phydm_bf_debug(void *dm_void, char input[][16], u32 *_used, char *output,
		    u32 *_out_len)
{
#if ((DM_ODM_SUPPORT_TYPE & (ODM_WIN | ODM_CE)) && defined(PHYDM_BEAMFORMING_SUPPORT)) //|| defined(PHYDM_IC_JGR3_SERIES_SUPPORT)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
	char help[] = "-h";
	u32 var1[3] = {0};
