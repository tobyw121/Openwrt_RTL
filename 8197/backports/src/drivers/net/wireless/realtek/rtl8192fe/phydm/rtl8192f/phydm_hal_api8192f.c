...
)
{
	if (dm->rfe_type == 7) {
	...
	} else if ((dm->rfe_type == 15) || (dm->rfe_type == 20)) {
		/*CUTB+RFE15(PCIE QFN46_NXP_BGS8324_iPA+RXFEM wi RX bypass mode)*/
		odm_set_bb_reg(dm, R_0x103c, 0x70000, 0x7);
		odm_set_bb_reg(dm, R_0x4c, 0x6c00000, 0x0);
		odm_set_bb_reg(dm, R_0x64, BIT(29) | BIT(28), 0x3);
		odm_set_bb_reg(dm, R_0x1038, 0x600000 | BIT(4), 0x0);
		odm_set_bb_reg(dm, R_0x944, MASK12BITS, 0x081F);
		odm_set_bb_reg(dm, R_0x930, 0xFFFFF, 0x32320);
		odm_set_bb_reg(dm, R_0x938, 0xFFFFF, 0x32302);
		odm_set_bb_reg(dm, R_0x934, 0xF000, 0x2);
		odm_set_bb_reg(dm, R_0x93c, 0xF000, 0x2);
		odm_set_bb_reg(dm, R_0x92c, MASKDWORD, 0x00150016);
		odm_set_bb_reg(dm, R_0x968, BIT(2), 0x0);
		odm_set_bb_reg(dm, R_0x920, MASKDWORD, 0x03000003);
		if (tx_path == BB_PATH_A || rx_path == BB_PATH_A)
		...
		/*CUTB+RFE16(PCIE QFN46_SKY85333 wi RX bypass mode)*/
		odm_set_bb_reg(dm, R_0x103c, 0x70000, 0x7);
		odm_set_bb_reg(dm, R_0x4c, 0x6c00000, 0x0);
		odm_set_bb_reg(dm, R_0x64, BIT(29) | BIT(28), 0x3);
		odm_set_bb_reg(dm, R_0x1038, 0x600000 | BIT(4), 0x0);
		odm_set_bb_reg(dm, R_0x944, MASK12BITS, 0x00000017);
		odm_set_bb_reg(dm, R_0x940, MASKDWORD, 0x00000104);
		odm_set_bb_reg(dm, R_0x930, 0xF, 0x0);
		odm_set_bb_reg(dm, R_0x930, 0xF00, 0x3);
		odm_set_bb_reg(dm, R_0x938, 0xF0, 0x0);
		odm_set_bb_reg(dm, R_0x938, 0xF0000, 0x3);
		odm_set_bb_reg(dm, R_0x92c, MASKDWORD, 0x00000000);
		odm_set_bb_reg(dm, R_0x968, BIT(2), 0x0);
		odm_set_bb_reg(dm, R_0x920, MASKDWORD, 0x04000004);
		odm_set_bb_reg(dm, R_0x91c, BIT(13) | BIT(12), 0x0);
		
		odm_cmn_info_init(dm, ODM_CMNINFO_EXT_LNA, true);
		odm_cmn_info_init(dm, ODM_CMNINFO_EXT_PA, true);
	} else if (dm->rfe_type == 17 || dm->rfe_type == 21) {
		/*CUTB+RFE17(PCIE QFN46_RTC7646 wi RX bypass mode)*/
		odm_set_bb_reg(dm, R_0x103c, 0x70000, 0x7);
		odm_set_bb_reg(dm, R_0x4c, 0x6c00000, 0x0);
		odm_set_bb_reg(dm, R_0x64, BIT(29) | BIT(28), 0x3);
		odm_set_bb_reg(dm, R_0x1038, 0x600000 | BIT(4), 0x0);
		odm_set_bb_reg(dm, R_0x944, MASK12BITS, 0x0000081F);
		odm_set_bb_reg(dm, R_0x940, MASKDWORD,  0x00400104);
		odm_set_bb_reg(dm, R_0x930, 0xF, 0x0);
		odm_set_bb_reg(dm, R_0x930, 0xFF00, 0x43);
		odm_set_bb_reg(dm, R_0x938, 0xF0, 0x0);
		odm_set_bb_reg(dm, R_0x938, 0xF0000, 0x3);
		odm_set_bb_reg(dm, R_0x93c, 0xf000, 0x4);
		odm_set_bb_reg(dm, R_0x92c, MASKDWORD, 0x00000000);
			        
		odm_set_bb_reg(dm, R_0x968, BIT(2) | BIT(1), 0x1);
		odm_set_bb_reg(dm, R_0x908, 0xF00000, 0x8);
		odm_set_bb_reg(dm, R_0x91c, 0x3F00, 0x1);
			        
		odm_set_bb_reg(dm, R_0x920, 0x3F, 0x3);
		odm_set_bb_reg(dm, R_0x920, 0x3FFFC000, 0x0C18);
		odm_set_bb_reg(dm, R_0x858, 0xFF, 0xA5);
		odm_set_bb_reg(dm, R_0x858, 0xFF0000, 0xA5);
		odm_cmn_info_init(dm, ODM_CMNINFO_EXT_LNA, true);
		odm_cmn_info_init(dm, ODM_CMNINFO_EXT_PA, true);
	} else if (dm->rfe_type ==18) {
		/*CUTB+RFE18(PCIE QFN46_RTC66232 wi RX bypass mode) */
		odm_set_bb_reg(dm, R_0x103c, 0x70000, 0x7);
		odm_set_bb_reg(dm, R_0x4c, 0x6c00000, 0x0);
		odm_set_bb_reg(dm, R_0x64, BIT(29) | BIT(28), 0x3);
		odm_set_bb_reg(dm, R_0x1038, 0x600000 | BIT(4), 0x0);
		...
		odm_set_bb_reg(dm, R_0x920, 0x3F, 0x4);
		odm_set_bb_reg(dm, R_0x920, 0x3FFFC000, 0x1018);
		odm_set_bb_reg(dm, R_0x858, 0xFF, 0xA5);
		odm_set_bb_reg(dm, R_0x858, 0xFF0000, 0xA5);
		odm_cmn_info_init(dm, ODM_CMNINFO_EXT_LNA, true);
		odm_cmn_info_init(dm, ODM_CMNINFO_EXT_PA, true);
	} else if (dm->rfe_type == 19) {
		/*CUTB+RFE19(PCIE QFN46_NXP_BGS8324_iPA+RXFEM wi RX bypass mode)*/
		odm_set_bb_reg(dm, R_0x103c, 0x70000, 0x7);
		odm_set_bb_reg(dm, R_0x4c, 0x6c00000, 0x0);
		odm_set_bb_reg(dm, R_0x64, BIT(29) | BIT(28), 0x3);
		odm_set_bb_reg(dm, R_0x1038, 0x600000 | BIT(4), 0x0);
