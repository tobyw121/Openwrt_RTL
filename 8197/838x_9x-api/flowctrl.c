...
rtk_flowctrl_init(uint32 unit)
{
    ...
    return RT_MAPPER(unit)->flowctrl_init(unit);
} /* end of rtk_flowctrl_init */
...
rtk_flowctrl_portEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEnable_get(unit, port, pEnable);
} /* end of rtk_flowctrl_portEnable_get */
...
rtk_flowctrl_portEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEnable_set(unit, port, enable);
} /* end of rtk_flowctrl_portEnable_set */
...
rtk_flowctrl_portPauseForceModeEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portPauseForceModeEnable_get(unit, port, pEnable);
} /* end of rtk_flowctrl_portPauseForceModeEnable_get */
...
rtk_flowctrl_portPauseForceModeEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portPauseForceModeEnable_set(unit, port, enable);
} /* end of rtk_flowctrl_portPauseForceModeEnable_set */
    ...
    rtk_flowctrl_pauseOnAction_t    *pAction)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAction_get(unit, phy_port, pAction);
    }
#else
    return RT_MAPPER(unit)->flowctrl_pauseOnAction_get(unit, port, pAction);
#endif
} /* end of rtk_flowctrl_pauseOnAction_get */
    ...
    rtk_flowctrl_pauseOnAction_t    action)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAction_set(unit, phy_port, action);
    }
#else
    return RT_MAPPER(unit)->flowctrl_pauseOnAction_set(unit, port, action);
#endif
} /* end of rtk_flowctrl_pauseOnAction_set */
...
rtk_flowctrl_pauseOnAllowedPageNum_get(uint32 unit, rtk_port_t port, uint32 *pPageNum)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPageNum_get(unit, phy_port, pPageNum);
    }
#else
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPageNum_get(unit, port, pPageNum);
#endif
} /* end of rtk_flowctrl_pauseOnAllowedPageNum_get */
...
rtk_flowctrl_pauseOnAllowedPageNum_set(uint32 unit, rtk_port_t port, uint32 pageNum)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPageNum_set(unit, phy_port, pageNum);
    }
#else
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPageNum_set(unit, port, pageNum);
#endif
} /* end of rtk_flowctrl_pauseOnAllowedPageNum_set */
...
rtk_flowctrl_pauseOnAllowedPktLen_get(uint32 unit, rtk_port_t port, uint32 *pPktLen)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPktLen_get(unit, port, pPktLen);
} /* end of rtk_flowctrl_pauseOnAllowedPktLen_get */
...
rtk_flowctrl_pauseOnAllowedPktLen_set(uint32 unit, rtk_port_t port, uint32 pktLen)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPktLen_set(unit, port, pktLen);
} /* end of rtk_flowctrl_pauseOnAllowedPktLen_set */
...
rtk_flowctrl_pauseOnAllowedPktNum_get(uint32 unit, rtk_port_t port, uint32 *pPktNum)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPktNum_get(unit, port, pPktNum);
} /* end of rtk_flowctrl_pauseOnAllowedPktNum_get */
...
rtk_flowctrl_pauseOnAllowedPktNum_set(uint32 unit, rtk_port_t port, uint32 pktNum)
{
    ...
    return RT_MAPPER(unit)->flowctrl_pauseOnAllowedPktNum_set(unit, port, pktNum);
} /* end of rtk_flowctrl_pauseOnAllowedPktNum_set */
...
rtk_flowctrl_igrSystemPauseThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrSystemPauseThresh_get(unit, pThresh);
} /* end of rtk_flowctrl_igrSystemPauseThresh_get */
...
rtk_flowctrl_igrSystemPauseThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrSystemPauseThresh_set(unit, pThresh);
} /* end of rtk_flowctrl_igrSystemPauseThresh_set */
...
rtk_flowctrl_igrPortPauseThresh_get(uint32 unit, rtk_port_t port, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPortPauseThresh_get(unit, port, pThresh);
} /* end of rtk_flowctrl_igrPortPauseThresh_get */
...
rtk_flowctrl_igrPortPauseThresh_set(uint32 unit, rtk_port_t port, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPortPauseThresh_set(unit, port, pThresh);
} /* end of rtk_flowctrl_igrPortPauseThresh_set */
...
rtk_flowctrl_igrPauseThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPauseThreshGroup_get(unit, grp_idx, pThresh);
} /* end of rtk_flowctrl_igrPauseThreshGroup_get */
...
rtk_flowctrl_igrPauseThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPauseThreshGroup_set(unit, grp_idx, pThresh);
} /* end of rtk_flowctrl_igrPauseThreshGroup_set */
...
rtk_flowctrl_igrPortPauseThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPortPauseThreshGroupSel_get(unit, phy_port, pGrp_idx);
    }
#else
    return RT_MAPPER(unit)->flowctrl_igrPortPauseThreshGroupSel_get(unit, port, pGrp_idx);
#endif
} /* end of rtk_flowctrl_igrPortPauseThreshGroupSel_get */
...
rtk_flowctrl_igrPortPauseThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPortPauseThreshGroupSel_set(unit, phy_port, grp_idx);
    }
#else
    return RT_MAPPER(unit)->flowctrl_igrPortPauseThreshGroupSel_set(unit, port, grp_idx);
#endif
} /* end of rtk_flowctrl_igrPortPauseThreshGroupSel_set */
...
rtk_flowctrl_egrPortDropMode_get(uint32 unit, rtk_port_t port, rtk_flowctrl_egrDropMode_t *pDropMode)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropMode_get(unit, port, pDropMode);
} /* end of rtk_flowctrl_egrPortDropMode_get */
...
rtk_flowctrl_egrPortDropMode_set(uint32 unit, rtk_port_t port, rtk_flowctrl_egrDropMode_t dropMode)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropMode_set(unit, port, dropMode);
} /* end of rtk_flowctrl_egrPortDropMode_set */
...
rtk_flowctrl_egrPortDropForceModeEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropForceModeEnable_get(unit, port, pEnable);
} /* end of rtk_flowctrl_egrPortDropForceModeEnable_get */
...
rtk_flowctrl_egrPortDropForceModeEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropForceModeEnable_set(unit, port, enable);
} /* end of rtk_flowctrl_egrPortDropForceModeEnable_set */
...
rtk_flowctrl_igrSystemCongestThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrSystemCongestThresh_get(unit, pThresh);
} /* end of rtk_flowctrl_igrSystemCongestThresh_get */
...
rtk_flowctrl_igrSystemCongestThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrSystemCongestThresh_set(unit, pThresh);
} /* end of rtk_flowctrl_igrSystemCongestThresh_set */
...
rtk_flowctrl_igrPortCongestThresh_get(uint32 unit, rtk_port_t port, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPortCongestThresh_get(unit, port, pThresh);
} /* end of rtk_flowctrl_igrPortCongestThresh_get */
...
rtk_flowctrl_igrPortCongestThresh_set(uint32 unit, rtk_port_t port, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrPortCongestThresh_set(unit, port, pThresh);
} /* end of rtk_flowctrl_igrPortCongestThresh_set */
...
rtk_flowctrl_igrCongestThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrCongestThreshGroup_get(unit, grp_idx, pThresh);
} /* end of rtk_flowctrl_igrCongestThreshGroup_get */
...
rtk_flowctrl_igrCongestThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrCongestThreshGroup_set(unit, grp_idx, pThresh);
} /* end of rtk_flowctrl_igrCongestThreshGroup_set */
...
rtk_flowctrl_egrSystemDropThresh_get(uint32 unit, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrSystemDropThresh_get(unit, pThresh);
} /* end of rtk_flowctrl_egrSystemDropThresh_get */
...
rtk_flowctrl_egrSystemDropThresh_set(uint32 unit, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrSystemDropThresh_set(unit, pThresh);
} /* end of rtk_flowctrl_egrSystemDropThresh_set */
...
rtk_flowctrl_egrPortDropThresh_get(uint32 unit, rtk_port_t port, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropThresh_get(unit, port, pThresh);
} /* end of rtk_flowctrl_egrPortDropThresh_get */
...
rtk_flowctrl_egrPortDropThresh_set(uint32 unit, rtk_port_t port, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropThresh_set(unit, port, pThresh);
} /* end of rtk_flowctrl_egrPortDropThresh_set */
    ...
    rtk_flowctrl_drop_thresh_t  *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropThresh_get(unit, port, queue, pThresh);
} /* end of rtk_flowctrl_egrPortQueueDropThresh_get */
    ...
    rtk_flowctrl_drop_thresh_t  *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropThresh_set(unit, port, queue, pThresh);
} /* end of rtk_flowctrl_egrPortQueueDropThresh_set */
...
rtk_flowctrl_egrPortQueueDropEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropEnable_get(unit, port, pEnable);
} /* end of rtk_flowctrl_egrPortQueueDropEnable_get */
...
rtk_flowctrl_egrPortQueueDropEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropEnable_set(unit, port, enable);
} /* end of rtk_flowctrl_egrPortQueueDropEnable_set */
...
rtk_flowctrl_egrQueueDropThresh_get(uint32 unit, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrQueueDropThresh_get(unit, queue, pThresh);
} /* end of rtk_flowctrl_egrQueueDropThresh_get */
...
rtk_flowctrl_egrQueueDropThresh_set(uint32 unit, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrQueueDropThresh_set(unit, queue, pThresh);
} /* end of rtk_flowctrl_egrQueueDropThresh_set */
...
rtk_flowctrl_egrCpuQueueDropThresh_get(uint32 unit, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrCpuQueueDropThresh_get(unit, queue, pThresh);
} /* end of rtk_flowctrl_egrCpuQueueDropThresh_get */
...
rtk_flowctrl_egrCpuQueueDropThresh_set(uint32 unit, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrCpuQueueDropThresh_set(unit, queue, pThresh);
} /* end of rtk_flowctrl_egrCpuQueueDropThresh_set */
...
rtk_flowctrl_egrPortDropRefCongestEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropRefCongestEnable_set(unit, phy_port, enable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrPortDropRefCongestEnable_set(unit, port, enable);
#endif
} /* end of rtk_flowctrl_egrPortDropRefCongestEnable_set */
...
rtk_flowctrl_egrPortDropRefCongestEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropRefCongestEnable_get(unit, phy_port, pEnable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrPortDropRefCongestEnable_get(unit, port, pEnable);
#endif
} /* end of rtk_flowctrl_egrPortDropRefCongestEnable_get */
...
rtk_flowctrl_egrPortDropThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropThreshGroup_get(unit, grp_idx, pThresh);
} /* end of rtk_flowctrl_egrPortDropThreshGroup_get */
...
rtk_flowctrl_egrPortDropThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropThreshGroup_set(unit, grp_idx, pThresh);
} /* end of rtk_flowctrl_egrPortDropThreshGroup_set */
...
rtk_flowctrl_egrQueueDropThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrQueueDropThreshGroup_get(unit, grp_idx, queue, pThresh);
} /* end of rtk_flowctrl_egrQueueDropThreshGroup_get */
...
rtk_flowctrl_egrQueueDropThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrQueueDropThreshGroup_set(unit, grp_idx, queue, pThresh);
} /* end of rtk_flowctrl_egrQueueDropThreshGroup_set */
...
rtk_flowctrl_igrQueueDropEnable_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueueDropEnable_get(unit, phy_port, queue, pEnable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_igrQueueDropEnable_get(unit, port, queue, pEnable);
#endif
} /* end of rtk_flowctrl_igrQueueDropEnable_get */
...
rtk_flowctrl_igrQueueDropEnable_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueueDropEnable_set(unit, phy_port, queue, enable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_igrQueueDropEnable_set(unit, port, queue, enable);
#endif
} /* end of rtk_flowctrl_igrQueueDropEnable_set */
...
rtk_flowctrl_igrQueuePauseThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueuePauseThreshGroup_get(unit, grp_idx, queue, pThresh);
} /* end of rtk_flowctrl_igrQueuePauseThreshGroup_get */
...
rtk_flowctrl_igrQueuePauseThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueuePauseThreshGroup_set(unit, grp_idx, queue, pThresh);
} /* end of rtk_flowctrl_igrQueuePauseThreshGroup_set */
...
rtk_flowctrl_igrQueuePauseDropThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueuePauseDropThreshGroupSel_get(unit, phy_port, pGrp_idx);
    }
#else
    return RT_MAPPER(unit)->flowctrl_igrQueuePauseDropThreshGroupSel_get(unit, port, pGrp_idx);
#endif
} /* end of rtk_flowctrl_igrQueuePauseDropThreshGroupSel_get */
...
rtk_flowctrl_igrQueuePauseDropThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueuePauseDropThreshGroupSel_set(unit, phy_port, grp_idx);
    }
#else
    return RT_MAPPER(unit)->flowctrl_igrQueuePauseDropThreshGroupSel_set(unit, port, grp_idx);
#endif
} /* end of rtk_flowctrl_igrQueuePauseDropThreshGroupSel_set */
...
rtk_flowctrl_egrPortQueueDropThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropThreshGroupSel_get(unit, phy_port, pGrp_idx);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropThreshGroupSel_get(unit, port, pGrp_idx);
#endif
} /* end of rtk_flowctrl_egrPortQueueDropThreshGroupSel_get */
...
rtk_flowctrl_egrPortQueueDropThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropThreshGroupSel_set(unit, phy_port, grp_idx);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrPortQueueDropThreshGroupSel_set(unit, port, grp_idx);
#endif
} /* end of rtk_flowctrl_egrPortQueueDropThreshGroupSel_set */
...
rtk_flowctrl_egrQueueDropEnable_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrQueueDropEnable_get(unit, phy_port, queue, pEnable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrQueueDropEnable_get(unit, port, queue, pEnable);
#endif
} /* end of rtk_flowctrl_egrQueueDropEnable_get */
...
rtk_flowctrl_egrQueueDropEnable_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrQueueDropEnable_set(unit, phy_port, queue, enable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrQueueDropEnable_set(unit, port, queue, enable);
#endif
} /* end of rtk_flowctrl_egrQueueDropEnable_set */
...
rtk_flowctrl_egrPortDropEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropEnable_get(unit, phy_port, pEnable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrPortDropEnable_get(unit, port, pEnable);
#endif
} /* end of rtk_flowctrl_egrPortDropEnable_get */
...
rtk_flowctrl_egrPortDropEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrPortDropEnable_set(unit, phy_port, enable);
    }
#else
    return RT_MAPPER(unit)->flowctrl_egrPortDropEnable_set(unit, port, enable);
#endif
} /* end of rtk_flowctrl_egrPortDropEnable_set */
...
rtk_flowctrl_specialCongestThreshold_get(uint32 unit, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_specialCongestThreshold_get(unit, pThresh);
} /* end of rtk_flowctrl_specialCongestThreshold_get */
...
rtk_flowctrl_specialCongestThreshold_set(uint32 unit, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_specialCongestThreshold_set(unit, pThresh);
} /* end of rtk_flowctrl_specialCongestThreshold_set */
...
rtk_flowctrl_igrQueueDropThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueueDropThreshGroup_get(unit, grp_idx, queue, pThresh);
} /* end of rtk_flowctrl_igrQueueDropThreshGroup_get */
...
rtk_flowctrl_igrQueueDropThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueueDropThreshGroup_set(unit, grp_idx, queue, pThresh);
} /* end of rtk_flowctrl_igrQueueDropThreshGroup_set */
...
rtk_flowctrl_portHolTrafficDropEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portHolTrafficDropEnable_get(unit, port, pEnable);
}
...
rtk_flowctrl_portHolTrafficDropEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portHolTrafficDropEnable_set(unit, port, enable);
}
...
rtk_flowctrl_holTrafficTypeDropEnable_get(uint32 unit, rtk_flowctrl_holTrafficType_t type, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_holTrafficTypeDropEnable_get(unit, type, pEnable);
}
...
rtk_flowctrl_holTrafficTypeDropEnable_set(uint32 unit, rtk_flowctrl_holTrafficType_t type, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_holTrafficTypeDropEnable_set(unit, type, enable);
}
