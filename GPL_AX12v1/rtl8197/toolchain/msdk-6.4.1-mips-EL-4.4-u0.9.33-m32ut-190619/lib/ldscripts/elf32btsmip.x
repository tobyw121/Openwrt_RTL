...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/tmp/builder-jenkins/msdk-6.4.1-3055/release/msdk-6.4.1/linux/uclibc/mips-linux-uclibc/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
