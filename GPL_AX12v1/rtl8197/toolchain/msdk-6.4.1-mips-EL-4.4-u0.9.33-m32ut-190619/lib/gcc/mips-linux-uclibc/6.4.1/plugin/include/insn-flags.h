...
#define HAVE_madsi_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_madsidi3_32bit_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_umadsidi3_32bit_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_madhl_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_msubsi_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_msubsidi3_32bit_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_umsubsidi3_32bit_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_msbhl_mac ((TARGET_RLX && !TARGET_MIPS16) && TARGET_MAC)
#define HAVE_mszhl_mac ((TARGET_RLX && !TARGET_MIPS16) && GET_CODE(operands[3]) == GET_CODE(operands[4]) && TARGET_MAC)
#define HAVE_mazhl_mac ((TARGET_RLX && !TARGET_MIPS16) && GET_CODE(operands[3]) == GET_CODE(operands[4]) && TARGET_MAC)
...
#define HAVE_tls_get_tp_mips16r_si ((HAVE_AS_TLS && TARGET_MIPS16 && TARGET_MIPS16R) && (Pmode == SImode))
#define HAVE_tls_get_tp_mips16r_di ((HAVE_AS_TLS && TARGET_MIPS16 && TARGET_MIPS16R) && (Pmode == DImode))
...
extern rtx        gen_madsi_mac                       (rtx, rtx, rtx);
extern rtx        gen_madsidi3_32bit_mac              (rtx, rtx, rtx, rtx);
extern rtx        gen_umadsidi3_32bit_mac             (rtx, rtx, rtx, rtx);
extern rtx        gen_madhl_mac                       (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_msubsi_mac                      (rtx, rtx, rtx);
extern rtx        gen_msubsidi3_32bit_mac             (rtx, rtx, rtx, rtx);
extern rtx        gen_umsubsidi3_32bit_mac            (rtx, rtx, rtx, rtx);
extern rtx        gen_msbhl_mac                       (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_mszhl_mac                       (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_mazhl_mac                       (rtx, rtx, rtx, rtx, rtx);
