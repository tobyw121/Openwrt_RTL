...
int rtl_nf_ct_seqadj_set(struct nf_conn *ct, enum ip_conntrack_info ctinfo,
		     __be32 seq, s32 off)
{
	...
	if (this_way->offset_before == this_way->offset_after ||
	    before_eq(this_way->correction_pos, ntohl(seq))) {
...
EXPORT_SYMBOL_GPL(rtl_nf_ct_seqadj_set);
#endif
