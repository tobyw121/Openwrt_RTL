...
/* Used for Sheipa Spi Bus. */
#define SPINOR_OP_AUTO_MODE		0xf5	/* sheipa auto mode */
#endif
...
enum write_mode {
	SPI_NOR_QUAD_WRITE = 5,
	SPI_NOR_DUAL_WRITE,
	SPI_NOR_NORMAL_WRITE,
	SPI_NOR_AUTO_WRITE
};
#else
enum read_mode {
...
#if defined(CONFIG_RTL819X_SPI_FLASH_SHEIPA)
/**
* spi_nor_get_chip_clk()- get spi nor chip clk
* The drivers can use this fuction to get SPI NOR CHIP clk.
* Return: 0 for clk not defined, others for chip clk
*/
unsigned int spi_nor_get_chip_clk(void);
#endif
