...
static struct mac_pwr_cfg mac_pwron_8192xb[] = {
	{0x1086,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_SDIO,
	 PWR_BASE_MAC,
...
static struct mac_pwr_cfg mac_pwroff_8192xb[] = {
	{0x0270,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_ALL,
	 PWR_BASE_MAC,
...
/* Power on sequence */
struct mac_pwr_cfg *pwr_on_seq_8192xb[] = {
	mac_pwron_8192xb,
	NULL
};

/* Power off sequence */
struct mac_pwr_cfg *pwr_off_seq_8192xb[] = {
	mac_pwroff_8192xb,
	NULL
};
...
static struct mac_pwr_cfg mac_carddisable_seq_8192xb[] = {
	{0xFFFF,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_ALL,
	 0,
...
static struct mac_pwr_cfg mac_enterlps_seq_8192xb[] = {
	{0x0068,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_ALL,
	 PWR_BASE_MAC,
...
static struct mac_pwr_cfg mac_leavelps_seq_8192xb[] = {
	{0x1083,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_SDIO,
	 PWR_BASE_MAC,
...
static struct mac_pwr_cfg mac_ips_seq_8192xb[] = {
	{0xFFFF,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_ALL,
	 0,
...
struct mac_pwr_cfg *card_disable_seq_8192xb[] = {
	mac_carddisable_seq_8192xb,
	NULL
};

struct mac_pwr_cfg *enter_lps_seq_8192xb[] = {
	mac_enterlps_seq_8192xb,
	NULL
};

struct mac_pwr_cfg *leave_lps_seq_8192xb[] = {
	mac_leavelps_seq_8192xb,
	NULL
};

struct mac_pwr_cfg *ips_seq_8192xb[] = {
	mac_ips_seq_8192xb,
	NULL
};
