...
#ifndef PLATFORM_MIPS_97F_RTW_PLTFM_POSTCONF_H_
#define PLATFORM_MIPS_97F_RTW_PLTFM_POSTCONF_H_
...
#define CONFIG_TXSC_ONE_LOCK // for CPU loading in Single CPU
//#endif
...
#define RTW_WKARD_AP_CMD_DISPATCH
#define RTW_WKAPD_AP_CMD_THREAD_USING_RT
#define RTW_WKARD_MBA_AC_TX_IOT
#define RTW_WKARD_APSEC_MAXTXTP /* for 32br sec max throughput */
#define RTW_WKARD_REDUCE_CONNECT_LOG
#define RTW_WRARD_FREE_BSS_IN_CFG80211_WQ	//ref: wqcap3440
...
/* RF power limit customized table enable */
//#define RTW_WKARD_CUSTOM_PWRLMT_EN
...
#ifndef __IMEM_WLAN_SECTION__
#define __IMEM_WLAN_SECTION__	__attribute__ ((section("txtext-rtkwlan")))
#endif

#ifndef __DMEM_SECTION__
#define __DMEM_SECTION__		__attribute__ ((section("txdata-rtkwlan")))
#endif

#endif /* PLATFORM_MIPS_97F_RTW_PLTFM_POSTCONF_H_ */
