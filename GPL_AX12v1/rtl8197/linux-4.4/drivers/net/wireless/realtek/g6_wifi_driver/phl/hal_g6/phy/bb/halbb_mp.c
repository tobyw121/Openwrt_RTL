...
struct rssi_physts halbb_get_mp_rssi_physts(struct bb_info *bb, enum rf_path path, enum phl_phy_idx phy_idx)
{
	...
	halbb_set_reg_cmn(bb, cr->dataon_to_sts_flag, cr->dataon_to_sts_flag_m, 1, phy_idx);
	halbb_set_reg_cmn(bb, cr->sts_flag_guard, cr->sts_flag_guard_m, 0x4, phy_idx);
...
void halbb_cr_cfg_mp_init(struct bb_info *bb)
{
	...
	case BB_AP:
		...
		cr->dataon_to_sts_flag = DATAON_TO_STS_FLAG_A;
		cr->dataon_to_sts_flag_m = DATAON_TO_STS_FLAG_A_M;
		cr->sts_flag_guard = STS_FLAG_GUARD_A;
		cr->sts_flag_guard_m = STS_FLAG_GUARD_A_M;
		break;
	...
	case BB_AP2:
		...
		cr->dataon_to_sts_flag = DATAON_TO_STS_FLAG_A2;
		cr->dataon_to_sts_flag_m = DATAON_TO_STS_FLAG_A2_M;
		cr->sts_flag_guard = STS_FLAG_GUARD_A2;
		cr->sts_flag_guard_m = STS_FLAG_GUARD_A2_M;
		break;
	...
	case BB_CLIENT:
		...
		cr->dataon_to_sts_flag = DATAON_TO_STS_FLAG_C;
		cr->dataon_to_sts_flag_m = DATAON_TO_STS_FLAG_C_M;
		cr->sts_flag_guard = STS_FLAG_GUARD_C;
		cr->sts_flag_guard_m = STS_FLAG_GUARD_C_M;
		break;
	#endif
