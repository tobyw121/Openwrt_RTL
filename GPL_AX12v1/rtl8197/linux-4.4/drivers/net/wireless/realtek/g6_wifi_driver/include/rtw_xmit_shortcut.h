...
#define AMSDU_1_SIZE (7991 - 128)
#define AMSDU_2_SIZE (11454 - 128)
...
struct txsc_entry {
	u8 txsc_is_used;
	/*
	 * use_cnt: 0, no one use the entry currently, can be updated or used right now
	 * use_cnt[7]: 1, the entry is being updated, it cannot be used right now
	 * use_cnt[7]: 0 and use_cnt != 0, the entry is being used, it cannot be updated
	 */
	u8 use_cnt;
