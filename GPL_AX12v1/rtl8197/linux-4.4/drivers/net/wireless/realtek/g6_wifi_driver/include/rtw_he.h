...
#define SET_HE_PHY_CAP_SUPPORT_242_TONE_RU_24G(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE(_pEleStart, 5, 1, _val)
#define SET_HE_PHY_CAP_SUPPORT_242_TONE_RU_5G(_pEleStart, _val) \
...
#define SET_HE_CAP_160M_MCS_1SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart)+2, 0, 2, _val)
#define SET_HE_CAP_160M_MCS_2SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart)+2, 2, 2, _val)
#define SET_HE_CAP_160M_MCS_3SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart)+2, 4, 2, _val)
#define SET_HE_CAP_160M_MCS_4SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart)+2, 6, 2, _val)
#define SET_HE_CAP_160M_MCS_5SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart) + 3, 0, 2, _val)
#define SET_HE_CAP_160M_MCS_6SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart) + 3, 2, 2, _val)
#define SET_HE_CAP_160M_MCS_7SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart) + 3, 4, 2, _val)
#define SET_HE_CAP_160M_MCS_8SS(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart) + 3, 6, 2, _val)
...
#define SET_MU_EDCA_QoS_INFO(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart), 0, 8, _val)

#define SET_MU_EDCA_AIC_AIFSN(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart), 0, 8, _val)

#define SET_MU_EDCA_ECW_MIN_MAX(_pEleStart, _val) \
	SET_BITS_TO_LE_1BYTE((_pEleStart) + 1, 0, 8, _val)

#define SET_MU_EDCA_TIMER(_pEleStart, _val) \
...
#define GET_HE_OP_BSS_COLOR_INFO_BSS_COLOR(_pEleStart) \
	LE_BITS_TO_1BYTE(_pEleStart, 0, 6)
...
#define SET_EXT_CAPABILITY_ELE_TWT_RESPONDER(_pEleStart, _val)	\
	SET_BITS_TO_LE_1BYTE((_pEleStart)+9, 6, 1, _val)
...
#define MU_EDCA_QoS_INFO_LEN			1
#define MU_EDCA_MUAC_BE_LEN 		3
#define MU_EDCA_MUAC_BK_LEN 		3
#define MU_EDCA_MUAC_VI_LEN 		3
#define MU_EDCA_MUAC_VO_LEN 		3

#define MU_EDCA_ELE_MAX_LEN (1 + MU_EDCA_QoS_INFO_LEN + \
	+ MU_EDCA_MUAC_BE_LEN + MU_EDCA_MUAC_BK_LEN + MU_EDCA_MUAC_VI_LEN + MU_EDCA_MUAC_VO_LEN)

struct he_priv {
	u8	he_option;
	u8 	he_cap[HE_CAP_ELE_MAX_LEN];
	u8	he_op[HE_OPER_ELE_MAX_LEN];
	u8	mu_edca[MU_EDCA_ELE_MAX_LEN];
	u8 	op_present;
};

#define MAX_RU_STA	4	/* HALBB_MAX_RU_STA_NUM */
