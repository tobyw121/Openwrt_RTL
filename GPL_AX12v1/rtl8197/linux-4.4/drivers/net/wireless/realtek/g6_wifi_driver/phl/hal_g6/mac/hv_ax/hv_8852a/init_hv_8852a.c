...
#include "init_hv_8852a.h"
#include "trx_desc_hv_8852a.h"
...
#include "../fwcmd_hv.h"
#include "../gpio_hv.h"
#include "../../mac_ax/mac_8852a/gpio_8852a.h"
#include "../../mac_ax/mac_8852a/coex_8852a.h"
#include "../hw_hv.h"
#include "pwr_seq_hv_8852a.h"
#include "btc_hv_8852a.h"
#if MAC_AX_8852A_SUPPORT

static struct hv_ax_ops hv8852a_ops = {
	hv_tx_post_agg_8852a /* tx_post_desc */,
	...
	hv_cfg_btc_dbg_port_8852a /* cfg_btc_dbg_port */,
	hv_en_rtk_mode_8852a /*en_btc_rtk_mode */,
	...
	mac_get_gpio_status_8852a /* get_gpio_status */,
	...
	hv_run_pwr_seq_8852a /* run_pwr_seq */,
	mac_read_lte_8852a /* read_lte */,
	mac_write_lte_8852a /* write_lte */,
	hv_c2h_log_test /* c2h_log_test */,
};

struct hv_ax_ops *get_hv_8852a_ops(void)
{
	return &hv8852a_ops;
}
