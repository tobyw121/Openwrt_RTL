...
#ifndef _MAC_AX_GPIO_8851B_H_
#define _MAC_AX_GPIO_8851B_H_

#include "../../type.h"
#if MAC_AX_8851B_SUPPORT

/**
 * @brief mac_pinmux_set_func_8851b
 *
 * @param *adapter
 * @param func
...
/**
 * @brief mac_get_gpio_status_8851b
 *
 * @param *adapter
 * @param *func
 * @param gpio
