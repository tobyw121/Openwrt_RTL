...
#ifndef PLATFORM_I386_PC_RTW_PLTFM_POSTCONF_H_
#define PLATFORM_I386_PC_RTW_PLTFM_POSTCONF_H_
...
#define CONFIG_SMP_PHL_RX_RECYCLE
#endif
...
#define CORE_RXSC_RFRAME /* this feature do not use in multiple STA/Interface */
...
#define RXQ_0_BUF_SIZE			(RXQ_0_BASE_BUF_SIZE * 2)
#else
#define RXQ_0_BUF_SIZE			RXQ_0_BASE_BUF_SIZE
#endif
#define MAX_RX_BD_NUM_RXQ_0_CORE	(256)
#define MAX_RX_BUF_NUM_RXQ_0_CORE	(MAX_RX_BD_NUM_RXQ_0_CORE * 3)
#define RX_BUF_SIZE_RXQ_0_CORE		(RXQ_0_BUF_SIZE - SKB_OVERHEAD)
...
#ifdef CONFIG_RTW_RX_BUF_SHARING
#define RPQ_0_BUF_SIZE			((512 + 192 ) * 2)
#else
#define RPQ_0_BUF_SIZE			(512 + 192)
#endif
#define RX_BUF_SIZE_RPQ_0_CORE		(RPQ_0_BUF_SIZE - SKB_OVERHEAD)
...
#ifdef CONFIG_RTW_RX_BUF_SHARING
#define RXQ_1_BUF_SIZE			(RXQ_1_BASE_BUF_SIZE * 2)
#else
#define RXQ_1_BUF_SIZE			RXQ_1_BASE_BUF_SIZE
#endif
#define RX_BUF_SIZE_RXQ_1_CORE		(RXQ_1_BUF_SIZE - SKB_OVERHEAD)
/*rpq, number of rxbd & rxbuf, size of rxbuf*/
#define MAX_RX_BD_NUM_RPQ_1_CORE	(64)
#define MAX_RX_BUF_NUM_RPQ_1_CORE	(MAX_RX_BD_NUM_RPQ_1_CORE*2)
#ifdef CONFIG_RTW_RX_BUF_SHARING
#define RPQ_1_BUF_SIZE			((512 + 192 ) * 2)
#else
#define RPQ_1_BUF_SIZE			(512 + 192)
#endif
#define RX_BUF_SIZE_RPQ_1_CORE		(RPQ_1_BUF_SIZE - SKB_OVERHEAD)
...
#define WKARD_DBCC /* Keep for linking withold PHL */
#define CPU_ID_TX_PHL_0		3
#define CPU_ID_TX_PHL_1		2
#define CPU_ID_RX_CORE_0	2
#define CPU_ID_RX_CORE_1	3
...
#if defined(CONFIG_PROFILING) && defined(CONFIG_ARM64)
#define CONFIG_CPU_PROFILING
#define CONFIG_CPU_PMU_PROFILING	/* for ARM PMU profiling */
#endif
...
#if defined(CONFIG_RTW_CURRENT_RATE_ACCOUNTING) || defined(CPTCFG_RTW_CURRENT_RATE_ACCOUNTING)
...
/* RF FEM 50 PON config*/
#ifdef  CONFIG_WLAN0_AP_5G
#undef  CONFIG_WLAN0_AP_5G
#define CONFIG_WLAN0_PON_5G
#endif
#ifdef  CONFIG_WLAN1_AP_5G
#undef  CONFIG_WLAN1_AP_5G
#define CONFIG_WLAN1_PON_5G
#endif
#ifdef  CONFIG_WLAN0_AP_2G
#undef  CONFIG_WLAN0_AP_2G
#define CONFIG_WLAN0_PON_2G
#endif
#ifdef  CONFIG_WLAN1_AP_2G
#undef  CONFIG_WLAN1_AP_2G
#define CONFIG_WLAN1_PON_2G
#endif
...
#define CTC_WIFI_DIAG
#ifdef CTC_WIFI_DIAG
#define DIAG_LOG_MSG_MAXLEN 197
#define DIAG_LOG_REC_MAXNUM 4096
#ifndef CONFIG_SNR_RPT
...
#endif /* PLATFORM_I386_PC_RTW_PLTFM_POSTCONF_H_ */
