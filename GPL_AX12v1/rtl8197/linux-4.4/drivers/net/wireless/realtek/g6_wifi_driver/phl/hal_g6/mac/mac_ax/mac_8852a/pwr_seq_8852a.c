...
struct mac_pwr_cfg mac_pwron_nic_8852a[] = {
	{0x00C6,
	 PWR_CBV_MSK,
	 PWR_INTF_MSK_PCIE,
	 PWR_BASE_MAC,
...
struct mac_pwr_cfg mac_pwroff_nic_8852a[] = {
	{0x02F0,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_ALL,
	 PWR_BASE_MAC,
...
struct mac_pwr_cfg mac_pwron_ap_8852a[] = {
	{0x00C6,
	 PWR_CBV_MSK,
	 PWR_INTF_MSK_PCIE,
	 PWR_BASE_MAC,
...
struct mac_pwr_cfg mac_pwroff_ap_8852a[] = {
	{0x02F0,
	 PWR_CVALL_MSK,
	 PWR_INTF_MSK_ALL,
	 PWR_BASE_MAC,
