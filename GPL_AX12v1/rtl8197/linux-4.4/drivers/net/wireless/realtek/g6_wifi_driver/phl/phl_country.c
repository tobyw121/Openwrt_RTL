...
const struct country_domain_mapping cdmap[MAX_COUNTRY_NUM] = {
    ...
    {0x62, 0x05, {'B', 'R'}, TPO_NA, 0x0f}, /* 0002 */
    {0x76, 0x05, {'C', 'L'}, TPO_CHILE, 0x0f}, /* 0003 */
    {0x76, 0x00, {'C', 'O'}, TPO_NA, 0x0f}, /* 0004 */
    {0x76, 0x05, {'C', 'R'}, TPO_NA, 0x0f}, /* 0005 */
    {0x76, 0x00, {'E', 'C'}, TPO_NA, 0x0f}, /* 0006 */
    {0x76, 0x00, {'S', 'V'}, TPO_NA, 0x0f}, /* 0007 */
    {0x76, 0x00, {'G', 'T'}, TPO_NA, 0x0f}, /* 0008 */
    {0x76, 0x05, {'H', 'N'}, TPO_NA, 0x0f}, /* 0009 */
    ...
    {0x76, 0x05, {'U', 'S'}, TPO_NA, 0x0f}, /* 0015 */
    {0x30, 0x00, {'U', 'Y'}, TPO_NA, 0x0f}, /* 0016 */
    {0x30, 0x00, {'V', 'E'}, TPO_NA, 0x0f}, /* 0017 */
    {0x76, 0x00, {'P', 'R'}, TPO_NA, 0x0f}, /* 0018 */
    {0x76, 0x00, {'D', 'O'}, TPO_NA, 0x0f}, /* 0019 */
    {0x5e, 0x06, {'A', 'T'}, TPO_NA, 0x0f}, /* 0020 */
    {0x5e, 0x06, {'B', 'E'}, TPO_NA, 0x0f}, /* 0021 */
    {0x5e, 0x06, {'C', 'Y'}, TPO_NA, 0x0f}, /* 0022 */
    {0x5e, 0x06, {'C', 'Z'}, TPO_NA, 0x0f}, /* 0023 */
    {0x5e, 0x06, {'D', 'K'}, TPO_NA, 0x0f}, /* 0024 */
    {0x5e, 0x06, {'E', 'E'}, TPO_NA, 0x0f}, /* 0025 */
    {0x5e, 0x06, {'F', 'I'}, TPO_NA, 0x0f}, /* 0026 */
    {0x5e, 0x06, {'F', 'R'}, TPO_NA, 0x0f}, /* 0027 */
    {0x5e, 0x06, {'D', 'E'}, TPO_NA, 0x0f}, /* 0028 */
    {0x5e, 0x06, {'G', 'R'}, TPO_NA, 0x0f}, /* 0029 */
    {0x5e, 0x06, {'H', 'U'}, TPO_NA, 0x0f}, /* 0030 */
    {0x5e, 0x06, {'I', 'S'}, TPO_NA, 0x0f}, /* 0031 */
    {0x5e, 0x06, {'I', 'E'}, TPO_NA, 0x0f}, /* 0032 */
    {0x5e, 0x06, {'I', 'T'}, TPO_NA, 0x0f}, /* 0033 */
    {0x5e, 0x06, {'L', 'V'}, TPO_NA, 0x0f}, /* 0034 */
    {0x5e, 0x06, {'L', 'I'}, TPO_NA, 0x0f}, /* 0035 */
    {0x5e, 0x06, {'L', 'T'}, TPO_NA, 0x0f}, /* 0036 */
    {0x5e, 0x06, {'L', 'U'}, TPO_NA, 0x0f}, /* 0037 */
    {0x5e, 0x06, {'M', 'T'}, TPO_NA, 0x0f}, /* 0038 */
    {0x5e, 0x06, {'M', 'C'}, TPO_NA, 0x0f}, /* 0039 */
    {0x5e, 0x06, {'N', 'L'}, TPO_NA, 0x0f}, /* 0040 */
    {0x5e, 0x06, {'N', 'O'}, TPO_NA, 0x0f}, /* 0041 */
    {0x5e, 0x06, {'P', 'L'}, TPO_NA, 0x0f}, /* 0042 */
    {0x5e, 0x06, {'P', 'T'}, TPO_NA, 0x0f}, /* 0043 */
    {0x5e, 0x06, {'S', 'K'}, TPO_NA, 0x0f}, /* 0044 */
    {0x5e, 0x06, {'S', 'I'}, TPO_NA, 0x0f}, /* 0045 */
    {0x5e, 0x06, {'E', 'S'}, TPO_NA, 0x0f}, /* 0046 */
    {0x5e, 0x06, {'S', 'E'}, TPO_NA, 0x0f}, /* 0047 */
    {0x5e, 0x06, {'C', 'H'}, TPO_NA, 0x0f}, /* 0048 */
    {0x0b, 0x06, {'G', 'B'}, TPO_UK, 0x0f}, /* 0049 */
    ...
    {0x5e, 0x06, {'A', 'E'}, TPO_NA, 0x0f}, /* 0083 */
    ...
    {0x5e, 0x00, {'I', 'N'}, TPO_NA, 0x0f}, /* 0090 */
    {0x5d, 0x00, {'I', 'D'}, TPO_NA, 0x0f}, /* 0091 */
    {0x4b, 0x08, {'K', 'R'}, TPO_NA, 0x0f}, /* 0092 */
    ...
    {0x2b, 0x07, {'C', 'A'}, TPO_NA, 0x0f}, /* 0104 */
    ...
    {0x3a, 0x00, {'U', 'Z'}, TPO_NA, 0x0f}, /* 0231 */
