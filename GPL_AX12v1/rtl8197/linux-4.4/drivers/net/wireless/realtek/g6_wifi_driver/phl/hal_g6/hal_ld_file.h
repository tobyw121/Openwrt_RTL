...
enum _halrf_pw_lmt_regulation_type {
	_PW_LMT_REGU_WW13 = REGULATION_WW,
	_PW_LMT_REGU_ETSI = REGULATION_ETSI,
	_PW_LMT_REGU_FCC = REGULATION_FCC,
	_PW_LMT_REGU_MKK = REGULATION_MKK,
	_PW_LMT_REGU_NA = REGULATION_NA,
	_PW_LMT_REGU_IC = REGULATION_IC,
	_PW_LMT_REGU_KCC = REGULATION_KCC,
	_PW_LMT_REGU_ACMA = REGULATION_ACMA,
	_PW_LMT_REGU_NCC = REGULATION_NCC,
	_PW_LMT_REGU_CHILE = REGULATION_CHILE,
	_PW_LMT_REGU_MEXICO = REGULATION_MEX,
	_PW_LMT_REGU_UKRAINE,
	_PW_LMT_REGU_CN,
	_PW_LMT_REGU_NULL,
	_PW_LMT_REGU_EXT_PWR,
	_PW_LMT_MAX_REGULATION_NUM
};
...
void rtw_hal_dl_all_ext_para_file(struct rtw_phl_com_t *phl_com, char *ic_name, void *hal);
