 ...
 *
 *****************************************************************************/
#define _RTL8192XB_OPS_C_
#include "../hal_headers.h"
#include "rtl8192xb_hal.h"

static void read_chip_version_8192xb(struct rtw_phl_com_t *phl_com,
					...
					struct hal_info_t *hal)
{
	...
	/*** initialize section ***/
	ops->read_chip_version = read_chip_version_8192xb;
	ops->hal_cfg_fw = hal_cfg_fw_8192xb;
...
#ifdef RTW_PHL_BCN
	ops->cfg_bcn = hal_config_beacon_8192xb;
	ops->upt_bcn = hal_update_beacon_8192xb;
#endif
	...
	ops->dbg_tx_rpt = hal_debug_tx_report_8192xb;
...
void hal_set_trx_ops_8192xb(struct hal_info_t *hal)
{
	...
	ops->get_txdesc_len = get_txdesc_len_8192xb;
	ops->fill_txdesc_h2c = fill_txdesc_h2c_8192xb;
	ops->fill_txdesc_fwdl = fill_txdesc_fwdl_8192xb;
	ops->fill_txdesc_pkt = fill_txdesc_pkt_8192xb;
}
#endif
