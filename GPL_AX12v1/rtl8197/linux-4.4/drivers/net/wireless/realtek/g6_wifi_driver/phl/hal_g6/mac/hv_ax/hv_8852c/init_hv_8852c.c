...
#include "init_hv_8852c.h"
#include "trx_desc_hv_8852c.h"
...
#include "../fwcmd_hv.h"
#include "../gpio_hv.h"
#include "../../mac_ax/mac_8852c/gpio_8852c.h"
#include "../../mac_ax/mac_8852c/coex_8852c.h"
#include "../hw_hv.h"
#include "pwr_seq_hv_8852c.h"
#include "btc_hv_8852c.h"
#if MAC_AX_8852C_SUPPORT

static struct hv_ax_ops hv8852c_ops = {
	hv_tx_post_agg_8852c /* tx_post_desc */,
	...
	hv_cfg_btc_dbg_port_8852c /* cfg_btc_dbg_port */,
	hv_en_rtk_mode_8852c /*en_btc_rtk_mode */,
	...
	mac_get_gpio_status_8852c /* get_gpio_status */,
	...
	hv_run_pwr_seq_8852c /* run_pwr_seq */,
	mac_read_lte_8852c /* read_lte */,
	mac_write_lte_8852c /* write_lte */,
	hv_c2h_log_test /* c2h_log_test */,
};

struct hv_ax_ops *get_hv_8852c_ops(void)
{
	return &hv8852c_ops;
}
