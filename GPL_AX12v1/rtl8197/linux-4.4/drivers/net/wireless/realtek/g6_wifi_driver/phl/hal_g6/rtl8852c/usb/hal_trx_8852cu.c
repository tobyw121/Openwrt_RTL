...
static u8 hal_mapping_hw_tx_chnl_8852cu(u16 macid, enum rtw_phl_ring_cat cat,
					u8 band)
{
	u8 dma_ch = 0;
 ...
 */
enum rtw_hal_status
hal_fill_wd_8852cu(struct hal_info_t *hal, struct rtw_xmit_req *tx_req,
...
enum rtw_hal_status
hal_usb_rx_agg_cfg_8852cu(struct hal_info_t *hal, u8 mode, u8 agg_mode,
...
static struct hal_trx_ops ops= {
	...
	.usb_rx_agg_cfg = hal_usb_rx_agg_cfg_8852cu,
