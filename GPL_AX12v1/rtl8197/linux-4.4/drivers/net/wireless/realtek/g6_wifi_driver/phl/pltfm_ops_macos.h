...
/* txbd, rxbd, wd */
static inline void *_os_shmem_alloc(void *d,  *bus_addr_l,
				     *bus_addr_h, u32 buf_sz,
				    u8 cache, u8 direction, void **os_rsvd)
{
	return NULL;
}
static inline void _os_shmem_free(void *d, u8 *vir_addr,  *bus_addr_l,
				   *bus_addr_h, u32 buf_sz,
				  u8 cache, u8 direction, void *os_rsvd)
{
	return NULL;
...
static inline void *_os_pkt_buf_unmap_rx(void *d,  bus_addr_l,  bus_addr_h, u32 buf_sz)
{
	return NULL;
}

static inline void *_os_pkt_buf_map_rx(void *d,  *bus_addr_l,  *bus_addr_h,
					u32 buf_sz, void *os_priv)
{
	return NULL;
}

static inline void *_os_pkt_buf_alloc_rx(void *d,  *bus_addr_l,  *bus_addr_h,
					u32 buf_sz, void **os_priv)
{
	return NULL;
}
static inline u8 *_os_pkt_buf_free_rx(void *d, u8 *vir_addr,  bus_addr_l,
				 bus_addr_h, u32 buf_sz, void *os_priv)
{
	return NULL;
}
