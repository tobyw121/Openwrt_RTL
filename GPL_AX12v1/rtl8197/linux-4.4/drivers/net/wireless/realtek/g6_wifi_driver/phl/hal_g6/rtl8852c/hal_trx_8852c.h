...
#define GET_RX_AX_DESC_HDR_CNV_8852C(__pRxStatusDesc) LE_BITS_TO_4BYTE(__pRxStatusDesc+28, 21, 1)
#define GET_RX_AX_DESC_HDR_OFST_8852C(__pRxStatusDesc) LE_BITS_TO_4BYTE(__pRxStatusDesc+28, 22, 5)
#define GET_RX_AX_DESC_BIP_KID_8852C(__pRxStatusDesc) LE_BITS_TO_4BYTE(__pRxStatusDesc+28, 27, 1)
#define GET_RX_AX_DESC_BIP_ENC_8852C(__pRxStatusDesc) LE_BITS_TO_4BYTE(__pRxStatusDesc+28, 28, 1)
