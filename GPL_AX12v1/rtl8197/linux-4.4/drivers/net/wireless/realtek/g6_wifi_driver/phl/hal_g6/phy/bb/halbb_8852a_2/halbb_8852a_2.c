...
void halbb_dyn_mu_bypass_vht_sigb_init_8852a_2(struct bb_info *bb)
{
	struct vht_mu_cr_backup_table *reset_val = &bb->vht_mu_backup_val;

	reset_val->muic_en_a = halbb_get_reg(bb, 0x40f8, BIT(0));
	reset_val->lpbw_sw_symb0_a = halbb_get_reg(bb, 0x4410, BIT(5));
	reset_val->ch_tracking_symb0_a = halbb_get_reg(bb, 0x43fc, 0x07000000);
	reset_val->lpbw_sel_d1_a = halbb_get_reg(bb, 0x4400, 0x000f8000);
	reset_val->ch_tracking_symb1_a = halbb_get_reg(bb, 0x4400, 0x0000001f);
	reset_val->ch_tracking_a1_a = halbb_get_reg(bb, 0x43f4, 0x00fc0000);
	reset_val->lpbw_sel_p1_a = halbb_get_reg(bb, 0x4408, 0x000f8000);
	reset_val->noise_tracking_en_a = halbb_get_reg(bb, 0x43f8, BIT(30));
}

void halbb_dyn_mu_bypass_vht_sigb_8852a_2(struct bb_info *bb)
{
	...
	if (vht_mu_pkt > vht_mu_pkt_th) {
		halbb_set_reg(bb, 0x40f8, BIT(0), 0);
		halbb_set_reg(bb, 0x4410, BIT(5), 1);
		halbb_set_reg(bb, 0x43fc, 0x07000000, 0x3);
		halbb_set_reg(bb, 0x4400, 0x000f8000, 0x1f);
		halbb_set_reg(bb, 0x4400, 0x0000001f, 0x4);
		halbb_set_reg(bb, 0x43f4, 0x00fc0000, 0x0);
		halbb_set_reg(bb, 0x4408, 0x000f8000, 0x1f);
		halbb_set_reg(bb, 0x43f8, BIT(30), 0);
	} else {
		halbb_set_reg(bb, 0x40f8, BIT(0), reset_val->muic_en_a);
		halbb_set_reg(bb, 0x4410, BIT(5), reset_val->lpbw_sw_symb0_a);
		halbb_set_reg(bb, 0x43fc, 0x07000000, reset_val->ch_tracking_symb0_a);
		halbb_set_reg(bb, 0x4400, 0x000f8000, reset_val->lpbw_sel_d1_a);
		halbb_set_reg(bb, 0x4400, 0x0000001f, reset_val->ch_tracking_symb1_a);
		halbb_set_reg(bb, 0x43f4, 0x00fc0000, reset_val->ch_tracking_a1_a);
		halbb_set_reg(bb, 0x4408, 0x000f8000, reset_val->lpbw_sel_p1_a);
		halbb_set_reg(bb, 0x43f8, BIT(30), reset_val->noise_tracking_en_a);
	}
}
...
void halbb_ic_hw_setting_init_8852a_2(struct bb_info *bb)
{
	...
	if(phl_is_mp_mode(bb->phl_com)) {
		...
		halbb_set_reg(bb, 0xc, BIT(2), 0x0);
	} else {
		// r_en_sound_wo_ndp
		...
		halbb_set_reg(bb, 0x2378, 0xff, 0xbf);
		halbb_set_reg(bb, 0x2360, 0xff00, 0xb0);
		halbb_set_reg(bb, 0xc, BIT(2), 0x1);
...
#endif
	// Keeper setting
	halbb_set_reg(bb, 0x738, MASKDWORD, 0x20410050);
}
...
bool halbb_set_pd_lower_bound_cck_8852a_2(struct bb_info *bb, u8 bound,
				      enum channel_width bw,
				      enum phl_phy_idx phy_idx)
{
	u8 bw_attenuation = 0;
