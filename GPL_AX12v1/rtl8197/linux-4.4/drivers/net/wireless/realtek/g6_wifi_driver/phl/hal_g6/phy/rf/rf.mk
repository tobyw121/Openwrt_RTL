...
ifeq ($(CONFIG_RTL8832CRVU), y)
rf_ic := 8832crvu

# Level 2 directory
path_halrf_8832crvu := $(path_halrf_d1)/halrf_$(rf_ic)

halrf-y += $(path_halrf_8832crvu)/halrf_8832crvu.o \
			$(path_halrf_8832crvu)/halrf_8832crvu_api.o \
			$(path_halrf_8832crvu)/halrf_hwimg_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_txgapk_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_iqk_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_reg_cfg_8832crvu.o \
			$(path_halrf_8832crvu)/halrf_set_pwr_table_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_dack_8832crvu.o \
			$(path_halrf_8832crvu)/halrf_dpk_8832crvu.o \
			$(path_halrf_8832crvu)/halrf_efuse_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_tssi_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_kfree_8832crvu.o\
			$(path_halrf_8832crvu)/halrf_psd_8832crvu.o
endif


ifeq ($(CONFIG_RTL8832BRVT), y)
rf_ic := 8832brvt

# Level 2 directory
path_halrf_8832brvt := $(path_halrf_d1)/halrf_$(rf_ic)

halrf-y += $(path_halrf_8832brvt)/halrf_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_8832brvt_api.o \
			$(path_halrf_8832brvt)/halrf_hwimg_8832brvt.o\
			$(path_halrf_8832brvt)/halrf_iqk_8832brvt.o\
			$(path_halrf_8832brvt)/halrf_reg_cfg_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_set_pwr_table_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_dack_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_dpk_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_efuse_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_txgapk_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_tssi_8832brvt.o \
			$(path_halrf_8832brvt)/halrf_kfree_8832brvt.o\
			$(path_halrf_8832brvt)/halrf_psd_8832brvt.o
endif
