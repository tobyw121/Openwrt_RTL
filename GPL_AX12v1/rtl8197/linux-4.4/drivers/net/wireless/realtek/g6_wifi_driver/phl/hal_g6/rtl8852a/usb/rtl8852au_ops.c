...
static void init_int_default_value_8852au(struct hal_info_t *hal, enum rtw_hal_int_set_opt opt)
{
...
static void init_default_value_8852au(struct hal_info_t *hal)
{
	init_default_value_8852a(hal);

	init_int_default_value_8852au(hal, INT_SET_OPT_HAL_INIT);
}
					...
					struct hal_info_t *hal)
{
	...
	ops->init_int_default_value = init_int_default_value_8852au;
