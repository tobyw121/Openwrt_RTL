...
#define RTW_RX_8852A_DESC_PPDU_T_LCCK 0
#define RTW_RX_8852A_DESC_PPDU_T_SCCK 1
#define RTW_RX_8852A_DESC_PPDU_T_OFDM 2
#define RTW_RX_8852A_DESC_PPDU_T_HT 3
#define RTW_RX_8852A_DESC_PPDU_T_HTGF 4
#define RTW_RX_8852A_DESC_PPDU_T_VHT_SU 5
#define RTW_RX_8852A_DESC_PPDU_T_VHT_MU 6
#define RTW_RX_8852A_DESC_PPDU_T_HE_SU 7
#define RTW_RX_8852A_DESC_PPDU_T_HE_ERSU 8
#define RTW_RX_8852A_DESC_PPDU_T_HE_MU 9
#define RTW_RX_8852A_DESC_PPDU_T_HE_TB 10
#define RTW_RX_8852A_DESC_PPDU_T_UNKNOWN 15
...
#define RTW_GET_RATE_NSS(_rtw_data_rate) (u8)((_rtw_data_rate >> 4) & (BIT(0) | BIT(1)))
...
enum OFDMA_PROTECTION_TYPE {
	FRAME_EXCHANGE_NO_PROETCT = 0,
	FRAME_EXCHANGE_PRIUSER_HW_RTS = 1,
	FRAME_EXCHANGE_RTS = 2,
	FRAME_EXCHANGE_CTS2SELF = 3,
	FRAME_EXCHANGE_MU_RTS = 4,
	DEFAULT_PROTECT_SETTING = 5
};

enum OFDMA_RSP_TYPE {
	FRAME_EXCHANGE_NMINUS1USER_BA = 0,
	FRAME_EXCHANGE_NUSER_BA = 1,
	FRAME_EXCHANGE_MU_BAR = 2,
	FRAME_EXCHANGE_HTP_ACK = 3,
	DEFAULT_BA_SETTING = 4
};
...
enum RTW_PHL_GPIO_CTL_TYPE{
	RTW_PHL_GPIO_CTL_READ,
	RTW_PHL_GPIO_CTL_WRITE,
	RTW_PHL_GPIO_CTL_SET_MODE,
	RTW_PHL_GPIO_CTL_MAX,
};
