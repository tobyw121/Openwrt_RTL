 ...
 * @retval u32
 */
u32 mac_get_rrsr_cfg_8192xb(struct mac_ax_adapter *adapter,
 ...
 * @retval u32
 */
u32 mac_set_rrsr_cfg_8192xb(struct mac_ax_adapter *adapter,
			    struct mac_ax_rrsr_cfg *cfg);
/**
 * @}
 * @}
...
u32 mac_get_cts_rrsr_cfg_8192xb(struct mac_ax_adapter *adapter,
...
u32 mac_set_cts_rrsr_cfg_8192xb(struct mac_ax_adapter *adapter,
				struct mac_ax_cts_rrsr_cfg *cfg);
/**
 * @}
 * @}
