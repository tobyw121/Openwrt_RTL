...
{
#if !defined(PLATFORM_ECOS) && (defined(CPTCFG_BPAUTO_RHASHTABLE) || (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 9, 0)))
	rhashtable_walk_enter((ht), (iter));
	return 0;
#elif !defined(PLATFORM_ECOS) && (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 7, 0))
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 4, 0)) || defined(PLATFORM_ECOS)
