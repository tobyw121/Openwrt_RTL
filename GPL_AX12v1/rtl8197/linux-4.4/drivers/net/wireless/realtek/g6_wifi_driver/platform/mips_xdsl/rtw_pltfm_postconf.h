...
#ifndef PLATFORM_MIPS_XDSL_RTW_PLTFM_POSTCONF_H_
#define PLATFORM_MIPS_XDSL_RTW_PLTFM_POSTCONF_H_
...
#endif /* PLATFORM_MIPS_XDSL_RTW_PLTFM_POSTCONF_H_ */
