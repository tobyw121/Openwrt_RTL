...
void _halrf_get_total_efuse_8852bp(struct rf_info *rf,
					enum phl_phy_idx phy)
{
	struct halrf_kfree_info *kfree = &rf->kfree_info;
	u32 i, array_size = sizeof(kfree->efuse_content);

	if (array_size < HIDE_EFUSE_SIZE_8852BP) {
		RF_DBG(rf, DBG_RF_TSSI_TRIM, "======> %s   sizeof(kfree->efuse_content)(0x%x) < HIDE_EFUSE_SIZE_8852BP(0x%x)\n",
			__func__, array_size, HIDE_EFUSE_SIZE_8852BP);
		return;
	}

	halrf_phy_efuse_get_info(rf, HIDE_EFUSE_START_ADDR_8852BP,
		HIDE_EFUSE_SIZE_8852BP, kfree->efuse_content);

	for (i = 0; i < HIDE_EFUSE_SIZE_8852BP; i++)
		RF_DBG(rf, DBG_RF_TSSI_TRIM, "======> %s   efuse_con[0x%x] = 0x%x\n",
			__func__, i + HIDE_EFUSE_START_ADDR_8852BP, kfree->efuse_content[i]);
}

u8 _halrf_get_1byte_efuse_8852bp(struct rf_info *rf, u32 addr, u8 *value)
{
	struct halrf_kfree_info *kfree = &rf->kfree_info;

	if (addr < HIDE_EFUSE_START_ADDR_8852BP || addr > HIDE_EFUSE_END_ADDR_8852BP) {
		RF_DBG(rf, DBG_RF_TSSI_TRIM, "===> %s addr(0x%x) < 0x%x(Min), > 0x%x(Max) Over Range Return !!!\n",
			__func__, addr, HIDE_EFUSE_START_ADDR_8852BP, HIDE_EFUSE_END_ADDR_8852BP);
		return 0xff;
	}

	*value = kfree->efuse_content[addr - HIDE_EFUSE_START_ADDR_8852BP];

	return *value;
}

s8 _halrf_efuse_exchange_8852bp(struct rf_info *rf, u8 value, u8 mask)
{
	s8 tmp = 0;
...
void _halrf_set_thermal_trim_8852bp(struct rf_info *rf,
					enum phl_phy_idx phy)
{
	...
	tmp = _halrf_get_1byte_efuse_8852bp(rf, THERMAL_TRIM_HIDE_EFUSE_A_8852BP, &thermal_a);

	tmp = _halrf_get_1byte_efuse_8852bp(rf, THERMAL_TRIM_HIDE_EFUSE_B_8852BP, &thermal_b);
...
void _halrf_set_pa_bias_trim_8852bp(struct rf_info *rf,
					enum phl_phy_idx phy)
{
	...
	tmp = _halrf_get_1byte_efuse_8852bp(rf, PABIAS_TRIM_HIDE_EFUSE_A_8852BP, &pa_bias_a);

	tmp = _halrf_get_1byte_efuse_8852bp(rf, PABIAS_TRIM_HIDE_EFUSE_B_8852BP, &pa_bias_b);
...
void _halrf_get_tssi_trim_8852bp(struct rf_info *rf,
					enum phl_phy_idx phy)
{
	...
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_2GL_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][0]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_2GH_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][1]);

	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GL1_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][2]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GL2_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][3]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GM1_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][4]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GM2_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][5]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GH1_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][6]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GH2_A_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_A][7]);

	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_2GL_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][0]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_2GH_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][1]);

	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GL1_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][2]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GL2_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][3]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GM1_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][4]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GM2_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][5]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GH1_B_8852BP,
		(u8 *)&tssi->tssi_trim[RF_PATH_B][6]);
	_halrf_get_1byte_efuse_8852bp(rf, TSSI_TRIM_HIDE_EFUSE_5GH2_B_8852BP,
...
void halrf_get_efuse_trim_8852bp(struct rf_info *rf,
					enum phl_phy_idx phy)
{
	_halrf_get_total_efuse_8852bp(rf, phy);
	_halrf_set_thermal_trim_8852bp(rf, phy);
	_halrf_set_pa_bias_trim_8852bp(rf, phy);
	_halrf_get_tssi_trim_8852bp(rf, phy);
}

void halrf_kfree_get_info_8852bp(struct rf_info *rf, char input[][16], u32 *_used,
			 char *output, u32 *_out_len)
{
	...
	RF_DBG_CNSL(*_out_len, *_used, output + *_used, *_out_len - *_used,
		" %-30s : 0x%X = 0x%X\n",
		"Thermal 2G A Efuse",
		THERMAL_TRIM_HIDE_EFUSE_A_8852BP,
		_halrf_get_1byte_efuse_8852bp(rf, THERMAL_TRIM_HIDE_EFUSE_A_8852BP, &tmp));
	...
	RF_DBG_CNSL(*_out_len, *_used, output + *_used, *_out_len - *_used,
		" %-30s : 0x%X = 0x%X\n",
		"Thermal 2G B Efuse",
		THERMAL_TRIM_HIDE_EFUSE_B_8852BP,
		_halrf_get_1byte_efuse_8852bp(rf, THERMAL_TRIM_HIDE_EFUSE_B_8852BP, &tmp));
	...
	RF_DBG_CNSL(*_out_len, *_used, output + *_used, *_out_len - *_used,
		" %-30s : 0x%X = 0x%X\n",
		"PABias 2G A Efuse",
		PABIAS_TRIM_HIDE_EFUSE_A_8852BP,
		_halrf_get_1byte_efuse_8852bp(rf, PABIAS_TRIM_HIDE_EFUSE_A_8852BP, &tmp));
	...
	RF_DBG_CNSL(*_out_len, *_used, output + *_used, *_out_len - *_used,
		" %-30s : 0x%X = 0x%X\n",
		"PABias 2G B Efuse",
		PABIAS_TRIM_HIDE_EFUSE_B_8852BP,
		_halrf_get_1byte_efuse_8852bp(rf, PABIAS_TRIM_HIDE_EFUSE_B_8852BP, &tmp));
