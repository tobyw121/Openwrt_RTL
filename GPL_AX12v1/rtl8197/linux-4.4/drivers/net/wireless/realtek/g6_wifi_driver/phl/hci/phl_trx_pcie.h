...
struct rtw_rx_buf_ring {
	...
	int pool_idx; /* skb pool used for this RX ring */
...
#define USED_DMA_CH    0x1FFF /* All DMA channels */
#else
#define USED_DMA_CH    0x130F /* No CH 0~3, 8, 9, 12 */
#endif /* CONFIG_DBCC_SUPPORT */

#define IS_DMA_CH_USED(ch) (BIT(ch) & USED_DMA_CH)
