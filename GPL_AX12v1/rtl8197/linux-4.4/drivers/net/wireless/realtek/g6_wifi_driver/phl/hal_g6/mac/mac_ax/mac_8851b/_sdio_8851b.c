...
u32 get_sdio_rx_req_len_8851b(struct mac_ax_adapter *adapter, u32 *rx_req_len)
{
	u8 pwr_state;
	u32 val32;
...
u32 sdio_pre_init_8851b(struct mac_ax_adapter *adapter, void *param)
{
	u16 val16;
	u32 val32;
...
u32 tx_mode_cfg_sdio_8851b(struct mac_ax_adapter *adapter,
...
u32 get_int_latency_sdio_8851b(struct mac_ax_adapter *adapter)
{
...
u32 get_clk_cnt_sdio_8851b(struct mac_ax_adapter *adapter, u32 *cnt)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32;
...
u32 set_wt_cfg_sdio_8851b(struct mac_ax_adapter *adapter, u8 en)
{
...
u32 set_clk_mon_sdio_8851b(struct mac_ax_adapter *adapter,
...
u32 leave_suspend_sdio_8851b(struct mac_ax_adapter *adapter)
{
	u8 val8;
	u32 cnt;
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
...
u32 sdio_pwr_switch_8851b(void *vadapter,
			  u8 pre_switch, u8 on)
{
...
u8 r_indir_cmd52_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr)
{
	u8 count = 0;
...
u8 _r_indir_cmd52_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr)
{
	u8 tmp;
	u32 cnt;
...
u32 _r_indir_cmd53_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr)
{
	u8 val[12] = {0};
	u32 cnt, i;
...
u32 r16_indir_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr)
{
	u8 pwr_state;
	union {
		__le32 dword;
...
u32 r32_indir_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr)
{
	u8 pwr_state;
	union {
		__le32 dword;
...
void w_indir_cmd52_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr, u32 val,
...
void w_indir_cmd53_sdio_8851b(struct mac_ax_adapter *adapter, u32 adr, u32 val,
			      enum sdio_io_size size)
{
	u8 value[12] = {0};
	u8 tmp;
...
void ud_fs_8851b(struct mac_ax_adapter *adapter)
{
	u8 val[28] = {0};
...
void rx_agg_cfg_sdio_8851b(struct mac_ax_adapter *adapter,
...
void aval_page_cfg_sdio_8851b(struct mac_ax_adapter *adapter,
