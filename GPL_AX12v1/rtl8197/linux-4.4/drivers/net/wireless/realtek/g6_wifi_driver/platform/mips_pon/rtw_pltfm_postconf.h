...
#ifndef PLATFORM_MIPS_PON_RTW_PLTFM_POSTCONF_H_
#define PLATFORM_MIPS_PON_RTW_PLTFM_POSTCONF_H_
...
#define CPU_ID_RX_CORE_0	1
#define CPU_ID_RX_CORE_1	0
...
#endif /* PLATFORM_MIPS_PON_RTW_PLTFM_POSTCONF_H_ */
