			   ...
			   u32 folder_len, u32 *folder_array)
{
	...
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_radio_a_reg(rf, 0);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_radio_a_reg(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_radio_b_reg(rf, 0);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_radio_b_reg(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_power_by_rate(rf, 0);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_power_by_rate(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_power_limit(rf, 0);
		halrf_config_8832crvu_store_power_limit_6g(rf, 0);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_power_limit(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_power_limit_ru(rf, 0);
		halrf_config_8832crvu_store_power_limit_ru_6g(rf, 0);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_power_limit_ru(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_pwr_track(rf, 0);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_pwr_track(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_xtal_track(rf, 0);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_radio_b_reg(rf, phy);
		halrf_config_8832crvu_radio_a_reg(rf, phy);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_radio_a_reg(rf, phy);
		halrf_config_8832brvt_radio_b_reg(rf, phy);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_power_by_rate(rf, phy);
	}
#endif

#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_power_by_rate(rf, phy);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_power_limit(rf, phy);
...
#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_power_limit(rf, phy);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_power_limit_ru(rf, phy);
...
#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_power_limit_ru(rf, phy);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_pwr_track(rf, phy);
	}
#endif
	
#ifdef RF_8832BRVT_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832BRVT) {
		halrf_config_8832brvt_store_pwr_track(rf, phy);
	}
#endif
...
#ifdef RF_8832CRVU_SUPPORT
	if (hal_com->chip_id == CHIP_WIFI6_8832CRVU) {
		halrf_config_8832crvu_store_xtal_track(rf, phy);
	}
#endif
