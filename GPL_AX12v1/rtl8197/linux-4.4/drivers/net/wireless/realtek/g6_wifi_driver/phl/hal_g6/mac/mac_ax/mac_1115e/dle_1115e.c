...
const u32 b_preld_hiq_mbid_en_l_1115[MAC_AX_P0_MBID_MAX] = {
	B_BE_PRELD_HIQ_P0_EN, B_BE_PRELD_HIQ_P0MB1_EN, B_BE_PRELD_HIQ_P0MB2_EN,
	B_BE_PRELD_HIQ_P0MB3_EN, B_BE_PRELD_HIQ_P0MB4_EN,
	B_BE_PRELD_HIQ_P0MB5_EN, B_BE_PRELD_HIQ_P0MB6_EN,
	B_BE_PRELD_HIQ_P0MB7_EN, B_BE_PRELD_HIQ_P0MB8_EN,
	B_BE_PRELD_HIQ_P0MB9_EN, B_BE_PRELD_HIQ_P0MB10_EN,
	B_BE_PRELD_HIQ_P0MB11_EN, B_BE_PRELD_HIQ_P0MB12_EN,
	B_BE_PRELD_HIQ_P0MB13_EN, B_BE_PRELD_HIQ_P0MB14_EN,
	B_BE_PRELD_HIQ_P0MB15_EN
};

const u32 b_preld_hiq_port_en_l_1115[MAC_AX_PORT_NUM] = {
	B_BE_PRELD_HIQ_P0_EN, B_BE_PRELD_HIQ_P1_EN, B_BE_PRELD_HIQ_P2_EN,
	B_BE_PRELD_HIQ_P3_EN, B_BE_PRELD_HIQ_P4_EN
};
...
u32 dle_dfi_sel_1115e(struct mac_ax_adapter *adapter,
...
u32 dle_dfi_ctrl_1115e(struct mac_ax_adapter *adapter, struct dle_dfi_ctrl_t *ctrl_p)
{
	...
	case DLE_CTRL_TYPE_WDE:
		ctrl_reg = R_BE_WDE_DBG_FUN_INTF_CTL;
		data_reg = R_BE_WDE_DBG_FUN_INTF_DATA;
		ctrl_data = SET_WORD(ctrl_p->target,
				     B_BE_WDE_DFI_TRGSEL) |
			    SET_WORD(ctrl_p->addr, B_BE_WDE_DFI_ADDR) |
			    B_BE_WDE_DFI_ACTIVE;
		break;
	case DLE_CTRL_TYPE_PLE:
		ctrl_reg = R_BE_PLE_DBG_FUN_INTF_CTL;
		data_reg = R_BE_PLE_DBG_FUN_INTF_DATA;
		ctrl_data = SET_WORD(ctrl_p->target,
				     B_BE_PLE_DFI_TRGSEL) |
			    SET_WORD(ctrl_p->addr, B_BE_PLE_DFI_ADDR) |
			    B_BE_PLE_DFI_ACTIVE;
		break;
	default:
	...
	while (cnt && MAC_REG_R32(ctrl_reg) & B_BE_WDE_DFI_ACTIVE) {
...
u32 dle_is_txq_empty_1115e(struct mac_ax_adapter *adapter, u8 *val)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32, rval32;

	val32 = B_BE_WDE_EMPTY_QUE_CMAC0_ALL_AC | B_BE_WDE_EMPTY_QUE_CMAC0_MBH |
		B_BE_WDE_EMPTY_QUE_CMAC1_MBH | B_BE_WDE_EMPTY_QUE_CMAC0_WMM0 |
		B_BE_WDE_EMPTY_QUE_CMAC0_WMM1 | B_BE_WDE_EMPTY_QUE_OTHERS |
		B_BE_PLE_EMPTY_QUE_DMAC_MPDU_TX | B_BE_PLE_EMPTY_QTA_DMAC_H2C |
		B_BE_PLE_EMPTY_QUE_DMAC_SEC_TX | B_BE_WDE_EMPTY_QUE_DMAC_PKTIN |
		B_BE_WDE_EMPTY_QTA_DMAC_HIF | B_BE_WDE_EMPTY_QTA_DMAC_WLAN_CPU |
		B_BE_WDE_EMPTY_QTA_DMAC_PKTIN | B_BE_WDE_EMPTY_QTA_DMAC_CPUIO |
		B_BE_PLE_EMPTY_QTA_DMAC_B0_TXPL |
		B_BE_PLE_EMPTY_QTA_DMAC_B1_TXPL |
		B_BE_PLE_EMPTY_QTA_DMAC_MPDU_TX |
		B_BE_PLE_EMPTY_QTA_DMAC_CPUIO |
		B_BE_WDE_EMPTY_QTA_DMAC_DATA_CPU |
		B_BE_PLE_EMPTY_QTA_DMAC_WLAN_CPU;

	rval32 = MAC_REG_R32(R_BE_DLE_EMPTY0);
...
u32 dle_is_rxq_empty_1115e(struct mac_ax_adapter *adapter, u8 *val)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32, rval32;

	val32 = B_BE_WDE_EMPTY_QUE_DMAC_WDRLS | B_BE_PLE_EMPTY_QUE_DMAC_SEC_RX |
		B_BE_PLE_EMPTY_QUE_DMAC_MPDU_RX | B_BE_PLE_EMPTY_QUE_DMAC_HDP |
		B_BE_PLE_EMPTY_QUE_DMAC_PLRLS | B_BE_PLE_EMPTY_QUE_DMAC_CPUIO |
		B_BE_PLE_EMPTY_QTA_DMAC_C2H | B_BE_PLE_EMPTY_QTA_CMAC0_DMA_RX |
		B_BE_PLE_EMPTY_QTA_CMAC1_DMA_RX |
		B_BE_PLE_EMPTY_QTA_CMAC1_DMA_BBRPT |
		B_BE_PLE_EMPTY_QTA_DMAC_WDRLS;

	rval32 = MAC_REG_R32(R_BE_DLE_EMPTY1);
	if (val32 != (rval32 & val32)) {
		*val = DLE_QUEUE_NONEMPTY;
...
u32 mac_is_txq_empty_1115e(struct mac_ax_adapter *adapter,
			   struct mac_ax_tx_queue_empty *val)
{
	...
	qempty.grpsel = WDE_QEMPTY_MGQ_SEL_1115E;
	ret = dle_dfi_qempty(adapter, &qempty);
	if (ret != MACSUCCESS) {
	...
	val32 = B_BE_WDE_EMPTY_QTA_DMAC_WLAN_CPU |
		B_BE_WDE_EMPTY_QTA_DMAC_DATA_CPU |
		B_BE_PLE_EMPTY_QTA_DMAC_WLAN_CPU;
	val32_emp0 = MAC_REG_R32(R_BE_DLE_EMPTY0);
	if (val32 != (val32_emp0 & val32))
		val->fw_txq_empty = 0;

	if (!(val32_emp0 & B_BE_PLE_EMPTY_QTA_DMAC_H2C))
		val->h2c_empty = 0;

	val32 = B_BE_WDE_EMPTY_QUE_OTHERS | B_BE_PLE_EMPTY_QUE_DMAC_MPDU_TX |
		B_BE_WDE_EMPTY_QTA_DMAC_CPUIO | B_BE_PLE_EMPTY_QTA_DMAC_CPUIO |
		B_BE_WDE_EMPTY_QUE_DMAC_PKTIN | B_BE_WDE_EMPTY_QTA_DMAC_HIF |
		B_BE_PLE_EMPTY_QUE_DMAC_SEC_TX | B_BE_WDE_EMPTY_QTA_DMAC_PKTIN |
		B_BE_PLE_EMPTY_QTA_DMAC_B0_TXPL |
		B_BE_PLE_EMPTY_QTA_DMAC_B1_TXPL |
		B_BE_PLE_EMPTY_QTA_DMAC_MPDU_TX;
...
u32 mac_is_rxq_empty_1115e(struct mac_ax_adapter *adapter,
			   struct mac_ax_rx_queue_empty *val)
{
	...
	val32_emp1 = MAC_REG_R32(R_BE_DLE_EMPTY1);
	if (!(val32_emp1 & B_BE_PLE_EMPTY_QTA_CMAC0_DMA_RX))
		val->band0_rxq_empty = 0;

	if (!(val32_emp1 & B_BE_PLE_EMPTY_QTA_CMAC1_DMA_RX))
		val->band1_rxq_empty = 0;

	if (!(val32_emp1 & B_BE_PLE_EMPTY_QTA_DMAC_C2H))
		val->c2h_empty = 0;
...
u32 preload_cfg_set_1115e(struct mac_ax_adapter *adapter, enum mac_ax_band band,
			  struct mac_ax_preld_cfg *cfg)
{
	...
	reg = band == MAC_AX_BAND_0 ? R_BE_PTCL_PRELD_CTRL :
				      R_BE_PTCL_PRELD_CTRL_C1;
	val32 = MAC_REG_R32(reg);
	val32 = cfg->mgq_en ? val32 | B_BE_PRELD_MGQ0_EN :
			      val32 & ~B_BE_PRELD_MGQ0_EN;
	for (i = MAC_AX_PORT_0; i < MAC_AX_PORT_NUM; i++)
		val32 &= ~b_preld_hiq_port_en_l_1115[i];
	for (i = MAC_AX_P0_MBID1; i < MAC_AX_P0_MBID_LAST; i++)
		val32 &= ~b_preld_hiq_mbid_en_l_1115[i];
	if (cfg->hiq_en) {
		val32 = cfg->hiq_port == MAC_AX_PORT_0 ?
			val32 | b_preld_hiq_mbid_en_l_1115[cfg->hiq_mbid] :
			val32 | b_preld_hiq_port_en_l_1115[cfg->hiq_port];
	}
	...
	reg = band == MAC_AX_BAND_0 ? R_BE_TXPKTCTL_B0_PRELD_CFG0 :
				      R_BE_TXPKTCTL_B1_PRELD_CFG0;
	val32 = MAC_REG_R32(reg);
	val32 = SET_CLR_WORD(val32, grp0_num, B_BE_B0_PRELD_CAM_G0ENTNUM);
	val32 = SET_CLR_WORD(val32, grp1_num, B_BE_B0_PRELD_CAM_G1ENTNUM);
	MAC_REG_W32(reg, val32);

	return MACSUCCESS;
}

u32 preload_init_set_1115e(struct mac_ax_adapter *adapter, enum mac_ax_band band,
			   enum mac_ax_qta_mode mode)
{
	...
	reg = band == MAC_AX_BAND_0 ? R_BE_TXPKTCTL_B0_PRELD_CFG0 :
				      R_BE_TXPKTCTL_B1_PRELD_CFG0;
	val32 = MAC_REG_R32(reg);
	val32 = SET_CLR_WORD(val32, max_preld_size, B_BE_B0_PRELD_USEMAXSZ);
	val32 |= B_BE_B0_PRELD_FEN;
	MAC_REG_W32(reg, val32);

	min_rsvd_size = PRELD_AMSDU_SIZE;
	reg = band == MAC_AX_BAND_0 ? R_BE_TXPKTCTL_B0_PRELD_CFG1 :
				      R_BE_TXPKTCTL_B1_PRELD_CFG1;
	val32 = MAC_REG_R32(reg);
	val32 = SET_CLR_WORD(val32, PRELD_NEXT_WND, B_BE_B0_PRELD_NXT_TXENDWIN);
	val32 = SET_CLR_WORD(val32, min_rsvd_size, B_BE_B0_PRELD_NXT_RSVMINSZ);
	MAC_REG_W32(reg, val32);

	return MACSUCCESS;
}

u32 dle_func_en_1115e(struct mac_ax_adapter *adapter, u8 en)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32;
	...
	if (en == MAC_AX_FUNC_EN)
		val32 |= (B_BE_WDE_DLE_EN | B_BE_PLE_DEL_EN);
	else if (en == MAC_AX_FUNC_DIS)
		val32 &= ~(B_BE_WDE_DLE_EN | B_BE_PLE_DEL_EN);
	else
		return MACSUCCESS;
	MAC_REG_W32(R_BE_DMAC_FUNC_EN, val32);

	return MACSUCCESS;
}

u32 dle_clk_en_1115e(struct mac_ax_adapter *adapter, u8 en)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32;

	val32 = MAC_REG_R32(R_BE_DMAC_CLK_EN);
	if (en == MAC_AX_FUNC_EN)
		val32 |= (B_BE_WDE_DLE_CKEN | B_BE_PLE_DEL_CKEN);
	else if (en == MAC_AX_FUNC_DIS)
		val32 &= ~(B_BE_WDE_DLE_CKEN | B_BE_PLE_DEL_CKEN);
	else
		return MACSUCCESS;
	MAC_REG_W32(R_BE_DMAC_CLK_EN, val32);

	return MACSUCCESS;
}

u32 dle_mix_cfg_1115e(struct mac_ax_adapter *adapter, struct dle_mem_t *cfg)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	struct dle_size_t *size_cfg;
	u32 val32, bound;

	val32 = MAC_REG_R32(R_BE_WDE_PKTBUF_CFG);
	bound = 0;
	...
	val32 = SET_CLR_WORD(val32, bound, B_BE_WDE_START_BOUND);
	val32 = SET_CLR_WORD(val32, size_cfg->lnk_pge_num,
			     B_BE_WDE_FREE_PAGE_NUM);
	MAC_REG_W32(R_BE_WDE_PKTBUF_CFG, val32);

	val32 = MAC_REG_R32(R_BE_PLE_PKTBUF_CFG);
	...
	val32 = SET_CLR_WORD(val32, bound, B_BE_PLE_START_BOUND);
	val32 = SET_CLR_WORD(val32, size_cfg->lnk_pge_num,
			     B_BE_PLE_FREE_PAGE_NUM);
	MAC_REG_W32(R_BE_PLE_PKTBUF_CFG, val32);

	return MACSUCCESS;
}

u32 wde_quota_cfg_1115e(struct mac_ax_adapter *adapter,
			...
			struct wde_quota_t *max_cfg)
{
	...
	val32 = SET_WORD(min_cfg->hif, B_BE_WDE_Q0_MIN_SIZE) |
		SET_WORD(max_cfg->hif, B_BE_WDE_Q0_MAX_SIZE);
	MAC_REG_W32(R_BE_WDE_QTA0_CFG, val32);

	val32 = SET_WORD(min_cfg->wcpu, B_BE_WDE_Q1_MIN_SIZE) |
		SET_WORD(max_cfg->wcpu, B_BE_WDE_Q1_MAX_SIZE);
	MAC_REG_W32(R_BE_WDE_QTA1_CFG, val32);

	val32 = SET_WORD(min_cfg->dcpu, B_BE_WDE_Q2_MIN_SIZE) |
		SET_WORD(max_cfg->dcpu, B_BE_WDE_Q2_MAX_SIZE);
	MAC_REG_W32(R_BE_WDE_QTA2_CFG, val32);

	val32 = SET_WORD(min_cfg->pkt_in, B_BE_WDE_Q3_MIN_SIZE) |
		SET_WORD(max_cfg->pkt_in, B_BE_WDE_Q3_MAX_SIZE);
	MAC_REG_W32(R_BE_WDE_QTA3_CFG, val32);

	val32 = SET_WORD(min_cfg->cpu_io, B_BE_WDE_Q4_MIN_SIZE) |
		SET_WORD(max_cfg->cpu_io, B_BE_WDE_Q4_MAX_SIZE);
	MAC_REG_W32(R_BE_WDE_QTA4_CFG, val32);

	return MACSUCCESS;
}

u32 ple_quota_cfg_1115e(struct mac_ax_adapter *adapter,
			...
			struct ple_quota_t *max_cfg)
{
	...
	val32 = SET_WORD(min_cfg->cma0_tx, B_BE_PLE_Q0_MIN_SIZE) |
		SET_WORD(max_cfg->cma0_tx, B_BE_PLE_Q0_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA0_CFG, val32);

	val32 = SET_WORD(min_cfg->cma1_tx, B_BE_PLE_Q1_MIN_SIZE) |
		SET_WORD(max_cfg->cma1_tx, B_BE_PLE_Q1_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA1_CFG, val32);

	val32 = SET_WORD(min_cfg->c2h, B_BE_PLE_Q2_MIN_SIZE) |
		SET_WORD(max_cfg->c2h, B_BE_PLE_Q2_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA2_CFG, val32);

	val32 = SET_WORD(min_cfg->h2c, B_BE_PLE_Q3_MIN_SIZE) |
		SET_WORD(max_cfg->h2c, B_BE_PLE_Q3_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA3_CFG, val32);

	val32 = SET_WORD(min_cfg->wcpu, B_BE_PLE_Q4_MIN_SIZE) |
		SET_WORD(max_cfg->wcpu, B_BE_PLE_Q4_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA4_CFG, val32);

	val32 = SET_WORD(min_cfg->mpdu_proc, B_BE_PLE_Q5_MIN_SIZE) |
		SET_WORD(max_cfg->mpdu_proc, B_BE_PLE_Q5_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA5_CFG, val32);

	val32 = SET_WORD(min_cfg->cma0_dma, B_BE_PLE_Q6_MIN_SIZE) |
		SET_WORD(max_cfg->cma0_dma, B_BE_PLE_Q6_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA6_CFG, val32);

	val32 = SET_WORD(min_cfg->cma1_dma, B_BE_PLE_Q7_MIN_SIZE) |
		SET_WORD(max_cfg->cma1_dma, B_BE_PLE_Q7_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA7_CFG, val32);

	val32 = SET_WORD(min_cfg->bb_rpt, B_BE_PLE_Q8_MIN_SIZE) |
		SET_WORD(max_cfg->bb_rpt, B_BE_PLE_Q8_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA8_CFG, val32);

	val32 = SET_WORD(min_cfg->wd_rel, B_BE_PLE_Q9_MIN_SIZE) |
		SET_WORD(max_cfg->wd_rel, B_BE_PLE_Q9_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA9_CFG, val32);

	val32 = SET_WORD(min_cfg->cpu_io, B_BE_PLE_Q10_MIN_SIZE) |
		SET_WORD(max_cfg->cpu_io, B_BE_PLE_Q10_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA10_CFG, val32);

	val32 = SET_WORD(min_cfg->tx_rpt, B_BE_PLE_Q11_MIN_SIZE) |
		SET_WORD(max_cfg->tx_rpt, B_BE_PLE_Q11_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA11_CFG, val32);

	val32 = SET_WORD(min_cfg->h2d, B_BE_PLE_Q12_MIN_SIZE) |
		SET_WORD(max_cfg->h2d, B_BE_PLE_Q12_MAX_SIZE);
	MAC_REG_W32(R_BE_PLE_QTA12_CFG, val32);

	return MACSUCCESS;
}

u32 chk_dle_rdy_1115e(struct mac_ax_adapter *adapter, enum DLE_CTRL_TYPE type)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 val32 = 0, reg, rdy_bit, cnt;

	if (type == DLE_CTRL_TYPE_WDE) {
		reg = R_BE_WDE_INI_STATUS;
		rdy_bit = B_BE_WDE_Q_MGN_INI_RDY | B_BE_WDE_BUF_MGN_INI_RDY;
	} else if (type == DLE_CTRL_TYPE_PLE) {
		reg = R_BE_PLE_INI_STATUS;
		rdy_bit = B_BE_PLE_Q_MGN_INI_RDY | B_BE_PLE_BUF_MGN_INI_RDY;
	} else {
		return MACFUNCINPUT;
	}
