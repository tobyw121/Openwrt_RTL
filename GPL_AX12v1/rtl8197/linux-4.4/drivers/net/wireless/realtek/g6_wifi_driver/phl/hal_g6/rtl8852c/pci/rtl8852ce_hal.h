 ...
 *
 *****************************************************************************/
#ifndef _RTL8852CE_HAL_H_
#define _RTL8852CE_HAL_H_
...
#if 0
enum rtw_hal_status hal_get_flash_8852ce(struct rtw_phl_com_t *phl_com,
					 struct hal_info_t *hal);
#endif
...
enum rtw_hal_status hal_stop_8852ce(struct rtw_phl_com_t *phl_com,
				    struct hal_info_t *hal);
#ifdef CONFIG_WOWLAN
enum rtw_hal_status hal_wow_init_8852ce(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal, struct rtw_phl_stainfo_t *sta);
enum rtw_hal_status hal_wow_deinit_8852ce(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal, struct rtw_phl_stainfo_t *sta);
#endif /* CONFIG_WOWLAN */

enum rtw_hal_status hal_mp_init_8852ce(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal);
enum rtw_hal_status hal_mp_deinit_8852ce(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal);
