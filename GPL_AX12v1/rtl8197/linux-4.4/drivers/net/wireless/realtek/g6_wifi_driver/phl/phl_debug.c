...
struct phl_dbg_comp_list _phl_dbg_comp_list[] = {
	...
	{"COMP_PHL_BB",		_PHL_BB,	BIT14},
	{"COMP_PHL_RF",		_PHL_RF,	BIT15},
	{"COMP_PHL_LED",	_PHL_LED,	BIT16},
	{"COMP_PHL_MAC",	_PHL_MCC,	BIT17},
	{"COMP_PHL_P2PPS",	_PHL_P2PPS,	BIT18},
	{"COMP_PHL_ECSA",	_PHL_ECSA,	BIT19},
	{"COMP_PHL_CMDDISP",	_PHL_CMDDISP,	BIT20},
	{"COMP_PHL_BTC",	_PHL_BTC,	BIT21},
};
...
u32 phl_log_components = COMP_PHL_DBG |
			 ...
			 COMP_PHL_WOW |
			/* COMP_PHL_CMDDISP |*/
			 COMP_PHL_MAC | COMP_PHL_PS | 0;
u8 phl_log_level = _PHL_WARNING_;
...
void phl_dbg_dump_log_comp(void)
{
	...
	u32 array_size = ARRAY_SIZE(_phl_dbg_comp_list);
	int i;
