...
struct rfk_iqk_info rf_iqk_hwspec_8852a = {
  	.rf_iqk_ops = &iqk_ops,
	.rf_max_path_num = 2,
	.rf_iqk_version = iqk_version_8852a,
	.rf_iqk_ch_num = 2,
	.rf_iqk_path_num = 2,
...
void halrf_before_one_shot_enable_8852a(struct rf_info *rf) {	
...
bool halrf_one_shot_nctl_done_check_8852a(struct rf_info *rf, enum rf_path path) {	
	/* for check status */
	u32 r_bff8 = 0;
	u32 r_80fc = 0;
	bool is_ready = false;
	...
	while (count < 2000) {	
		...
		/* TXGAPK_NCTL_FINAL_LINE_8852A 0x9c00 */
		if (r_80fc == TXGAPK_NCTL_FINAL_LINE_8852A) {
			is_ready = true;
			break;
		}	
