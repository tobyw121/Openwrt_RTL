...
#if defined(RTK_MULTI_AP) && defined(RTK_MULTI_AP_R1_DFS)	//skip reset dfsSwitchChCountDown and skip selecting new channel for multiap csa, instead use the channel from received csa
