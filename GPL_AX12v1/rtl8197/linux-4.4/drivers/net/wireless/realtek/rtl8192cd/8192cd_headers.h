...
#ifdef FT_DEBUGMSG
#define FTDEBUG(fmt, args...) panic_printk("[%s %d] "fmt,__FUNCTION__,__LINE__,## args)
#else
...
#ifdef DTTP
EXTERN void dttp(struct rtl8192cd_priv *priv);
#endif
...
EXTERN void sync_11w_capability(struct rtl8192cd_priv *priv, struct bss_desc *bss_target);
...
int check_full_ofld(struct rtl8192cd_priv *priv, struct stat_info *pstat, struct sk_buff *pskb, struct tx_insn* txcfg);
EXTERN __IRAM_IN_865X
int rtl8192cd_xmit_offload(struct stat_info *pstat, struct sk_buff *pskb, struct tx_insn* txcfg);
EXTERN __IRAM_IN_865X int rtl88XX_fill_txPktInfo(struct rtl8192cd_priv *priv, struct tx_insn *txcfg, unsigned char pktType);
...
EXTERN void dc_sta_update_group(struct rtl8192cd_priv *priv);
...
EXTERN void dc_if_update(struct rtl8192cd_priv *priv, int update_only);
...
#ifdef TCP_ACK_ACC
EXTERN void check_tcp_ack_timeout(struct rtl8192cd_priv *priv);
...
EXTERN int wpa2_ie_check(struct rtl8192cd_priv *priv,unsigned char *ie_ptr_in, int ie_len_in);
...
EXTERN void get_pg_val(int val,char *str);
...
EXTERN struct rtl8192cd_priv *ipc_8814b_priv;
...
EXTERN unsigned char a4_rx_check_reuse_offload(struct rtl8192cd_priv *priv, struct rx_frinfo *pfrinfo, struct stat_info *pstat, unsigned char * myhwaddr);
...
EXTERN int rtk_multi_ap_get_ap_capability(struct rtl8192cd_priv *priv, unsigned char* result_buf2);
EXTERN int rtk_multi_ap_get_client_capability(struct rtl8192cd_priv *priv, unsigned char* result_buf2);
EXTERN int rtk_multi_ap_do_backhaul_steer(struct rtl8192cd_priv *priv, unsigned char *tmpbuf);
EXTERN int rtk_multi_ap_get_metric(struct rtl8192cd_priv *priv, unsigned char *buf);
EXTERN int rtk_multi_ap_get_assoc_sta_metric(struct rtl8192cd_priv *priv, unsigned char *buf);
EXTERN int rtk_multi_ap_record_unassoc_sta_metric(struct rtl8192cd_priv *priv, unsigned char *buf);
EXTERN void rtk_multi_ap_beacon_metrics_response_notify(struct stat_info *pstat);
EXTERN void rtk_multi_ap_update_backhaul_steer_results(unsigned long task_priv);
...
EXTERN int rtk_multi_ap_update_policy(struct rtl8192cd_priv *priv, unsigned char *tmpbuf);
EXTERN void rtk_multi_ap_trigger_unassoc_sta_metric(unsigned long task_priv);
EXTERN int rtk_multi_ap_terminate_backhaul_ap_connection(struct rtl8192cd_priv *priv);
...
EXTERN void rtk_multi_ap_update_channel_scan_results(unsigned long task_priv);
EXTERN void rtk_multi_ap_update_cac_results(unsigned long task_priv);
EXTERN void rtk_multi_ap_update_cac_status(unsigned long task_priv);
EXTERN int rtk_multi_ap_cac_channel_switch(unsigned long task_priv);
...
#if defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8881A) || defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_RTL_8723B_SUPPORT) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8821CE) || defined(CONFIG_WLAN_HAL_8822CE) || defined(CONFIG_WLAN_HAL_8812FE)
