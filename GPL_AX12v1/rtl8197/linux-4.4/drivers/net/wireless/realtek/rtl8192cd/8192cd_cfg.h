...
/*adjusted for support AMSDU*/
	...
	#ifdef CONFIG_RTK_MESH
    #define MAX_RX_BUF_LEN	4400//2600   // wlan0 8814B
    #define MIN_RX_BUF_LEN	4400//2600   // wlan0 8814B
	#else
...
/*when Curr_Ther reach a TH(X) continue 5 secs, then decrease y dbm , just do it once*/
#define	THER_DECREASE_TSSI_TARGET_POWER
#ifdef	THER_DECREASE_TSSI_TARGET_POWER
#define DTTP
#if 1
#define dttplog(msg, ...) do {panic_printk("[%s %d]: " msg "\n", __func__,__LINE__,##__VA_ARGS__);} while(0)
#else
#define dttplog(msg, ...) NOP
#endif
