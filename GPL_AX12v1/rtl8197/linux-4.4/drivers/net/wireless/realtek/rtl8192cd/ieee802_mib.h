...
// RTK_AC_SUPPORT
	...
	/*DTTP*/
	unsigned char	dttp_toggle;/*0:no derease,1:has dereased*/
	unsigned int	currthermal[4];/*record current temperature*/
	/*belowing two mibs can be config*/
	unsigned char	dttp_monitor_ther_up;
	unsigned char	dttp_monitor_ther_low;
	unsigned char	dttp_dbm;
};
...
//#endif
	...
	unsigned int 	dc_debug;
	unsigned int	check_hang_hold;
};
