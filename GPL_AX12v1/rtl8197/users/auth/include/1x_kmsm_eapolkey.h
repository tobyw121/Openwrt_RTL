...
extern	void Message_ReplayCounter_OC2LI(OCTET_STRING f, LARGE_INTEGER * li);
extern	void ReplayCounter_OC2LI(OCTET_STRING f, LARGE_INTEGER * li);
extern int Message_EqualReplayCounter(LARGE_INTEGER li1, OCTET_STRING f);
extern int Message_SmallerEqualReplayCounter(LARGE_INTEGER li1, OCTET_STRING f);
extern int Message_LargerReplayCounter(LARGE_INTEGER li1, OCTET_STRING f);
extern void Message_setReplayCounter(OCTET_STRING f, u_long h, u_long l);
...
//---------------------------------------------------------------------
extern  void INCLargeInteger(
	LARGE_INTEGER * x);

extern  void ReplayCounter_LI2OC(
	OCTET_STRING f,
	LARGE_INTEGER * li);
