...
function saveChanges_basic(form, wlan_id)
{
	...
	var repeater_ssid =form.elements["repeaterSSID"+wlan_id] ;
	if(repeater_ssid.value == ""){
		alert(util_gw_vxd_ssid_empty);

		repeater_ssid.value = repeater_ssid.defaultValue;
		repeater_ssid.focus();
		return false;
	}
    ...
    if(band & 4){
		...
		if (band & 8) 
		{
			...
			if ((band & 1) || (band & 2))
				...
				basicRate=0x1f0;
			else if(form.elements["Band2G5GSupport"].value == 1)
				basicRate=0xf;
			else
				basicRate=0x1f0;
		}
...
//--------------------Multi AP----------------------//
	if (enable_vlan) {
		if (map_vid[wlan_id * 5]) {
			if ((wlan_disabled == wlan_state) || (ssid.value != wps_ssid_old)) {
				...
				if(-1 != map_ssid.indexOf(ssid.value))
					map_vid[wlan_id * 5] = map_vid[map_ssid.indexOf(ssid.value)];
			}
		} else if (wlan_state) {
			...
			map_vid[wlan_id * 5] = default_sec_vid;
		}
...
//ac2g
	if(band_value == 9 || band_value ==10 || band_value==7 || band_value==11 || band_value==14 || band_value==63 || band_value==71 || band_value==75 || band_value==74 || band_value==203){ //8812
...
/* MKK */			reg_chan_8812_full[5]= new Array("36","40","44","48","52","56","60","64","100","104","108","112","116","120","124","128","132","136","140","144");                                          
...
var currentBand;		
	...
	if(band_value ==3 || band_value ==11 || band_value ==63|| band_value ==71|| band_value ==75 ||band_value ==203){
		currentBand = 2;
	}
...
//ac2g
	if(band_value ==3|| band_value ==11 || (band_value ==7 && Band2G5GSupport == 2)|| band_value ==63|| band_value ==71 || band_value ==75 || band_value ==203){ // 3:5g_a 11:5g_an 7:n 2:PHYBAND_5G
		currentBand = 2;
	}
...
function showBand_MultipleAP(form, wlan_id, band_root, index_id)
{
  ...
  if(form.elements["wlan_support_ax"])
	wlan_support_ax=form.elements["wlan_support_ax"].value;
  ...
  if(band_root ==0){
...
else if ((wlan_support_ax)&& (band_root == 203)){
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (A)", "3", false, false);
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (N)", "7", false, false);
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (A+N)", "11", false, false);
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (AC)", "63", false, false);
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (N+AC)", "71", false, false);
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (A+N+AC)", "75", false, false);
	form.elements["wl_band_ssid"+index_id].options[idx++] = new Option("5 GHz (A+N+AC+AX)", "203", false, false);
}
...
if(form.name == "wizard")
{
	...
	if(Band2G5GSupport == 2 || wlBandMode == 3) // 2:PHYBAND_5G 3:BANDMODESIGNLE
	{
		...
		if( (wlan_support_8812e==1) &&  (wlan_support_8192f!=1))
		{
			...
			if(wlan_support_ax)
				form.elements["band"+wlan_id].options[idx++] = new Option("5 GHz (A+N+AC+AX)", "203", false, false);
		}
	}
...
function updateMode(form, wlan_id)
{
	...
	|| bandIdx[wlan_id] == 14 || bandIdx[wlan_id] == 63 || bandIdx[wlan_id] == 71 || bandIdx[wlan_id] == 75 || bandIdx[wlan_id] == 203){
...
ntp_zone_array[0]=new ntp_entry("<script>dw(util_gw_array0)</script>","12 1");
ntp_zone_array[1]=new ntp_entry("<script>dw(util_gw_array1)</script>","11 1");
ntp_zone_array[2]=new ntp_entry("<script>dw(util_gw_array2)</script>","10 1");
ntp_zone_array[3]=new ntp_entry("<script>dw(util_gw_array3)</script>","9 1");
ntp_zone_array[4]=new ntp_entry("<script>dw(util_gw_array4)</script>","8 1");
ntp_zone_array[5]=new ntp_entry("<script>dw(util_gw_array5)</script>","7 1");
ntp_zone_array[6]=new ntp_entry("<script>dw(util_gw_array6)</script>","7 2");
ntp_zone_array[7]=new ntp_entry("<script>dw(util_gw_array7)</script>","6 1");
ntp_zone_array[8]=new ntp_entry("<script>dw(util_gw_array8)</script>","6 2");
ntp_zone_array[9]=new ntp_entry("<script>dw(util_gw_array9)</script>","6 3");
ntp_zone_array[10]=new ntp_entry("<script>dw(util_gw_array10)</script>","5 1");
ntp_zone_array[11]=new ntp_entry("<script>dw(util_gw_array11)</script>","5 2");
ntp_zone_array[12]=new ntp_entry("<script>dw(util_gw_array12)</script>","5 3");
ntp_zone_array[13]=new ntp_entry("<script>dw(util_gw_array13)</script>","4 1");
ntp_zone_array[14]=new ntp_entry("<script>dw(util_gw_array14)</script>","4 2");
ntp_zone_array[15]=new ntp_entry("<script>dw(util_gw_array15)</script>","4 3");
ntp_zone_array[16]=new ntp_entry("<script>dw(util_gw_array16)</script>","3 1");
ntp_zone_array[17]=new ntp_entry("<script>dw(util_gw_array17)</script>","3 2");
ntp_zone_array[18]=new ntp_entry("<script>dw(util_gw_array18)</script>","3 3");
ntp_zone_array[19]=new ntp_entry("<script>dw(util_gw_array19)</script>","2 1");
ntp_zone_array[20]=new ntp_entry("<script>dw(util_gw_array20)</script>","1 1");
ntp_zone_array[21]=new ntp_entry("<script>dw(util_gw_array21)</script>","0 1");
ntp_zone_array[22]=new ntp_entry("<script>dw(util_gw_array22)</script>","0 2");
ntp_zone_array[23]=new ntp_entry("<script>dw(util_gw_array23)</script>","-1 1");
ntp_zone_array[24]=new ntp_entry("<script>dw(util_gw_array24)</script>","-1 2");
ntp_zone_array[25]=new ntp_entry("<script>dw(util_gw_array25)</script>","-1 3");
ntp_zone_array[26]=new ntp_entry("<script>dw(util_gw_array26)</script>","-1 4");
ntp_zone_array[27]=new ntp_entry("<script>dw(util_gw_array27)</script>","-1 5");
ntp_zone_array[28]=new ntp_entry("<script>dw(util_gw_array28)</script>","-1 6");
ntp_zone_array[29]=new ntp_entry("<script>dw(util_gw_array29)</script>","-2 1");
ntp_zone_array[30]=new ntp_entry("<script>dw(util_gw_array30)</script>","-2 2");
ntp_zone_array[31]=new ntp_entry("<script>dw(util_gw_array31)</script>","-2 3");
ntp_zone_array[32]=new ntp_entry("<script>dw(util_gw_array32)</script>","-2 4");
ntp_zone_array[33]=new ntp_entry("<script>dw(util_gw_array33)</script>","-2 5");
ntp_zone_array[34]=new ntp_entry("<script>dw(util_gw_array34)</script>","-2 6");
ntp_zone_array[35]=new ntp_entry("<script>dw(util_gw_array35)</script>","-3 1");
ntp_zone_array[36]=new ntp_entry("<script>dw(util_gw_array36)</script>","-3 2");
ntp_zone_array[37]=new ntp_entry("<script>dw(util_gw_array37)</script>","-3 3");
ntp_zone_array[38]=new ntp_entry("<script>dw(util_gw_array38)</script>","-3 4");
ntp_zone_array[39]=new ntp_entry("<script>dw(util_gw_array39)</script>","-4 1");
ntp_zone_array[40]=new ntp_entry("<script>dw(util_gw_array40)</script>","-4 2");
ntp_zone_array[41]=new ntp_entry("<script>dw(util_gw_array41)</script>","-4 3");
ntp_zone_array[42]=new ntp_entry("<script>dw(util_gw_array42)</script>","-5 1");
ntp_zone_array[43]=new ntp_entry("<script>dw(util_gw_array43)</script>","-5 2");
ntp_zone_array[44]=new ntp_entry("<script>dw(util_gw_array44)</script>","-5 3");
ntp_zone_array[45]=new ntp_entry("<script>dw(util_gw_array45)</script>","-6 1");
ntp_zone_array[46]=new ntp_entry("<script>dw(util_gw_array46)</script>","-6 2");
ntp_zone_array[47]=new ntp_entry("<script>dw(util_gw_array47)</script>","-7 1");
ntp_zone_array[48]=new ntp_entry("<script>dw(util_gw_array48)</script>","-8 1");
ntp_zone_array[49]=new ntp_entry("<script>dw(util_gw_array49)</script>","-8 2");
ntp_zone_array[50]=new ntp_entry("<script>dw(util_gw_array50)</script>","-8 3");
ntp_zone_array[51]=new ntp_entry("<script>dw(util_gw_array51)</script>","-8 4");
ntp_zone_array[52]=new ntp_entry("<script>dw(util_gw_array52)</script>","-9 1");
ntp_zone_array[53]=new ntp_entry("<script>dw(util_gw_array53)</script>","-9 2");
ntp_zone_array[54]=new ntp_entry("<script>dw(util_gw_array54)</script>","-9 3");
ntp_zone_array[55]=new ntp_entry("<script>dw(util_gw_array55)</script>","-9 4");
ntp_zone_array[56]=new ntp_entry("<script>dw(util_gw_array56)</script>","-9 5");
ntp_zone_array[57]=new ntp_entry("<script>dw(util_gw_array57)</script>","-10 1");
ntp_zone_array[58]=new ntp_entry("<script>dw(util_gw_array58)</script>","-10 2");
ntp_zone_array[59]=new ntp_entry("<script>dw(util_gw_array59)</script>","-10 3");
ntp_zone_array[60]=new ntp_entry("<script>dw(util_gw_array60)</script>","-10 4");
ntp_zone_array[61]=new ntp_entry("<script>dw(util_gw_array61)</script>","-10 5");
ntp_zone_array[62]=new ntp_entry("<script>dw(util_gw_array62)</script>","-11 1");
ntp_zone_array[63]=new ntp_entry("<script>dw(util_gw_array63)</script>","-12 1");
ntp_zone_array[64]=new ntp_entry("<script>dw(util_gw_array64)</script>","-12 2");
...
function showcontrolsideband_updated(form, band, wlan_id, rf_num, index)
{
  ...
  if((band==7 && index==1) || band ==11 || band ==63 || band ==71 || band ==75 || band == 203)
  {
...
function showchannelbound_updated(form, band, wlan_id, rf_num)
{
	...
	if(band == 75 || band ==71|| band ==63 || band==203){ //ac2g
...
function showtxrate_updated(form, band, wlan_id, rf_num)
{
	...
	form.elements["txRate"+wlan_id].options[idx++] = new Option(wlbasic_data_rate_auto, "0", false, false);
	...
	if(band ==9 || band ==10 || band ==1 || band ==2 || band == 11 || band == 3 || band==75 || band == 74 || band==203)
	{
	...
	if(band ==9 || band ==10 || band == 7 || band == 11 || band ==71|| band ==75 || band == 74 || band==203)
	{
		...
		if(rf_num >= 4)
		{
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS24", "37", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS25", "38", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS26", "39", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS27", "40", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS28", "41", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS29", "42", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS30", "43", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("MCS31", "44", false, false);
		}
	}

	if(band ==63 || band ==71 || band == 75 || band == 74 || band==203)
	{
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS0", "45", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS1", "46", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS2", "47", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS3", "48", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS4", "49", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS5", "50", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS6", "51", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS7", "52", false, false);
	 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS8", "53", false, false);
	 	if(!channel_width_20M_flag)
		{
	 		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS1-MCS9", "54", false, false);
		}

	 	if(rf_num >=2)//8812_1t1r
		{
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS0", "55", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS1", "56", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS2", "57", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS3", "58", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS4", "59", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS5", "60", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS6", "61", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS7", "62", false, false);
		 	form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS8", "63", false, false);
			if(!channel_width_20M_flag)
			{
		 		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS2-MCS9", "64", false, false);
		 	}
	 	}
	}
	if(rf_num >= 3 &&( band == 75 || band == 74) && (channel_width_20M_flag == 1 || channel_width_40M_flag == 1))
	{
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS0", "65", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS1", "66", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS2", "67", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS3", "68", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS4", "69", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS5", "70", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS6", "71", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS7", "72", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS8", "73", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS9", "74", false, false);
	}
	if(rf_num >= 3 && (band == 75 || band == 74) && channel_width_80M_flag == 1)
	{
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS0", "75", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS1", "76", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS2", "77", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS3", "78", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS4", "79", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS5", "80", false, false);
		//form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS6", "81", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS7", "82", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS8", "83", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("NSS3-MCS9", "84", false, false);
	}
	if ((wlan_support_ax)&& (band == 203))
	{
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS0", "85", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS1", "86", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS2", "87", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS3", "88", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS4", "89", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS5", "90", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS6", "91", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS7", "92", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS8", "93", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS9", "94", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS10", "95", false, false);
		form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS1-MCS11", "96", false, false);
		if(rf_num >=2)
		{
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS0", "97", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS1", "98", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS2", "99", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS3", "100", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS4", "101", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS5", "102", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS6", "103", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS7", "104", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS8", "105", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS9", "106", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS10", "107", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS2-MCS11", "108", false, false);
		}
		if(rf_num >=4)
		{
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS0", "109", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS1", "110", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS2", "111", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS3", "112", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS4", "113", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS5", "114", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS6", "115", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS7", "116", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS8", "117", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS9", "118", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS10", "119", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS4-MCS11", "120", false, false);
		}
		if(rf_num >=8)
		{
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS0", "121", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS1", "122", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS2", "123", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS3", "124", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS4", "125", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS5", "126", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS6", "127", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS7", "128", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS8", "129", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS9", "130", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS10", "131", false, false);
			form.elements["txRate"+wlan_id].options[idx++] = new Option("HE-NSS8-MCS11", "132", false, false);
		}
	}
...
//ac2g
	if(index ==0 || index==2 || (wlan_support_8812e==1 && (band_value==11 || band_value==63 || band_value==71 || band_value==75 || band_value == 203 ||(band_value==7 && idx_value==1)))) //8812
		disableTextField(form.elements["controlsideband"+wlan_id]);
	else
		enableTextField(form.elements["controlsideband"+wlan_id]);
