...
#endif
#endif //CONFIG_USER_WLAN_USE_DRVCOMMON_HEADER
...
#define FT_MDID_LENGTH				5
#define FT_R0KH_ID_LENGTH			49
#endif

//=========== Multi_ap =========================

#if defined(CONFIG_APP_MULTI_AP)
	#if defined(CONFIG_RTK_MULTI_AP_R2) || defined(CPTCFG_RTK_MULTI_AP_R2) || defined(CPTCFG_RTW_MULTI_AP_R2)
	...
	#endif
	#if defined(CONFIG_USER_RTK_MULTI_AP_OPEN_ENCRYPT_SUPPORT)
		#define MULTI_AP_OPEN_ENCRYPT_SUPPORT
	#endif
	#if defined(CONFIG_USER_RTK_MULTI_AP_ETH_ADAPTER)
		#define MULTI_AP_ETH_ADAPTER_SUPPORT
	#endif
#endif

//============ Macro for support 11AX ============
/*CONFIG_RTLWIFI6 or CONFIG_RTL8852AE_BACKPORTS can exist any one or both*/
#if defined(CONFIG_RTL8852AE_BACKPORTS) || defined(CONFIG_RTLWIFI6) || defined(CONFIG_RTLWIFI6_MODULE)
#if defined(CONFIG_BAND_2G_ON_WLAN0) && defined(CONFIG_BAND_5G_ON_WLAN0)
#error "CONFIG_BAND_2G_ON_WLAN0 and CONFIG_BAND_5G_ON_WLAN0 at the same time !!!"
#endif
#if !defined(CONFIG_BAND_2G_ON_WLAN0) && !defined(CONFIG_BAND_5G_ON_WLAN0)
#define CONFIG_BAND_5G_ON_WLAN0 //test for wlan2 config disabled
#endif

/*Note: please use IS_AX_SUPPORT to indicate wifi6 support*/
#define IS_AX_SUPPORT
...
#define WPS_RESTART_TIMEOUT		3
#ifdef FOR_DUAL_BAND
//#define WLAN_WPS_PUSHBUTTON_TRIGGER_ONE_INTERFACE
#endif
#define WPS_WLAN0_START_TIME 	1
#define WPS_WLAN1_START_TIME 	4
#define WPS_BOTH_START_TIME		3
#endif

#if defined(CONFIG_RTL_11W_SUPPORT) || defined(CPTCFG_WIFI6_80211W) || defined(CONFIG_RTW_80211W_SUPPORT)
#define CONFIG_IEEE80211W
#endif

#if defined(CONFIG_RTW_80211K) || defined(CONFIG_RTL_DOT11K_SUPPORT) || defined(CONFIG_HAPD_DOT11K_SUPPORT)
#define DOT11K
#endif
...
#if defined(CONFIG_RTW_80211V) || defined(CONFIG_RTL_11V_SUPPORT) || defined(CONFIG_HAPD_DOT11V_SUPPORT)
#define CONFIG_IEEE80211V
#endif
#if defined(CONFIG_HAPD_DOT11V_SUPPORT)
#define HAPD_11V
#endif

#if !defined(CONFIG_MBO_SUPPORT)
#if defined(DOT11K) && defined(CONFIG_IEEE80211V) && defined(CONFIG_IEEE80211W)
...
#ifdef CONFIG_USER_WLAN_USE_DRVCOMMON_HEADER
//user layer use wifi_common.h of wlan driver
#ifndef WLAN_USE_DRVCOMMON_HEADER
#define WLAN_USE_DRVCOMMON_HEADER
#endif
#elif defined(CONFIG_WLAN_USE_DRVCOMMON_HEADER)
//copy driver structure for user use.
#ifndef WLAN_DRVCOMMON_HEADER
#define WLAN_DRVCOMMON_HEADER
#endif
#endif

#define SIOCDEVPRIVATEAXEXT 0x89f2 //SIOCDEVPRIVATE+2

#define WPAS_WPS_STAS 				"/var/wpas_wps_stas"
...
#define H_VAP_CLI_INDEX		1 // the same as H_VAP_INDEX in driver.
#endif
#endif

typedef enum slope_k{SLOPE_K_2G, SLOPE_K_5G} SLOPE_K_T;
#define SLOPE_K_PREFIX_5G  "HW_5G_TSSI_"
...
#ifdef IS_AX_SUPPORT
#define DIR_WIFI5_DRV	"/proc/%s"
#if defined(CONFIG_RTLWIFI6) || defined(CONFIG_RTLWIFI6_MODULE)
#define DIR_WIFI6_DRV	"/proc/net/rtk_wifi6/%s"
#elif defined(CONFIG_RTL8852AE_BACKPORTS)
#define DIR_WIFI6_DRV	"/proc/net/rtl8852ae/%s"
#endif
...
#define MIB_NO_REINIT_FLAG 0x200000
#endif
...
#define MIB_HW_COUNTRY_STR		9200
...
#define MIB_BT_CONFIG_ENABLED		5102
#endif
...
#ifdef IS_AX_SUPPORT
#define MIB_HW_5G_TSSI_GAIN_DIFF_A  CUSTOMER_HW_MIB_BaseId+6
#define MIB_HW_5G_TSSI_GAIN_DIFF_B  CUSTOMER_HW_MIB_BaseId+7
#define MIB_HW_5G_TSSI_GAIN_DIFF_C  CUSTOMER_HW_MIB_BaseId+8
#define MIB_HW_5G_TSSI_GAIN_DIFF_D  CUSTOMER_HW_MIB_BaseId+9
#define MIB_HW_5G_TSSI_CW_DIFF_A    CUSTOMER_HW_MIB_BaseId+10
#define MIB_HW_5G_TSSI_CW_DIFF_B    CUSTOMER_HW_MIB_BaseId+11
#define MIB_HW_5G_TSSI_CW_DIFF_C    CUSTOMER_HW_MIB_BaseId+12
#define MIB_HW_5G_TSSI_CW_DIFF_D    CUSTOMER_HW_MIB_BaseId+13
#endif
#endif

#if defined(CONFIG_RF_DPK_SETTING_SUPPORT)
#define RF_DPK_SETTING_SUPPORT
//#define RF_DPK_DEBUG
#endif
#ifdef RF_DPK_DEBUG
#define DPK_DEBUG(fmt, args...) printf("\n\n\n\n"fmt"\n\n\n\n", ## args)
#else
#define DPK_DEBUG(fmt, args...) 
#endif
#ifdef RF_DPK_SETTING_SUPPORT
enum rf_dpk_mib {
	RF_DPK_MIB_BaseId=10000,
	MIB_RF_DPK_ROOT=(RF_DPK_MIB_BaseId|MIB_TABLE_LIST),

	RF_DPK_MIB_BEG=RF_DPK_MIB_BaseId+1,

	/* DPK 2G parameters */
	MIB_RF_DPK_DP_PATH_A_OK,
	MIB_RF_DPK_DP_PATH_B_OK,

	MIB_RF_DPK_PWSF_2G_A,
	MIB_RF_DPK_PWSF_2G_B,

	MIB_RF_DPK_LUT_2G_EVEN_A0,
	MIB_RF_DPK_LUT_2G_ODD_A0,
	MIB_RF_DPK_LUT_2G_EVEN_B0,
	MIB_RF_DPK_LUT_2G_ODD_B0,
		
	MIB_RF_DPK_LUT_2G_EVEN_A1,
	MIB_RF_DPK_LUT_2G_ODD_A1,
	MIB_RF_DPK_LUT_2G_EVEN_B1,
	MIB_RF_DPK_LUT_2G_ODD_B1,
		
	MIB_RF_DPK_LUT_2G_EVEN_A2,
	MIB_RF_DPK_LUT_2G_ODD_A2,
	MIB_RF_DPK_LUT_2G_EVEN_B2,
	MIB_RF_DPK_LUT_2G_ODD_B2,

	/* Reserved01 ~ Reserved09 is reserved for DPK 2G */
	MIB_RF_DPK_RESERVED01,
	MIB_RF_DPK_RESERVED02,
	MIB_RF_DPK_RESERVED03,
	MIB_RF_DPK_RESERVED04,
	MIB_RF_DPK_RESERVED05,
	MIB_RF_DPK_RESERVED06,
	MIB_RF_DPK_RESERVED07,
	MIB_RF_DPK_RESERVED08,
	MIB_RF_DPK_RESERVED09,

	/* reserved for other */
	MIB_RF_DPK_RESERVED10,
	MIB_RF_DPK_RESERVED11,
	MIB_RF_DPK_RESERVED12,
	MIB_RF_DPK_RESERVED13,
	MIB_RF_DPK_RESERVED14,
	MIB_RF_DPK_RESERVED15,
	MIB_RF_DPK_RESERVED16,
	MIB_RF_DPK_RESERVED17,
	MIB_RF_DPK_RESERVED18,
	MIB_RF_DPK_RESERVED19,
	MIB_RF_DPK_RESERVED20,

	/* DPK 5G parameters */
	MIB_RF_DPK_DP_5G_PATH_A_OK,
	MIB_RF_DPK_DP_5G_PATH_B_OK,

	MIB_RF_DPK_PWSF_5G_A,
	MIB_RF_DPK_PWSF_5G_B,

	MIB_RF_DPK_LUT_5G_EVEN_A0,
	MIB_RF_DPK_LUT_5G_ODD_A0,
	MIB_RF_DPK_LUT_5G_EVEN_B0,
	MIB_RF_DPK_LUT_5G_ODD_B0,
		
	MIB_RF_DPK_LUT_5G_EVEN_A1,
	MIB_RF_DPK_LUT_5G_ODD_A1,
	MIB_RF_DPK_LUT_5G_EVEN_B1,
	MIB_RF_DPK_LUT_5G_ODD_B1,
		
	MIB_RF_DPK_LUT_5G_EVEN_A2,
	MIB_RF_DPK_LUT_5G_ODD_A2,
	MIB_RF_DPK_LUT_5G_EVEN_B2,
	MIB_RF_DPK_LUT_5G_ODD_B2,

	MIB_RF_DPK_LUT_5G_EVEN_A3,
	MIB_RF_DPK_LUT_5G_ODD_A3,
	MIB_RF_DPK_LUT_5G_EVEN_B3,
	MIB_RF_DPK_LUT_5G_ODD_B3,

	MIB_RF_DPK_LUT_5G_EVEN_A4,
	MIB_RF_DPK_LUT_5G_ODD_A4,
	MIB_RF_DPK_LUT_5G_EVEN_B4,
	MIB_RF_DPK_LUT_5G_ODD_B4,

	MIB_RF_DPK_LUT_5G_EVEN_A5,
	MIB_RF_DPK_LUT_5G_ODD_A5,
	MIB_RF_DPK_LUT_5G_EVEN_B5,
	MIB_RF_DPK_LUT_5G_ODD_B5,

	MIB_RF_DPK_LUT_5G_EVEN_A6,
	MIB_RF_DPK_LUT_5G_ODD_A6,
	MIB_RF_DPK_LUT_5G_EVEN_B6,
	MIB_RF_DPK_LUT_5G_ODD_B6,

	MIB_RF_DPK_LUT_5G_EVEN_A7,
	MIB_RF_DPK_LUT_5G_ODD_A7,
	MIB_RF_DPK_LUT_5G_EVEN_B7,
	MIB_RF_DPK_LUT_5G_ODD_B7,

	MIB_RF_DPK_LUT_5G_EVEN_A8,
	MIB_RF_DPK_LUT_5G_ODD_A8,
	MIB_RF_DPK_LUT_5G_EVEN_B8,
	MIB_RF_DPK_LUT_5G_ODD_B8,

	/* Reserved01 ~ Reserved09 is reserved for DPK 5G */
	MIB_RF_DPK_5G_RESERVED01,
	MIB_RF_DPK_5G_RESERVED02,
	MIB_RF_DPK_5G_RESERVED03,
	MIB_RF_DPK_5G_RESERVED04,
	MIB_RF_DPK_5G_RESERVED05,
	MIB_RF_DPK_5G_RESERVED06,
	MIB_RF_DPK_5G_RESERVED07,
	MIB_RF_DPK_5G_RESERVED08,
	MIB_RF_DPK_5G_RESERVED09,
...
#define MIB_CUSTOM_PASSTHRU_ENABLED		360
...
#define MIB_IPV6_LAN_ORIGIN             (MIB_IPV6_ID+38)
...
typedef enum IPV6_ORIGIN_T_
{
	...
	IPV6_ORIGIN_IP6INIP = 3,
#endif
#ifdef CONFIG_IP6TO4_TUNNEL_SUPPORT
	IPV6_ORIGIN_IP6TO4 =4,
#endif
	IPV6_ORIGIN_NONE = 5
} IPV6_ORIGIN_T;
...
#endif
#define MIB_DNS_CLIENT_SERVER_TBL_NUM	410
...
#define MIB_DSLITE_ENABLE           423
#endif
#ifdef CONFIG_SIXRD_SUPPORT
#define MIB_IPV6_6RD_PREFIX_PARAM	424
#define MIB_IPV4_6RD_MASK_LEN		425
#define MIB_IPV4_6RD_BR_ADDR		426
#define MIB_SIXRD_MODE				427
#endif
#ifdef CONFIG_IP6IP_TUNNEL_SUPPORT
#define MIB_IPV6_IP6IP_REMOTE_ADDR6_PARAM	428
#define MIB_IPV6_IP6IP_REMOTE_ADDR	429
#endif
#endif
...
#define MIB_HW_11N_THER_3 529
#define MIB_HW_11N_THER_4 530
#define MIB_HW_11N_TSSI_ENABLE 531
...
#define MIB_WLAN_MESH_WPS_MODE		565
#define MIB_WLAN_MESH_RESERVED		566
...
#define MIB_WLAN_TWT_ENABLED 661
...
//=========add for CROSS BAND========
#define MIB_WLAN_CROSSBAND_ENABLE	672
#define MIB_WLAN_CROSSBAND_ACTIVATE 673
#define MIB_WLAN_CROSSBAND_RSSI_THRESHOLD 674
#define MIB_WLAN_CROSSBAND_CU_THRESHOLD 675
#define MIB_WLAN_CROSSBAND_NOISE_THRESHOLD 676
#define MIB_WLAN_CROSSBAND_RSSI_WEIGHT 677
#define MIB_WLAN_CROSSBAND_CU_WEIGHT 678
#define MIB_WLAN_CROSSBAND_NOISE_WEIGHT 679
...
#define LAYER2BRIDGING_MAX_BRIDGE_NUM 4
#define LAYER2BRIDGING_NAMSIZE       16
#define TOTAL_INTERFACE_PORT_NUM     15  	//WAN_INTERFACE_LAN_PORT_NUM+WAN_INTERFACE_WLAN_PORT_NUM+1
...
#define MAX_DHCPS_SERVING_POOL_NUM	5
#define MAX_EACH_POOL_DHCP_OPTION_NUM 5
#define MAX_DHCP_SERVER_OPTION_NUM	MAX_EACH_POOL_DHCP_OPTION_NUM*(MAX_DHCPS_SERVING_POOL_NUM+1)
...
#define MIB_CWMP_PROVISIONINGCODE				CWMP_ID + 1
#define MIB_CWMP_ACS_URL						CWMP_ID + 2
#define MIB_CWMP_ACS_USERNAME					CWMP_ID + 3
#define MIB_CWMP_ACS_PASSWORD					CWMP_ID + 4
#define MIB_CWMP_INFORM_ENABLE					CWMP_ID + 5
#define MIB_CWMP_INFORM_INTERVAL				CWMP_ID + 6
#define MIB_CWMP_INFORM_TIME					CWMP_ID + 7
#define MIB_CWMP_CONREQ_USERNAME				CWMP_ID + 8
#define MIB_CWMP_CONREQ_PASSWORD				CWMP_ID + 9
#define MIB_CWMP_ACS_UPGRADESMANAGED			CWMP_ID + 10
...
#define MIB_CWMP_DL_QUEUE_IDX                   CWMP_ID + 34

#define MIB_CWMP_SI_DELAYTIME					CWMP_ID + 71	/*ScheduleInform's delaytime*/
#define MIB_CWMP_DEBUG_MODULE					CWMP_ID + 72
#define MIB_CWMP_DEBUG_LEVEL					CWMP_ID + 73
...
#define MIB_CWMP_ACS_URL_OLD					CWMP_ID + 85
...
#define MIB_CWMP_BRIDGE_MAX_INST_NUM      		CWMP_ID+169
#define MIB_CWMP_BRIDGE_TBL_NUM      			CWMP_ID+170
#define MIB_CWMP_BRIDGE_TBL          			((MIB_CWMP_BRIDGE_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_CWMP_BRIDGE_ADD          			((MIB_CWMP_BRIDGE_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_CWMP_BRIDGE_DEL          			((MIB_CWMP_BRIDGE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_CWMP_BRIDGE_MOD          			((MIB_CWMP_BRIDGE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_CWMP_BRIDGE_DELALL       			((MIB_CWMP_BRIDGE_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_CWMP_BRIDGE_INST_NUM				CWMP_ID+171
#define MIB_CWMP_BRIDGE_VALID					CWMP_ID+172
#define MIB_CWMP_BRIDGE_KEY						CWMP_ID+173
#define MIB_CWMP_BRIDGE_ENABLED					CWMP_ID+174
#define MIB_CWMP_BRIDGE_NAME					CWMP_ID+175
#define MIB_CWMP_BRIDGE_VID						CWMP_ID+176
#define MIB_CWMP_BRIDGE_PORT_NUM				CWMP_ID+177
#define MIB_CWMP_PORT_MAX_INST_NUM				CWMP_ID+178
#define MIB_CWMP_PORT_INST_NUM					CWMP_ID+179
#define MIB_CWMP_PORT_IDX						CWMP_ID+180
#define MIB_CWMP_WANNAME					CWMP_ID+190
#define MIB_CWMP_MIB_END						CWMP_ID + 200	/* Reserve 200 mib for tr069*/
#endif /*CONFIG_APP_TR069*/

#ifdef MULTI_LANGUAGE
#define MIB_WEB_LANGUAGE 958
typedef enum {ENGLISH=0,SIMPLE_CHINESE=1} LANGUAGE_TYPE_T;
#endif
#ifdef IP_RANGE_CMCC_SUPPORT
typedef enum {IP_BASED=0, PROTO_BASED=1} IPFILTER_TYPE_T;
#endif
...
#define MIB_DHCPRSVDIP_DHCP_SERVER_USEDFOR		1007
#define MIB_DHCPRSVDIP_DHCP_SERVER_DHCPCONSPINSTNUM	1008

#define MIB_LAN_DNS1					1009
#define MIB_LAN_DNS2					1010
#define MIB_LAN_DNS3					1016
#endif

#ifdef SUPPORT_RESERVED_DHCP_IPADDR
#define MIB_DHCP_RESERVED_IPADDR		1053
#endif
...
#define MIB_PORTFW_EXTEND_ENABLED				1017
...
#define MIB_OSPF_NETWORK	1133
#define MIB_OSPF_NETMASK	1134
#define MIB_OSPF_AREA	1135
#define MIB_OSPF_INTERFACE_TYPE	1136
#define MIB_OSPF_INTERFACE_KEY	1137
#define MIB_OSPF_INTERFACE_NAME	1138
#define MIB_OSPF_INTERFACE_COST	1139
#define MIB_OSPF_AREA_ID	1140
#define MIB_OSPF_AREA_TYPE		1141
#endif
#ifdef CONFIG_APP_RTL_QUAGGA

#define MIB_BGP_IP	1142
#define MIB_BGP_AS	1143
#define MIB_BGP_NETWORK	1144
#define MIB_BGP_NETMASK	1145
#endif

#ifdef CONFIG_APP_RTL_QUAGGA

#define MIB_ISIS_NET_AU_TYPE	1146
#define MIB_ISIS_NET_KEY	1147
#define MIB_ISIS_IF	1148
#define MIB_ISIS_IF_LEVEL	1149
#define MIB_ISIS_IF_METRIC 1150
#define MIB_ISIS_IF_AY_TYPE	 1151
#define MIB_ISIS_IF_KEY 1152
#endif
#define MIB_CERTROOT_COMMENT	1153
...
#define MIB_DHCP_CLIENT_OPTION_LEN				(DHCP_CLIENT_OPTION_ID+4)
...
#ifdef SUPPORT_RESERVED_DHCP_IPADDR
#define MIB_DHCPS_SERVING_POOL_RESERVED_IPADDR      (DHCPS_SERVING_POOL_ID+29)
#endif
...
#ifdef CONFIG_APP_RTL_QUAGGA
//#define MIB_QUAGGA_DISABLE	1799
#define MIB_OSPF_ENABLE	1800
#define MIB_OSPF_DEBUG		1801
#define MIB_OSPF_ROUTERID	1802
#define MIB_OSPF_NET_TBL_NUM         1803
#define MIB_OSPF_NETWORK_TBL             ((MIB_OSPF_NET_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_OSPF_NETWORK_ADD             ((MIB_OSPF_NET_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_OSPF_NETWORK_DEL             ((MIB_OSPF_NET_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_OSPF_NETWORK_MOD             ((MIB_OSPF_NET_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_OSPF_NETWORK_DELALL          ((MIB_OSPF_NET_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#define MIB_OSPF_INTERFACE_TBL_NUM         1810
#define MIB_OSPF_INTERFACE_TBL             ((MIB_OSPF_INTERFACE_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_OSPF_INTERFACE_ADD             ((MIB_OSPF_INTERFACE_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_OSPF_INTERFACE_DEL             ((MIB_OSPF_INTERFACE_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_OSPF_INTERFACE_MOD             ((MIB_OSPF_INTERFACE_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_OSPF_INTERFACE_DELALL          ((MIB_OSPF_INTERFACE_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#define MIB_OSPF_AREA_TBL_NUM         1820
#define MIB_OSPF_AREA_TBL             ((MIB_OSPF_AREA_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_OSPF_AREA_ADD             ((MIB_OSPF_AREA_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_OSPF_AREA_DEL             ((MIB_OSPF_AREA_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_OSPF_AREA_MOD             ((MIB_OSPF_AREA_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_OSPF_AREA_DELALL          ((MIB_OSPF_AREA_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#endif
#ifdef CONFIG_APP_RTL_QUAGGA
#define MIB_BGP_ENABLE	1830
#define MIB_BGP_DEBUG		1831
#define MIB_BGP_ROUTERID	1832
#define MIB_BGP_ROUTE_INPUT	1833
#define MIB_BGP_OSPF_ROUTE_INPUT	1834
#define MIB_BGP_AS_NUMBER	1835
#define MIB_BGP_NETWORK_TBL_NUM         1836
#define MIB_BGP_NETWORK_TBL             ((MIB_BGP_NETWORK_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_BGP_NETWORK_ADD             ((MIB_BGP_NETWORK_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_BGP_NETWORK_DEL             ((MIB_BGP_NETWORK_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_BGP_NETWORK_MOD             ((MIB_BGP_NETWORK_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_BGP_NETWORK_DELALL          ((MIB_BGP_NETWORK_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#define MIB_BGP_PEER_TBL_NUM         1846
#define MIB_BGP_PEER_TBL             ((MIB_BGP_PEER_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_BGP_PEER_ADD             ((MIB_BGP_PEER_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_BGP_PEER_DEL             ((MIB_BGP_PEER_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_BGP_PEER_MOD             ((MIB_BGP_PEER_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_BGP_PEER_DELALL          ((MIB_BGP_PEER_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#endif

#ifdef CONFIG_APP_RTL_QUAGGA
#define MIB_ISIS_ENABLE	1840
#define MIB_ISIS_DEBUG		1841
#define MIB_ISIS_PROCESS_ID	1842
#define MIB_ISIS_NET	1843
#define MIB_ISIS_NET_LEVEL	1844
#define MIB_ISIS_NET_AU_TYPE_TBL_NUM         1845
#define MIB_ISIS_NET_AU_TYPE_TBL             ((MIB_ISIS_NET_AU_TYPE_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_ISIS_NET_AU_TYPE_ADD             ((MIB_ISIS_NET_AU_TYPE_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_ISIS_NET_AU_TYPE_DEL             ((MIB_ISIS_NET_AU_TYPE_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_ISIS_NET_AU_TYPE_MOD             ((MIB_ISIS_NET_AU_TYPE_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_ISIS_NET_AU_TYPE_DELALL          ((MIB_ISIS_NET_AU_TYPE_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#define MIB_ISIS_IF_TBL_NUM         1850
#define MIB_ISIS_IF_TBL             ((MIB_ISIS_IF_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_ISIS_IF_ADD             ((MIB_ISIS_IF_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_ISIS_IF_DEL             ((MIB_ISIS_IF_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_ISIS_IF_MOD             ((MIB_ISIS_IF_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_ISIS_IF_DELALL          ((MIB_ISIS_IF_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#endif
...
#define WLAN_TELCO_SELECTED_ID					2150
#define MIB_TELCO_SELECTED						(WLAN_TELCO_SELECTED_ID+0)

#define MIB_HW_5G_ON_WLAN					(WLAN_TELCO_SELECTED_ID+1)

#ifdef IS_AX_SUPPORT
#define MIB_HW_AX_BASE							6000
/* ----- 11AX HW MIB ------*/
#define MIB_HW_XCAP_WLAN0_AX					(MIB_HW_AX_BASE+0)
#define MIB_HW_RFE_TYPE_WLAN0					(MIB_HW_AX_BASE+1)
#define MIB_HW_THERMAL_A_WLAN0					(MIB_HW_AX_BASE+2)
#define MIB_HW_THERMAL_B_WLAN0					(MIB_HW_AX_BASE+3)
#define MIB_HW_THERMAL_C_WLAN0					(MIB_HW_AX_BASE+4)
#define MIB_HW_THERMAL_D_WLAN0					(MIB_HW_AX_BASE+5)

#define MIB_HW_XCAP_WLAN1_AX					(MIB_HW_AX_BASE+6)
#define MIB_HW_RFE_TYPE_WLAN1					(MIB_HW_AX_BASE+7)
#define MIB_HW_THERMAL_A_WLAN1					(MIB_HW_AX_BASE+8)
#define MIB_HW_THERMAL_B_WLAN1					(MIB_HW_AX_BASE+9)
#define MIB_HW_THERMAL_C_WLAN1					(MIB_HW_AX_BASE+10)
#define MIB_HW_THERMAL_D_WLAN1					(MIB_HW_AX_BASE+11)

#define MIB_HW_CUSTOM_PARA_PATH					(MIB_HW_AX_BASE+12)

#define MIB_HW_2G_CCK_TSSI_A					(MIB_HW_AX_BASE+13)
#define MIB_HW_2G_CCK_TSSI_B					(MIB_HW_AX_BASE+14)
#define MIB_HW_2G_CCK_TSSI_C					(MIB_HW_AX_BASE+15)
#define MIB_HW_2G_CCK_TSSI_D					(MIB_HW_AX_BASE+16)
#define MIB_HW_2G_BW40_1S_TSSI_A				(MIB_HW_AX_BASE+17)
#define MIB_HW_2G_BW40_1S_TSSI_B				(MIB_HW_AX_BASE+18)
#define MIB_HW_2G_BW40_1S_TSSI_C				(MIB_HW_AX_BASE+19)
#define MIB_HW_2G_BW40_1S_TSSI_D				(MIB_HW_AX_BASE+20)

#define MIB_HW_5G_BW40_1S_TSSI_A				(MIB_HW_AX_BASE+21)
#define MIB_HW_5G_BW40_1S_TSSI_B				(MIB_HW_AX_BASE+22)
#define MIB_HW_5G_BW40_1S_TSSI_C				(MIB_HW_AX_BASE+23)
#define MIB_HW_5G_BW40_1S_TSSI_D				(MIB_HW_AX_BASE+24)

#define MIB_HW_RX_GAINGAP_2G_CCK_AB				(MIB_HW_AX_BASE+25)
#define MIB_HW_RX_GAINGAP_2G_CCK_CD				(MIB_HW_AX_BASE+26)
#define MIB_HW_RX_GAINGAP_2G_OFDM_AB			(MIB_HW_AX_BASE+27)
#define MIB_HW_RX_GAINGAP_2G_OFDM_CD			(MIB_HW_AX_BASE+28)
#define MIB_HW_RX_GAINGAP_5GL_AB				(MIB_HW_AX_BASE+29)
#define MIB_HW_RX_GAINGAP_5GL_CD				(MIB_HW_AX_BASE+30)
#define MIB_HW_RX_GAINGAP_5GM_AB				(MIB_HW_AX_BASE+31)
#define MIB_HW_RX_GAINGAP_5GM_CD				(MIB_HW_AX_BASE+32)
#define MIB_HW_RX_GAINGAP_5GH_AB				(MIB_HW_AX_BASE+33)
#define MIB_HW_RX_GAINGAP_5GH_CD				(MIB_HW_AX_BASE+34)

#define MIB_HW_CHANNEL_PLAN_5G					(MIB_HW_AX_BASE+35)
#endif
...
#if defined(CONFIG_RTL_8198C)||defined(CONFIG_RTL_8196C) || defined(CONFIG_RTL_8198) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8198B)  || defined(CONFIG_RTL_8881A) || defined(CONFIG_RTL_8197F) || defined(CONFIG_RTL_8197G)
...
#define MIB_HW_TX_POWER_TSSI_5G_HT40_1S_A 915
#define MIB_HW_TX_POWER_TSSI_5G_HT40_1S_B 916
#define MIB_HW_TX_POWER_TSSI_5G_HT40_1S_C 917
#define MIB_HW_TX_POWER_TSSI_5G_HT40_1S_D 918
#define MIB_HW_TX_POWER_TSSI_CCK_A 919
#define MIB_HW_TX_POWER_TSSI_CCK_B 920
#define MIB_HW_TX_POWER_TSSI_CCK_C 921
#define MIB_HW_TX_POWER_TSSI_CCK_D 922
#define MIB_HW_TX_POWER_TSSI_HT40_1S_A 923
#define MIB_HW_TX_POWER_TSSI_HT40_1S_B 924
#define MIB_HW_TX_POWER_TSSI_HT40_1S_C 925
#define MIB_HW_TX_POWER_TSSI_HT40_1S_D 926
...
#if defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8881A) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8822CE) || defined(CONFIG_WLAN_HAL_8812FE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_8852A) || defined(CONFIG_WLAN_8832B)
...
#define MIB_MINIDLNA_ENABLED 2700
#define MIB_MINIDLNA_SHAREDFOLDER_TBL_NUM					2710
#define MIB_MINIDLNA_SHAREDFOLDER_TBL			((MIB_MINIDLNA_SHAREDFOLDER_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_MINIDLNA_SHAREDFOLDER_ADD			((MIB_MINIDLNA_SHAREDFOLDER_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_MINIDLNA_SHAREDFOLDER_DEL			((MIB_MINIDLNA_SHAREDFOLDER_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_MINIDLNA_SHAREDFOLDER_MOD			((MIB_MINIDLNA_SHAREDFOLDER_TBL_NUM+3)|MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_MINIDLNA_SHAREDFOLDER_DELALL			((MIB_MINIDLNA_SHAREDFOLDER_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)
#define MIB_MINIDLNA_SHAREOLDER_TYPE 2711
#define MIB_MINIDLNA_SHAREOLDER_NAME 2712
#endif
...
#define MIB_WLAN_AX_SUPPORT		2270
#define MIB_WLAN_OFDMA_ENABLED	2271
#define MIB_WLAN_LIFETIME		2272
...
#define MIB_MAP_SYNC_SPECIFIC_DATA           2391
#define MIB_MAP_SYNC_IP_ADDR                 2392
#define MIB_MAP_SYNC_PORT_ADDR               2393
#define MAX_MAP_SYNC_IP_ADDR_LEN             16
#define MAX_MAP_SYNC_PORT_ADDR_LEN           8
#define MIB_MAP_ENABLE_VLAN                  2394
#define MIB_MAP_PRIMARY_VID                  2395
#define MIB_MAP_DEFAULT_SECONDARY_VID        2396
#define MIB_WLAN_MAP_VID                     2397
#define MIB_MAP_BACKHAUL_ENCRYPT_NONE        2398 //easymesh debug no encryption
#endif
...
#define MIB_HTTP_REDIRECT_ENABLED 3800
#define MIB_HTTP_REDIRECT_URL 3801
#ifdef CONFIG_RTL_HTTPS_REDIRECT
#define MIB_HTTP_REDIRECT_HOST 3802
#endif
#endif
...
#define MIB_ROAMING_BASE			9000
#define MIB_ROAMING5G_ENABLE 		9000+1
#define MIB_ROAMING5G_STARTTIME		9000+2
#define MIB_ROAMING5G_RSSI_TH1		9000+3
#define MIB_ROAMING5G_RSSI_TH2		9000+4

#define MIB_ROAMING2G_ENABLE		9000+5
#define MIB_ROAMING2G_STARTTIME		9000+6
#define MIB_ROAMING2G_RSSI_TH1		9000+7
#define MIB_ROAMING2G_RSSI_TH2		9000+8

/* band steering mib/macro define start */
#ifdef BAND_STEERING_SUPPORT
#define MIB_BAND_STEERING_BASE		9110
#define MIB_WIFI_STA_CONTROL_ENABLE	9110
#define MIB_STACTRL_ROAM_DETECT_TH	9110+1
#define MIB_PREFER_BAND				9110+2
#define MIB_PREFER_BAND_RSSI_HIGH	9110+3
#define MIB_PREFER_BAND_RSSI_LOW	9110+4

#define PREFER_BAND_5G 0
#define PREFER_BAND_24G 1
#endif
/* band steering mib/macro define end */
...
/* ==== multiple wan mib define end =====================*/
#define MIB_WLAN_PEER_BSSID					7000	
#if defined(WIFI_SIMPLE_CONFIG) && defined(CONFIG_APP_TR069)
#define MIB_WLAN_WSC_LAST_CONFIG_ERR		7001 	
#define MIB_WLAN_WSC_ER_DISABLE				7002
#define MIB_WLAN_WSC_ER_UUID				7003
#define MIB_WLAN_WSC_ER_DEVICENAME			7004

#define MIB_WLAN_WSC_ER_NUM					7005 
#define MIB_WLAN_WSC_ER_TBL					((MIB_WLAN_WSC_ER_NUM+1)|MIB_TABLE_LIST)
#define MIB_WLAN_WSC_ER_ADD					((MIB_WLAN_WSC_ER_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_WLAN_WSC_ER_DEL					((MIB_WLAN_WSC_ER_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_WLAN_WSC_ER_DELALL				((MIB_WLAN_WSC_ER_NUM+4)|MIB_DELALL_TBL_ENTRY)
#define MIB_WLAN_WSC_AUTO_LOCK_DOWN			7006
#define MIB_WLAN_WSC_LOCKDOWN_PIN_REACHED	7007
#endif
...
#define MAX_COUNTRY_STRING		8
#define MAX_SSID_LEN			33
#define MAX_MESH_RESERVED_LEN	200
#define WEP64_KEY_LEN			5
#define WEP128_KEY_LEN			13
#define MAX_NAME_LEN			31
#if defined(WIFI_SIMPLE_CONFIG) && defined(CONFIG_APP_TR069)
#define	UUID_STR_LEN				33
#define MAX_ER_DEVICENAME_LEN 		32
#endif
...
#define MAX_OSPF_NETWORK_NUM			20
#define MAX_OSPF_AREA_NUM			20
#define MAX_OSPF_INTERFACE_NUM	5
#define MAX_BGP_NETWORK_NUM			20
#define MAX_BGP_PEER_NUM			20
#define MAX_ISIS_NET_AU_TYPE			2
#define MAX_ISIS_IF_NUM			5
#define MAX_ISIS_NET_LENTH			60
#endif
...
#ifdef CONFIG_APP_MINIDLNA
#define MAX_MINIDLNA_SHAREFOLDER_NUM		10
#define MAX_MINIDLNA_SHAREFOLDER_TYPE_LEN	10
#define MAX_MINIDLNA_SHAREFOLDER_NAME_LEN	32
#endif
...
#define FLASH_DEVICE_SETTING_BACKUP		("/hw_setting/hwbackup.bin")		//mtdblock1
...
#define BLUETOOTH_HW_SETTING_OFFSET (HW_SETTING_OFFSET+0x1000) //Warning->Now hw setting real size is over 0x1000 which will affects bluetooth hw setting.
...
#define CUSTOMER_HW_SETTING_OFFSET (get_next_offset(HW_SETTING_OFFSET) - CUSTOMER_HW_SETTING_SIZE)
#define CUSTOMER_HW_SETTING_SECTOR_LEN CUSTOMER_HW_SETTING_SIZE
#endif
//////////////////////////////////////////////////////////////////////////////////////////////////

//#define BACKUP_CURRENT_SETTING_SUPPORT
#ifdef BACKUP_CURRENT_SETTING_SUPPORT
#ifdef CONFIG_MTD_NAND
#define BACKUP_CURRENT_SETTING_OFFSET (CONFIG_RTL_CURRENT_SETTING_OFFSET-NAND_BOOT_PARTITION_SIZE)
#define BACKUP_CURRENT_SETTING_SECTOR_LEN CURRENT_SETTING_SECTOR_LEN
#else
#define BACKUP_CURRENT_SETTING_OFFSET CONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET
#define BACKUP_CURRENT_SETTING_SECTOR_LEN CURRENT_SETTING_SECTOR_LEN
#endif
#endif
...
//BACKUP_HARDWARE_SETTING_OFFSET
#ifdef CONFIG_MTD_NAND
//NAND FLASH
#define BACKUP_HARDWARE_SETTING_OFFSET (CONFIG_RTL_BACKUP_HARDWARE_SETTING_OFFSET-NAND_BOOT_PARTITION_SIZE)
#else
//NOR FLASH
#define BACKUP_HARDWARE_SETTING_OFFSET CONFIG_RTL_BACKUP_HARDWARE_SETTING_OFFSET
#endif

#define BACKUP_HARDWARE_SETTING_SECTOR_LEN HW_SETTING_SECTOR_LEN
#ifdef BLUETOOTH_HW_SETTING_SUPPORT
#define BACKUP_BLUETOOTH_HW_SETTING_OFFSET (BACKUP_HARDWARE_SETTING_OFFSET+0x1000)//Warning->Now hw setting real size is over 0x1000 which will affects bluetooth hw setting.
#define BACKUP_BLUETOOTH_HW_SECTOR_LEN BLUETOOTH_HW_SETTING_SIZE
#endif
#ifdef CUSTOMER_HW_SETTING_SUPPORT
#define BACKUP_CUSTOMER_HW_SETTING_OFFSET (BACKUP_HARDWARE_SETTING_OFFSET+HW_SETTING_SECTOR_LEN-CUSTOMER_HW_SETTING_SIZE)
#define BACKUP_CUSTOMER_HW_SECTOR_LEN  CUSTOMER_HW_SETTING_SIZE
#endif
...
#ifdef CONFIG_MTD_NAND
#define BACKUP_DEFAULT_SETTING_OFFSET  (CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET-NAND_BOOT_PARTITION_SIZE)
#define BACKUP_DEFAULT_SETTING_SECTOR_LEN  DEFAULT_SETTING_SECTOR_LEN//(CONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET-CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET)
#else
#define BACKUP_DEFAULT_SETTING_OFFSET CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET

#ifdef BACKUP_CURRENT_SETTING_SUPPORT
#define BACKUP_DEFAULT_SETTING_SECTOR_LEN  DEFAULT_SETTING_SECTOR_LEN// (CONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET-CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET)

#else
#define BACKUP_DEFAULT_SETTING_SECTOR_LEN  DEFAULT_SETTING_SECTOR_LEN//(CONFIG_RTL_WEB_PAGES_OFFSET-CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET)
...
#if  defined(CONFIG_RTL_8196E) && defined(CONFIG_RTL8192F) && !defined(CONFIG_RTL_DUAL_PCIESLOT_BIWLAN)
#define RF_DPK_SETTING_SIZE 0x1000
#define RF_DPK_SETTING_OFFSET (HW_SETTING_OFFSET+0x800)
#else
#define RF_DPK_SETTING_SIZE 0x1C00
#define RF_DPK_SETTING_OFFSET (HW_SETTING_OFFSET+0x2000)
#endif
#define RF_DPK_SETTING_SECTOR_LEN RF_DPK_SETTING_SIZE

#if (RF_DPK_SETTING_OFFSET+RF_DPK_SETTING_SIZE > CONFIG_RTL_DEFAULT_SETTING_OFFSET)
#error "RF_DPK_SETTING_OFFSET overlay to CONFIG_RTL_DEFAULT_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CONFIG_RTL_DEFAULT_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CONFIG_RTL_DEFAULT_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CONFIG_RTL_DEFAULT_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CONFIG_RTL_DEFAULT_SETTING_OFFSET!!!"
...
#ifdef CUSTOMER_HW_SETTING_SUPPORT
#if (RF_DPK_SETTING_OFFSET+RF_DPK_SETTING_SIZE > CUSTOMER_HW_SETTING_OFFSET)
#error "RF_DPK_SETTING_OFFSET overlay to CUSTOMER_HW_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CUSTOMER_HW_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CUSTOMER_HW_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CUSTOMER_HW_SETTING_OFFSET!!!"
#error "RF_DPK_SETTING_OFFSET overlay to CUSTOMER_HW_SETTING_OFFSET!!!"
#endif
#endif /* CUSTOMER_HW_SETTING_SUPPORT */
...
/**
* @brief
*	   get_next_offset() is used to get next offset value of this offset which supported for mib and nor flash(mtd0).
*
* @param[in]
*	   offset (unsigned int): Each sector offset of flash in the range of MTD0(Less than ROOT_IMAGE_OFFSET!).
*
* @return
*	   next_offset (unsigned int):The next offset of offset(param[in]).
*	   If offset-param[in] is larger than ROOT_IMAGE_OFFSET, return offset-param[in](Err!).
*
* @retval:
* - 	[0, ROOT_IMAGE_OFFSET)
*/
#if 1 //ndef CONFIG_MTD_NAND
static __attribute__((unused)) unsigned int get_next_offset(unsigned int offset){
	int i = 0, next_i = 0, offset_num;
	unsigned int next_offset, min;
	unsigned int all_offset[] = {	HW_SETTING_OFFSET,
								...
								#endif
								#ifdef BACKUP_DEFAULT_SETTING_SUPPORT
									BACKUP_DEFAULT_SETTING_OFFSET,
								#endif
								#ifdef BACKUP_CURRENT_SETTING_SUPPORT
									BACKUP_CURRENT_SETTING_OFFSET,
								#endif
									CODE_IMAGE_OFFSET,
									ROOT_IMAGE_OFFSET,
								};
	if(offset >=  ROOT_IMAGE_OFFSET){
		printf("ERR!! The offset is over mtd0! [%s-%u]\n",__FILE__,__LINE__);
		return ROOT_IMAGE_OFFSET;
	}
	min = ROOT_IMAGE_OFFSET - offset;
	offset_num = sizeof(all_offset) / sizeof(all_offset[0]);
	for(i = 0; i < offset_num; i++){
		if((all_offset[i] > offset) && ((all_offset[i] - offset) < min)){
			min = all_offset[i] - offset;
			next_i = i;
		}
	}
	next_offset = all_offset[next_i];
	return next_offset;
}
#endif
...
#define HW_SETTING_SECTOR_LEN 		(get_next_offset(HW_SETTING_OFFSET) - HW_SETTING_OFFSET)
#define DEFAULT_SETTING_SECTOR_LEN	(get_next_offset(DEFAULT_SETTING_OFFSET) - DEFAULT_SETTING_OFFSET)

#ifdef CONFIG_MTD_NAND
#define CURRENT_SETTING_SECTOR_LEN	(CONFIG_RTL_WEB_PAGES_OFFSET-CONFIG_RTL_CURRENT_SETTING_OFFSET)
#else
#define CURRENT_SETTING_SECTOR_LEN	(get_next_offset(CURRENT_SETTING_OFFSET) - CURRENT_SETTING_OFFSET)
#endif
...
#ifdef BACKUP_DEFAULT_SETTING_SUPPORT
	BACKUP_DEFAULT_SETTING=32,
#endif
#ifdef BLUETOOTH_HW_SETTING_SUPPORT
	BLUETOOTH_HW_SETTING=64,
#endif
#ifdef BACKUP_HARDWARE_SETTING_SUPPORT
	BACKUP_HW_SETTING=128,
#ifdef BLUETOOTH_HW_SETTING_SUPPORT
	BACKUP_BLUETOOTH_HW_SETTING=256,
#endif
#ifdef CUSTOMER_HW_SETTING_SUPPORT
	BACKUP_CUSTOMER_HW_SETTING=512,
#endif
#endif
	END_OF_SETTING=4096
} CONFIG_DATA_T;
...
#define BACKUP_HW_SETTING_HEADER_TAG  ((char *)"6h")
...
#define BACKUP_BLUETOOTH_HW_SETTING_HEADER_TAG ((char *)"tb")
#endif
#ifdef CUSTOMER_HW_SETTING_SUPPORT
#define CUSTOMER_HW_SETTING_HEADER_TAG ((char *)"us")
#define BACKUP_CUSTOMER_HW_SETTING_HEADER_TAG ((char *)"su")
#endif
#ifdef RF_DPK_SETTING_SUPPORT
#define RF_DPK_SETTING_HEADER_TAG ((char *)"rs")
#endif /* RF_DPK_SETTING_SUPPORT */
...
enum { PSK_ENABLE_WPA=1, PSK_ENABLE_WPA2=2,PSK_ENABLE_WPA3=8 };
typedef enum { ENCRYPT_DISABLED=0, ENCRYPT_WEP=1, ENCRYPT_WPA=2, ENCRYPT_WPA2=4, ENCRYPT_WPA2_MIXED=6 ,ENCRYPT_WAPI=7, ENCRYPT_WPA3=16, ENCRYPT_WPA2_WPA3_MIXED=20} ENCRYPT_T;
...
typedef enum { BAND_11B=1, BAND_11G=2, BAND_11BG=3, BAND_11A=4, BAND_11N=8, BAND_11BGN=11, BAND_5G_11AN=12,
	BAND_5G_11AC=64, BAND_5G_11AAC=68, BAND_5G_11NAC=72, BAND_11BGNAC=75, BAND_5G_11ANAC=76,BAND_5G_11AX=128,BAND_11BGNAX=139,BAND_5G_11ANACAX=204} BAND_TYPE_T;
...
#else
#if defined(WLAN_DRVCOMMON_HEADER)
...
} __PACK__ sta_info_2_web;
#endif //WLAN_DRVCOMMON_HEADER

/* WLAN sta info structure */ /* same as 8192cd.h _sta_info_2_web */
...
#endif //end WLAN_USE_DRVCOMMON_HEADER
...
#ifdef CONFIG_APP_MINIDLNA
typedef struct minidlna_sharefolder_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id  ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ MINIDLNA_SHAREFOLDER_T, *MINIDLNA_SHAREFOLDER_Tp;
#endif
...
#undef MIBDEF
}__PACK__ OSPF_NET_T, *OSPF_NET_Tp;

typedef struct ospf_interface_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ OSPF_INTERFACE_T, *OSPF_INTERFACE_Tp;
...
#undef MIBDEF
}__PACK__ OSPF_AREA_T, *OSPF_AREA_Tp;

typedef struct bgp_net_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ BGP_NET_T, *BGP_NET_Tp;
typedef struct bgp_peer_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ BGP_PEER_T, *BGP_PEER_Tp;

typedef struct isis_net_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ ISIS_NET_T, *ISIS_NET_Tp;
typedef struct isis_interface_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#if defined(WIFI_SIMPLE_CONFIG) && defined(CONFIG_APP_TR069)
typedef struct wlanwsc_ER_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ CWMP_BRIDGE_T, *CWMP_BRIDGE_Tp;
#endif
...
#undef MIBDEF
}__PACK__ RF_DPK_SETTING_T, *RF_DPK_SETTING_Tp;
#endif /* RF_DPK_SETTING_SUPPORT */
...
#ifdef BACKUP_HARDWARE_SETTING_SUPPORT
#ifdef CUSTOMER_HW_SETTING_SUPPORT
#define COMP_BU_SIGNATURE			"COMPBU"
#endif
#ifdef BLUETOOTH_HW_SETTING_SUPPORT
#define COMP_BB_SIGNATURE			"COMPBB"
#endif
#endif

#ifdef BACKUP_CURRENT_SETTING_SUPPORT
#define COMP_BC_SIGNATURE			"COMPBC"
#endif

#ifdef BACKUP_DEFAULT_SETTING_SUPPORT
#define COMP_BD_SIGNATURE			"COMPBD"
#endif

#ifdef RF_DPK_SETTING_SUPPORT
#define COMP_RS_SIGNATURE			"COMPRS"
#endif /* RF_DPK_SETTING_SUPPORT */
...
#endif
#ifdef RF_DPK_SETTING_SUPPORT
extern HW_PARAM_HEADER_T rfDpkHeader;
#endif /* RF_DPK_SETTING_SUPPORT */
...
#ifdef CUSTOMER_HW_SETTING_SUPPORT
#define CUSTOMER_HW_SHM_KEY 11
#endif
#if defined(BACKUP_CURRENT_SETTING_SUPPORT)
#define BACKUP_CSCONF_SHM_KEY 4
#endif
#if defined(BACKUP_DEFAULT_SETTING_SUPPORT)
#define BACKUP_DSCONF_SHM_KEY 5
#endif
#ifdef DEFSETTING_AUTO_UPDATE
#define LAST_DSCONF_SHM_KEY 12
#endif
#if defined(BACKUP_HARDWARE_SETTING_SUPPORT)
#define BACKUP_HWCONF_SHM_KEY	10
#if defined(BLUETOOTH_HW_SETTING_SUPPORT)
#define BACKUP_BLUETOOTH_HW_SHM_KEY 8
#endif

#if defined(CUSTOMER_HW_SETTING_SUPPORT)
#define BACKUP_CUSTOMER_HW_SHM_KEY 9
#endif
#endif
#ifdef RF_DPK_SETTING_SUPPORT
#define RF_DPK_SHM_KEY 7
#endif /* RF_DPK_SETTING_SUPPORT */
...
typedef enum 
{
	...
	REINIT_LAN_APP_SAMBA_FUNC_ID,

#ifdef CONFIG_APP_MINIDLNA
	REINIT_LAN_APP_MINIDLNA_FUNC_ID,
#endif
...
typedef struct extRegInfo {
	...
	char devicename[MAX_ER_DEVICENAME_LEN];
} extRegInfoT, *extRegInfoTp;
#endif
