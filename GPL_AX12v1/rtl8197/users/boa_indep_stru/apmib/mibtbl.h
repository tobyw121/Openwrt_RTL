...
#ifdef IS_AX_SUPPORT
#define _MIB_CUSTOMER_HWID_NAME_EXT(name) MIB_HW_5G_TSSI_##name, #name
#endif
#endif

#ifdef RF_DPK_SETTING_SUPPORT
#define _MIB_RF_DPK_ID_NAME(name) MIB_RF_DPK_##name, #name
...
#endif
#ifdef RF_DPK_SETTING_SUPPORT
extern mib_table_entry_T rf_dpk_mib_table[];
#endif /* RF_DPK_SETTING_SUPPORT */
