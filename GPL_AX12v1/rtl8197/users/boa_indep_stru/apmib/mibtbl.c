...
#ifdef WLAN_PROFILE
mib_table_entry_T mib_wlan_profile_tbl[]={
#ifdef MIB_TLV
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	{_MIBID_NAME(_mib_name), _mib_type, _OFFSET_SIZE_FIELD(_mib_parents_ctype, _cname), _UNIT_SIZE(_ctype), _default_value, _next_tbl, _REINIT_FIELD(decision_id,reinit_id)},
#else
...
#ifdef IS_AX_SUPPORT
#ifdef MIB_TLV
#define MIBDEF_CUST_HW_EXT(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl,decision_id, reinit_id ) \
		{_MIB_CUSTOMER_HWID_NAME_EXT(_mib_name), _mib_type, _OFFSET_SIZE_FIELD(_mib_parents_ctype, _cname), _UNIT_SIZE(_ctype), _default_value, _next_tbl, _REINIT_FIELD(decision_id,reinit_id)},
#else
#define MIBDEF_CUST_HW_EXT(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl,decision_id, reinit_id ) \
		{_MIB_CUSTOMER_HWID_NAME_EXT(_mib_name), _mib_type, FIELD_OFFSET(_mib_parents_ctype, _cname), FIELD_SIZE(_mib_parents_ctype, _cname)},
#endif
#endif
