...
#if 0 //move to apmib.h
#ifdef CONFIG_USER_WLAN_USE_DRVCOMMON_HEADER
#ifndef WLAN_USE_DRVCOMMON_HEADER
#define WLAN_USE_DRVCOMMON_HEADER
#endif
#endif
...
extern const char SYSTEMD_ACTION[];
...
#define WLAN_FORMAT_S	"wlan%d"
#define WLAN_VXD_FORMAT_S	"wlan%d-vxd"
...
#else
#define VAP_IF_ONLY   "va%d"
#define VAP_IF		  "wlan%d-va%d"
#define VAP_IF_SUFFIX	"-va"
#endif
...
#endif
//t_stamp[1], pmf info
#define BSS_PMF_REQ		0x400
#define BSS_PMF_CAP		0x200
#define BSS_PMF_NONE	0x000

#if 0 //move to apmib.h
#if 1//def WLAN_USE_DRVCOMMON_HEADER
//use ieee802_mib.h struct bss_desc instead
typedef struct bss_desc BssDscr, *pBssDscr;     //wifi5 use
#else
...
typedef struct _ax_sitesurvey_status {
    unsigned char number;
    unsigned char pad[3];
    BssDscr_ax bssdb[MAX_BSS_DESC_AX];
//} __PACK__ AX_SS_STATUS_T, *AX_SS_STATUS_Tp;
}AX_SS_STATUS_T, *AX_SS_STATUS_Tp;
#endif
