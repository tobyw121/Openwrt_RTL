...
#if defined(CONFIG_RTK_MESH) || defined(FOR_DUAL_BAND)
	int wlan0_mode=1;
#endif
#if defined(FOR_DUAL_BAND)	
	int wlan1_mode=1;
#endif
#ifdef FOR_DUAL_BAND
	int wlan1_wpa_auth_root=0, wlan0_hidden_ssid_enabled=0, wlan1_hidden_ssid_enabled=0;
#ifdef CONFIG_WPS_EITHER_AP_OR_VXD
	int both_band_ap=0;
#endif
#endif
