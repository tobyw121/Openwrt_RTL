...
ifeq ($(KERNEL_VER),linux-4.4)
COMMON_CFLAGS += -DKERNEL_4_4
endif
...
ifeq ($(CONFIG_RTK_SYSCMD_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_RTK_SYSCMD_SUPPORT
endif
...
ifeq ($(CPTCFG_RTW_80211W_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_RTW_80211W_SUPPORT
endif
ifeq ($(CPTCFG_RTL_11W_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_RTL_11W_SUPPORT
endif

ifeq ($(CONFIG_APP_HOSTAPD), y)
COMMON_CFLAGS += -DCONFIG_APP_HOSTAPD
endif

ifeq ($(CONFIG_RTK_HOSTAPD_ONLY_GLOBAL), y)
COMMON_CFLAGS += -DCONFIG_RTK_HOSTAPD_ONLY_GLOBAL
endif

ifeq ($(CONFIG_APP_MULTI_AP), y)
COMMON_CFLAGS += -DCONFIG_APP_MULTI_AP
endif

ifeq ($(CONFIG_USER_RTK_COMMON_NETLINK), y)
COMMON_CFLAGS += -DCONFIG_USER_RTK_COMMON_NETLINK
endif

ifeq ($(CONFIG_USER_RTK_MULTI_AP_OPEN_ENCRYPT_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_USER_RTK_MULTI_AP_OPEN_ENCRYPT_SUPPORT
endif

ifeq ($(CONFIG_USER_RTK_MULTI_AP_ETH_ADAPTER), y)
COMMON_CFLAGS += -DCONFIG_USER_RTK_MULTI_AP_ETH_ADAPTER
endif

ifeq ($(CONFIG_APP_WPA_SUPPLC),)
COMMON_CFLAGS += -DCONFIG_APP_WPA_SUPPLC
endif
...
else ifeq ($(CPTCFG_RTL_11R_SUPPORT),y)
COMMON_CFLAGS += -DFAST_BSS_TRANSITION
else ifeq ($(CPTCFG_RTW_80211R),y)
COMMON_CFLAGS += -DFAST_BSS_TRANSITION
endif
...
ifeq ($(CONFIG_RTL_HTTPS_REDIRECT), y)
COMMON_CFLAGS += -DCONFIG_RTL_HTTPS_REDIRECT
endif
endif
...
COMMON_CFLAGS += -DCONFIG_RTL_EXCHANGE_PORTMASK
endif
...
ifeq ($(CPTCFG_RTL_DOT11K_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_RTL_DOT11K_SUPPORT
endif
ifeq ($(CPTCFG_HAPD_DOT11K_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_HAPD_DOT11K_SUPPORT
endif
ifeq ($(CPTCFG_RTW_80211K),y)
COMMON_CFLAGS += -DCONFIG_RTW_80211K
endif

ifeq ($(CPTCFG_RTW_80211V), y)
COMMON_CFLAGS += -DCONFIG_RTW_80211V
endif
ifeq ($(CPTCFG_HAPD_DOT11V_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_HAPD_DOT11V_SUPPORT
endif
ifeq ($(CPTCFG_RTL_11V_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_RTL_11V_SUPPORT
endif
...
ifeq ($(CONFIG_USER_RTK_MULTI_AP_WFA), y)
COMMON_CFLAGS += -DRTK_MULTI_AP_WFA
endif
...
ifeq ($(CONFIG_SLOT_0_8192FE),y)
COMMON_CFLAGS += -DCONFIG_RTL8192F
endif
ifeq ($(CONFIG_SLOT_1_8192FE),y)
COMMON_CFLAGS += -DCONFIG_RTL8192F
endif
...
ifeq ($(CONFIG_IPV6_FORD_RA_PREFIX_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_IPV6_FORD_RA_PREFIX_SUPPORT
endif
...
ifeq ($(CONFIG_IP6IP_TUNNEL_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_IP6IP_TUNNEL_SUPPORT
endif

ifeq ($(CONFIG_IP6TO4_TUNNEL_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_IP6TO4_TUNNEL_SUPPORT
endif
...
COMMON_CFLAGS += -DCONFIG_RTL_83XX_SUPPORT
endif

ifeq ($(CONFIG_RTL_8363NB_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_RTL_8363NB_SUPPORT
endif
...
ifeq ($(CPTCFG_RTW_CLIENT_MODE_SUPPORT),y)
COMMON_CFLAGS += -DCONFIG_WLAN_CLIENT_MODE
endif
...
ifeq ($(CPTCFG_RTW_REPEATER_MODE_SUPPORT), y)
COMMON_CFLAGS += -DCONFIG_WLAN_REPEATER_MODE
endif
...
ifdef CONFIG_BACKUP_CURRENT_SETTING
COMMON_CFLAGS += -DBACKUP_CURRENT_SETTING_SUPPORT
ifdef CONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET
COMMON_CFLAGS += -DCONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET=$(CONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET)
endif
endif

ifdef CONFIG_BACKUP_DEFAULT_SETTING
COMMON_CFLAGS += -DBACKUP_DEFAULT_SETTING_SUPPORT
ifdef CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET
COMMON_CFLAGS += -DCONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET=$(CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET)
endif
endif

ifdef CONFIG_BACKUP_HARDWARE_SETTING
COMMON_CFLAGS += -DBACKUP_HARDWARE_SETTING_SUPPORT
ifdef CONFIG_RTL_BACKUP_HARDWARE_SETTING_OFFSET
COMMON_CFLAGS += -DCONFIG_RTL_BACKUP_HARDWARE_SETTING_OFFSET=$(CONFIG_RTL_BACKUP_HARDWARE_SETTING_OFFSET)
endif
endif
...
ifeq ($(CPTCFG_BAND_2G_ON_WLAN0), y)
COMMON_CFLAGS += -DCONFIG_BAND_2G_ON_WLAN0
endif

ifeq ($(CPTCFG_2G_ON_WLAN0), y)
COMMON_CFLAGS += -DCONFIG_BAND_2G_ON_WLAN0
endif
...
ifeq ($(CPTCFG_BAND_5G_ON_WLAN0), y)
COMMON_CFLAGS += -DCONFIG_BAND_5G_ON_WLAN0
endif
...
ifeq ($(CONFIG_RTK_BLUETOOTH_HW_RTL8761A_T),y)
COMMON_CFLAGS += -DCONFIG_RTK_BLUETOOTH_HW_RTL8761A_T
endif
ifeq ($(CONFIG_RTK_BLUETOOTH_HW_RTL8761A_TV),y)
COMMON_CFLAGS += -DCONFIG_RTK_BLUETOOTH_HW_RTL8761A_TV
endif
ifeq ($(CONFIG_RTK_BLUETOOTH_HW_RTL8761B_T),y)
COMMON_CFLAGS += -DCONFIG_RTK_BLUETOOTH_HW_RTL8761B_T
endif
ifeq ($(CONFIG_RTK_BLUETOOTH_HW_RTL8761B_TV),y)
COMMON_CFLAGS += -DCONFIG_RTK_BLUETOOTH_HW_RTL8761B_TV
endif
ifeq ($(CONFIG_RTK_BLUETOOTH_CONFIGURATION_IN_EFUSE),y)
COMMON_CFLAGS += -DCONFIG_RTK_BLUETOOTH_CONFIGURATION_IN_EFUSE
endif
ifeq ($(CONFIG_RTK_BLUETOOTH_CONFIGURATION_IN_FLASH),y)
COMMON_CFLAGS += -DCONFIG_RTK_BLUETOOTH_CONFIGURATION_IN_FLASH
endif
...
ifneq ($(CPTCFG_RTL8832BR),)
COMMON_CFLAGS += -DCONFIG_WLAN_USE_DRVCOMMON_HEADER
endif

ifeq ($(CONFIG_RTL_KERNEL_USER_SHARE_STRUCTURE),y)
COMMON_CFLAGS += -DCONFIG_RTL_KERNEL_USER_SHARE_STRUCTURE
endif

ifneq ($(CONFIG_CPU_LITTLE_ENDIAN), y)
COMMON_CFLAGS += -D_BIG_ENDIAN_
endif
...
COMMON_CFLAGS += -DCONFIG_WLAN_HAL_8197G
COMMON_CFLAGS += -DCONFIG_RTL_8197G
ifneq ($(CPTCFG_RTL8852AE),)
COMMON_CFLAGS += -DCONFIG_RTL_92D_SUPPORT
COMMON_CFLAGS += -DFOR_DUAL_BAND
COMMON_CFLAGS += -DCONFIG_RTL_DUAL_PCIESLOT_BIWLAN_D
endif
...
COMMON_CFLAGS += -DCONFIG_RTL_11AC_SUPPORT
COMMON_CFLAGS += -DCONFIG_RTL_92D_SUPPORT
COMMON_CFLAGS += -DCONFIG_WLAN_8852A
...
COMMON_CFLAGS += -DCONFIG_RTL_92D_SUPPORT
COMMON_CFLAGS += -DFOR_DUAL_BAND
COMMON_CFLAGS += -DCONFIG_WLAN_8832B
COMMON_CFLAGS += -DCONFIG_WLAN_UI_SUPPORT
COMMON_CFLAGS += -DCONFIG_RTL_DFS_SUPPORT
endif

ifneq ($(CPTCFG_RTLWIFI6),)
COMMON_CFLAGS += -I$(DIR_ROOT)/$(BACKPORT_DIR)/drivers/net/wireless/realtek/rtl8192fe
COMMON_CFLAGS += -DCONFIG_RTLWIFI6
endif

ifeq ($(CPTCFG_RTL8852AE_BACKPORTS), y)
COMMON_CFLAGS += -I$(DIR_ROOT)/$(BACKPORT_DIR)/drivers/net/wireless/realtek/rtl8192fe
COMMON_CFLAGS += -DCONFIG_RTL8852AE_BACKPORTS
endif

ifeq ($(CONFIG_RTL8852AE_BACKPORTS),y)
ifneq ("$(wildcard $(DIR_ROOT)/$(BACKPORT_DIR)/drivers/net/wireless/realtek/g6_wifi_driver)","")
COMMON_CFLAGS += -I$(DIR_ROOT)/$(BACKPORT_DIR)/drivers/net/wireless/realtek/g6_wifi_driver
endif
else
...
ifeq ($(CONFIG_USER_WLAN_USE_DRVCOMMON_HEADER),y)
COMMON_CFLAGS += -DCONFIG_USER_WLAN_USE_DRVCOMMON_HEADER
endif

ifeq ($(CONFIG_RTW_BRSC), y)
COMMON_CFLAGS += -DCONFIG_RTW_BRSC
endif

ifeq ($(CONFIG_USER_RTK_WLAN_MANAGER),y)
COMMON_CFLAGS += -DRTK_WLAN_MANAGER
COMMON_CFLAGS += -DBAND_STEERING_SUPPORT
ifeq ($(CONFIG_USER_RTK_CROSSBAND_REPEATER),y)
COMMON_CFLAGS += -DRTK_CROSSBAND_REPEATER
endif
endif
