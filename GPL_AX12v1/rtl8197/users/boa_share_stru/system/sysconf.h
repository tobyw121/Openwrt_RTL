...
#define PROC_FASTIPV6_FILE "/proc/ipv6_fast_forward"
#endif
#if defined(CONFIG_RTL_HARDWARE_IPV6_SUPPORT)
#define PROC_HWIPV6_ROUTING_FILE "/proc/hwL3v6"
#endif
...
#define RESOLV_V4_CONF "/var/resolv_v4.conf"
#define RESOLV_V6_CONF "/var/resolv_v6.conf"
...
#define RDNSSD_PID_FILE "/var/rdnssd.pid"
#define DNSV6_RDNS_FILE	"/var/rdnss.conf"
#define DNSV6_RDNSSD_FILE "/var/rdnssd.conf"
#ifdef CONFIG_IPV6_RA_DNSSL_SUPPORT
#define DNSV6_SEAR_FILE "/var/dnssl.conf"
#endif
#endif
#endif
//mldproxy
...
#define MAP_E_FILE "/var/run/mape.pid"
#endif
#endif
#ifdef MULTI_PPPOE
