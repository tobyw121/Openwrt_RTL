...
/*for DOT11D  DOT11H DOT11K move to here*/
#define MAX_CHANNEL_SET_NUMBER	22
...
#define _ASOCREQ_RSN_AKM_type_IE_OFFSET_ 19
#define _ASOCREQ_RSN_PMKID_COUNT_OFFSET_ 22
#define _ASOCREQ_RSN_PMKID_IE_OFFSET_ 24
...
#define _SUPPORTED_REGULATORY_CLASSES_IE_ 59
#if defined(CONFIG_RTL_WAPI_SUPPORT)
...
#define _PROTECTED_PUBLIC_CATEGORY_ID_		9
...
/*-----------------------------------------------------------------------------
      Below is for DPP (Device Provisioning Protocol) related definition
------------------------------------------------------------------------------*/
#define _DPP_ACTION_FIELD_          9     // IEEE 802.11 Vendor Specific
/*-----------------------------------------------------------------------------
...
#define _WNM_NOTIF_REQ_ACTION_ID_		26
#define _WNM_NOTIF_RSP_ACTION_ID_		27
...
/*-----------------------------------------------------------------------------
                   Below is for Multiband related definition
 ------------------------------------------------------------------------------*/
#if (defined CONFIG_MBO) || (defined CONFIG_MBO_CLI)
#define _MBO_AP_CAPCABILITY_INDICATION_ATTR_ID_			1
#define _NON_PREFERRED_CHANNEL_REPORT_ATTR_ID_			2
#define _CELLULAR_DATA_CAPCABILITIES_ATTR_ID_			3
#define _ASSOCIATION_DISALLOWED_ATTR_ID_				4
#define _CELLULAR_DATA_CNEECTION_PREFERENCE_ATTR_ID_	5
#define _TRANSITION_REASON_CODE_ATTR_ID_				6
#define _TRANSITION_REJECTION_REASON_CODE_ATTR_ID_		7
#define _ASSOCIATION_RETRY_DELAY_ATTR_ID_				8
#endif

/*-----------------------------------------------------------------------------
				Below is for Multi-AP related definition
------------------------------------------------------------------------------*/
#define _MAP_PROFILE_SUBIE_ID_			0x07		// Profile subelement ID
#define _MAP_VLAN_ID_SUBIE_ID_			0x08		// 802.1Q Setting (Primary VLAN ID)
...
/*-----------------------------------------------------------------------------
			Below is list all type action frame types
			from hostapd
------------------------------------------------------------------------------*/
...
#define WLAN_FT_ACTION_REQ 1
#define WLAN_FT_ACTION_RESP 2
#define WLAN_FT_ACTION_CONFIRM 3
#define WLAN_FT_ACTION_ACK 4

/* WLAN_ACTION_PUBLIC ; Public action codes */
...
#define SET_CFG80211_REPORT_MGMT(w, t) (w->registered_nl80211_mgmt_frame_type |= BIT(t >> 4))
#define CLR_CFG80211_REPORT_MGMT(w, t) (w->registered_nl80211_mgmt_frame_type &= (~BIT(t >> 4)))
#define GET_CFG80211_REPORT_MGMT(w, t) ((w->registered_nl80211_mgmt_frame_type & BIT(t >> 4)) > 0)
...
#define PEER_PMF_CAP ((priv->pmib->dot11Bss.t_stamp[1]>>9)&3)
