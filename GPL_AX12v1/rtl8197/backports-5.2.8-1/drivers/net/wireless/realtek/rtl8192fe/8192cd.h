...
#ifdef CONFIG_IEEE80211W
#ifndef  RTK_NL80211
	struct timer_list		SA_timer;	//SA_timer: Security Association 
#endif
#endif
...
//	unsigned short		fw_src_version;
	...
	struct timer_list		LED_Timer;		// for SW LED
#if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
...
#endif
	struct timer_list		amsdu_sw_timer;
#ifdef ADAPTIVITY_STATS_DEBUG
	struct timer_list		ada_stats_timer;
#endif

#if (BEAMFORMING_SUPPORT == 1)
	struct timer_list		BeamformingTimer;
#if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
	struct timer_event_entry	BeamformingTimer_event;
#endif
	struct timer_list		BFSoundingTimeoutTimer;
#endif
...
typedef struct rtl8192cd_priv {
	...
	/*support wpa3 r3 RSN Extension element*/
	u8 rsn_xe[3];
	u8 rsn_xe_len;
	u8 hapd_supp_rates[10];
	u8 hapd_supp_rates_len;
	u8 hapd_ext_supp_rates[10];
	u8 hapd_ext_supp_rates_len;
#endif
...
#endif
#ifdef RTK_MULTI_AP
	struct timer_list		multiap_backhaul_steer_timer;
	struct timer_list		multiap_unassoc_sta_timer;
#if (EASYMESH_VERSION >= MULTI_AP_VERSION(2,0,0))
	struct timer_list		multiap_cac_process_timer;
#endif
#endif
#if defined(CONFIG_PCI_HCI) && (defined(CONFIG_RTL_92D_SUPPORT) || defined(CONFIG_RTL_92C_SUPPORT))
	struct timer_list		add_ps_timer;
#endif
	struct timer_list		MIC_check_timer;		// for MIC check
...
#endif
#ifdef DOT11K
	struct timer_list		rm_delay_timer;
#if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
	...
	/* ******************************************* */
#if defined(CONFIG_RTL_TRIBAND_SUPPORT)
	struct timer_list		send_timer_wlan2;
#if defined(MBSSID)
	struct timer_list		send_timer_wlan2_vap[RTL8192CD_NUM_VWLAN];
#endif
#if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
