...
#include "../../../data_AGC_TAB_8197G.c"
#include "../../../data_RadioA_8197G.c"
#include "../../../data_RadioB_8197G.c"

#include "../../../data_MAC_REG_8197G.c"
#include "../../../data_PHY_REG_8197G.c"



VAR_MAPPING(AGC_TAB_8197G, AGC_TAB_8197G);
VAR_MAPPING(MAC_REG_8197G, MAC_REG_8197G);
VAR_MAPPING(PHY_REG_8197G, PHY_REG_8197G);
VAR_MAPPING(RadioA_8197G, RadioA_8197G);
VAR_MAPPING(RadioB_8197G, RadioB_8197G);
...
#include "../../../data_AGC_TAB_8197GMP_2layer.c"
#endif
#ifdef CONFIG_8197G_2LAYER
VAR_MAPPING(AGC_TAB_8197GMP_2layer, AGC_TAB_8197GMP_2layer);
#endif

#ifdef CONFIG_8197G_2LAYER
#include "../../../data_RadioA_8197GMP_2layer.c"
#endif
#ifdef CONFIG_8197G_2LAYER
VAR_MAPPING(RadioA_8197GMP_2layer, RadioA_8197GMP_2layer);
#endif

#include "../../../data_PHY_REG_PG_8197Gmp.c"
#include "../../../data_PHY_REG_PG_8197Gmp_Type0.c"
#if CFG_HAL_HIGH_POWER_EXT_PA
#include "../../../data_PHY_REG_PG_8197Gmp_Type1.c"
#include "../../../data_PHY_REG_PG_8197Gmp_Type2.c"
#include "../../../data_PHY_REG_PG_8197Gmp_Type3.c"
#include "../../../data_PHY_REG_PG_8197Gmp_Type4.c"
#include "../../../data_PHY_REG_PG_8197Gmp_Type5.c"
#endif

VAR_MAPPING(PHY_REG_PG_8197Gmp, PHY_REG_PG_8197Gmp);
VAR_MAPPING(PHY_REG_PG_8197Gmp_Type0, PHY_REG_PG_8197Gmp_Type0);
#if CFG_HAL_HIGH_POWER_EXT_PA
VAR_MAPPING(PHY_REG_PG_8197Gmp_Type1, PHY_REG_PG_8197Gmp_Type1);
VAR_MAPPING(PHY_REG_PG_8197Gmp_Type2, PHY_REG_PG_8197Gmp_Type2);
VAR_MAPPING(PHY_REG_PG_8197Gmp_Type3, PHY_REG_PG_8197Gmp_Type3);
VAR_MAPPING(PHY_REG_PG_8197Gmp_Type4, PHY_REG_PG_8197Gmp_Type4);
VAR_MAPPING(PHY_REG_PG_8197Gmp_Type5, PHY_REG_PG_8197Gmp_Type5);
#endif

#ifdef TXPWR_LMT_8197G
#include "../../../data_TXPWR_LMT_8197Gmp.c"
#include "../../../data_TXPWR_LMT_8197Gmp_Type0.c"
VAR_MAPPING(TXPWR_LMT_8197Gmp,TXPWR_LMT_8197Gmp);
VAR_MAPPING(TXPWR_LMT_8197Gmp_Type0,TXPWR_LMT_8197Gmp_Type0);
#if CFG_HAL_HIGH_POWER_EXT_PA
#include "../../../data_TXPWR_LMT_8197Gmp_Type1.c"
#include "../../../data_TXPWR_LMT_8197Gmp_Type2.c"
#include "../../../data_TXPWR_LMT_8197Gmp_Type3.c"
#include "../../../data_TXPWR_LMT_8197Gmp_Type4.c"
#include "../../../data_TXPWR_LMT_8197Gmp_Type5.c"
VAR_MAPPING(TXPWR_LMT_8197Gmp_Type1,TXPWR_LMT_8197Gmp_Type1);
VAR_MAPPING(TXPWR_LMT_8197Gmp_Type2,TXPWR_LMT_8197Gmp_Type2);
VAR_MAPPING(TXPWR_LMT_8197Gmp_Type3,TXPWR_LMT_8197Gmp_Type3);
VAR_MAPPING(TXPWR_LMT_8197Gmp_Type4,TXPWR_LMT_8197Gmp_Type4);
VAR_MAPPING(TXPWR_LMT_8197Gmp_Type5,TXPWR_LMT_8197Gmp_Type5);
#endif
#endif

#if 1   //Filen, file below should be updated
#include "../../../data_PHY_REG_MP_8197G.c"
#include "../../../data_rtl8197Gfw.c"

#endif

//3 MACDM
//default
#include "../../../data_MACDM_def_high_8197G.c"
#include "../../../data_MACDM_def_low_8197G.c"
#include "../../../data_MACDM_def_normal_8197G.c"
//general
#include "../../../data_MACDM_gen_high_8197G.c"
#include "../../../data_MACDM_gen_low_8197G.c"
#include "../../../data_MACDM_gen_normal_8197G.c"
//txop
#include "../../../data_MACDM_txop_high_8197G.c"
#include "../../../data_MACDM_txop_low_8197G.c"
#include "../../../data_MACDM_txop_normal_8197G.c"
//criteria
#include "../../../data_MACDM_state_criteria_8197G.c"

#if 1   //Filen, file below should be updated
VAR_MAPPING(PHY_REG_MP_8197G, PHY_REG_MP_8197G);
VAR_MAPPING(rtl8197Gfw, rtl8197Gfw);

#endif

//3 MACDM
VAR_MAPPING(MACDM_def_high_8197G, MACDM_def_high_8197G);
VAR_MAPPING(MACDM_def_low_8197G, MACDM_def_low_8197G);
VAR_MAPPING(MACDM_def_normal_8197G, MACDM_def_normal_8197G);

VAR_MAPPING(MACDM_gen_high_8197G, MACDM_gen_high_8197G);
VAR_MAPPING(MACDM_gen_low_8197G, MACDM_gen_low_8197G);
VAR_MAPPING(MACDM_gen_normal_8197G, MACDM_gen_normal_8197G);

VAR_MAPPING(MACDM_txop_high_8197G, MACDM_txop_high_8197G);
VAR_MAPPING(MACDM_txop_low_8197G, MACDM_txop_low_8197G);
VAR_MAPPING(MACDM_txop_normal_8197G, MACDM_txop_normal_8197G);

VAR_MAPPING(MACDM_state_criteria_8197G, MACDM_state_criteria_8197G);
...
)
{
    ...
    if (!HalPwrSeqCmdParsing88XX(Adapter, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK,
        PWR_INTF_PCI_MSK, rtl8197G_card_enable_flow))
    {
...
)
{
    ...
    pHalFunc->InitPONHandler        = InitPON8197G;
...
//    pHalFunc->ReleaseShortCutTxDescHandler  = ReleaseShortCutTxDesc88XX;
    ...
    pHalFunc->FillShortCutTxHwCtrlHandler   = (NicFillShortCutTxHwCtrlHandler)FillShortCutTxHwCtrl88XX;
    ...
    //pHalFunc->ReadMACIDSleepHandler         =   ReadMACIDSleep88XX;
    ...
    pHalFunc->CAMEmptyEntryHandler          =   CAMEmptyEntry88XX_V1;
    ...
    pHalFunc->PHYUpdateBBRFValHandler       = UpdateBBRFVal819X_N;
    pHalFunc->PHYSwBWModeHandler            = SwBWMode88XX_8197G;
    // TODO: 8197G Power Tracking should be done
    pHalFunc->TXPowerTrackingHandler        = TXPowerTracking_ThermalMeter_Tmp8197G;
    pHalFunc->PHYSSetRFRegHandler           = PHY_SetRFReg_8197G;    
    pHalFunc->PHYQueryRFRegHandler          = PHY_QueryRFReg_8197G;
    ...
    pHalFunc->MACIDPauseDropHandler             = MacidPauseDropCtrl88XX;
#endif
#ifdef AP_SWPS_OFFLOAD
    pHalFunc->ClearDropIDHandler            = ClearDropID88XX;
    pHalFunc->UpdateMacidSWPSInfoHandler    = UpdateMacidSWPSInfo88XX; //no use now
    pHalFunc->MACIDSWPSCtrlHandler          = MACIDSWPSCtrl88XX;
    pHalFunc->UpdateAPSWPSReportSizeHandler = UpdateAPSWPSReportSize88XX;
#endif    
#ifdef STA_AGING_FUNC_OFFLOAD        
    pHalFunc->AgingFuncOfflaodHandler       = AgingFuncOfflaod88XX; //no use now
#endif
