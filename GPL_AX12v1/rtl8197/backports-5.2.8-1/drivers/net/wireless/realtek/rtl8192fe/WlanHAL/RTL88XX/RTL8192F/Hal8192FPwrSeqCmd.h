...
/* 
	...
	TRANS_END
*/
#define	RTL8192F_TRANS_CARDEMU_TO_ACT_STEPS	30
...
#define	RTL8192F_TRANS_CARDDIS_TO_CARDEMU_STEPS	7
...
#define RTL8192F_TRANS_CARDEMU_TO_ACT 														\
	...
	{0x0001, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_USB_MSK|PWR_INTF_SDIO_MSK,PWR_BASEADDR_MAC,PWR_CMD_DELAY, 1, PWRSEQ_DELAY_MS*5},/*Delay 1ms*/   \
	...
	{0x00DC, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, 0xFF, 0xC4},/*AFE_Ctrl*/\
	{0x001C, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, 0},/*Register Lock Enable*/\
	{0x00B1, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, (BIT7|BIT6|BIT5), (BIT7|BIT6|BIT5)},/*Register Lock Enable*/\
