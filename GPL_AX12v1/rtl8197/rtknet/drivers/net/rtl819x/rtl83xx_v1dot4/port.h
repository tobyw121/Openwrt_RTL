...
typedef enum rtk_port_linkMode_e
{
    PORT_MAC_NORMAL = 0,
    PORT_MAC_FORCE,
}rtk_port_linkMode_t;
 ...
 */
extern rtk_api_ret_t rtk_port_duplexAutoChange_set(rtk_enable_t state);
 ...
 */
extern rtk_api_ret_t rtk_port_duplexAutoChange_get(rtk_enable_t *pState);
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLinkExtSSC_set(rtk_port_t port, rtk_enable_t state);
 ...
 *      The API can get the state of SSC.
 */
extern rtk_api_ret_t rtk_port_macForceLinkExtSSC_get(rtk_port_t port, rtk_enable_t *pState);
 ...
 */
extern rtk_api_ret_t rtk_port_autoDownSpeed10M_set(rtk_enable_t state);
 ...
 */
extern rtk_api_ret_t rtk_port_autoDownSpeed10M_get(rtk_enable_t *pState);
