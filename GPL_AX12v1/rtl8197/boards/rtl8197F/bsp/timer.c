...
static const struct proc_ops watchdog_reboot_proc_fops;
static const struct proc_ops watchdog_cmd_proc_fops;
static const struct proc_ops watchdog_kick_proc_fops;
#else
...
static const struct proc_ops watchdog_cmd_proc_fops = {
        ...
        .proc_write     = watchdog_cmd_single_write,
};
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,10,0)
static const struct proc_ops watchdog_kick_proc_fops = {
        .proc_open      = watchdog_kick_open,
        .proc_read      = seq_read,
        .proc_lseek     = seq_lseek,
        .proc_release   = single_release,
        .proc_write     = watchdog_kick_single_write,
};
#else
struct file_operations watchdog_kick_proc_fops = {
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,10,0)
static const struct proc_ops watchdog_reboot_proc_fops = {
        .proc_open      = watchdog_reboot_open,
        .proc_read      = seq_read,
        .proc_lseek     = seq_lseek,
        .proc_release   = single_release,
        .proc_write     = write_watchdog_reboot,
};
#else
struct file_operations watchdog_reboot_proc_fops = {
