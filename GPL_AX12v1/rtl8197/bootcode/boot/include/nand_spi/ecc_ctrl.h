...
/***********************************************
  * ECC Driver APIs
  ***********************************************/
extern SECTION_NAND_SPI void ecc_encode_bch_6t(void *dma_addr, void *p_eccbuf,unsigned int pageaddr,unsigned int chunk_size);
extern SECTION_NAND_SPI int ecc_decode_bch_6t(void *dma_addr, void *p_eccbuf,unsigned int pageaddr,unsigned int chunk_size);	
