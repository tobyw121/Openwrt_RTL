...
#define PABCD_CNR                           PABCDCNR
#define PABCD_PTYPE                         PABCDPTYPE
#define PABCD_DIR                           PABCDDIR
#define PABCD_DAT                           PABCDDAT
#define PABCD_ISR                           PABCDISR
#define PAB_IMR                             PABIMR
#define PCD_IMR                             PCDIMR
#define PEFGH_CNR                           PEFGHCNR
#define PEFGH_PTYPE                         PEFGHPTYPE
#define PEFGH_DIR                           PEFGHDIR
#define PEFGH_DAT                           PEFGHDAT
#define PEFGH_ISR                           PEFGHISR
#define PEF_IMR                             PEFIMR
#define PGH_IMR                             PGHIMR
