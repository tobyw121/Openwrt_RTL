 ...
 */
rtk_api_ret_t dal_rtl8367c_led_enable_set(rtk_led_group_t group, rtk_portmask_t *pPortmask)
{
...
rtk_api_ret_t dal_rtl8367c_led_groupConfig_set(rtk_led_group_t group, rtk_led_congig_t config)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_enable_get(rtk_led_group_t group, rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
 ...
 *      - LED_OP_SERIAL,
 */
rtk_api_ret_t dal_rtl8367c_led_operation_set(rtk_led_operation_t mode)
{
    rtk_api_ret_t retVal;
    rtk_uint32 regData;
 ...
 *      - LED_OP_SERIAL,
 */
rtk_api_ret_t dal_rtl8367c_led_operation_get(rtk_led_operation_t *pMode)
{
    rtk_api_ret_t retVal;
    rtk_uint32 regData;
 ...
 *      - LED_FORCE_ON.
 */
rtk_api_ret_t dal_rtl8367c_led_modeForce_set(rtk_port_t port, rtk_led_group_t group, rtk_led_force_mode_t mode)
{
    rtk_api_ret_t retVal;
 ...
 *      - LED_FORCE_ON.
 */
rtk_api_ret_t dal_rtl8367c_led_modeForce_get(rtk_port_t port, rtk_led_group_t group, rtk_led_force_mode_t *pMode)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_blinkRate_set(rtk_led_blink_rate_t blinkRate)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_blinkRate_get(rtk_led_blink_rate_t *pBlinkRate)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_groupConfig_get(rtk_led_group_t group, rtk_led_congig_t *pConfig)
{
    rtk_api_ret_t retVal;
...
rtk_api_ret_t dal_rtl8367c_led_groupAbility_set(rtk_led_group_t group, rtk_led_ability_t *pAbility)
{
    rtk_api_ret_t retVal;
    rtk_uint32 regData;
    ...
    if( (pAbility->link_10m >= RTK_ENABLE_END) || (pAbility->link_100m >= RTK_ENABLE_END) ||
        (pAbility->link_500m >= RTK_ENABLE_END) || (pAbility->link_1000m >= RTK_ENABLE_END) || (pAbility->link_2500m != DISABLED) ||
...
rtk_api_ret_t dal_rtl8367c_led_groupAbility_get(rtk_led_group_t group, rtk_led_ability_t *pAbility)
{
    rtk_api_ret_t retVal;
    rtk_uint32 regData;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_serialMode_set(rtk_led_active_t active)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_serialMode_get(rtk_led_active_t *pActive)
{
    rtk_api_ret_t retVal;
    rtk_uint32 regData;
 ...
 *      This API set LED I/O state.
 */
rtk_api_ret_t dal_rtl8367c_led_OutputEnable_set(rtk_enable_t state)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_led_OutputEnable_get(rtk_enable_t *pState)
{
    rtk_api_ret_t retVal;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_led_serialModePortmask_set(rtk_led_serialOutput_t output, rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_led_serialModePortmask_get(rtk_led_serialOutput_t *pOutput, rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
