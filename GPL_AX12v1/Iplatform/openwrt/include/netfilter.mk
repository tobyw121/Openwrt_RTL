...
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_CORE,CONFIG_NF_REJECT_IPV4, $(P_V4)nf_reject_ipv4),))
...
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),lt,4.1.0)),1)
...
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_MATCH_RECENT, $(P_XT)xt_mark))
...
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_IPV6,CONFIG_NF_REJECT_IPV6, $(P_V6)nf_reject_ipv6),))
...
# kernel only
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,4.2.0)),1)
...
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_NAT,CONFIG_NF_NAT_IPV4, $(P_V4)nf_nat_ipv4),))
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_NAT,CONFIG_NF_NAT, $(P_V4)iptable_nat),))


# userland only
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_NAT,CONFIG_NF_NAT, ipt_SNAT ipt_DNAT)))

$(eval $(if $(NF_KMOD),$(call nf_add,IPT_NAT,CONFIG_NF_NAT_MASQUERADE_IPV4, $(P_V4)nf_nat_masquerade_ipv4),))
#MASQUERADE is not needed in the new kernel of ax80v1
ifeq ($(KERNELVERSION), 5.4.164)
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_MASQUERADE, $(P_XT)xt_MASQUERADE))
...
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),lt,4.18.0)),1)
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_REDIRECT, $(P_XT)nf_nat_redirect))
endif

ifeq ($(KERNELVERSION), 4.4.60)
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_REDIRECT, $(P_XT)nf_nat_redirect))
endif
...
$(eval $(call nf_add,IPT_NAT_EXTRA,CONFIG_IP_NF_TARGET_REDIRECT, $(P_V4)ipt_REDIRECT))
  ...
  # added by CCy for C2200 which is kernel 4.1.x, must add xt_nat.ko.
  $(eval $(call nf_add,IPT_NAT_EXTRA,CONFIG_NETFILTER_XT_NAT, $(P_XT)xt_nat))
  $(eval $(call nf_add,IPT_NAT_EXTRA,CONFIG_NETFILTER_XT_TARGET_NETMAP, $(P_XT)xt_NETMAP))
  $(eval $(call nf_add,IPT_NAT_EXTRA,CONFIG_NETFILTER_XT_TARGET_REDIRECT, $(P_XT)xt_REDIRECT))
endif
...
ifeq ($(KERNELVERSION), 3.10.14+)
$(eval $(call nf_add,IPT_NATHELPER,CONFIG_NF_NAT_FTP, $(P_XT)nf_nat_ftp))
else ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,4.2.0)),1)
$(eval $(call nf_add,IPT_NATHELPER,CONFIG_NF_NAT_FTP, $(P_XT)nf_nat_ftp))
else
...
ifeq ($(KERNELVERSION), 3.10.14+)
$(eval $(call nf_add,IPT_NATHELPER_EXTRA,CONFIG_NF_NAT_AMANDA, $(P_XT)nf_nat_amanda))
else ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,4.2.0)),1)
$(eval $(call nf_add,IPT_NATHELPER_EXTRA,CONFIG_NF_NAT_AMANDA, $(P_XT)nf_nat_amanda))
else
...
ifeq ($(KERNELVERSION), 3.10.14+)
$(eval $(call nf_add,IPT_NATHELPER_EXTRA,CONFIG_NF_NAT_SIP, $(P_XT)nf_nat_sip))
else ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,4.2.0)),1)
$(eval $(call nf_add,IPT_NATHELPER_EXTRA,CONFIG_NF_NAT_SIP, $(P_XT)nf_nat_sip))
else
...
ifeq ($(KERNELVERSION), 3.10.14+)
$(eval $(call nf_add,IPT_NATHELPER_EXTRA,CONFIG_NF_NAT_TFTP, $(P_XT)nf_nat_tftp))
else ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,4.2.0)),1)
$(eval $(call nf_add,IPT_NATHELPER_EXTRA,CONFIG_NF_NAT_TFTP, $(P_XT)nf_nat_tftp))
else
