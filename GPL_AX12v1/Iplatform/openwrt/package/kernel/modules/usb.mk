...
define KernelPackage/usb-gadget
  ...
  AUTOLOAD:=$(call AutoLoad,40,udc-core)
...
define KernelPackage/usb-gadget-dwc3
  ...
  AUTOLOAD:=$(call AutoLoad,40,dwc3)
...
define KernelPackage/usb-gadget-dwc3-ipq
  TITLE:=USB Gadget support for IPQ DWC3 controller
  KCONFIG:=CONFIG_USB_DWC3_IPQ
  FILES:=$(LINUX_DIR)/drivers/usb/dwc3/dwc3-ipq.ko
  AUTOLOAD:=$(call AutoLoad,50,dwc3-ipq)
  DEPENDS:=kmod-usb-gadget-dwc3
  $(call AddDepends/usb)
endef

define KernelPackage/usb-gadget-dwc3-ipq/description
  Kernel support for USB Gadget MSM DWC3 controller.
endef

$(eval $(call KernelPackage,usb-gadget-dwc3-ipq))
...
#  FILES:= \
#	$(LINUX_DIR)/drivers/usb/dwc2/dwc2.o \
#	$(LINUX_DIR)/drivers/usb/dwc2/platform.o
...
define KernelPackage/mii
  TITLE:=Kernel modules for Media Idependent Interface
  KCONFIG:=CONFIG_MII
  FILES:=$(LINUX_DIR)/drivers/net/mii.ko
endef

define KernelPackage/mii/description
 Kernel modules for Media Idependent Interface
endef
...
define KernelPackage/usb-net-cdc-mbim
  TITLE:=Support for cdc mbim mobile broadband modems
  KCONFIG:=CONFIG_USB_NET_CDC_MBIM
  FILES:=$(LINUX_DIR)/drivers/$(USBNET_DIR)/cdc_mbim.ko
  $(call AddDepends/usb-net)
endef

define KernelPackage/usb-net-cdc-mbim/description
 Kernel support for cdc mbim mobile broadband modems
endef
...
define KernelPackage/usb-net-cdc-ncm/description
 Kernel support for USB CDC NCM devices
endef
...
define KernelPackage/usb-net-huawei-cdc-ncm
  ...
  #AUTOLOAD:=$(call AutoLoad,61,huawei_cdc_ncm)
  $(call AddDepends/usb-net)
endef

define KernelPackage/usb-net-huawei-cdc-ncm/description
 Kernel support for USB HUAWEI CDC NCM devices
endef
