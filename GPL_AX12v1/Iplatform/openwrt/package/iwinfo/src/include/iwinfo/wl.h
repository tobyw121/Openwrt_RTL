 ...
 * The value corresponds to 5925 MHz for ch2, to 5950MHz for others.
 */
#define WF_CHAN_FACTOR_6_G		11900	/* 6 GHz band except for ch2, 5950 MHz */
#define WF_CHAN_FACTOR_6_G_CH2	11850	/* 6 GHz band ch2, 5925 MHz */
...
/*
    lizhou@tp-link.com.cn 2019-6-28
    note:
    model	BCM_WL_STA_INFO_VER		WLC_WDS_RESULT
    4000/5400x	5				324
    ax10/1500	7				400
*/
#if BCM_WL_STA_INFO_VER > 5
#define WLC_WDS_RESULTS         400
#else
#define WLC_WDS_RESULTS         324
#endif
/* END 2019-6-28 */
