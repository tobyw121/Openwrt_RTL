...
static int hostapd_cli_cmd_disconnectstaofbss(struct wpa_ctrl *ctrl, int argc,
					char *argv[])
{
	char buf[64];
	
	os_snprintf(buf, sizeof(buf), "DISCONNECTSTAOFBSS");
	return wpa_ctrl_command(ctrl, buf);
}
...
static int hostapd_cli_cmd_log_console(struct wpa_ctrl *ctrl, int argc,
				     char *argv[])
{
	return hostapd_cli_cmd(ctrl, "LOG_CONSOLE", 1, argc, argv);
}
...
static int hostapd_cli_cmd_apply_macacl(struct wpa_ctrl *ctrl, int argc,
				       char *argv[])
{
	return wpa_ctrl_command(ctrl, "APPLY_ACL");
}
...
static const struct hostapd_cli_cmd hostapd_cli_commands[] = {
	...
	{ "DisConnectStaOfBss", hostapd_cli_cmd_disconnectstaofbss, NULL,
	   "= disconnect all stas of bss" },
#ifdef CONFIG_TAXONOMY
	...
	{ "log_console", hostapd_cli_cmd_log_console, NULL,
	...
	{ "apply_acl", hostapd_cli_cmd_apply_macacl, NULL,
	  "=Apply MAC ACL parameters" },
