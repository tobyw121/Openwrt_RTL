...
#define MKA_PSK_SET (MKA_PSK_SET_CKN | MKA_PSK_SET_CAK)
	...
	/**
	 * easymesh_support - Easymesh support
	 * 0 = support easymesh
	 * 1 = not support easymesh
	 */
	int easymesh_support;

	/**
	 * onemesh_support - TP-LINK onemesh support
	 * 0 = support onemesh
	 * 1 = not support onemesh
	 */
	int onemesh_support;

#define MAX_ONEMESH_TPIE_LEN 32
	/**
	 * onemesh_tpie - TP-LINK onemesh TPIE
	 * value equal to struct wpa_bss_ie_tpinfo in bss.h
	 */
	u8 onemesh_tpie[MAX_ONEMESH_TPIE_LEN];
