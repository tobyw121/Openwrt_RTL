...
static int wpa_cli_cmd_wps_get_status(struct wpa_ctrl *ctrl, int argc,
					  char *argv[])
{
...
static int wpa_cli_cmd_tp_mesh_enable(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "TP_MESH_ENABLE", 0, argc, argv);
}

static int wpa_cli_cmd_node_id(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "NODE_ID", 0, argc, argv);
}

static int wpa_cli_cmd_rootap_tpie_get(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "ROOTAP_TPIE_GET", 0, argc, argv);
}

static int wpa_cli_cmd_easymesh_support(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "EASYMESH_SUPPORT", 0, argc, argv);
}
...
static int wpa_cli_cmd_log_console(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "LOG_CONSOLE", 1, argc, argv);
}
...
static const struct wpa_cli_cmd wpa_cli_commands[] = {
	...
	{ "log_console", wpa_cli_cmd_log_console, NULL,
	  cli_cmd_flag_none,
	  "<enable> open/close console log when work as deamon" },
	...
	{ "tp_mesh_enable", wpa_cli_cmd_tp_mesh_enable, NULL,
	  cli_cmd_flag_none,
	  "<value> = set tp_mesh_enable parameter" },
	{ "node_id", wpa_cli_cmd_node_id, NULL,
	  cli_cmd_flag_none,
	  "<value> = set node_id parameter" },
	{ "rootap_tpie_get", wpa_cli_cmd_rootap_tpie_get, NULL,
	  cli_cmd_flag_none,
	  "<value> = get rootap_tpie parameter" },
	{ "easymesh_support", wpa_cli_cmd_easymesh_support, NULL,
	  cli_cmd_flag_none,
	  "<value> = get easymesh_support parameter" },
	...
	{ "wps_get_status", wpa_cli_cmd_wps_get_status, NULL,
	  cli_cmd_flag_none,
