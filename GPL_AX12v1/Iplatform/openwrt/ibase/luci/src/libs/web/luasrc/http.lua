...
function Request.set_hash(self, hash)
	if hash then
		self.message.encrypt.hash = hash
	end
end

function Request.get_hash(self)
	return self.message.encrypt.hash
end
...
function set_hash(hash)
	context.request:set_hash(hash)
end

function get_hash()
	return context.request:get_hash()
end
