...
#ifdef HAVE_TLS
#define UCI_MODE_CFG    "sysmode"
#define UCI_NET_CFG     "network"
#define UCI_ADMIN_CFG   "administration"
#define DEFAULT_HTTP_PORT   (80)
#define DEFAULT_HTTPS_PORT  (443)
#define UH_MIN_PORT         (1024)
#define UH_MAX_PORT         (65535)
#define UH_LAN_IP       "192.168.0.1"
#define UH_LAN_MASK     "255.255.255.0"
#endif
