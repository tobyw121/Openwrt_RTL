...
*/
static PS_ALERT_CONF g_tcp_low_ps =       {0,290,25,290};
static PS_ALERT_CONF g_tcp_low_decoy_ps = {0,145,50,290};
static PS_ALERT_CONF g_tcp_low_sweep =    {0,5,5,15};
static PS_ALERT_CONF g_tcp_low_dist_ps =  {0,75,100,15};
                             ...
                             PS_TRACKER **scanned)
{
    ...
    */
    if(portscan_eval_config->detect_scan_type & (PS_TYPE_PORTSCAN | PS_TYPE_DECOYSCAN | PS_TYPE_DISTPORTSCAN | PS_TYPE_PORTSWEEP))
    {
