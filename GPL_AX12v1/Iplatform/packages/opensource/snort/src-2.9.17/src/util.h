...
#define STD_BUF  1024
#define URL_CAT_SECURITY_IOT			0x1 << 16
#define URL_CAT_SECURITY_INTRUSION		0x1 << 17

//ATTACK TYPE & EVENT TYPE
enum ATTACK_EVENT_TYPE {
    //EVENT TYPE
    ATTACK_PORTSCANING = 0X10,
    ATTACK_NETWORK_PENETRATION = 0x20,
    ATTACK_DDOS = 0x30,
	//ATTACK TYPE
    PORTSCANING = 0x11,
	PENETRATION_INCOMING = 0x21,
    PENETRATION_OUTGOING = 0x22,
	DDOS = 0x31,
} attack_event;

#define CV_LEN 8
#define ALERT_FILE "/tmp/reportinfo"
#define CMD_LEN 160
#define IP_TRANS_LEN 46
#define IPV4_LOCAL 0xc0a8     //192.168.0.0/16
#define IPV6_LOCAL 0X3fa      //fe80::/10
#define IPV6_PUBLIC1 0x2001   //2001::/16
#define IPV6_PUBLIC2 0x2002   //2002::/16
#define IPV6_PUBLIC3 0x3ffe   //3ffe::/16

#define DDOS_RULE_START 100001200
#define PENETRATION_RULE_START 100001300

#define DEGRADATION_INTERVAL (60 * 60)         //Time interval when node removed from list
#define REPORT_BUF_SIZE 144
