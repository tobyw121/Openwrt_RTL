...
//#define PPPD		"/tmp/pppd"
//#define PPPD        "/home/yang/ppp/ppp-2.4.3/pppd/pppd"
#endif
...
//added by yangxv for log, 2008.05.09
extern void log_to_web(const char *fmt, ...);
//end added
...
//added by yangxv for debug, 2008.05.09
#ifdef XL2TP_DEBUG
#define YANG_DEBUG
#endif
...
#define DEBUG_ZLB
#define DEBUG_FLOW
//information is to much so delete it
//#define DEBUG_PAYLOAD
#define DEBUF_FILE
#define DEBUG_CONTROL_XMIT
