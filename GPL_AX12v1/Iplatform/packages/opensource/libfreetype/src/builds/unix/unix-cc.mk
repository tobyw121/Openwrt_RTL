...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -I/usr/local/include   -pthread \
...
# Linker flags.
#
LDFLAGS :=  -L/usr/local/lib -lz   -pthread -lpthread

# export symbols
#
CCraw_build  := gcc -std=gnu11	# native CC of building system
