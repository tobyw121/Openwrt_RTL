...
soapMethods[] =
{
	...
	{ "QueryStateVariable", QueryStateVariable, wancfgControlURL},
	{ "GetTotalBytesSent", GetTotalBytesSent, wancfgControlURL},
	{ "GetTotalBytesReceived", GetTotalBytesReceived, wancfgControlURL},
	{ "GetTotalPacketsSent", GetTotalPacketsSent, wancfgControlURL},
	{ "GetTotalPacketsReceived", GetTotalPacketsReceived, wancfgControlURL},
	{ "GetCommonLinkProperties", GetCommonLinkProperties, wancfgControlURL},
	/* WANIPConnection */
	{ "GetStatusInfo", GetStatusInfo, wanIPCControlURL},
	{ "GetConnectionTypeInfo", GetConnectionTypeInfo, wanIPCControlURL},
	{ "GetNATRSIPStatus", GetNATRSIPStatus, wanIPCControlURL},
	{ "GetExternalIPAddress", GetExternalIPAddress, wanIPCControlURL},
	{ "AddPortMapping", AddPortMapping, wanIPCControlURL},
	{ "DeletePortMapping", DeletePortMapping, wanIPCControlURL},
	{ "GetGenericPortMappingEntry", GetGenericPortMappingEntry, wanIPCControlURL},
	{ "GetSpecificPortMappingEntry", GetSpecificPortMappingEntry, wanIPCControlURL},
/* Required in WANIPConnection:2 */
	{ "SetConnectionType", SetConnectionType, wanIPCControlURL},
	{ "RequestConnection", RequestConnection, wanIPCControlURL},
	{ "ForceTermination", ForceTermination, wanIPCControlURL},
	{ "AddAnyPortMapping", AddAnyPortMapping, wanIPCControlURL},
	{ "DeletePortMappingRange", DeletePortMappingRange, wanIPCControlURL},
	{ "GetListOfPortMappings", GetListOfPortMappings, wanIPCControlURL},
#ifdef ENABLE_L3F_SERVICE
	/* Layer3Forwarding */
	{ "SetDefaultConnectionService", SetDefaultConnectionService, L3FControlURL},
	{ "GetDefaultConnectionService", GetDefaultConnectionService, L3FControlURL},
#endif
#ifdef ENABLE_6FC_SERVICE
	/* WANIPv6FirewallControl */
	{ "GetFirewallStatus", GetFirewallStatus, wanIP6FCControlURL},	/* Required */
	{ "AddPinhole", AddPinhole, wanIP6FCControlURL},				/* Required */
	{ "UpdatePinhole", UpdatePinhole, wanIP6FCControlURL},			/* Required */
	{ "GetOutboundPinholeTimeout", GetOutboundPinholeTimeout, wanIP6FCControlURL},	/* Optional */
	{ "DeletePinhole", DeletePinhole, wanIP6FCControlURL},			/* Required */
	{ "CheckPinholeWorking", CheckPinholeWorking, wanIP6FCControlURL},	/* Optional */
	{ "GetPinholePackets", GetPinholePackets, wanIP6FCControlURL},	/* Required */
#endif
	{ 0, 0 }
};
...
ExecuteSoapAction(struct upnphttp * h, const char * action, int n)
{
	...
	if(p)
	{
		...
		while(soapMethods[i].methodName)
		{
			...
			{
				if (0 == strcmp(soapMethods[i].ctlPath, h->req_url))
				{
					soapMethods[i].methodImpl(h, soapMethods[i].methodName);
				}
				else
				{
					syslog(LOG_NOTICE, "SoapMethod: %s: illegal url %s", p, h->req_url);
