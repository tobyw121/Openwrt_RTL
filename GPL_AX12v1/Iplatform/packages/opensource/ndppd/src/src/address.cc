...
bool address::is_local_link_address() const
{
    return (_addr.s6_addr[0] == 0xfe && _addr.s6_addr[1] == 0x80 &&
            _addr.s6_addr[2] == 0x00 && _addr.s6_addr[3] == 0x00 &&
            _addr.s6_addr[4] == 0x00 && _addr.s6_addr[5] == 0x00 &&
            _addr.s6_addr[6] == 0x00 && _addr.s6_addr[7] == 0x00);
}
