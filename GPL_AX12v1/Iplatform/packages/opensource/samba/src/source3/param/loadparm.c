...
static struct parm_struct parm_table[] = {
...
#ifdef GUEST_NETWORK_LIMIT
	{
		.label		= "guest network enable",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.ptr		= &sDefault.bGuestNetworkEnable,
		.special	= NULL,
		.enum_list	= NULL,
		.flags		= FLAG_BASIC | FLAG_ADVANCED | FLAG_SHARE,
	},
	...
	{
		.label		= "deny login names",
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.ptr		= &Globals.szDenyLoginNames,
		.special	= NULL,
		.enum_list	= NULL,
		.flags		= FLAG_ADVANCED,
	},
...
FN_GLOBAL_STRING(lp_deny_login_names, &Globals.szDenyLoginNames)
...
#ifdef GUEST_NETWORK_LIMIT
FN_LOCAL_BOOL(lp_guest_network_enable, bGuestNetworkEnable)
#endif 
