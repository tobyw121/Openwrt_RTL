...
#ifdef ENABLE_SVR_UCI_AUTH || PASSWD_IN_SHADOW

#include <uci.h>

int check_passwd(const unsigned char *username, const unsigned char *password) {
#define PACKAGE_NAME "accountmgnt"
#define CONFIG_TYPE "account"
#define OPTION_USERNAME "username"
#define OPTION_SHADOW "password"
