...
#define LOCAL_SSH_IDENT "SSH-2.0-dropbear_" DROPBEAR_VERSION
#endif
...
#define ISP_FILE_PATH "/etc/3g4g.gz"
//android cmd
#define ALLOWED_SCP_CMD1 "scp -f "ISP_FILE_PATH
//ios cmd
#define ALLOWED_SCP_CMD2 "scp -pf '"ISP_FILE_PATH"'"

#define TM_FILTER_APPS_FILE_PATH "/tmp/tm-shn/list_pc_filter_apps.db.gz"
#define ALLOWED_SCP_CMD3 "scp -f "TM_FILTER_APPS_FILE_PATH
#define ALLOWED_SCP_CMD4 "scp -pf '"TM_FILTER_APPS_FILE_PATH"'"

#define TM_SEC_RULES_FILE_PATH "/tmp/tm-shn/list_security_rules.db.gz"
#define ALLOWED_SCP_CMD5 "scp -f "TM_SEC_RULES_FILE_PATH
#define ALLOWED_SCP_CMD6 "scp -pf '"TM_SEC_RULES_FILE_PATH"'"

#define TM_SEC_WRS_CATS_FILE_PATH "/tmp/tm-shn/list_security_wrs_cats.db.gz"
#define ALLOWED_SCP_CMD7 "scp -f "TM_SEC_WRS_CATS_FILE_PATH
#define ALLOWED_SCP_CMD8 "scp -pf '"TM_SEC_WRS_CATS_FILE_PATH"'"

#define TM_APPBLOCKLIST_FILE_PATH "/tmp/appblock/avira_applist.gz"
#define ALLOWED_SCP_CMD9 "scp -f "TM_APPBLOCKLIST_FILE_PATH
#define ALLOWED_SCP_CMD10 "scp -pf '"TM_APPBLOCKLIST_FILE_PATH"'"
...
#if !(DROPBEAR_AES128 || DROPBEAR_3DES || DROPBEAR_AES256 || DROPBEAR_BLOWFISH || DROPBEAR_TWOFISH256 || DROPBEAR_TWOFISH128)
