...
#define OPTION_NTPSERVER_IP      42
#define OPTION_VENDOR_CLASS_OPT  43
#define OPTION_NBNS_OPT          44     /* NetBIOS over TCP/IP Name Server Option */
#define OPTION_NBDD_OPT          45     /* NetBIOS over TCP/IP Datagram Distribution Server Option */
#define OPTION_NBNT_OPT          46     /* NetBIOS over TCP/IP Node Type Option */
