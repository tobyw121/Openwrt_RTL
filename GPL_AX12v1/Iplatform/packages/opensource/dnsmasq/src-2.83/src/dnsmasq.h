...
#define DNSMASQ_LOG_THRESHOLD LOG_WARNING
...
/* client-type.c */
#ifdef HAVE_DHCP
DEVICE_TYPE device_type_check(const char *p_hostname, const char *p_vendor,
					const unsigned char *p_req_options, size_t max_dhcp_message_size);
#endif
...
int ffs_dns_intercept_hook(const char * name, struct in_addr * addr);
#endif
