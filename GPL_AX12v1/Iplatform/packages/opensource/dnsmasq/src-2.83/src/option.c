...
#ifdef FFS_SUPPORT
#define LOPT_FFS_DOMAIN    361
#define LOPT_FFS_PROTO     362
#define LOPT_FFS_PORT      363
#define LOPT_FFS_ENABLE    364
#endif
