...
static bool xt_nat_checkports_handle(struct sk_buff *skb, struct nf_nat_range2 * dst, 
							const struct nf_nat_ipv4_multi_range_checkports_compat *pCheckParam)
#else
static bool xt_nat_checkports_handle(struct sk_buff *skb, struct nf_nat_range * dst, 
							const struct nf_nat_ipv4_multi_range_checkports_compat *pCheckParam)
#endif
{
...
xt_checkports_target_v0(struct sk_buff *skb, const struct xt_action_param *par)
{
	...
	{
		if( xt_nat_checkports_handle(skb, &range, pCheckParam) )
		{
