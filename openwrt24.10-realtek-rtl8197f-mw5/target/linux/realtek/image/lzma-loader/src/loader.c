		 ...
		 unsigned long reg_a2, unsigned long reg_a3)
{
	...
	printf("\n\nOpenWrt kernel loader for Realtek RTL8197F/RTL8197FH\n");
	...
	/*
	 * The image builder verifies that the complete decompressed kernel plus
	 * appended DTB ends below the linked loader.  With that invariant, the
	 * ordinary decoded size is safe for the cache-maintenance range.
	 */
	cache_size = lzma_outsize;
	flush_cache(kernel_la, cache_size);
