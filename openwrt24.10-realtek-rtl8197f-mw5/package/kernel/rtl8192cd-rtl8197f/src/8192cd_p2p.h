...
#define CLIENT_MODE_WAIT_TIME	10
#define WSC_MODE_WAIT_TIME 20
#define WSC_MODE_WAIT_TIME_GC 20

#define GO_TEAR_DOWN_TIMEOUT 30

#define ALL_GC_GONE_BAKTO_DEV_TIME 1
...
#define UNDER_TMP_GO_TIRGGER_WSCD 7
...
enum {
	...
	P2P_S_CLIENT_back_2_dev	/*P2P client mode when  rx peer's disAssoc   DeAuth */
};
...
struct p2p_context {
	struct mw5_legacy_timer p2p_search_timer_t;
	struct mw5_legacy_timer p2p_find_timer_t;
	...
	unsigned char p2p_probe_rsp_ie[MAX_P2P_IE_LEN + 32];
	...
	unsigned char pre_client_timeout;
	unsigned char pre_go_timeout;
	unsigned char no_gc_cnt;
	...
	unsigned int on_provision_req_cnt;
};
...
//#define P2P_NO_RESP_PROBE 1
//#define P2P_RESP_PROBE 0      //default

//#define P2P_DENY_MORE_CLIENT 1
//#define P2P_ALLOW_MORE_CLIENT 0       //default
#endif
