...
/*@===========================================================*/
    ...
    u8          tdma_adptv_en;
	u8			tdma_adptv_trb_flag;
	u8			tdma_dig_adptv_trb_state_number;
	u8			tdma_dig_adptv_trb_swtch_th;
	u8			fix_expire_to_zero;
	boolean			original_dig_restore;
	boolean		tdmadig_active_en;
	boolean		edcca_by_igi;
	/*@---------------------------*/
...
/*@=== PHYDM Structure ======================================== (start)*/
	...
	u32			retry_cnt; /* AP diagnostic accumulator */
