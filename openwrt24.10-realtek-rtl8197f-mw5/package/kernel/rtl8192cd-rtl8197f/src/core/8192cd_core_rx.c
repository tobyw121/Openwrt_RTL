...
#ifndef RTK_NL80211
static const unsigned char mw5_rfc1042_header[WLAN_LLC_HEADER_SIZE]={0xaa,0xaa,0x03,00,00,00}; //mark_wrt
#else
//For OpenWRT, mw5_rfc1042_header is defined at compat-wireless/net/wireless/util.c
extern const unsigned char mw5_rfc1042_header[];
#endif
/*---------------------------------------------------------------
	return value:
