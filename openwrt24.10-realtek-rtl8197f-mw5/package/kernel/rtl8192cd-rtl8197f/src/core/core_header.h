...
extern void pe_pwr_state(struct rtl8192cd_priv *priv, struct stat_info *pstat, unsigned char sta_state);
extern void pe_sta_hw_queue_set(struct rtl8192cd_priv *priv, struct stat_info *pstat);
#endif
/*============*/
