...
typedef enum {
	WFO_IPC_T2H_PE_READY = 0,
        ...
        WFO_IPC_T2H_FUNC = 5,
        WFO_IPC_T2H_ADD_STAINFO = 6,
        WFO_IPC_T2H_ADD_PRIV_PARAM = 7,
        WFO_IPC_T2H_DEBUG = 8,
        WFO_IPC_T2H_MAX = 9,
} ca_wfo_ipc_t2h_t;
...
typedef enum {
	...
	WFO_IPC_FUNC_MAC_CLONE = 4,
	WFO_IPC_FUNC_ADD_A4_CLIENT = 5,
    WFO_IPC_FUNC_MAX = 6,
} ca_wfo_ipc_func_t;
...
struct func_handler_s{
	...
	bool (* do_func)(struct rtl8192cd_priv *, void*);
};
