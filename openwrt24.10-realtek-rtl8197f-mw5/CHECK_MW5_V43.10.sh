...
check "driver version v43.10" contains "$D" '1.4.10-sdk-mw5-oem-cdp-v43.10'
...
check "TX cleanup clears stale OWN" regex "$D" 'desc->opts1 = cpu_to_le32\(idx == priv->tx_ring_size - 1'
check "RX recycle repairs DMA address" contains "$D" 'also repairs an address field if a malformed completion corrupted it'
check "RX malformed snapshot exists" contains "$D" 'mw5 rx-bad v43.10:'
check "RX malformed payload dump exists" contains "$D" 'mw5 rx-bad v43.10 data:'
check "RX descriptor trace v43.10 exists" contains "$D" 'mw5 rxdesc v43.10:'
check "TX submit trace v43.10 exists" contains "$D" 'mw5 tx-submit v43.10:'
check "TX completion trace v43.10 exists" contains "$D" 'mw5 tx-complete v43.10:'
...
check "tagger logs v43.10" contains "$T" 'rtl4_9 v43.10'
check "netdiag reports v43.10" contains "$N" 'MW5 V43.10 AUTOMATIC WIRED TEST'
...
check "profile announces v43.10" contains "$P" 'MW5 v43.10:'
