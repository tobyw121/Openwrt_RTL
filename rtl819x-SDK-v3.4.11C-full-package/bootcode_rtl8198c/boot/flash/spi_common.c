...
#define SPI_TSLCH(val)			 ((val) << 0)			/*4 bit, 1111 */
...
#define SPICMD_SBULK			(0x39 << 24)	/*  */
#define SPICMD_GBULK			(0x98 << 24)	/*  */
...
#if 0 //Initial 3 byte , need to issue "EN4B" command first
...
#endif 
/*
  1.Set size to 16MB due to SFSIZE no 32MB option //for 3-Byte addressing flash , default is 16MB maximum
  2.Set size to 8MB:
    *When EN4B=1 , flash size above should be multiplied by 4! 
*/
//#define MX25L25735F		0x00C22019
#ifndef CONFIG_SPI_3to4BYTES_ADDRESS_SUPPORT
//8MB*4=32MB
{0x00C22019, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B, "MX25L25735F", 80
#else
//It's 3to4byte addressing SPI flash, initialize is 3-byte addressing and max 16MB
{0x00C22019, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B, "MX25L25635F", 80
#endif
#ifndef CONFIG_SPI_STD_MODE
, ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1//Single IO
//, ComSrlCmd_SE, mxic_cmd_read_d1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1//Dual IO
//, ComSrlCmd_SE, mxic_cmd_read_q1, mxic_spi_setQEBit, mxic_cmd_write_q1//Quad IO
#endif
},
//#define MX25L1635D		0x00C22415
...
{0x008c4014, 0x00, SIZEN_01M, SIZE_064K, SIZE_004K, SIZE_256B, "F25L08", 80
#ifndef CONFIG_SPI_STD_MODE
, ComSrlCmd_SE, mxic_cmd_read_d1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1 //Dual IO
#endif
},
//#define F25L16		0x008c4015
{0x008c4015, 0x00, SIZEN_02M, SIZE_064K, SIZE_004K, SIZE_256B, "F25L16", 80
#ifndef CONFIG_SPI_STD_MODE
, ComSrlCmd_SE, mxic_cmd_read_d1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1 //Dual IO
#endif
},
//#define F25L32		0x008c4116
{0x008c4116, 0x00, SIZEN_04M, SIZE_064K, SIZE_004K, SIZE_256B, "F25L32", 80
#ifndef CONFIG_SPI_STD_MODE
, ComSrlCmd_SE, mxic_cmd_read_d1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1 //Dual IO
#endif
},
//#define F25L64		0x008c4117
{0x008c4117, 0x00, SIZEN_08M, SIZE_064K, SIZE_004K, SIZE_256B, "F25L64", 80
#ifndef CONFIG_SPI_STD_MODE
//, ComSrlCmd_SE, mxic_cmd_read_s1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1//Single IO
, ComSrlCmd_SE, mxic_cmd_read_d1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1 //Dual IO
//, ComSrlCmd_SE, mxic_cmd_read_q1, mxic_spi_setQEBit, mxic_cmd_write_s1//Quad IO
#endif
},
//#define F25L128		0x008c4118
{0x008c4118, 0x00, SIZEN_16M, SIZE_064K, SIZE_004K, SIZE_256B, "F25L128", 80
#ifndef CONFIG_SPI_STD_MODE
, ComSrlCmd_SE, mxic_cmd_read_d1, ComSrlCmd_NoneQeBit, mxic_cmd_write_s1 //Dual IO
#endif
},
...
unsigned int CheckDramFreq(void)                       //JSW:For 8196C
{
	...
	//usFreqBit = (0x00007800 & (*(unsigned int*)0xb8000008)) >> 11 ;
	//NDEBUG("usFreqBit:%d\n", usFreqBit);
...
//	*((volatile unsigned int *)(SFCSR)) = SFCSR_SPI_CSB(1 + (ucChip)) | SFCSR_LEN(ucLen) | SFCSR_SPI_RDY(1) |  SFCSR_IO_WIDTH(ucIOWidth) | SFCSR_CHIP_SEL(0) | SFCSR_CMD_BYTE(0x9f);
...
//	*((volatile unsigned int *)(SFCSR)) = SFCSR_SPI_CSB(3) | SFCSR_LEN(ucLen) | SFCSR_SPI_RDY(1) |  SFCSR_IO_WIDTH(ucIOWidth) | SFCSR_CHIP_SEL(0) | SFCSR_CMD_BYTE(0x9f);
