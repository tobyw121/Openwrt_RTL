...
#undef HW_SETTING_OFFSET

#define HW_SETTING_OFFSET		0x20000
#define DEFAULT_SETTING_OFFSET	0x24000
#define CURRENT_SETTING_OFFSET	0x2a000
#else
#undef HW_SETTING_OFFSET
...
***************************************************************************/
/* main.c */
extern int tftp P((const char *name, int (*)(unsigned char *, int, int, int),int));
