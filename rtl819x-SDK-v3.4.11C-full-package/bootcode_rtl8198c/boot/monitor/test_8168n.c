...
#if 0//<Coverity: DEADCODE> portnum is always 0
	else
	{
		addr=PCIE2_EP_MEM;
	}
...
#undef NULL
#define NULL 0
struct irqaction irq_PCIE = {(void *)PCIE_isr, (unsigned long)NULL, (unsigned long)PCIE_IRQ_NO,"PCIE", (void *)NULL, (struct irqaction *)NULL};   
