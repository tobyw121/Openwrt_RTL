...
#else
#undef DDR3_STD_REF_MS
#undef DDR3_STD_RCD_NS
#undef DDR3_STD_RP_NS
#undef DDR3_STD_RAS_NS
#undef DDR3_STD_WTR_CK
#undef DDR3_STD_WTR_NS
#undef DDR3_STD_WR_NS
#undef DDR3_STD_FAWG_NS
#undef DDR3_STD_RTP_NS
#undef DDR3_STD_RRD_NS
...
#else
#undef DDR3_STD_RFC_128MB_NS
#undef DDR3_STD_RFC_256MB_NS
#undef DDR3_STD_RFC_512MB_NS
#undef DDR3_STD_RFC_1GB_NS

#define DDR3_STD_RFC_64MB_NS	(115)
#define DDR3_STD_RFC_128MB_NS	(115)
#define DDR3_STD_RFC_256MB_NS	(165)
#define DDR3_STD_RFC_512MB_NS	(305)
#define DDR3_STD_RFC_1GB_NS	(355)
#endif
//#define DDR3_STD_RFC_2GB_NS	(350)
//#define DDR3_STD_RFC_4GB_NS	(350)
