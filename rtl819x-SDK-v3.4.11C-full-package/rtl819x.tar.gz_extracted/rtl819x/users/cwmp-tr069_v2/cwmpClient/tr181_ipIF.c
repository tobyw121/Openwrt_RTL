...
#ifdef _PRMT_TR143_
    {&tIpDiagIpPingObjectInfo[eDownloadDiagnostics],	tDownloadDiagnosticsLeaf,NULL},
    {&tIpDiagIpPingObjectInfo[eUploadDiagnostics],	tUploadDiagnosticsLeaf,	NULL},
    {&tIpDiagIpPingObjectInfo[eUDPEchoConfig],	tUDPEchoConfigLeaf,	NULL},
#endif //_PRMT_TR143_
	{NULL,						NULL,			NULL}
};
