...
#define CONFIG_FILE "/web/config.dat"
        ...
        struct stat fstat;
        unsigned char *raw;
        unsigned char *result = malloc(32*1024); // max allowed in spec
...
#if 0
        // upvel test don't start with this
...
/*star:20100312 END*/
		...
		if(fp)
		{
			...
			return ERR_9002;
#endif		
		return 0; //because configfile didn't take effect, just return 0
#else
