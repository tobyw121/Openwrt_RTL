...
extern void rtl8367_setFlowControl(int qosEnable);
#endif
...
#if (defined(CONFIG_RTL_LOCAL_PUBLIC) || defined(CONFIG_RTL_MULTIPLE_WAN) || defined(CONFIG_RTL_REDIRECT_ACL_SUPPORT_FOR_ISP_MULTI_WAN) ||(defined(CONFIG_NET_SCHED)&&defined(CONFIG_RTL_IPTABLES_FAST_PATH))) && defined(CONFIG_RTL_819X_SWCORE)
extern int rtl865x_curOpMode;
...
#if defined CONFIG_RTL_8367_QOS_SUPPORT
	rtl8367_setFlowControl(gQosEnabled);
#endif
