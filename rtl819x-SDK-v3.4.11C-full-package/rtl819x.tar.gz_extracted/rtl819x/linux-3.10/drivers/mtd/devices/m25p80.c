...
static const struct spi_device_id m25p_ids[] = {
	...
	{ "en25q16",   INFO(0x1c3015, 0, 64 * 1024,   32, 0, 41000000, 75000000, 0x0) },
...
//		spi->max_speed_hz = spi->max_speed_hz / 3;
	...
	dev_info(&spi->dev, "%s (%lld Kbytes) (%d Hz)\n", id->name,
			(long long)flash->mtd.size >> 10, spi->max_speed_hz);
	 ...
	 */
#if defined(CONFIG_MTD_RTKXX_PARTS)
	return mtd_device_parse_register(&flash->mtd, probes, NULL, NULL, 0);
#else
