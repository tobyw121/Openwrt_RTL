...
#define CONFIG_NAND_PAGE_SIZE CONFIG_MTD_NAND_RTK_PAGE_SIZE
#endif
...
#define ETRON_RDID_EM73D044SNA			(0xD512)
#define ETRON_MANUFACTURER_ID			(0xD5)
#define ETRON_DEVICE_ID_EM73D044SNA     (0x12)

#define ETRON_RDID_EM73E044SNA			(0xD503)
#define ETRON_MANUFACTURER_ID			(0xD5)
#define ETRON_DEVICE_ID_EM73E044SNA     (0x03)
#if CONFIG_NAND_PAGE_SIZE == 0x800
#define SPI_NAND_PAGE_SPARE_SIZE	(0x800+0x40)
#endif

#if CONFIG_NAND_PAGE_SIZE == 0x1000
#define SPI_NAND_PAGE_SPARE_SIZE	(0x1000+0x80)
#endif
