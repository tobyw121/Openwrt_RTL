...
/* RTL8197F is not an SDIO device, therefore halmac_reg2.h intentionally does
 * not expose the SDIO-only aliases for this chip. halmac_api.c still compiles
 * its unreachable SDIO helper paths, so provide the common 88xx offsets for
 * source compatibility. */
#if HALMAC_8197F_SUPPORT
#ifndef REG_SDIO_INDIRECT_REG_CFG
#define REG_SDIO_INDIRECT_REG_CFG 0x10250040
#endif
#ifndef REG_SDIO_INDIRECT_REG_DATA
