	...
	)
{
	...
	case HAL_HW_TYPE_ID_8192E:
        ...
        case HAL_HW_TYPE_ID_8822B:
			...
			unsigned char hci_type_22b = (HCI_22B >> 12) & 0x7;
			switch (hci_type_22b) {
				case 3:
				case 6:
        ...
        case HAL_HW_TYPE_ID_8822C:
			...
			unsigned char hci_type_22c = (HCI_22C >> 12) & 0x7;
			switch (hci_type_22c) {
				case 3:
				case 6:
        ...
        case HAL_HW_TYPE_ID_8812F:
			...
			unsigned char hci_type_12f = (HCI_12F >> 12) & 0x7;
			switch (hci_type_12f) {
				case 3:
				case 6:
        ...
        case HAL_HW_TYPE_ID_8821C:
			...
			unsigned char hci_type_21c = (HCI_21C >> 12) & 0x3;
			switch (hci_type_21c) {
				case 2:
				case 3:
...
{   
    ...
    if (type == 0) {
        ...
        // TX DESC
        lowAddr = HAL_VIRT_TO_BUS((const volatile void *)(txDescBaseAddr[qNum] + offset * sizeof(TX_DESC_88XX)));
        hiAddr  = HAL_VIRT_TO_BUS((const volatile void *)(lowAddr + sizeof(TX_DESC_88XX)));        
    } else if (type == 2) {    
        // RXBD
