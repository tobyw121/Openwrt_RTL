...
#ifndef CFG_HAL_DUAL_BCN_BUF
#define CFG_HAL_DUAL_BCN_BUF 0
#endif

#ifndef CFG_HAL_AP_PS_OFFLOAD
...
#define CFG_HAL_HW_DETECT_PS_OFFLOAD 0
...
#ifndef TXBD_BEACON_OFFSET_8197F
#define TXBD_BEACON_OFFSET_8197F    TXBD_BEACON_OFFSET_V1
#endif
...
#define NUM_AC_QUEUE_MAX NUM_AC_QUEUE
#if IS_RTL8814B_SERIES
#define NUM_AC_QUEUE_V1                20
#undef NUM_AC_QUEUE_MAX
#define NUM_AC_QUEUE_MAX NUM_AC_QUEUE_V1
#endif

#if (IS_RTL8198F_SERIES || IS_RTL8197G_SERIES)
#define NUM_AC_QUEUE_V2                16
#undef NUM_AC_QUEUE_MAX
#define NUM_AC_QUEUE_MAX NUM_AC_QUEUE_V2
#endif
//4 TRX DMA Queue
...
#define ADDR_CAM_Network_type_No_Link          ~(BIT16|BIT17)
...
#define HAL_CACHE_SYNC_WBACK(Adapter, start, size, direction)   rtl_cache_sync_wback(Adapter, (unsigned long)bus_to_virt(start), size, direction)
#else
