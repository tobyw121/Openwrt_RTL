...
#ifdef DMA_BUF_SEP
#define DESC_DMA_TXBD_PAGE_8814B	((TOTAL_NUM_TXBD_NO_BCN_8814B * sizeof(TX_BUFFER_DESCRIPTOR)))
#define DESC_DMA_TXDESC_PAGE_8814B	(TOTAL_NUM_TXBD_NO_BCN_8814B * SIZE_TXDESC_88XX_8814B)
#define DESC_DMA_BCN_PAGE_8814B		(((1+HAL_NUM_VWLAN) * TXBD_BEACON_OFFSET_MAX) + ((1+HAL_NUM_VWLAN) * SIZE_TXDESC_88XX_8814B))
#else
