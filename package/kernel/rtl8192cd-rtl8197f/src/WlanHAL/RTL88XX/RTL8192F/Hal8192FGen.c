...
#include "../../../data_PHY_REG_PG_8192F_type3.c"
#include "../../../data_PHY_REG_PG_8192F_type19.c"
#include "../../../data_PHY_REG_PG_8192F_type20.c"
#include "../../../data_PHY_REG_PG_8192F_type17.c"
#include "../../../data_PHY_REG_PG_8192F_type21.c"
#if IS_EXIST_PCI
#include "../../../data_rtl8192FfwMP.c"
#endif
#if IS_EXIST_SDIO
...
VAR_MAPPING(PHY_REG_PG_8192F_type3, PHY_REG_PG_8192F_type3);
VAR_MAPPING(PHY_REG_PG_8192F_type19, PHY_REG_PG_8192F_type19);
VAR_MAPPING(PHY_REG_PG_8192F_type20, PHY_REG_PG_8192F_type20);
VAR_MAPPING(PHY_REG_PG_8192F_type17, PHY_REG_PG_8192F_type17);
VAR_MAPPING(PHY_REG_PG_8192F_type21, PHY_REG_PG_8192F_type21);
...
#include "../../../data_TXPWR_LMT_92FE_type3.c"
VAR_MAPPING(TXPWR_LMT_92FE_type3,TXPWR_LMT_92FE_type3);
#include "../../../data_TXPWR_LMT_92FE_type19.c"
VAR_MAPPING(TXPWR_LMT_92FE_type19,TXPWR_LMT_92FE_type19);

#include "../../../data_TXPWR_LMT_92FE_type20.c"
VAR_MAPPING(TXPWR_LMT_92FE_type20,TXPWR_LMT_92FE_type20);

#include "../../../data_TXPWR_LMT_92FE_type17.c"
VAR_MAPPING(TXPWR_LMT_92FE_type17,TXPWR_LMT_92FE_type17);

#include "../../../data_TXPWR_LMT_92FE_type21.c"
VAR_MAPPING(TXPWR_LMT_92FE_type21,TXPWR_LMT_92FE_type21);
