...
/* OpenWrt 24.10 runs Linux 6.6 with cfg80211/mac80211 backported from 6.12.
 * LINUX_VERSION_CODE therefore describes the base kernel, not the wireless
 * callback ABI actually visible to this external module. */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0) || \
    defined(RTL8192CD_CFG80211_BACKPORT_612)
#define RTL8192CD_CFG80211_API_612 1
#endif
...
/*
 * Legacy Realtek mesh/guest-access paths used a vendor-only skb private
 * marker field. Linux 6.x does not expose that field.
 * Do not define a global __unused macro: Linux headers also use __unused as
 * an ordinary bit-field name. Use this driver-local helper at call sites.
 */
#ifndef RTL8192CD_SKB_LEGACY_UNUSED
#define RTL8192CD_SKB_LEGACY_UNUSED(_skb) ((_skb)->cb[0])
#endif
