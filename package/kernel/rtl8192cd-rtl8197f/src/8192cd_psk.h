...
enum { PSK_WPA=1, PSK_WPA2=2, PSK_WPA3=8, OWE_WPA3=16}; /*AUTH_SAE*//*HAPD_OWE*/
...
typedef struct _wpa_global_info {
	...
	int					GTKRekey;
	int					GKeyFailure;
	struct mw5_legacy_timer	GKRekeyTimer;
} WPA_GLOBAL_INFO;
#endif
...
#endif
	unsigned char		sae_ie[256];
	unsigned int		sae_ie_len;
} WPA_STA_INFO;
...
typedef struct _wpa_sta_info {
	...
	struct mw5_legacy_timer	resendTimer;
	struct rtl8192cd_priv	*priv;
	int					resendCnt;
	int					isGuest;
