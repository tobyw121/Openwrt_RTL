...
# MW5 Linux6 uses cfg80211/nl80211 and does not instantiate the legacy VXD
# repeater netdev.  Compiling UNIVERSAL_REPEATER in this profile leaves many
# timer/DFS/security paths able to dereference a NULL pvxd_priv.
ifeq ($(CONFIG_RTL8192CD_LINUX6_BUS),y)
CONFIG_RTL_REPEATER_MODE_SUPPORT :=n
endif
...
ifeq ($(CONFIG_RTL_MESH_SUPPORT),y)
	EXTRA_CFLAGS += -DCONFIG_RTL_MESH_SUPPORT -DCONFIG_RTL_MESH_SINGLE_IFACE
endif
