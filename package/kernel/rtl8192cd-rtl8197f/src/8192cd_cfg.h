...
#include "config_8192cd.h"  

#if defined(CONFIG_OPENWRT_SDK) || defined(CONFIG_WLAN_HAL_8197G)
...
#endif
#ifndef CTC_ORIENTATION_REFINE
	#define CTC_ORIENTATION_REFINE
#endif
#ifndef CTC_AP_COEXIST
	#define CTC_AP_COEXIST
#endif
#endif

#if defined(CONFIG_RTL8672) && !defined(CONFIG_USB_HCI) && !defined(CONFIG_WLAN_HAL_8814BE) && !defined(CONFIG_AX1500)
#ifndef CONFIG_SMP_LOAD_BALANCE_SUPPORT
    #define CONFIG_SMP_LOAD_BALANCE_SUPPORT
#endif
#endif
...
|| defined(CONFIG_MW5_FORCE_WLAN_DEVICE_TABLE)
...
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8812F)
#define MAX_CONFIG_FILE_SIZE (64*1024) // for 8814, added to 64k
#else
#define MAX_CONFIG_FILE_SIZE (20*1024)
#endif

#define MAX_RSV_BUF_SIZE	(64*1024) //reserve for pre-allocated buffer

#define MAX_REG_FILE_SIZE	MAX_CONFIG_FILE_SIZE
...
#define DRV_RELDATE		"2020-10-08"
#define DRV_NAME		"RTK-8192FE-wlan-driver"
...
#define INCLUDE_PROC_FS
	...
	!defined(CONFIG_RTL8192CD_LINUX6_BUS)
...
#define _IOCTL_DEBUG_CMD_		// legacy private ioctl register/memory debug
#endif
...
#define HUAWEI_PORT_UNAUTH_ENQUE
#endif
...
#if defined(_CORTINA_) || defined(CONFIG_RTL8672)
...
#endif
// Support RTK TDMA ATM
// ------------------------------------------------------------

#if defined(CONFIG_RTL_TDMA_ATM_SUPPORT)
#define RTK_TDMA_ATM
//#undef CONFIG_SMP_LOAD_BALANCE_SUPPORT
#endif
...
// CTC_WIFI_DIAGNOSE
//-------------------------------------------------------------
#ifdef CONFIG_CTC_FEATURE_SUPPORT
#define CTC_ORIENTATION_REFINE
#define CTC_AP_COEXIST
#endif
...
#if defined(CONFIG_RTL_CROSSBAND_REPEATER_SUPPORT) || defined(CONFIG_CROSSBAND_REPEATER_SUPPORT_WIFI5_WIFI6)
...
//-------------------------------------------------------------
#if defined(CONFIG_PCI_HCI) && !defined(CONFIG_RTL8192CD_LINUX6_BUS)
//#if !defined(CONFIG_WLAN_HAL_8198F) && !defined(CONFIG_WLAN_HAL_8197G) // charlie, disable CHECK_HANGUP temporarily
#define CHECK_HANGUP
//#endif
//#define CHECK_HANG_DEBUG
	...
	#define CHECK_DATACPU_HANGUP		64
...
#if defined(CONFIG_RTL_HW_ENC_GROUP_CIPHER)
#if defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8814AE) ||\
	defined(CONFIG_WLAN_HAL_8197F) || defined(CONFIG_WLAN_HAL_8192FE) || \
	defined (CONFIG_WLAN_HAL_8812FE) || defined(CONFIG_WLAN_HAL_8197G)
...
/*LUNA ENV, define RTK_NL80211 here*/
...
#ifdef CONFIG_AX1500
/*USDK ENV, define RTK_NL80211 here*/
#ifdef	CONFIG_BACKPORTED_CFG80211
#define RTK_NL80211 1
	/*
	These CFG_XXX_API diff between linux base and backport base ,
	when 8192cd driver under backport env
	you need define CFG80211_FOR_BACKPORT
	*/
#define CFG80211_FOR_BACKPORT

#else

#error ax1500_8192fe_cfg80211_shouldbe_opened
#endif
#endif
...
//-------------------------------------------------------------
// HostAP DPP (Device Provisioning Protocol) Support
//-------------------------------------------------------------
#ifdef CONFIG_HAPD_DPP_SUPPORT
#define HAPD_DPP
#endif
//-------------------------------------------------------------
...
#if !defined(CONFIG_WEXT_PRIV) && !defined(CONFIG_RTL8192CD_LINUX6_BUS)
...
/* 20210324 wpa_supplicant SAE support.  The MW5 bring-up first uses the
 * legacy FullMAC/WEXT control plane; enable this block again with cfg80211. */
#ifndef CONFIG_MW5_LEGACY_WEXT
#define SUPPORT_WPAS_SAE
#ifndef RTK_NL80211
#error SUPPORT_WPAS_SAE must under RTK_NL80211 has enabled
#endif
#endif
#define NOP	((void)0)
#if 1
...
//#define modlog(msg, ...) do {panic_printk("[module_chk][%s %d]: " msg "\n", __func__,__LINE__,##__VA_ARGS__);} while(0)
#define modlog(msg, ...) do {} while(0)


//#define rfelog(msg, ...) do {printk("[RFETYPE][%s %d]: " msg "\n", __func__,__LINE__,##__VA_ARGS__);} while(0)
#define rfelog(msg, ...) do {} while(0)
...
#if defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8812FE)
#define SUPPORT_TX_AMSDU_SMALL_PKTS_ONLY
#endif
#if defined(TX_SHORTCUT)
#if !defined(CONFIG_RTL_8198C) && !defined(CONFIG_RTK_MESH) // && !defined(CONFIG_RTK_MULTI_AP)
...
#define CONFIG_8814B_FWLOG_PRINTK
...
#else
#define WLAN_HAL_TXDESC_CHECK_ADDR_LEN    0
#endif
...
/*********************************************************************/
/* DMA buffer separation */
/*********************************************************************/
#if !defined(PRIV_STA_BUF) && !defined(CONFIG_RTL_OFFLOAD_DRIVER)
#define DMA_BUF_SEP
#ifdef DMA_BUF_SEP
#undef NEW_BUUFER_ALLOCATION
#endif
#endif
...
#define dybw_thrd	3
	...
	#define NUM_RX_DESC		64
		...
		#define NUM_RX_DESC		1024//2048		// Reduce #RXDESC to meet yueme memory requirement
...
#elif (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822BE)) || (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8821CE)) || (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822CE)) || (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8812FE)) 
...
/*-------------------------------------------------------------
// Support Hapd base 802.11V
//-------------------------------------------------------------*/
//#define CONFIG_HAPD_DOT11V_SUPPORT
#ifdef CONFIG_HAPD_DOT11V_SUPPORT
#define HAPD_11V
#endif
...
#ifdef CONFIG_RTL_MBO_SUPPORT
#define CONFIG_MBO
// #define CONFIG_MBO_CLI
#define CONFIG_MBO_TEST
#endif
...
#define SS_AUTO_CHNL_NHM_TO_VALUE   200     //unit:ms
...
// DFS
#define CH_AVAIL_CHK_TO			RTL_SECONDS_TO_JIFFIES(75)	 // 62 seconds
...
/*adjusted for support AMSDU*/
    ...
    #define MAX_RX_BUF_LEN	1820   // wlan0 8822
    #define MIN_RX_BUF_LEN	1820   // wlan0 8822
    #elif defined(CONFIG_RTL_OFFLOAD_DRIVER) && defined(CONFIG_WLAN_HAL_8814BE)
    #define MAX_RX_BUF_LEN	2600   // wlan0 8814B
    #define MIN_RX_BUF_LEN	2600   // wlan0 8814B
...
#if defined(CONFIG_RTK_SOC_RTL8198D) && !defined(CONFIG_RTL_TRIBAND_SUPPORT) // 98D+8812FR+92FR
#undef NUM_TX_DESC
#undef NUM_RX_DESC
#undef NUM_RX_DESC_2G
#undef MAX_RX_BUF_LEN
...
#undef MAX_SKB_NUM
#undef MAX_SKB_NUM_1
#define NUM_TX_DESC         1200
#if !defined(CONCURRENT_MODE) && defined(CONFIG_WLAN_HAL_8192FE)
#define NUM_RX_DESC         500
#else
#define NUM_RX_DESC         1024
#endif
#if defined(CONFIG_WLAN_HAL_8814BE)
#define MAX_RX_BUF_LEN      2600 // for 8812FR
#else
#ifdef SUPPORT_RX_AMSDU_AMPDU
#define MAX_RX_BUF_LEN      4400 // for 8812FR
#else
#if !defined(CONCURRENT_MODE) && defined(CONFIG_WLAN_HAL_8192FE)
#define MAX_RX_BUF_LEN      2000

#else
#define MAX_RX_BUF_LEN      2200
#endif
#endif
#endif
#define NUM_RX_DESC_2G      500
#define MAX_RX_BUF_LEN_1    2000 // for 92FR
#define MIN_RX_BUF_LEN      MAX_RX_BUF_LEN
...
#undef MIN_RX_BUF_LEN
#undef MAX_RX_BUF_LEN
#define NUM_RX_DESC         NUM_RX_DESC_2G
#define MIN_RX_BUF_LEN		MIN_RX_BUF_LEN_1
#define MAX_RX_BUF_LEN		MAX_RX_BUF_LEN_1
#endif

/* Refine TX/RX Buffer define in xDSL/PON platform*/
#elif defined(CONFIG_RTL8672) && defined(RX_BUFFER_GATHER) && !defined(__OSK__)
#undef NUM_TX_DESC
#undef NUM_RX_DESC
#undef NUM_RX_DESC_2G
#undef MAX_RX_BUF_LEN
...
#ifdef CONFIG_WLAN_HAL
#define PRE_ALLOCATED_HDR		(NUM_TX_DESC * 5)
#else
...
#define SUPPORT_CH_NUM		MAX_2G_CHANNEL_NUM
#endif
...
// Support 802.11d
//-------------------------------------------------------------
#if defined(RTK_5G_SUPPORT) || defined(CONFIG_RTL_80211D_SUPPORT) || defined(RTK_NL80211)
#define DOT11D
#endif
...
/*-------------------------------------------------------------
// Support HAPD base OWE security
//-------------------------------------------------------------*/
#ifdef CONFIG_HAPD_OWE_SUPPORT
#define HAPD_OWE
#endif
/*-------------------------------------------------------------
// Support Hapd base 802.11k
//-------------------------------------------------------------*/
//#define CONFIG_HAPD_DOT11K_SUPPORT
#ifdef CONFIG_HAPD_DOT11K_SUPPORT
#define HAPD_11K
#endif
...
#define RTK_SMART_ROAMING_VERSION "Realtek Smart Roaming v3.4.3"
...
#define RTK_MULTI_AP
#ifdef CONFIG_RTK_MULTI_AP_LOGO
#define RTK_MULTI_AP_LOGO
#endif
#ifdef CONFIG_RTK_MULTI_AP_R3
#define RTK_MULTI_AP_R3
#define RTK_MULTI_AP_R2
#endif // CONFIG_RTK_MULTI_AP_R3
#ifdef CONFIG_RTK_MULTI_AP_R2
#define RTK_MULTI_AP_R2
#else
...
#endif
#endif
#define RTK_REPEATER_MODE_DFS_REFINE
#endif
...
#define EASYMESH_VERSION MULTI_AP_VERSION(3, 0, 0)
#else
#ifdef RTK_MULTI_AP_R2
#define EASYMESH_VERSION MULTI_AP_VERSION(2, 0, 0)
#else
#define EASYMESH_VERSION MULTI_AP_VERSION(1, 0, 0)
#endif // RTK_MULTI_AP_R2
#endif // RTK_MULTI_AP_R3
#define SS_MAP_TO		RTL_MILISECONDS_TO_JIFFIES(300)	//MAP channel scan time out
#endif
...
#undef CONFIG_WLAN_STATS_EXTENTION
#endif
...
#if defined(CONFIG_WLAN_HAL_8814BE)
#define PWR_CONSUMPTION_REDUCE			// Wlan CPU - Tx Duty
#endif
#define CONFIG_SUPPORT_DYNAMIC_TXPWR	// BB - Tx Power Offset
#define RTK_STA_BWC
#define THERMAL_CONTROL_DAEMON
#if defined(CONFIG_WLAN_HAL_8192EE)
...
#define RTK_STA_BWC_DIRECT_XMIT
#define RTK_STA_BWC_LEVEL_AVG
#else
#define STATE_INIT 0
...
#define INITIAL_PA 70  // limit Tx throughput to origin's INITIAL_PA percent for the 1st-time of tx duty cycle mechanism
#define SECONDARY_PA 25  // limit Tx to current TP's SECONDARY_PA after 1st limitation
...
//-------------------------------------------------------------
// offload the execution of swq_tasklet to another CPU
//-------------------------------------------------------------
...
//-------------------------------------------------------------
#if defined(SMP_LOAD_BALANCE_SUPPORT) && defined(CONFIG_RTL9607C) && defined(CONCURRENT_MODE)
	#define TX_PROCESS_REFINE
	#define TX_DSR_CPU 0

	// Temporarily disable this feature when 8814B is used
	#ifdef CONFIG_WLAN_HAL_8814BE
		#undef TX_PROCESS_REFINE
	#endif
#endif

//-------------------------------------------------------------
// Offload process_all_queue to another CPU
//-------------------------------------------------------------
#if defined(SMP_SYNC) && defined(CONFIG_RTL9607C) && !defined(CONFIG_USB_HCI) && !defined(CONFIG_WLAN_HAL_8814BE)
	#define WIFI_RX_PROCESS_ALL_QUEUE_OFFLOAD
	#define RX_DATA_OFFLOAD_CPU 1

	// Temporarily disable this feature when 8814B is used
	#ifdef CONFIG_WLAN_HAL_8814BE
		#undef WIFI_RX_PROCESS_ALL_QUEUE_OFFLOAD
	#endif
#endif

// Prevent rxq_tasklet from busy waiting in process_rg_netif_rx_queue()
#if defined(WIFI_RX_PROCESS_ALL_QUEUE_OFFLOAD) && defined(CONFIG_RG_NETIF_RX_QUEUE_SUPPORT)
    #undef CONFIG_RG_NETIF_RX_QUEUE_SUPPORT
#endif

#ifdef WIFI_RX_PROCESS_ALL_QUEUE_OFFLOAD
	#define RING_BASED_DATA_FRAME_QUEUE
#endif

#if (NUM_STAT > FW_NUM_STAT)
#error NUM_STAT_MORE_THAN_FW_NUM_STAT_CHK
#endif

/*FOR HUA WEI struct vap_status_diag_info , arp pkt count*/
#define CONFIG_DIAG_WIFI

#ifdef CONFIG_AX1500
/*NL80211 base directly use hostapd's RSN IE*/
#define DIRECT_HAPD_RSN_IE
#endif
...
#ifdef CONFIG_WIFI_DE_SUPPORT
#define CONFIG_WLAN_DE_SUPPORT
#endif
/* the switch of tx assoc_resp via realtek_mgmt_tx
 *
 * v44.53 / MW5 Linux6: this driver advertises WIPHY_FLAG_HAVE_AP_SME, so
 * cfg80211/hostapd expects the driver SME to complete association and send
 * ASSOC/REASSOC responses.  Report18 showed repeated ASSOC-RX + NEW_STA but
 * zero MW5-ASSOC-RESP markers and the client immediately restarted AUTH.
 * Keep the historical hostapd-reply mode for non-MW5 builds only.
 */
#if !(defined(CONFIG_RTL8192CD_LINUX6_BUS) && defined(CONFIG_MW5_FORCE_WLAN_DEVICE_TABLE))
#define REPLY_ASSOC_BY_HAPD
#endif
/* v44.65.17 MW5 firewall ownership rule. The unified accelerator is the
 * only router-level fast path. WLAN-local descriptor caching/aggregation is
 * radio-internal and retained; bridge/NAT/extension-port shortcuts are not. */
#ifdef CONFIG_MW5_ACCEL
/* v44.65.17: one MW5 acceleration owner only.  Keep the WLAN-local descriptor
 * shortcut machinery, but remove every legacy bridge/NAT/extension-port path
 * which can forward before Linux nftables/conntrack. */
#ifdef BR_SHORTCUT
#undef BR_SHORTCUT
#endif
#ifdef CONFIG_RTL_FASTBRIDGE
#undef CONFIG_RTL_FASTBRIDGE
#endif
#ifdef CONFIG_RTW_BRSC
#undef CONFIG_RTW_BRSC
#endif
#ifdef CONFIG_RTK_BR_SHORTCUT
#undef CONFIG_RTK_BR_SHORTCUT
#endif
#ifdef CONFIG_RTL_EXT_PORT_SUPPORT
#undef CONFIG_RTL_EXT_PORT_SUPPORT
#endif
#ifdef CONFIG_RG_WLAN_HWNAT_ACCELERATION
#undef CONFIG_RG_WLAN_HWNAT_ACCELERATION
#endif
#ifdef CONFIG_HWNAT_FLEETCONTRACK
#undef CONFIG_HWNAT_FLEETCONTRACK
#endif
#ifdef CONFIG_RTK_FC_WLAN_HWNAT_ACCELERATION
#undef CONFIG_RTK_FC_WLAN_HWNAT_ACCELERATION
#endif
#ifdef CONFIG_RTK_L34_FC_KERNEL_MODULE
#undef CONFIG_RTK_L34_FC_KERNEL_MODULE
#endif
#endif
