...
void phydm_adaptive_soml_timers_usb(void *dm_void, u8 state)
{
	...
	if (state == INIT_SOML_TIMMER) {
		mw5_legacy_timer_init(&soml_tab->phydm_adaptive_soml_timer);
...
{
#if (RTL8821C_SUPPORT == 1) || (RTL8195B_SUPPORT == 1) || (RTL8822B_SUPPORT == 1)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#endif
#if (RTL8821C_SUPPORT == 1) || (RTL8195B_SUPPORT == 1) 
