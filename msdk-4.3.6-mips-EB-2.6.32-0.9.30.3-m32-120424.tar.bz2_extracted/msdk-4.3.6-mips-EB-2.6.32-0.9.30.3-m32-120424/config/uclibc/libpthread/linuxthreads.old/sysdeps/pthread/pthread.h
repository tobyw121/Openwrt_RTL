...
extern void *pthread_getattr_np (pthread_t __th, pthread_attr_t *__attr);
#endif
...
extern void _pthread_cleanup_push_defer (struct _pthread_cleanup_buffer *__buffer,
					 ...
					 void *__arg) __THROW;
# ifdef _LIBC
extern __typeof(_pthread_cleanup_push_defer) __pthread_cleanup_push_defer;
...
extern void _pthread_cleanup_pop_restore (struct _pthread_cleanup_buffer *__buffer,
					  int __execute) __THROW;
# ifdef _LIBC
extern __typeof(_pthread_cleanup_pop_restore) __pthread_cleanup_pop_restore;
