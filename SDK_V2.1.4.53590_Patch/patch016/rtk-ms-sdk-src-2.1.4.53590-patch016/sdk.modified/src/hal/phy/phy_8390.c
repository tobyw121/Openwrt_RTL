...
void _phy_8390_serdes_init_96m_1g_fiber (uint32 unit, int sds)
{
    ...
    SERDES_SET(0xb080 + ofst,  11 , 11  , 0x1);
    ...
    else
    {
        ...
        if (8 == sds)
        {
            ...
            SERDES_SET(0xb080,  13 , 13 , 0);
            SERDES_SET(0xb080,  6  , 6  , 1);
            SERDES_SET(0xb080,  12 , 12 , portNwayState[24]);
        ...
        else
        {
            ...
            SERDES_SET(0xb880,  13 , 13 , 0);
            SERDES_SET(0xb880,  6  , 6  , 1);
            SERDES_SET(0xb880,  12 , 12 , portNwayState[36]);
    ...
    SERDES_SET(0xb080 + ofst,  11 , 11  , 0x0);
