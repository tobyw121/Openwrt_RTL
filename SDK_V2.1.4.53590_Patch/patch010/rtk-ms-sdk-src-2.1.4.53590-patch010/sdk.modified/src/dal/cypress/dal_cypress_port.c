...
/* Function Name:
 *      dal_cypress_port_phyFiberTxDis_set
 * Description:
 ...
 */
int32
dal_cypress_port_phyFiberTxDis_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    int32   ret;
    ...
    return RT_ERR_OK;
}   /* end of dal_cypress_port_phyFiberTxDis_set */


/* Function Name:
 *      dal_cypress_port_phyFiberTxDisPin_set
 * Description:
 ...
 */
int32
dal_cypress_port_phyFiberTxDisPin_set(uint32 unit, rtk_port_t port, uint32 data)
{
    int32   ret;
    ...
    return RT_ERR_OK;
}   /* end of dal_cypress_port_phyFiberTxDisPin_set */
