 ...
 * Data Declaration
 */
rt_phydrv_t phy_8390_serdes_ge =
{
    ...
    (int32 (*)(uint32, rtk_port_t, rtk_enable_t))phy_common_unavail,
    (int32 (*)(uint32, rtk_port_t, uint32))phy_common_unavail,
}; /* end of phy_8390_serdes_ge */

void _phy_8390_init_fiber_1g_s12(uint32 unit)
{
    SERDES_SET(0xb818,  3 , 3  , 0x0);
    SERDES_SET(0xbbfc,  16 , 16  , 0x1);
    SERDES_SET(0xbbfc,  19 , 18  , 0x2);
    SERDES_SET(0xbb58,  0 , 0  , 0x1);
    SERDES_SET(0xbb58,  4 , 4  , 0x1);
    SERDES_SET(0xbb58,  16 , 16  , 0x1);
    SERDES_SET(0xbb58,  20 , 20  , 0x1);

    SERDES_SET(0xbb38,  15 , 0  , 0x8722);
    SERDES_SET(0xbb40,  15 , 0  , 0x18f5);
    SERDES_SET(0xbb00,  11 , 11  , 0x0);
    SERDES_SET(0xb804,  9 , 8  , 0x0);
    SERDES_SET(0xb880,  13 , 13  , 0x0);
    SERDES_SET(0xb880,  6 , 6  , 0x1);
    SERDES_SET(0xb880,  12 , 12  , 0x1);

    SERDES_SET(0xbb20,  5 , 5  , 0x1);
    SERDES_SET(0xbb1c,  11 , 7  , 0x15);

    SERDES_SET(0xbbf8,  21 , 20  , 0x3);
    SERDES_SET(0xbb20,  3  , 3  , 0x0);
    SERDES_SET(0xbb40,  15  , 15  , 0x1);
    osal_time_usleep(100 * 1000);
    SERDES_SET(0xbb40,  15  , 15  , 0x0);
    SERDES_SET(0xbbf8,  21 , 20  , 0x1);
    SERDES_SET(0xbbf8,  21 , 20  , 0x0);
}

void _phy_8390_init_fiber_1g_s13(uint32 unit)
{
    SERDES_SET(0xb918,  3 , 3  , 0x0);
    SERDES_SET(0xbbfc,  17 , 17  , 0x1);
    SERDES_SET(0xbbfc,  21 , 20  , 0x2);
    SERDES_SET(0xbbd8,  0 , 0  , 0x1);
    SERDES_SET(0xbbd8,  4 , 4  , 0x1);
    SERDES_SET(0xbbd8,  16 , 16  , 0x1);
    SERDES_SET(0xbbd8,  20 , 20  , 0x1);

    SERDES_SET(0xbbb8,  15 , 0  , 0x8722);
    SERDES_SET(0xbbc0,  15 , 0  , 0x18f5);
    SERDES_SET(0xbb80,  11 , 11  , 0x0);
    SERDES_SET(0xb904,  9 , 8  , 0x0);
    SERDES_SET(0xb980,  13 , 13  , 0x0);
    SERDES_SET(0xb980,  6 , 6  , 0x1);
    SERDES_SET(0xb980,  12 , 12  , 0x1);

    SERDES_SET(0xbba0,  5 , 5  , 0x1);
    SERDES_SET(0xbb9c,  11 , 7  , 0x15);

    SERDES_SET(0xbbf8,  23 , 22  , 0x0003);
    SERDES_SET(0xbba0,  3  , 3  , 0x0);
    SERDES_SET(0xbbc0,  15  , 15  , 0x1);

    osal_time_usleep(100 * 1000);

    SERDES_SET(0xbbc0,  15  , 15  , 0x0);
    SERDES_SET(0xbbf8,  23 , 22  , 0x0001);
    SERDES_SET(0xbbf8,  23 , 22  , 0x0000);
}

void _phy_8390_init_fiber_100_s12(uint32 unit)
{
    SERDES_SET(0xbbfc,  16 , 16  , 0x0);
    SERDES_SET(0xbbfc,  19 , 18  , 0x0);
    SERDES_SET(0xbb58,  0 , 0  , 0x0);
    SERDES_SET(0xbb58,  4 , 4  , 0x0);
    SERDES_SET(0xbb58,  16 , 16  , 0x0);
    SERDES_SET(0xbb58,  20 , 20  , 0x0);

    SERDES_SET(0xb880,  12 , 12  , 0x0);
    SERDES_SET(0xb880,  13 , 13  , 0x1);
    SERDES_SET(0xb880,  6 , 6  , 0x0);
...
{
    SERDES_SET(0xbbfc,  17 , 17  , 0x0);
    SERDES_SET(0xbbfc,  21 , 20  , 0x0);
    SERDES_SET(0xbbd8,  0 , 0  , 0x0);
    SERDES_SET(0xbbd8,  4 , 4  , 0x0);
    SERDES_SET(0xbbd8,  16 , 16  , 0x0);
    SERDES_SET(0xbbd8,  20 , 20  , 0x0);

    SERDES_SET(0xb980,  12 , 12  , 0x0);
    SERDES_SET(0xb980,  13 , 13  , 0x1);
    SERDES_SET(0xb980,  6 , 6  , 0x0);
...
{
    SERDES_SET(0xb3f8,  21 , 20  , 0x0003);
    ...
    SERDES_SET(0xb3f8,  21 , 20  , 0x0001);
    SERDES_SET(0xb3f8,  21 , 20  , 0x0000);

    SERDES_SET(0xb004,  22 , 22  , 0x0001);
    osal_time_usleep(100 * 1000);
    SERDES_SET(0xb004,  22 , 22  , 0x0000);
}

void _phy_8390_sfp_rst_s12(uint32 unit)
{
    SERDES_SET(0xbbf8,  21 , 20  , 0x0003);
    SERDES_SET(0xbb20,  3  , 3  , 0x0);
    SERDES_SET(0xbb40,  15  , 15  , 0x1);
    ...
    SERDES_SET(0xbb40,  15  , 15  , 0x0);
    SERDES_SET(0xbbf8,  21 , 20  , 0x0001);
    SERDES_SET(0xbbf8,  21 , 20  , 0x0000);

    SERDES_SET(0xb804,  22 , 22  , 0x0001);
    osal_time_usleep(100 * 1000);
    SERDES_SET(0xb804,  22 , 22  , 0x0000);
}
...
void _phy_8390_sfp_rst_s13(uint32 unit)
{
    ...
    SERDES_SET(0xb904,  22 , 22  , 0x0001);
    osal_time_usleep(100 * 1000);
    SERDES_SET(0xb904,  22 , 22  , 0x0000);
}
...
void _phy_8390_serdes_10g_rx_rst (uint32 unit, int sds_num)
{
    ...
    SERDES_SET(0xB004 + ofst,  31,  16 , 0x7146);
    osal_time_usleep(10 * 1000);
    SERDES_SET(0xB004 + ofst,  31,  16 , 0x7106);
    ...
    if (HAL_GET_CHIP_REV_ID(unit) >= CHIP_REV_ID_C)
    {
        SERDES_SET(0xb318 + ofst, 26, 26, 1);
    }
...
void _phy_8390_efusRead_config(uint32 unit, uint32 addr)
{
    uint32  val;

    reg_field_write(unit, CYPRESS_EFUSE_CMDr, CYPRESS_EFUSE_ADDRf, &addr);

    val = 0;
    reg_field_write(unit, CYPRESS_EFUSE_CMDr, CYPRESS_EFUSE_RWOPf, &val);

    val = 1;
    reg_field_write(unit, CYPRESS_EFUSE_CMDr, CYPRESS_EFUSE_CMDf, &val);
}   /* end of _phy_8390_efusRead_config */

int _phy_8390_efuse_chk(uint32 unit)
{
    uint32  val;
    int     i;
    ...
    for (i = 0; i < 30; ++i)
    {
        reg_field_read(unit, CYPRESS_EFUSE_CMDr, CYPRESS_EFUSE_CTRL_DONEf, &val);
        if (val)
        {
            return 1;
        }
    ...
    return 0;
}   /* end of _phy_8390_efuse_chk */

int _phy_8390_serdes_init_efuseConfig_set(uint32 unit, uint32 reg, uint32 addr)
{
    uint32  data, val;

    _phy_8390_efusRead_config(unit, ++addr);
    val = _phy_8390_efuse_chk(unit);
    if (!val)
    {
        return 0;
    }

    reg_read(unit, CYPRESS_EFUSE_RDATAr, &val);
    data = val << 16;
    ...
    return 1;
}   /* end of _phy_8390_serdes_init_efuseConfig_set */

void _phy_8390_serdes_init_efuseConfig(uint32 unit, int sds)
{
    uint32  val;
    uint32  addr, reg, idx;

    val = 0xa;
    reg_field_write(unit, CYPRESS_CHIP_INFOr, CYPRESS_CHIP_INFO_ENf, &val);
    ...
    for (idx = 0; idx <= 21; ++idx)
    {
        ...
        reg_read(unit, CYPRESS_EFUSE_RDATAr, &reg);
        ...
        switch (reg)
        {
            ...
            case 0xb320:
                if (8 == sds)
                    _phy_8390_serdes_init_efuseConfig_set(unit, reg, addr);
                break;
            case 0xbb18:
            case 0xbb1c:
            case 0xbb20:
    ...
    val = 0x0;
    reg_field_write(unit, CYPRESS_CHIP_INFOr, CYPRESS_CHIP_INFO_ENf, &val);
}   /* end of _phy_8390_serdes_init_efuseConfig */
...
void _phy_8390_serdes_10g_enable(uint32 unit, int sds,
    rtk_port_10gMedia_t media)
{
    ...
    if (8 == sds)
    {
        SERDES_SET(0x000c,  3  , 0  , val);
    }
    else if (12 == sds)
    {
        SERDES_SET(0x000c,  19 , 16 , val);
    }
    ...
    if (HAL_GET_CHIP_REV_ID(unit) < CHIP_REV_ID_C)
    {
        switch (media)
        {
            ...
            case PORT_10GMEDIA_FIBER_1G:
                if (8 == sds)
                    SERDES_SET(0x031c,  7  , 0  , 0x0);
                else
                    SERDES_SET(0x034c,  7  , 0  , 0x0);
                break;
            default:
                return;
        }
...
void _phy_8390_serdes_10g_foreground_offset_range_cali (uint32 unit, int sds_num)
{
    ...
    while (cnt < 4)
    {
        ...
        if ((ofst_range == 0x3) && (fgcal_offset == 0x0 || fgcal_offset == 0xf))
        {
            break;
        }
        else if ((fgcal_offset != 0x0) && (fgcal_offset != 0xf))
        {
            break;
        }
        else
...
void _phy_8390_serdes_init_10gr_50cm_copper (uint32 unit, int sds)
{
    if (HAL_GET_CHIP_REV_ID(unit) >= CHIP_REV_ID_C)
        return;
    ...
    if (8 == sds)
    {
        ...
        SERDES_SET(0xB350,  31 , 0  , 0x033EC3E0);
    ...
    else if (12 == sds)
    {
        ...
        SERDES_SET(0xBB50,  31 , 0  , 0x033EC3E0);
    ...
    _phy_8390_serdes_init_10gr_rx_current(unit, sds);

    _phy_8390_serdes_init_efuseConfig(unit, sds);
}   /* end of _phy_8390_serdes_init_10gr_50cm_copper */

void _phy_8390_serdes_init_10gr_100cm_copper (uint32 unit, int sds)
{
    if (HAL_GET_CHIP_REV_ID(unit) >= CHIP_REV_ID_C)
        return;
    ...
    if (8 == sds)
    {
        ...
        SERDES_SET(0xB34C,  31 , 0  , 0x0057C4F7);
        SERDES_SET(0xB350,  31 , 0  , 0x033EE3E0);
        SERDES_SET(0xB354,  31 , 0  , 0x2002619C);
        SERDES_SET(0xB358,  31 , 0  , 0xEEFAEAE2);
        SERDES_SET(0xB35C,  31 , 0  , 0x0E4B4A50);
        SERDES_SET(0xB360,  31 , 0  , 0x00000000);
    ...
    else if (12 == sds)
    {
        ...
        SERDES_SET(0xBB4C,  31 , 0  , 0x0057C4F7);
        SERDES_SET(0xBB50,  31 , 0  , 0x033EE3E0);
        SERDES_SET(0xBB54,  31 , 0  , 0x2002619C);
        SERDES_SET(0xBB58,  31 , 0  , 0xEEFAEAE2);
        SERDES_SET(0xBB5C,  31 , 0  , 0x0E4B4A50);
        SERDES_SET(0xBB60,  31 , 0  , 0x00000000);
    ...
    _phy_8390_serdes_init_efuseConfig(unit, sds);
}   /* end of _phy_8390_serdes_init_10gr_100cm_copper */

void _phy_8390_serdes_init_10gr_300cm_copper (uint32 unit, int sds)
{
    if (HAL_GET_CHIP_REV_ID(unit) >= CHIP_REV_ID_C)
        return;
    ...
    _phy_8390_serdes_init_efuseConfig(unit, sds);
}   /* end of _phy_8390_serdes_init_10gr_300cm_copper */
...
void _phy_8390_serdes_10g_dfe_adapt (uint32 unit, int sds_num)
{
    uint32  ofst;
    uint32  leq;
    uint32  tapMaxChk = 10;
    ...
    tap0_val = sum/10;
    SERDES_SET(0xb32c + ofst,  21 , 16 , tap0_val);
    SERDES_SET(0xb318 + ofst,  8  , 8  , 1);
    SERDES_SET(0xb318 + ofst,  0  , 0  , 0);
    ...
    osal_time_usleep(10 * 1000);
    SERDES_SET(0xb284 + ofst,  12 , 12 , 0);
}   /* end of _phy_8390_serdes_10g_dfe_adapt */
...
void _phy_8390_serdes_init_10gr_fiber (uint32 unit, int sds)
{
    ...
    if (HAL_GET_CHIP_REV_ID(unit) < CHIP_REV_ID_C)
    {
        if (8 == sds)
        {
            ...
            SERDES_SET(0xB344,  31 , 0  , 0xFFCC4206);
        ...
        _phy_8390_serdes_init_10gr_leq(unit, sds);

        _phy_8390_serdes_init_efuseConfig(unit, sds);
    }
    else if (HAL_GET_CHIP_REV_ID(unit) == CHIP_REV_ID_C)
    {
        if (8 == sds)
        {
            SERDES_SET(0x000c,  3 , 0  , 0x0);
            ...
            phy_8390_10gSds_restart(unit, 24);
        }
        else
        {
            SERDES_SET(0x000c,  19 , 16  , 0x0);
            ...
            _phy_8390_serdes_10g_foreground_offset_range_cali(unit, sds);
            phy_8390_10gSds_restart(unit, 36);
        }
    }
    else
    {
        ...
        SERDES_SET(0xB308 + ofst,  31 , 0  , 0x80009000);
        SERDES_SET(0xB30C + ofst,  31 , 0  , 0xFFFFBFFF);
        SERDES_SET(0xB310 + ofst,  31 , 0  , 0x806FFFFF);
        SERDES_SET(0xB314 + ofst,  31 , 0  , 0x400003E4);
        SERDES_SET(0xB318 + ofst,  31 , 0  , 0x241F7F80);
        SERDES_SET(0xB31C + ofst,  31 , 0  , 0x242D8A00);
        SERDES_SET(0xB320 + ofst,  31 , 0  , 0x984A3F16);
        _phy_8390_serdes_init_efuseConfig(unit, sds);
        SERDES_SET(0xB324 + ofst,  31 , 0  , 0xF108B632);
        SERDES_SET(0xB328 + ofst,  31 , 0  , 0x00001F73);
        SERDES_SET(0xB32C + ofst,  31 , 0  , 0xFFDF0020);
        ...
        SERDES_SET(0xB340 + ofst,  31 , 0  , 0x97E044F1);
...
{
    uint32  sds, pollSts = 0, utpLedSts = 1, val;
    int     ret;
    ...
    {
        val = 0;
        reg_array_field_write(unit, CYPRESS_MAC_FORCE_MODE_CTRLr, port,
                REG_ARRAY_INDEX_NONE, CYPRESS_FORCE_LINK_ENf, &val);
        val = 1;
        reg_array_field_write(unit, CYPRESS_MAC_FORCE_MODE_CTRLr, port,
                REG_ARRAY_INDEX_NONE, CYPRESS_MAC_FORCE_ENf, &val);
    ...
    switch (media)
    {
        ...
        case PORT_10GMEDIA_FIBER_1G:
            ...
            break;
        case PORT_10GMEDIA_DAC_50CM:
            _phy_8390_serdes_init_10gr_50cm_copper(unit, sds);
            break;
        case PORT_10GMEDIA_DAC_100CM:
            _phy_8390_serdes_init_10gr_100cm_copper(unit, sds);
            break;
        case PORT_10GMEDIA_DAC_300CM:
            _phy_8390_serdes_init_10gr_300cm_copper(unit, sds);
            break;
        default:
            ret = RT_ERR_INPUT;
            return ret;
    ...
    _phy_8390_serdes_10g_enable(unit, sds, media);

    ret = reg_array_field_write(unit, CYPRESS_SMI_PORT_POLLING_CTRLr,
            port, REG_ARRAY_INDEX_NONE,
            CYPRESS_SMI_POLLING_PMSKf, &pollSts);

    ret = reg_array_field_write(unit, CYPRESS_LED_FIB_PMASK_CTRLr,
            port, REG_ARRAY_INDEX_NONE,
            CYPRESS_FIB_PMASKf, &pollSts);

    ret = reg_array_field_write(unit, CYPRESS_LED_COPR_PMASK_CTRLr,
            port, REG_ARRAY_INDEX_NONE,
            CYPRESS_COPR_PMASKf, &utpLedSts);
...
phy_8390_speed_set(uint32 unit, rtk_port_t port, uint32 speed)
{
    ...
    if (HAL_IS_SERDES_10GE_PORT(unit, port))
    {
        ...
        if ((ret = phy_8390_speed_get(unit, port, &curSpeed)) != RT_ERR_OK)
            return ret;
        ...
        {
            case PORT_SPEED_10G:
                ret = phy_8390_10gMedia_set(unit, port,
    ...
    switch (speed)
    {
        ...
        case PORT_SPEED_100M:
            ...
            break;
        default:
            RT_ERR(RT_ERR_FAILED, (MOD_HAL), "port %d speed %d", port, speed);
...
phy_8390_10gSds_restart(uint32 unit, rtk_port_t port)
{
    ...
    if (HAL_GET_CHIP_REV_ID(unit) == CHIP_REV_ID_C)
        ...
        _phy_8390_serdes_10g_dfe_adapt(unit, sds);
    return RT_ERR_OK;
...
{
    uint32  reg, val, speed, rxReg = 0, rxField = 0;
    int32   ret;

    if (HAL_IS_SERDES_10GE_PORT(unit, port))
    {
        uint32  sds, txVal;
        uint32  stsVal, stsReg; /* For ES chip force link */
        uint32  ofst;
        ...
        if (PORT_SPEED_10G == speed)
        {
            ...
            /* For Tx configure */
            ioal_mem32_read(unit, reg, &val);
            val &= ~(0x3 << 20);
            val |= (txVal << 20);
            ioal_mem32_write(unit, reg, val);

            /* For ES chip force link */
            if (HAL_GET_CHIP_REV_ID(unit) < CHIP_REV_ID_C)
            {
                ioal_mem32_write(unit, stsReg, stsVal);
            }
...
/* Function Name:
 *      _phy_8390_extendPageLinkDown_watchdog
 * Description:
 *      For direct fiber port link down, update MAC link status
 *      Rx extend page cause, MAC polling link status incorrect.
 * Input:
 *      unit    - unit id
 *      port    - port id
 * Output:
 ...
 *      None
 */
void _phy_8390_extendPageLinkDown_watchdog(uint32 unit, rtk_port_t port)
{
    uint32  reg, val;

    /* check serdes link status */
    ...
    /* read twice for latch */
    reg_field_read(unit, reg, CYPRESS_FR1_LINK_STATUSf, &val);
    reg_field_read(unit, reg, CYPRESS_FR1_LINK_STATUSf, &val);
    if (0 == val)
    {
        /* check MAC link status */
        /* read twice for latch */
        reg_array_field_read(unit, CYPRESS_MAC_LINK_STSr, port,
                  REG_ARRAY_INDEX_NONE, CYPRESS_LINK_STSf, &val);
        reg_array_field_read(unit, CYPRESS_MAC_LINK_STSr, port,
                  REG_ARRAY_INDEX_NONE, CYPRESS_LINK_STSf, &val);

        /* MAC link status is different with serdes */
        if (1 == val)
        {
            reg_field_write(unit, reg, CYPRESS_SR0_AFE_LPKf, &val);
    ...
    return;
}   /* end of _phy_8390_extendPageLinkDown_watchdog */

/* Function Name:
 *      _phy_8390_rxFail_watchdog
 * Description:
 *      For direct fiber port far end fault, it won't TX idle code
 * Input:
 *      unit    - unit id
 *      port    - port id
 * Output:
 ...
 *      None
 */
void _phy_8390_rxFail_watchdog(uint32 unit, rtk_port_t port)
{
    uint32  reg, val;
    ...
    {
        /* check signal */
        reg_field_read(unit, reg, CYPRESS_SRE29_SIGNOK_LATf, &val);
        if (0 == val)
        {
            reg_field_read(unit, reg, CYPRESS_FR16_ANA_RG2Xf, &val);
            val &= ~(1 << 9);
            reg_field_write(unit, reg, CYPRESS_FR16_ANA_RG2Xf, &val);
        }
        else
        {
            reg_field_read(unit, reg, CYPRESS_FR16_ANA_RG2Xf, &val);
    ...
    return;
}   /* end of _phy_8390_rxFail_watchdog */
...
void phy_8390_linkdown_watchdog(uint32 unit)
{
    ...
    if(HAL_GET_SERDES_PORT_NUM(unit) == 0)
        return;

    for (port = HAL_GET_MIN_SERDES_PORT(unit); port <= HAL_GET_MAX_SERDES_PORT(unit); ++port)
    {
        ...
        {
            _phy_8390_extendPageLinkDown_watchdog(unit, port);
            _phy_8390_rxFail_watchdog(unit, port);
        }
    }
}   /* end of phy_8390_linkdown_watchdog */
#endif  /* CONFIG_SDK_WA_SERDES_FIBER_LINKDOWN_WATCHDOG */
