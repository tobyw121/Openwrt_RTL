...
int32 _rtk_getHsb(uint32 unit, hsb_param_t * hsb)
{
    ...
    if (CHIP_FAMILY_IS_RTL8389(pInfo->chip_id))
    {
...
#endif
#if defined(CONFIG_SDK_RTL8328)
    if (CHIP_FAMILY_IS_RTL8328(pInfo->chip_id))
    {
...
#endif
#if defined(CONFIG_SDK_RTL8390)
    if (CHIP_FAMILY_IS_RTL8350(pInfo->chip_id)   ||
        CHIP_FAMILY_IS_RTL8390(pInfo->chip_id))
    ...
    if (CHIP_FAMILY_IS_RTL8330(pInfo->chip_id) ||
        CHIP_FAMILY_IS_RTL8380(pInfo->chip_id))
    {
        /* HSB_DATA0 */
